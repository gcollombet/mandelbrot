# stop-preset-dropdown-preview Specification

## Purpose
Defines the compact stop preset dropdown, 32x32 visual row previews, and inline favorite/remote upload actions.
