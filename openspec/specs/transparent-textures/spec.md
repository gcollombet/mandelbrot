# transparent-textures Specification

## Purpose
Defines the blending rules and displacement masks for rendering tile and tessellation textures containing transparent pixels.
