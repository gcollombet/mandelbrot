# progressive-render-pipeline Specification

## Purpose
Defines the in-place compute pipeline selection, active pixel write gates, ping-pong pipeline fallback, and color/resolve bypass gating during rendering convergence.
