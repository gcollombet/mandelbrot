...
export async function fixtureManifest(): Promise<ExpmapManifest> {
  ...
  return { version: 5, name: 'Fixture', quality:0.9, forceRender: false, documentId: 'fixture', generation: 0, state: 'preparing', createdAt: '2026-09-05', scaleConvention: 'VideoPathLocation.scale', zoomReferenceScale: '1e0',
