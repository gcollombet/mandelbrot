...
export const EFFECT_FIELD_CONFIG: Record<EffectFieldName, EffectFieldMeta> = {
  ...
  reliefGain:          { label: 'Relief Gain',        defaultValue: 1.0, min: 0, max: 2,   step: 0.01, unit: '', textureRow: 6, textureChannel: 0, uiGroup: 'lighting' },
  protrusion:          { label: 'Protrusion',         defaultValue: 0.0, min: 0, max: 1,   step: 0.01, unit: '', textureRow: 6, textureChannel: 3, uiGroup: 'lighting' },
