...
<style scoped>
.dims{display:flex;align-items:center;gap:6px;margin:3px 0}.dims label{display:flex;flex-direction:column;gap:2px;flex:1;min-width:0;font-size:10px}.dims input{width:100%;min-width:0;background:var(--row);color:inherit;border:1px solid var(--line);border-radius:4px;padding:3px}
