(async ()=>{
    var qe = "" + new URL("mandelbrot_bg-BSpgMR6_.wasm", import.meta.url).href, e_ = async (n = {}, e)=>{
        let i;
    ...
    const Ne = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((n)=>t.__wbg_mobiusbufferinfo_free(n, 1)), De = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((n)=>t.__wbg_orbitbufferinfo_free(n, 1)), Oe = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    ...
    c_(ho);
    He();
    const yo = 3, $e = 21, ko = 6, Pe = 27, xo = 4;
    function Ro(n, e) {
