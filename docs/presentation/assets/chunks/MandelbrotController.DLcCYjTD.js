var Da=Object.defineProperty;var Ua=(pe,se,be)=>se in pe?Da(pe,se,{enumerable:!0,configurable:!0,writable:!0,value:be}):pe[se]=be;var n=(pe,se,be)=>Ua(pe,typeof se!="symbol"?se+"":se,be);import{aq as Na,ar as Oa,as as Ia,d as wt,at as ne,z as Ze,p as _r,s as mr,o as Fe,c as De,au as Ue,y as zt,U as Va,av as Ha,j as T,an as qa,n as de,J as St,T as Ya,w as Wa,a as $a,a2 as ja,e as Xa,_ as vr}from"./framework.R1PXT97o.js";let br,Mt,Za=(async()=>{const pe=`// Mandelbrot progressive-iteration shader.
//
...
`,wr=`// Merge pass: fuses the resolved (live) and frozen textures into a new frozen
...
`,zr=async(t={},e)=>{let r;if(e.startsWith("data:")){const i=e.replace(/^data:.*?base64,/,"");let a;if(typeof Buffer=="function"&&typeof Buffer.from=="function")a=Buffer.from(i,"base64");else if(typeof atob=="function"){const o=atob(i);a=new Uint8Array(o.length);for(let s=0;s<o.length;s++)a[s]=o.charCodeAt(s)}else throw new Error("Cannot decode base64-encoded data URL");r=await WebAssembly.instantiate(a,t)}else{const i=await fetch(e),a=i.headers.get("Content-Type")||"";if("instantiateStreaming"in WebAssembly&&a.startsWith("application/wasm"))r=await WebAssembly.instantiateStreaming(i,t);else{const o=await i.arrayBuffer();r=await WebAssembly.instantiate(o,t)}}return r.instance.exports};let p;function Sr(t){p=t}let Ne=null;function Oe(){return(Ne===null||Ne.byteLength===0)&&(Ne=new Uint8Array(p.memory.buffer)),Ne}let Ie=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});Ie.decode();const Mr=2146435072;let Ke=0;function Tr(t,e){return Ke+=e,Ke>=Mr&&(Ie=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),Ie.decode(),Ke=e),Ie.decode(Oe().subarray(t,t+e))}function Tt(t,e){return t=t>>>0,Tr(t,e)}let xe=null;function kr(){return(xe===null||xe.buffer.detached===!0||xe.buffer.detached===void 0&&xe.buffer!==p.memory.buffer)&&(xe=new DataView(p.memory.buffer)),xe}function Je(t,e){t=t>>>0;const r=kr(),i=[];for(let a=t;a<t+4*e;a+=4)i.push(p.__wbindgen_export_0.get(r.getUint32(a,!0)));return p.__externref_drop_slice(t,e),i}let fe=0;const Ce=new TextEncoder;"encodeInto"in Ce||(Ce.encodeInto=function(t,e){const r=Ce.encode(t);return e.set(r),{read:t.length,written:r.length}});function ye(t,e,r){if(r===void 0){const l=Ce.encode(t),c=e(l.length,1)>>>0;return Oe().subarray(c,c+l.length).set(l),fe=l.length,c}let i=t.length,a=e(i,1)>>>0;const o=Oe();let s=0;for(;s<i;s++){const l=t.charCodeAt(s);if(l>127)break;o[a+s]=l}if(s!==i){s!==0&&(t=t.slice(s)),a=r(a,i,i=s+t.length*3,1)>>>0;const l=Oe().subarray(a+s,a+i),c=Ce.encodeInto(t,l);s+=c.written,a=r(a,i,s,1)>>>0}return fe=s,a}const kt=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>p.__wbg_blabufferinfo_free(t>>>0,1));class Re{static __wrap(e){e=e>>>0;const r=Object.create(Re.prototype);return r.__wbg_ptr=e,kt.register(r,r.__wbg_ptr,r),r}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,kt.unregister(this),e}free(){const e=this.__destroy_into_raw();p.__wbg_blabufferinfo_free(e,0)}get ptr(){return p.__wbg_get_blabufferinfo_ptr(this.__wbg_ptr)>>>0}set ptr(e){p.__wbg_set_blabufferinfo_ptr(this.__wbg_ptr,e)}get count(){return p.__wbg_get_blabufferinfo_count(this.__wbg_ptr)>>>0}set count(e){p.__wbg_set_blabufferinfo_count(this.__wbg_ptr,e)}get levels_ptr(){return p.__wbg_get_blabufferinfo_levels_ptr(this.__wbg_ptr)>>>0}set levels_ptr(e){p.__wbg_set_blabufferinfo_levels_ptr(this.__wbg_ptr,e)}get level_count(){return p.__wbg_get_blabufferinfo_level_count(this.__wbg_ptr)>>>0}set level_count(e){p.__wbg_set_blabufferinfo_level_count(this.__wbg_ptr,e)}}Symbol.dispose&&(Re.prototype[Symbol.dispose]=Re.prototype.free),typeof FinalizationRegistry>"u"||new FinalizationRegistry(t=>p.__wbg_blalevel_free(t>>>0,1)),typeof FinalizationRegistry>"u"||new FinalizationRegistry(t=>p.__wbg_blastep_free(t>>>0,1));const Bt=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>p.__wbg_mandelbrotnavigator_free(t>>>0,1));class Qe{__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,Bt.unregister(this),e}free(){const e=this.__destroy_into_raw();p.__wbg_mandelbrotnavigator_free(e,0)}get_params(){const e=p.mandelbrotnavigator_get_params(this.__wbg_ptr);var r=Je(e[0],e[1]).slice();return p.__wbindgen_free(e[0],e[1]*4,4),r}rotate_direct(e){p.mandelbrotnavigator_rotate_direct(this.__wbg_ptr,e)}get_bla_epsilon(){return p.mandelbrotnavigator_get_bla_epsilon(this.__wbg_ptr)}set_bla_epsilon(e){p.mandelbrotnavigator_set_bla_epsilon(this.__wbg_ptr,e)}pixel_to_complex(e,r,i,a){const o=p.mandelbrotnavigator_pixel_to_complex(this.__wbg_ptr,e,r,i,a);var s=Je(o[0],o[1]).slice();return p.__wbindgen_free(o[0],o[1]*4,4),s}translate_direct(e,r){p.mandelbrotnavigator_translate_direct(this.__wbg_ptr,e,r)}use_perturbation(){p.mandelbrotnavigator_use_perturbation(this.__wbg_ptr)}get_approximation_mode(){return p.mandelbrotnavigator_get_approximation_mode(this.__wbg_ptr)}get_reference_orbit_len(){return p.mandelbrotnavigator_get_reference_orbit_len(this.__wbg_ptr)>>>0}compute_bla_reference_ptr(e){const r=p.mandelbrotnavigator_compute_bla_reference_ptr(this.__wbg_ptr,e);return Re.__wrap(r)}compute_reference_orbit_ptr(e){const r=p.mandelbrotnavigator_compute_reference_orbit_ptr(this.__wbg_ptr,e);return we.__wrap(r)}get_reference_orbit_capacity(){return p.mandelbrotnavigator_get_reference_orbit_capacity(this.__wbg_ptr)>>>0}compute_reference_orbit_chunk(e,r){const i=p.mandelbrotnavigator_compute_reference_orbit_chunk(this.__wbg_ptr,e,r);return we.__wrap(i)}constructor(e,r,i,a){const o=ye(e,p.__wbindgen_malloc,p.__wbindgen_realloc),s=fe,l=ye(r,p.__wbindgen_malloc,p.__wbindgen_realloc),c=fe,z=ye(i,p.__wbindgen_malloc,p.__wbindgen_realloc),h=fe,b=p.mandelbrotnavigator_new(o,s,l,c,z,h,a);return this.__wbg_ptr=b>>>0,Bt.register(this,this.__wbg_ptr,this),this}step(){const e=p.mandelbrotnavigator_step(this.__wbg_ptr);var r=Je(e[0],e[1]).slice();return p.__wbindgen_free(e[0],e[1]*4,4),r}zoom(e){p.mandelbrotnavigator_zoom(this.__wbg_ptr,e)}angle(e){p.mandelbrotnavigator_angle(this.__wbg_ptr,e)}scale(e){const r=ye(e,p.__wbindgen_malloc,p.__wbindgen_realloc),i=fe;p.mandelbrotnavigator_scale(this.__wbg_ptr,r,i)}origin(e,r){const i=ye(e,p.__wbindgen_malloc,p.__wbindgen_realloc),a=fe,o=ye(r,p.__wbindgen_malloc,p.__wbindgen_realloc),s=fe;p.mandelbrotnavigator_origin(this.__wbg_ptr,i,a,o,s)}rotate(e){p.mandelbrotnavigator_rotate(this.__wbg_ptr,e)}use_bla(){p.mandelbrotnavigator_use_bla(this.__wbg_ptr)}translate(e,r){p.mandelbrotnavigator_translate(this.__wbg_ptr,e,r)}}Symbol.dispose&&(Qe.prototype[Symbol.dispose]=Qe.prototype.free),typeof FinalizationRegistry>"u"||new FinalizationRegistry(t=>p.__wbg_mandelbrotstep_free(t>>>0,1));const Lt=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>p.__wbg_orbitbufferinfo_free(t>>>0,1));class we{static __wrap(e){e=e>>>0;const r=Object.create(we.prototype);return r.__wbg_ptr=e,Lt.register(r,r.__wbg_ptr,r),r}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,Lt.unregister(this),e}free(){const e=this.__destroy_into_raw();p.__wbg_orbitbufferinfo_free(e,0)}get ptr(){return p.__wbg_get_blabufferinfo_ptr(this.__wbg_ptr)>>>0}set ptr(e){p.__wbg_set_blabufferinfo_ptr(this.__wbg_ptr,e)}get offset(){return p.__wbg_get_blabufferinfo_count(this.__wbg_ptr)>>>0}set offset(e){p.__wbg_set_blabufferinfo_count(this.__wbg_ptr,e)}get count(){return p.__wbg_get_blabufferinfo_levels_ptr(this.__wbg_ptr)>>>0}set count(e){p.__wbg_set_blabufferinfo_levels_ptr(this.__wbg_ptr,e)}}Symbol.dispose&&(we.prototype[Symbol.dispose]=we.prototype.free);function Br(t){return Math.exp(t)}function Lr(){return Date.now()}function Cr(t,e){throw new Error(Tt(t,e))}function Rr(t,e){return Tt(t,e)}function Pr(){const t=p.__wbindgen_export_0,e=t.grow(4);t.set(0,void 0),t.set(e+0,void 0),t.set(e+1,null),t.set(e+2,!0),t.set(e+3,!1)}URL=globalThis.URL;const f=await zr({"./mandelbrot_bg.js":{__wbg_now_1e80617bcee43265:Lr,__wbg_exp_9293ded1248e1bd3:Br,__wbg_wbindgenthrow_451ec1a8469d7eb6:Cr,__wbindgen_init_externref_table:Pr,__wbindgen_cast_2241b6af4c4b2941:Rr}},Na),Ve=f.memory,Er=f.__wbg_blabufferinfo_free,Ar=f.__wbg_blalevel_free,Gr=f.__wbg_blastep_free,Fr=f.__wbg_get_blabufferinfo_count,Dr=f.__wbg_get_blabufferinfo_level_count,Ur=f.__wbg_get_blabufferinfo_levels_ptr,Nr=f.__wbg_get_blabufferinfo_ptr,Or=f.__wbg_get_blastep_ax,Ir=f.__wbg_get_blastep_ay,Vr=f.__wbg_get_blastep_bx,Hr=f.__wbg_get_blastep_by,qr=f.__wbg_get_blastep_radius_alpha,Yr=f.__wbg_get_blastep_radius_beta,Wr=f.__wbg_mandelbrotnavigator_free,$r=f.__wbg_mandelbrotstep_free,jr=f.__wbg_orbitbufferinfo_free,Xr=f.__wbg_set_blabufferinfo_count,Zr=f.__wbg_set_blabufferinfo_level_count,Kr=f.__wbg_set_blabufferinfo_levels_ptr,Jr=f.__wbg_set_blabufferinfo_ptr,Qr=f.__wbg_set_blastep_ax,ei=f.__wbg_set_blastep_ay,ti=f.__wbg_set_blastep_bx,ri=f.__wbg_set_blastep_by,ii=f.__wbg_set_blastep_radius_alpha,ai=f.__wbg_set_blastep_radius_beta,oi=f.mandelbrotnavigator_angle,ni=f.mandelbrotnavigator_compute_bla_reference_ptr,si=f.mandelbrotnavigator_compute_reference_orbit_chunk,li=f.mandelbrotnavigator_compute_reference_orbit_ptr,ui=f.mandelbrotnavigator_get_approximation_mode,ci=f.mandelbrotnavigator_get_bla_epsilon,di=f.mandelbrotnavigator_get_params,fi=f.mandelbrotnavigator_get_reference_orbit_capacity,hi=f.mandelbrotnavigator_get_reference_orbit_len,pi=f.mandelbrotnavigator_new,gi=f.mandelbrotnavigator_origin,_i=f.mandelbrotnavigator_pixel_to_complex,mi=f.mandelbrotnavigator_rotate,vi=f.mandelbrotnavigator_rotate_direct,bi=f.mandelbrotnavigator_scale,xi=f.mandelbrotnavigator_set_bla_epsilon,yi=f.mandelbrotnavigator_step,wi=f.mandelbrotnavigator_translate,zi=f.mandelbrotnavigator_translate_direct,Si=f.mandelbrotnavigator_use_bla,Mi=f.mandelbrotnavigator_use_perturbation,Ti=f.mandelbrotnavigator_zoom,ki=f.__wbg_set_blalevel__padding,Bi=f.__wbg_set_blalevel_count,Li=f.__wbg_set_blalevel_offset,Ci=f.__wbg_set_blalevel_skip,Ri=f.__wbg_set_mandelbrotstep_dx,Pi=f.__wbg_set_mandelbrotstep_dy,Ei=f.__wbg_set_mandelbrotstep_zx,Ai=f.__wbg_set_mandelbrotstep_zy,Gi=f.__wbg_set_orbitbufferinfo_count,Fi=f.__wbg_set_orbitbufferinfo_offset,Di=f.__wbg_set_orbitbufferinfo_ptr,Ui=f.__wbg_get_blalevel__padding,Ni=f.__wbg_get_blalevel_count,Oi=f.__wbg_get_blalevel_offset,Ii=f.__wbg_get_blalevel_skip,Vi=f.__wbg_get_orbitbufferinfo_count,Hi=f.__wbg_get_orbitbufferinfo_offset,qi=f.__wbg_get_orbitbufferinfo_ptr,Yi=f.__wbg_get_mandelbrotstep_dx,Wi=f.__wbg_get_mandelbrotstep_dy,$i=f.__wbg_get_mandelbrotstep_zx,ji=f.__wbg_get_mandelbrotstep_zy,Xi=f.__wbindgen_export_0,Zi=f.__externref_drop_slice,Ki=f.__wbindgen_free,Ji=f.__wbindgen_malloc,Qi=f.__wbindgen_realloc,Ct=f.__wbindgen_start,ea=Object.freeze(Object.defineProperty({__proto__:null,__externref_drop_slice:Zi,__wbg_blabufferinfo_free:Er,__wbg_blalevel_free:Ar,__wbg_blastep_free:Gr,__wbg_get_blabufferinfo_count:Fr,__wbg_get_blabufferinfo_level_count:Dr,__wbg_get_blabufferinfo_levels_ptr:Ur,__wbg_get_blabufferinfo_ptr:Nr,__wbg_get_blalevel__padding:Ui,__wbg_get_blalevel_count:Ni,__wbg_get_blalevel_offset:Oi,__wbg_get_blalevel_skip:Ii,__wbg_get_blastep_ax:Or,__wbg_get_blastep_ay:Ir,__wbg_get_blastep_bx:Vr,__wbg_get_blastep_by:Hr,__wbg_get_blastep_radius_alpha:qr,__wbg_get_blastep_radius_beta:Yr,__wbg_get_mandelbrotstep_dx:Yi,__wbg_get_mandelbrotstep_dy:Wi,__wbg_get_mandelbrotstep_zx:$i,__wbg_get_mandelbrotstep_zy:ji,__wbg_get_orbitbufferinfo_count:Vi,__wbg_get_orbitbufferinfo_offset:Hi,__wbg_get_orbitbufferinfo_ptr:qi,__wbg_mandelbrotnavigator_free:Wr,__wbg_mandelbrotstep_free:$r,__wbg_orbitbufferinfo_free:jr,__wbg_set_blabufferinfo_count:Xr,__wbg_set_blabufferinfo_level_count:Zr,__wbg_set_blabufferinfo_levels_ptr:Kr,__wbg_set_blabufferinfo_ptr:Jr,__wbg_set_blalevel__padding:ki,__wbg_set_blalevel_count:Bi,__wbg_set_blalevel_offset:Li,__wbg_set_blalevel_skip:Ci,__wbg_set_blastep_ax:Qr,__wbg_set_blastep_ay:ei,__wbg_set_blastep_bx:ti,__wbg_set_blastep_by:ri,__wbg_set_blastep_radius_alpha:ii,__wbg_set_blastep_radius_beta:ai,__wbg_set_mandelbrotstep_dx:Ri,__wbg_set_mandelbrotstep_dy:Pi,__wbg_set_mandelbrotstep_zx:Ei,__wbg_set_mandelbrotstep_zy:Ai,__wbg_set_orbitbufferinfo_count:Gi,__wbg_set_orbitbufferinfo_offset:Fi,__wbg_set_orbitbufferinfo_ptr:Di,__wbindgen_export_0:Xi,__wbindgen_free:Ki,__wbindgen_malloc:Ji,__wbindgen_realloc:Qi,__wbindgen_start:Ct,mandelbrotnavigator_angle:oi,mandelbrotnavigator_compute_bla_reference_ptr:ni,mandelbrotnavigator_compute_reference_orbit_chunk:si,mandelbrotnavigator_compute_reference_orbit_ptr:li,mandelbrotnavigator_get_approximation_mode:ui,mandelbrotnavigator_get_bla_epsilon:ci,mandelbrotnavigator_get_params:di,mandelbrotnavigator_get_reference_orbit_capacity:fi,mandelbrotnavigator_get_reference_orbit_len:hi,mandelbrotnavigator_new:pi,mandelbrotnavigator_origin:gi,mandelbrotnavigator_pixel_to_complex:_i,mandelbrotnavigator_rotate:mi,mandelbrotnavigator_rotate_direct:vi,mandelbrotnavigator_scale:bi,mandelbrotnavigator_set_bla_epsilon:xi,mandelbrotnavigator_step:yi,mandelbrotnavigator_translate:wi,mandelbrotnavigator_translate_direct:zi,mandelbrotnavigator_use_bla:Si,mandelbrotnavigator_use_perturbation:Mi,mandelbrotnavigator_zoom:Ti,memory:Ve},Symbol.toStringTag,{value:"Module"}));Sr(ea),Ct();class ta{constructor(e=1024,r=1024){n(this,"video");n(this,"stream",null);n(this,"width");n(this,"height");n(this,"lastDrawTime",0);this.width=e,this.height=r,this.video=document.createElement("video"),this.video.autoplay=!0,this.video.width=e,this.video.height=r}async openWebcam(){this.stream||(this.stream=await navigator.mediaDevices.getUserMedia({video:{width:this.width,height:this.height}}),this.video.srcObject=this.stream,await this.video.play())}async drawWebGPUTexture(e,r){const i=performance.now();if(i-this.lastDrawTime>15){if(this.video.readyState<HTMLMediaElement.HAVE_CURRENT_DATA)return;r.queue.copyExternalImageToTexture({source:this.video},{texture:e},[this.width,this.height]),this.lastDrawTime=i}}closeWebcam(){this.stream&&(this.stream.getTracks().forEach(e=>e.stop()),this.stream=null)}}function ze(t,e,r){t.prototype=e.prototype=r,r.constructor=t}function Pe(t,e){var r=Object.create(t.prototype);for(var i in e)r[i]=e[i];return r}function he(){}var ge=.7,Se=1/ge,Me="\\s*([+-]?\\d+)\\s*",Ee="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",re="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",ra=/^#([0-9a-f]{3,8})$/,ia=new RegExp(`^rgb\\(${Me},${Me},${Me}\\)$`),aa=new RegExp(`^rgb\\(${re},${re},${re}\\)$`),oa=new RegExp(`^rgba\\(${Me},${Me},${Me},${Ee}\\)$`),na=new RegExp(`^rgba\\(${re},${re},${re},${Ee}\\)$`),sa=new RegExp(`^hsl\\(${Ee},${re},${re}\\)$`),la=new RegExp(`^hsla\\(${Ee},${re},${re},${Ee}\\)$`),Rt={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};ze(he,et,{copy(t){return Object.assign(new this.constructor,this,t)},displayable(){return this.rgb().displayable()},hex:Pt,formatHex:Pt,formatHex8:ua,formatHsl:ca,formatRgb:Et,toString:Et});function Pt(){return this.rgb().formatHex()}function ua(){return this.rgb().formatHex8()}function ca(){return Ut(this).formatHsl()}function Et(){return this.rgb().formatRgb()}function et(t){var e,r;return t=(t+"").trim().toLowerCase(),(e=ra.exec(t))?(r=e[1].length,e=parseInt(e[1],16),r===6?At(e):r===3?new I(e>>8&15|e>>4&240,e>>4&15|e&240,(e&15)<<4|e&15,1):r===8?He(e>>24&255,e>>16&255,e>>8&255,(e&255)/255):r===4?He(e>>12&15|e>>8&240,e>>8&15|e>>4&240,e>>4&15|e&240,((e&15)<<4|e&15)/255):null):(e=ia.exec(t))?new I(e[1],e[2],e[3],1):(e=aa.exec(t))?new I(e[1]*255/100,e[2]*255/100,e[3]*255/100,1):(e=oa.exec(t))?He(e[1],e[2],e[3],e[4]):(e=na.exec(t))?He(e[1]*255/100,e[2]*255/100,e[3]*255/100,e[4]):(e=sa.exec(t))?Dt(e[1],e[2]/100,e[3]/100,1):(e=la.exec(t))?Dt(e[1],e[2]/100,e[3]/100,e[4]):Rt.hasOwnProperty(t)?At(Rt[t]):t==="transparent"?new I(NaN,NaN,NaN,0):null}function At(t){return new I(t>>16&255,t>>8&255,t&255,1)}function He(t,e,r,i){return i<=0&&(t=e=r=NaN),new I(t,e,r,i)}function tt(t){return t instanceof he||(t=et(t)),t?(t=t.rgb(),new I(t.r,t.g,t.b,t.opacity)):new I}function Te(t,e,r,i){return arguments.length===1?tt(t):new I(t,e,r,i??1)}function I(t,e,r,i){this.r=+t,this.g=+e,this.b=+r,this.opacity=+i}ze(I,Te,Pe(he,{brighter(t){return t=t==null?Se:Math.pow(Se,t),new I(this.r*t,this.g*t,this.b*t,this.opacity)},darker(t){return t=t==null?ge:Math.pow(ge,t),new I(this.r*t,this.g*t,this.b*t,this.opacity)},rgb(){return this},clamp(){return new I(_e(this.r),_e(this.g),_e(this.b),qe(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:Gt,formatHex:Gt,formatHex8:da,formatRgb:Ft,toString:Ft}));function Gt(){return`#${me(this.r)}${me(this.g)}${me(this.b)}`}function da(){return`#${me(this.r)}${me(this.g)}${me(this.b)}${me((isNaN(this.opacity)?1:this.opacity)*255)}`}function Ft(){const t=qe(this.opacity);return`${t===1?"rgb(":"rgba("}${_e(this.r)}, ${_e(this.g)}, ${_e(this.b)}${t===1?")":`, ${t})`}`}function qe(t){return isNaN(t)?1:Math.max(0,Math.min(1,t))}function _e(t){return Math.max(0,Math.min(255,Math.round(t)||0))}function me(t){return t=_e(t),(t<16?"0":"")+t.toString(16)}function Dt(t,e,r,i){return i<=0?t=e=r=NaN:r<=0||r>=1?t=e=NaN:e<=0&&(t=NaN),new ee(t,e,r,i)}function Ut(t){if(t instanceof ee)return new ee(t.h,t.s,t.l,t.opacity);if(t instanceof he||(t=et(t)),!t)return new ee;if(t instanceof ee)return t;t=t.rgb();var e=t.r/255,r=t.g/255,i=t.b/255,a=Math.min(e,r,i),o=Math.max(e,r,i),s=NaN,l=o-a,c=(o+a)/2;return l?(e===o?s=(r-i)/l+(r<i)*6:r===o?s=(i-e)/l+2:s=(e-r)/l+4,l/=c<.5?o+a:2-o-a,s*=60):l=c>0&&c<1?0:s,new ee(s,l,c,t.opacity)}function rt(t,e,r,i){return arguments.length===1?Ut(t):new ee(t,e,r,i??1)}function ee(t,e,r,i){this.h=+t,this.s=+e,this.l=+r,this.opacity=+i}ze(ee,rt,Pe(he,{brighter(t){return t=t==null?Se:Math.pow(Se,t),new ee(this.h,this.s,this.l*t,this.opacity)},darker(t){return t=t==null?ge:Math.pow(ge,t),new ee(this.h,this.s,this.l*t,this.opacity)},rgb(){var t=this.h%360+(this.h<0)*360,e=isNaN(t)||isNaN(this.s)?0:this.s,r=this.l,i=r+(r<.5?r:1-r)*e,a=2*r-i;return new I(it(t>=240?t-240:t+120,a,i),it(t,a,i),it(t<120?t+240:t-120,a,i),this.opacity)},clamp(){return new ee(Nt(this.h),Ye(this.s),Ye(this.l),qe(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const t=qe(this.opacity);return`${t===1?"hsl(":"hsla("}${Nt(this.h)}, ${Ye(this.s)*100}%, ${Ye(this.l)*100}%${t===1?")":`, ${t})`}`}}));function Nt(t){return t=(t||0)%360,t<0?t+360:t}function Ye(t){return Math.max(0,Math.min(1,t||0))}function it(t,e,r){return(t<60?e+(r-e)*t/60:t<180?r:t<240?e+(r-e)*(240-t)/60:e)*255}const Ot=Math.PI/180,It=180/Math.PI,We=18,Vt=.96422,Ht=1,qt=.82521,Yt=4/29,ke=6/29,Wt=3*ke*ke,fa=ke*ke*ke;function $t(t){if(t instanceof ie)return new ie(t.l,t.a,t.b,t.opacity);if(t instanceof le)return jt(t);t instanceof I||(t=tt(t));var e=lt(t.r),r=lt(t.g),i=lt(t.b),a=ot((.2225045*e+.7168786*r+.0606169*i)/Ht),o,s;return e===r&&r===i?o=s=a:(o=ot((.4360747*e+.3850649*r+.1430804*i)/Vt),s=ot((.0139322*e+.0971045*r+.7141733*i)/qt)),new ie(116*a-16,500*(o-a),200*(a-s),t.opacity)}function at(t,e,r,i){return arguments.length===1?$t(t):new ie(t,e,r,i??1)}function ie(t,e,r,i){this.l=+t,this.a=+e,this.b=+r,this.opacity=+i}ze(ie,at,Pe(he,{brighter(t){return new ie(this.l+We*(t??1),this.a,this.b,this.opacity)},darker(t){return new ie(this.l-We*(t??1),this.a,this.b,this.opacity)},rgb(){var t=(this.l+16)/116,e=isNaN(this.a)?t:t+this.a/500,r=isNaN(this.b)?t:t-this.b/200;return e=Vt*nt(e),t=Ht*nt(t),r=qt*nt(r),new I(st(3.1338561*e-1.6168667*t-.4906146*r),st(-.9787684*e+1.9161415*t+.033454*r),st(.0719453*e-.2289914*t+1.4052427*r),this.opacity)}}));function ot(t){return t>fa?Math.pow(t,1/3):t/Wt+Yt}function nt(t){return t>ke?t*t*t:Wt*(t-Yt)}function st(t){return 255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)}function lt(t){return(t/=255)<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)}function ha(t){if(t instanceof le)return new le(t.h,t.c,t.l,t.opacity);if(t instanceof ie||(t=$t(t)),t.a===0&&t.b===0)return new le(NaN,0<t.l&&t.l<100?0:NaN,t.l,t.opacity);var e=Math.atan2(t.b,t.a)*It;return new le(e<0?e+360:e,Math.sqrt(t.a*t.a+t.b*t.b),t.l,t.opacity)}function ut(t,e,r,i){return arguments.length===1?ha(t):new le(t,e,r,i??1)}function le(t,e,r,i){this.h=+t,this.c=+e,this.l=+r,this.opacity=+i}function jt(t){if(isNaN(t.h))return new ie(t.l,0,0,t.opacity);var e=t.h*Ot;return new ie(t.l,Math.cos(e)*t.c,Math.sin(e)*t.c,t.opacity)}ze(le,ut,Pe(he,{brighter(t){return new le(this.h,this.c,this.l+We*(t??1),this.opacity)},darker(t){return new le(this.h,this.c,this.l-We*(t??1),this.opacity)},rgb(){return jt(this).rgb()}}));var Xt=-.14861,ct=1.78277,dt=-.29227,$e=-.90649,Ae=1.97294,Zt=Ae*$e,Kt=Ae*ct,Jt=ct*dt-$e*Xt;function pa(t){if(t instanceof ve)return new ve(t.h,t.s,t.l,t.opacity);t instanceof I||(t=tt(t));var e=t.r/255,r=t.g/255,i=t.b/255,a=(Jt*i+Zt*e-Kt*r)/(Jt+Zt-Kt),o=i-a,s=(Ae*(r-a)-dt*o)/$e,l=Math.sqrt(s*s+o*o)/(Ae*a*(1-a)),c=l?Math.atan2(s,o)*It-120:NaN;return new ve(c<0?c+360:c,l,a,t.opacity)}function ft(t,e,r,i){return arguments.length===1?pa(t):new ve(t,e,r,i??1)}function ve(t,e,r,i){this.h=+t,this.s=+e,this.l=+r,this.opacity=+i}ze(ve,ft,Pe(he,{brighter(t){return t=t==null?Se:Math.pow(Se,t),new ve(this.h,this.s,this.l*t,this.opacity)},darker(t){return t=t==null?ge:Math.pow(ge,t),new ve(this.h,this.s,this.l*t,this.opacity)},rgb(){var t=isNaN(this.h)?0:(this.h+120)*Ot,e=+this.l,r=isNaN(this.s)?0:this.s*e*(1-e),i=Math.cos(t),a=Math.sin(t);return new I(255*(e+r*(Xt*i+ct*a)),255*(e+r*(dt*i+$e*a)),255*(e+r*(Ae*i)),this.opacity)}}));const ht=t=>()=>t;function Qt(t,e){return function(r){return t+r*e}}function ga(t,e,r){return t=Math.pow(t,r),e=Math.pow(e,r)-t,r=1/r,function(i){return Math.pow(t+i*e,r)}}function pt(t,e){var r=e-t;return r?Qt(t,r>180||r<-180?r-360*Math.round(r/360):r):ht(isNaN(t)?e:t)}function _a(t){return(t=+t)==1?Y:function(e,r){return r-e?ga(e,r,t):ht(isNaN(e)?r:e)}}function Y(t,e){var r=e-t;return r?Qt(t,r):ht(isNaN(t)?e:t)}const ma=(function t(e){var r=_a(e);function i(a,o){var s=r((a=Te(a)).r,(o=Te(o)).r),l=r(a.g,o.g),c=r(a.b,o.b),z=Y(a.opacity,o.opacity);return function(h){return a.r=s(h),a.g=l(h),a.b=c(h),a.opacity=z(h),a+""}}return i.gamma=t,i})(1);function va(t){return function(e,r){var i=t((e=rt(e)).h,(r=rt(r)).h),a=Y(e.s,r.s),o=Y(e.l,r.l),s=Y(e.opacity,r.opacity);return function(l){return e.h=i(l),e.s=a(l),e.l=o(l),e.opacity=s(l),e+""}}}const ba=va(pt);function er(t,e){var r=Y((t=at(t)).l,(e=at(e)).l),i=Y(t.a,e.a),a=Y(t.b,e.b),o=Y(t.opacity,e.opacity);return function(s){return t.l=r(s),t.a=i(s),t.b=a(s),t.opacity=o(s),t+""}}function xa(t){return function(e,r){var i=t((e=ut(e)).h,(r=ut(r)).h),a=Y(e.c,r.c),o=Y(e.l,r.l),s=Y(e.opacity,r.opacity);return function(l){return e.h=i(l),e.c=a(l),e.l=o(l),e.opacity=s(l),e+""}}}const ya=xa(pt);function tr(t){return(function e(r){r=+r;function i(a,o){var s=t((a=ft(a)).h,(o=ft(o)).h),l=Y(a.s,o.s),c=Y(a.l,o.l),z=Y(a.opacity,o.opacity);return function(h){return a.h=s(h),a.s=l(h),a.l=c(Math.pow(h,r)),a.opacity=z(h),a+""}}return i.gamma=e,i})(1)}const wa=tr(pt);tr(Y);const gt={palette:1,zebra:0,tessellation:0,shading:0,skybox:0,webcam:0,smoothness:1,shadingLevel:1.5,specularPower:20,lightAngle:.75,metallic:0,roughness:.35,anisotropy:.4};function je(t,e){return t[e]??gt[e]}const za={lab:er,rgb:ma,hcl:ya,hsl:ba,cubehelix:wa},rr=4096,Sa=4;function Ma(t,e,r,i){const a=je(t,r),o=je(e,r);return a+(o-a)*i}class ir{constructor(e,r="lab"){n(this,"points");n(this,"interpolate");this.points=e.slice().sort((i,a)=>i.position-a.position),this.interpolate=za[r]??er}getColorAt(e){if(this.points.length===0)return"#000";if(e<=this.points[0].position)return this.points[0].color;if(e>=this.points[this.points.length-1].position)return this.points[this.points.length-1].color;for(let r=0;r<this.points.length-1;++r){const i=this.points[r],a=this.points[r+1];if(e>=i.position&&e<=a.position){const o=(e-i.position)/(a.position-i.position),s=this.interpolate(i.color,a.color);return Te(s(o)).formatHex()}}return"#000"}getEffectAt(e,r){if(this.points.length===0)return gt[r];if(e<=this.points[0].position)return je(this.points[0],r);if(e>=this.points[this.points.length-1].position)return je(this.points[this.points.length-1],r);for(let i=0;i<this.points.length-1;++i){const a=this.points[i],o=this.points[i+1];if(e>=a.position&&e<=o.position){const s=(e-a.position)/(o.position-a.position);return Ma(a,o,r,s)}}return gt[r]}generateTexture(){const e=rr,r=Sa,i=new Float32Array(e*r*4);for(let a=0;a<e;++a){const o=a/(e-1),s=Te(this.getColorAt(o)),l=(0*e+a)*4;i[l]=(s.r??0)/255,i[l+1]=(s.g??0)/255,i[l+2]=(s.b??0)/255,i[l+3]=this.getEffectAt(o,"palette");const c=(1*e+a)*4;i[c]=this.getEffectAt(o,"zebra"),i[c+1]=this.getEffectAt(o,"tessellation"),i[c+2]=this.getEffectAt(o,"shading"),i[c+3]=this.getEffectAt(o,"skybox");const z=(2*e+a)*4;i[z]=this.getEffectAt(o,"webcam"),i[z+1]=this.getEffectAt(o,"smoothness"),i[z+2]=this.getEffectAt(o,"shadingLevel"),i[z+3]=this.getEffectAt(o,"specularPower");const h=(3*e+a)*4;i[h]=this.getEffectAt(o,"lightAngle"),i[h+1]=this.getEffectAt(o,"metallic"),i[h+2]=this.getEffectAt(o,"roughness"),i[h+3]=this.getEffectAt(o,"anisotropy")}return{data:i,width:e,height:r}}generateThumbnailRow(){const e=rr,r=new ImageData(e,1),i=r.data;for(let a=0;a<e;++a){const o=a/(e-1),s=Te(this.getColorAt(o)),l=a*4;i[l]=Math.max(0,Math.min(255,Math.round(s.r??0))),i[l+1]=Math.max(0,Math.min(255,Math.round(s.g??0))),i[l+2]=Math.max(0,Math.min(255,Math.round(s.b??0))),i[l+3]=255}return r}}const Be=7,Ta=4096,ka=2,Xe=100,Ba=1e4,La=5e6,_t=10,ar=.25,mt=3,Ca=3,Ra=100;function Pa(t){const e=Math.max(1,Math.floor(t));return 2**Math.floor(Math.log2(e))}const or=new Float32Array(1),Ea=new Uint32Array(or.buffer);function Aa(t){or[0]=t;const e=Ea[0],r=e>>>16&32768,i=(e>>>23&255)-127,a=e&8388607;if(i>=16)return r|31744;if(i>=-14){const o=i+15;return r|o<<10|a>>>13}if(i>=-24){const o=-14-i;return r|(a|8388608)>>>13+o}return r}function nr(t){const e=new Uint16Array(t.length);for(let r=0;r<t.length;++r)e[r]=Aa(t[r]);return e}const W=class W{constructor(e,r){n(this,"snapshotCallback");n(this,"snapshotDestWidth");n(this,"canvas");n(this,"device");n(this,"queue");n(this,"adapter");n(this,"ctx");n(this,"format");n(this,"mandelbrotNavigator");n(this,"rawTexture");n(this,"rawArrayView");n(this,"rawLayerViews",[]);n(this,"rawBrushTexture");n(this,"rawBrushArrayView");n(this,"rawBrushLayerViews",[]);n(this,"resolvedTexture");n(this,"resolvedArrayView");n(this,"resolvedLayerViews",[]);n(this,"frozenTexture");n(this,"frozenArrayView");n(this,"frozenLayerViews",[]);n(this,"pipelineMerge");n(this,"bindGroupMerge");n(this,"uniformBufferMerge");n(this,"uniformBufferMandelbrot");n(this,"uniformBufferColor");n(this,"uniformBufferBrush");n(this,"uniformBufferResolve");n(this,"mandelbrotReferenceBuffer");n(this,"mandelbrotBlaBuffer");n(this,"mandelbrotBlaLevelBuffer");n(this,"mandelbrotBlaBufferCapacity",0);n(this,"mandelbrotBlaLevelBufferCapacity",0);n(this,"pipelineBrush");n(this,"bindGroupBrush");n(this,"pipelineMandelbrot");n(this,"bindGroupMandelbrot");n(this,"pipelineResolve");n(this,"bindGroupResolve");n(this,"pipelineColor");n(this,"bindGroupColor");n(this,"pipelineCount");n(this,"counterBuffer");n(this,"counterReadbackSlots",[]);n(this,"counterReadbackWriteIndex",0);n(this,"counterReadbackSequence",0);n(this,"latestAppliedCounterReadbackSequence",0);n(this,"counterReadbackGeneration",0);n(this,"renderFrameSerial",0);n(this,"lastCounterDispatchFrame",-mt);n(this,"counterBindGroup");n(this,"uniformBufferCount");n(this,"unfinishedPixelCount",-1);n(this,"activePixelCount",-1);n(this,"_rafId",null);n(this,"_drawFn",null);n(this,"fps",0);n(this,"isRendering",!1);n(this,"gpuFrameTimeMs",0);n(this,"smoothedGpuTimeMs",0);n(this,"pendingGpuTiming",!1);n(this,"refinementWasGated",!1);n(this,"_fpsFrameCount",0);n(this,"_fpsLastTime",0);n(this,"neutralSize",0);n(this,"shaderPassCompute");n(this,"shaderPassColor");n(this,"width",0);n(this,"height",0);n(this,"antialiasLevel");n(this,"palettePeriod");n(this,"previousMandelbrot");n(this,"previousRenderOptions");n(this,"needRender",!0);n(this,"orbitIncomplete",!1);n(this,"prevGuardedMaxIter",0);n(this,"currentGuardedMaxIter",0);n(this,"currentMaxIterations",0);n(this,"currentBlaLevelCount",0);n(this,"mandelbrotReference",new Float32Array(1e6));n(this,"approximationMode","perturbation");n(this,"blaEpsilon",1e-6);n(this,"prevFrameMandelbrot");n(this,"clearHistoryNextFrame",!1);n(this,"cumulativeShiftX",0);n(this,"cumulativeShiftY",0);n(this,"zoomMagnificationThreshold",16);n(this,"zoomFactor",1);n(this,"frozenScale",0);n(this,"liveScale",0);n(this,"liveZoomFactor",1);n(this,"zoomReprojectionActive",!1);n(this,"needFreezeSnapshot",!1);n(this,"needMergeSnapshot",!1);n(this,"mergeUniforms",{zf:1,lzf:1,frozenShiftU:0,frozenShiftV:0,aspect:1,angle:0});n(this,"frozenAligned",!1);n(this,"zoomingIn",!0);n(this,"iterationBatchSize",Xe);n(this,"tileTexture");n(this,"tileTextureView");n(this,"skyboxTexture");n(this,"skyboxTextureView");n(this,"tileTextureSourceKey");n(this,"skyboxTextureSourceKey");n(this,"paletteTexture");n(this,"paletteTextureView");n(this,"paletteSampler");n(this,"skyboxSampler");n(this,"webcamTexture");n(this,"webcamTileTexture");n(this,"webcamTextureView");n(this,"webcamEnabled",!0);n(this,"time",0);n(this,"lastUpdateTime",0);n(this,"dprMultiplier",1);n(this,"targetFps",60);n(this,"gpuLoadMultiplier",1);this.canvas=e,this.shaderPassCompute=pe,this.shaderPassColor=se,this.antialiasLevel=r.antialiasLevel,this.palettePeriod=r.palettePeriod,this.time=0}async initialize(e){if(this.mandelbrotNavigator=e,this.approximationMode=this.mandelbrotNavigator.get_approximation_mode()===1?"bla":"perturbation",this.blaEpsilon=this.mandelbrotNavigator.get_bla_epsilon(),!navigator.gpu)throw new Error("WebGPU non support\xE9");if(this.adapter=await navigator.gpu.requestAdapter(),!this.adapter)throw new Error("Adapter WebGPU introuvable");this.device=await this.adapter.requestDevice(),this.device.label="Engine Device",this.queue=this.device.queue,this.queue.label="Engine Queue",this.ctx=this.canvas.getContext("webgpu"),this.format=navigator.gpu.getPreferredCanvasFormat(),this.ctx.configure({device:this.device,format:this.format,alphaMode:"opaque"});const[r,i]=await Promise.all([W._tileTexture?Promise.resolve(W._tileTexture):this._loadTexture(Oa),W._skyboxTexture?Promise.resolve(W._skyboxTexture):this._loadTexture(Ia)]);W._tileTexture=r,this.tileTexture=r,this.tileTextureView=this.tileTexture.createView(),W._skyboxTexture=i,this.skyboxTexture=i,this.skyboxTextureView=this.skyboxTexture.createView();const a=new ir([]).generateTexture(),o=nr(a.data);this.paletteTexture=this.device.createTexture({size:[a.width,a.height,1],format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT,label:"Engine PaletteTexture"}),this.device.queue.writeTexture({texture:this.paletteTexture},o.buffer,{bytesPerRow:a.width*8},[a.width,a.height]),this.paletteTextureView=this.paletteTexture.createView(),this.paletteSampler=this.device.createSampler({magFilter:"linear",minFilter:"linear",addressModeU:"repeat",addressModeV:"clamp-to-edge"}),this.skyboxSampler=this.device.createSampler({magFilter:"linear",minFilter:"linear",addressModeU:"repeat",addressModeV:"repeat"}),this.webcamTexture=new ta(1920,1080),this.webcamTileTexture=this.device.createTexture({size:[1920,1080,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),this.webcamTextureView=this.webcamTileTexture.createView(),this.uniformBufferMandelbrot=this.device.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Mandelbrot"}),this.uniformBufferColor=this.device.createBuffer({size:96,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Color"}),this.uniformBufferBrush=this.device.createBuffer({size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Brush"}),this.uniformBufferResolve=this.device.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Resolve"}),this.mandelbrotReferenceBuffer=this.device.createBuffer({size:4*1e6,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot Orbit ReferenceStorage Buffer"}),this.mandelbrotBlaBuffer=this.device.createBuffer({size:24,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Storage Buffer"}),this.mandelbrotBlaLevelBuffer=this.device.createBuffer({size:16,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Level Storage Buffer"}),this.mandelbrotBlaBufferCapacity=1,this.mandelbrotBlaLevelBufferCapacity=1,this.counterBuffer=this.device.createBuffer({size:8,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST,label:"Engine Counter Storage"}),this.counterReadbackSlots=Array.from({length:Ca},(s,l)=>({buffer:this.device.createBuffer({size:8,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ,label:`Engine Counter Readback ${l}`}),pending:!1,sequence:0,generation:0})),this.uniformBufferCount=this.device.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Count"}),this.uniformBufferMerge=this.device.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Merge"}),await this._createPipelines(),this.resize()}async _createPipelines(){const e=this.device.createShaderModule({code:be,label:"Engine ShaderModule Brush"}),r=this.device.createShaderModule({code:this.shaderPassCompute,label:"Engine ShaderModule Compute"}),i=this.device.createShaderModule({code:xr,label:"Engine ShaderModule Resolve"}),a=this.device.createShaderModule({code:this.shaderPassColor,label:"Engine ShaderModule Color"}),o=this.device.createShaderModule({code:yr,label:"Engine ShaderModule Count"}),s=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Brush"}),l=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Mandelbrot"}),c=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Resolve"}),z=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:5,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:6,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:7,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:8,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}],label:"Engine BindGroupLayout Color"}),h=Array.from({length:Be},()=>({format:"r32float"}));this.pipelineBrush=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[s]}),vertex:{module:e,entryPoint:"vs_main"},fragment:{module:e,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Brush"}),this.pipelineMandelbrot=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[l]}),vertex:{module:r,entryPoint:"vs_main"},fragment:{module:r,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Mandelbrot"}),this.pipelineResolve=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[c]}),vertex:{module:i,entryPoint:"vs_main"},fragment:{module:i,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Resolve"}),this.pipelineColor=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[z]}),vertex:{module:a,entryPoint:"vs_main"},fragment:{module:a,entryPoint:"fs_main",targets:[{format:this.format}]},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Color"});const b=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}],label:"Engine BindGroupLayout Count"});this.pipelineCount=this.device.createComputePipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[b]}),compute:{module:o,entryPoint:"count_unfinished"},label:"Engine ComputePipeline Count"});const y=this.device.createShaderModule({code:wr,label:"Engine ShaderModule Merge"}),_=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Merge"});this.pipelineMerge=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[_]}),vertex:{module:y,entryPoint:"vs_main"},fragment:{module:y,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Merge"}),this.bindGroupBrush=void 0,this.bindGroupMandelbrot=void 0,this.bindGroupResolve=void 0,this.bindGroupColor=void 0,this.counterBindGroup=void 0,this.bindGroupMerge=void 0}rebuildMandelbrotBindGroup(){if(!this.pipelineMandelbrot||!this.rawBrushArrayView||!this.uniformBufferMandelbrot||!this.mandelbrotReferenceBuffer||!this.mandelbrotBlaBuffer||!this.mandelbrotBlaLevelBuffer)return;const e=this.pipelineMandelbrot.getBindGroupLayout(0);this.bindGroupMandelbrot=this.device.createBindGroup({layout:e,entries:[{binding:0,resource:{buffer:this.uniformBufferMandelbrot}},{binding:1,resource:{buffer:this.mandelbrotReferenceBuffer}},{binding:2,resource:{buffer:this.mandelbrotBlaBuffer}},{binding:3,resource:{buffer:this.mandelbrotBlaLevelBuffer}},{binding:4,resource:this.rawBrushArrayView}],label:"Engine BindGroup Mandelbrot"})}ensureBlaBufferCapacity(e){var i,a;const r=Math.max(1,Math.ceil(e));r<=this.mandelbrotBlaBufferCapacity||((a=(i=this.mandelbrotBlaBuffer)==null?void 0:i.destroy)==null||a.call(i),this.mandelbrotBlaBuffer=this.device.createBuffer({size:r*4*6,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Storage Buffer"}),this.mandelbrotBlaBufferCapacity=r,this.rebuildMandelbrotBindGroup())}ensureBlaLevelBufferCapacity(e){var i,a;const r=Math.max(1,Math.ceil(e));r<=this.mandelbrotBlaLevelBufferCapacity||((a=(i=this.mandelbrotBlaLevelBuffer)==null?void 0:i.destroy)==null||a.call(i),this.mandelbrotBlaLevelBuffer=this.device.createBuffer({size:r*4*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Level Storage Buffer"}),this.mandelbrotBlaLevelBufferCapacity=r,this.rebuildMandelbrotBindGroup())}invalidateCounterReadback(){this.unfinishedPixelCount=-1,this.activePixelCount=-1,this.counterReadbackGeneration++,this.lastCounterDispatchFrame=-mt}hasPendingCounterReadbackForCurrentGeneration(){return this.counterReadbackSlots.some(e=>e.pending&&e.generation===this.counterReadbackGeneration)}acquireCounterReadbackSlot(){const e=this.counterReadbackSlots.length;for(let r=0;r<e;r++){const i=(this.counterReadbackWriteIndex+r)%e,a=this.counterReadbackSlots[i];if(!a.pending)return this.counterReadbackWriteIndex=(i+1)%e,a}}scheduleCounterReadback(e,r,i){e.pending=!0,e.sequence=r,e.generation=i,(async()=>{let a=!1;try{await e.buffer.mapAsync(GPUMapMode.READ),a=!0;const o=new Uint32Array(e.buffer.getMappedRange()),s=o[0],l=o[1];this.applyCounterReadback(r,i,s,l)}catch{}finally{a&&e.buffer.unmap(),e.pending=!1}})()}applyCounterReadback(e,r,i,a){if(r!==this.counterReadbackGeneration||e<=this.latestAppliedCounterReadbackSequence)return;this.latestAppliedCounterReadbackSequence=e;const o=this.unfinishedPixelCount;this.unfinishedPixelCount=i,this.activePixelCount=a,o>_t&&i<=_t&&!this.zoomReprojectionActive&&(this.needFreezeSnapshot=!0)}scheduleGpuTiming(e){this.pendingGpuTiming||(this.pendingGpuTiming=!0,this.device.queue.onSubmittedWorkDone().then(()=>{this.pendingGpuTiming=!1,this.applyGpuFrameTiming(performance.now()-e)}).catch(()=>{this.pendingGpuTiming=!1}))}applyGpuFrameTiming(e){if(this.gpuFrameTimeMs=e,this.smoothedGpuTimeMs===0?this.smoothedGpuTimeMs=e:this.smoothedGpuTimeMs=this.smoothedGpuTimeMs*(1-ar)+e*ar,e<=0)return;const r=1e3/this.targetFps/e,i=this.iterationBatchSize*r;this.iterationBatchSize=Math.round(Math.min(Ba,Math.max(Xe,this.iterationBatchSize*.7+i*.3)))}resize(){var _,S,u,m,g,R,P,G,A,F;const e=(window.devicePixelRatio||1)*this.dprMultiplier,r=this.canvas.parentElement,i=(r==null?void 0:r.clientWidth)||1,a=(r==null?void 0:r.clientHeight)||1;this.width=Math.max(1,Math.round(i*e)),this.height=Math.max(1,Math.round(a*e));const o=((S=(_=this.device)==null?void 0:_.limits)==null?void 0:S.maxTextureDimension2D)??8192;this.width=Math.min(this.width,o),this.height=Math.min(this.height,o),this.canvas.width=this.width,this.canvas.height=this.height,this.canvas.style.width=i+"px",this.canvas.style.height=a+"px",this.ctx.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.neutralSize=Math.ceil(Math.sqrt(this.width*this.width+this.height*this.height));const s=this.neutralSize;(m=(u=this.rawTexture)==null?void 0:u.destroy)==null||m.call(u),(R=(g=this.rawBrushTexture)==null?void 0:g.destroy)==null||R.call(g),(G=(P=this.resolvedTexture)==null?void 0:P.destroy)==null||G.call(P),(F=(A=this.frozenTexture)==null?void 0:A.destroy)==null||F.call(A);const l=Be,c=k=>{const U=this.device.createTexture({size:{width:s,height:s,depthOrArrayLayers:l},format:"r32float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC|GPUTextureUsage.COPY_DST,label:k}),M=U.createView({dimension:"2d-array",baseArrayLayer:0,arrayLayerCount:l,label:k+" ArrayView"}),L=[];for(let C=0;C<l;C++)L.push(U.createView({dimension:"2d",baseArrayLayer:C,arrayLayerCount:1,label:k+` Layer${C}`}));return{texture:U,arrayView:M,layerViews:L}},z=c("Engine RawTexture (A)");this.rawTexture=z.texture,this.rawArrayView=z.arrayView,this.rawLayerViews=z.layerViews;const h=c("Engine RawBrushTexture (B)");this.rawBrushTexture=h.texture,this.rawBrushArrayView=h.arrayView,this.rawBrushLayerViews=h.layerViews;const b=c("Engine ResolvedTexture");this.resolvedTexture=b.texture,this.resolvedArrayView=b.arrayView,this.resolvedLayerViews=b.layerViews;const y=c("Engine FrozenTexture");if(this.frozenTexture=y.texture,this.frozenArrayView=y.arrayView,this.frozenLayerViews=y.layerViews,this.zoomReprojectionActive=!1,this.zoomFactor=1,this.liveZoomFactor=1,this.frozenScale=0,this.liveScale=0,this.pipelineBrush){const k=this.pipelineBrush.getBindGroupLayout(0);this.bindGroupBrush=this.device.createBindGroup({layout:k,entries:[{binding:0,resource:{buffer:this.uniformBufferBrush}},{binding:1,resource:this.rawArrayView}],label:"Engine BindGroup Brush"})}if(this.pipelineMandelbrot&&this.rebuildMandelbrotBindGroup(),this.pipelineResolve){const k=this.pipelineResolve.getBindGroupLayout(0);this.bindGroupResolve=this.device.createBindGroup({layout:k,entries:[{binding:0,resource:{buffer:this.uniformBufferResolve}},{binding:1,resource:this.rawArrayView}],label:"Engine BindGroup Resolve"})}if(this.pipelineColor){const k=this.pipelineColor.getBindGroupLayout(0),U=[{binding:0,resource:{buffer:this.uniformBufferColor}},{binding:1,resource:this.resolvedArrayView},{binding:2,resource:this.tileTextureView},{binding:3,resource:this.skyboxTextureView},{binding:4,resource:this.webcamTextureView},{binding:5,resource:this.paletteTextureView},{binding:6,resource:this.frozenArrayView},{binding:7,resource:this.paletteSampler},{binding:8,resource:this.skyboxSampler}];this.bindGroupColor=this.device.createBindGroup({layout:k,entries:U,label:"Engine BindGroup Color"})}if(this.pipelineCount&&this.counterBuffer&&this.uniformBufferCount){const k=this.pipelineCount.getBindGroupLayout(0);this.counterBindGroup=this.device.createBindGroup({layout:k,entries:[{binding:0,resource:this.rawArrayView},{binding:1,resource:{buffer:this.counterBuffer}},{binding:2,resource:{buffer:this.uniformBufferCount}}],label:"Engine BindGroup Count"})}if(this.pipelineMerge&&this.uniformBufferMerge){const k=this.pipelineMerge.getBindGroupLayout(0);this.bindGroupMerge=this.device.createBindGroup({layout:k,entries:[{binding:0,resource:{buffer:this.uniformBufferMerge}},{binding:1,resource:this.resolvedArrayView},{binding:2,resource:this.rawBrushArrayView}],label:"Engine BindGroup Merge"})}this.prevFrameMandelbrot=void 0,this.previousMandelbrot=void 0,this.previousRenderOptions=void 0,this.needRender=!0,this.invalidateCounterReadback()}areObjectsEqual(e,r){return e===void 0||r===void 0?!1:JSON.stringify(e)===JSON.stringify(r)}areColorStopsEqual(e,r){if(e.length!==r.length)return!1;for(const[i,a]of e.entries()){const o=r[i];if(!o||JSON.stringify(a)!==JSON.stringify(o))return!1}return!0}setApproximationMode(e){e!==this.approximationMode&&(e==="bla"?this.mandelbrotNavigator.use_bla():this.mandelbrotNavigator.use_perturbation(),this.approximationMode=e,this.currentBlaLevelCount=0,this.clearHistoryNextFrame=!0,this.needRender=!0,this.invalidateCounterReadback())}getApproximationMode(){return this.approximationMode}setBlaEpsilon(e){const r=Math.max(Number.MIN_VALUE,e);r!==this.blaEpsilon&&(this.mandelbrotNavigator.set_bla_epsilon(r),this.blaEpsilon=r,this.approximationMode==="bla"&&(this.currentBlaLevelCount=0,this.clearHistoryNextFrame=!0,this.needRender=!0,this.invalidateCounterReadback()))}async update(e,r){var U,M,L,C;const i=performance.now();this.lastUpdateTime===0&&(this.lastUpdateTime=i);const a=(i-this.lastUpdateTime)/1e3;this.time+=a,this.lastUpdateTime=i;const o=this.mandelbrotNavigator.get_approximation_mode()===1?"bla":"perturbation",s=this.mandelbrotNavigator.get_bla_epsilon();(o!==this.approximationMode||s!==this.blaEpsilon)&&(this.approximationMode=o,this.blaEpsilon=s,this.currentBlaLevelCount=0,this.clearHistoryNextFrame=!0,this.needRender=!0,this.invalidateCounterReadback());const l=!this.areObjectsEqual(e,this.previousMandelbrot),c=!this.areObjectsEqual(r,this.previousRenderOptions);this.needRender=this.needRender||l||c,l&&this.invalidateCounterReadback(),r.colorStops.some(x=>(x.webcam??0)>0)?(await this.updateWebcamTexture(),this.needRender=!0):(U=this.webcamTexture)==null||U.closeWebcam(),r.activateAnimate&&(this.needRender=!0);const z=this.width/Math.max(1,this.height);let h=((M=this.previousMandelbrot)==null?void 0:M.scale)||1/e.scale;h<1&&(h=1/h),h=Math.sqrt(h)-1;{const x=this.prevFrameMandelbrot&&this.prevFrameMandelbrot.scale!==e.scale;if(x&&!this.zoomReprojectionActive&&(this.zoomReprojectionActive=!0,this.frozenScale=this.prevFrameMandelbrot.scale,this.zoomingIn=e.scale<this.frozenScale,this.liveScale=this.zoomingIn?this.frozenScale/this.zoomMagnificationThreshold:this.frozenScale*this.zoomMagnificationThreshold,this.needFreezeSnapshot=!0,this.clearHistoryNextFrame=!0),this.zoomReprojectionActive&&this.frozenScale>0?(this.zoomFactor=this.frozenScale/e.scale,this.liveZoomFactor=this.liveScale/e.scale,(this.zoomingIn?this.zoomFactor>=this.zoomMagnificationThreshold:this.zoomFactor<=1/this.zoomMagnificationThreshold)&&(this.needFreezeSnapshot=!0,this.clearHistoryNextFrame=!0,this.frozenScale=this.liveScale,this.liveScale=this.zoomingIn?e.scale/this.zoomMagnificationThreshold:e.scale*this.zoomMagnificationThreshold,this.zoomFactor=this.frozenScale/e.scale,this.liveZoomFactor=this.liveScale/e.scale)):this.zoomReprojectionActive||(this.zoomFactor=1,this.liveZoomFactor=1,this.liveScale=0),this.zoomReprojectionActive&&!x&&this.prevFrameMandelbrot&&this.prevFrameMandelbrot.scale===e.scale){const D=this.width/Math.max(1,this.height);this.mergeUniforms={zf:this.zoomFactor,lzf:this.liveZoomFactor,frozenShiftU:this.frozenScale>0?this.cumulativeShiftX*(this.liveScale/this.frozenScale)/this.neutralSize:0,frozenShiftV:this.frozenScale>0?-this.cumulativeShiftY*(this.liveScale/this.frozenScale)/this.neutralSize:0,aspect:D,angle:e.angle},this.needMergeSnapshot=!0,this.zoomReprojectionActive=!1,this.zoomFactor=1,this.liveZoomFactor=1,this.liveScale=0,this.clearHistoryNextFrame=!0}}if(!this.areColorStopsEqual(r.colorStops,((L=this.previousRenderOptions)==null?void 0:L.colorStops)||[])||r.interpolationMode!==((C=this.previousRenderOptions)==null?void 0:C.interpolationMode)){const x=new ir(r.colorStops,r.interpolationMode).generateTexture(),D=nr(x.data);this.device.queue.writeTexture({texture:this.paletteTexture},D.buffer,{bytesPerRow:x.width*8},[x.width,x.height]),this.needRender=!0}const b=new Float32Array([r.palettePeriod,r.paletteOffset,h,this.time,z,e.angle,r.activateAnimate?1:0,e.mu,this.zoomFactor,this.zoomReprojectionActive||this.frozenAligned?1:0,this.liveZoomFactor,this.zoomReprojectionActive&&this.frozenScale>0?this.cumulativeShiftX*(this.liveScale/this.frozenScale)/this.neutralSize:0,this.zoomReprojectionActive&&this.frozenScale>0?-this.cumulativeShiftY*(this.liveScale/this.frozenScale)/this.neutralSize:0,r.tessellationLevel,r.displacementAmount,r.animationSpeed,e.epsilon,r.ambientOcclusionStrength,r.microBumpStrength,r.clearcoatStrength,r.subsurfaceStrength,r.reliefDepth,r.localShadowStrength]);if(this.device.queue.writeBuffer(this.uniformBufferColor,0,b.buffer),!this.needsMoreFrames())return;const y=Math.ceil(e.maxIterations);this.currentMaxIterations=y;const _=this.mandelbrotNavigator.compute_reference_orbit_chunk(Ra,y),S=_.count,u=new Float32Array(Ve.buffer,_.ptr,_.count*4);_.offset<y&&this.device.queue.writeBuffer(this.mandelbrotReferenceBuffer,0,u,0);const m=Math.max(0,S-1),g=Math.min(y,m);this.currentGuardedMaxIter=g,this.orbitIncomplete=m<y;const R=m>=y;let P=0,G=0;if(this.approximationMode==="bla"&&R){const x=this.mandelbrotNavigator.compute_bla_reference_ptr(g);if(this.ensureBlaBufferCapacity(x.count),this.ensureBlaLevelBufferCapacity(x.level_count),x.count>0){const D=new Float32Array(Ve.buffer,x.ptr,x.count*6);this.device.queue.writeBuffer(this.mandelbrotBlaBuffer,0,D,0)}if(x.level_count>0){const D=new Uint32Array(Ve.buffer,x.levels_ptr,x.level_count*4);this.device.queue.writeBuffer(this.mandelbrotBlaLevelBuffer,0,D,0)}P=1,G=x.level_count}this.currentBlaLevelCount=G;const A=this.zoomReprojectionActive&&this.liveScale>0?this.liveScale:e.scale,F=new Float32Array([e.dx,e.dy,e.mu,A,z,e.angle,this.iterationBatchSize,e.epsilon,r.antialiasLevel,0,g,R?1:0,P,G,this.blaEpsilon,0]);this.device.queue.writeBuffer(this.uniformBufferMandelbrot,0,F.buffer);const k=_.offset===0&&!!this.prevFrameMandelbrot;(!this.prevFrameMandelbrot||k)&&(this.clearHistoryNextFrame=!0,this.zoomReprojectionActive=!1,this.zoomFactor=1,this.liveZoomFactor=1,this.liveScale=0),this.prevFrameMandelbrot&&this.prevFrameMandelbrot.mu!==e.mu&&(this.clearHistoryNextFrame=!0,this.zoomReprojectionActive=!1,this.zoomFactor=1,this.liveZoomFactor=1,this.liveScale=0),!this.zoomReprojectionActive&&R&&this.prevGuardedMaxIter<y&&this.prevGuardedMaxIter>0&&(this.needFreezeSnapshot=!0,this.clearHistoryNextFrame=!0),this.prevGuardedMaxIter=g,this.previousMandelbrot=structuredClone(e),this.previousRenderOptions=structuredClone(r)}async render(){if(!this.needsMoreFrames()||!this.pipelineBrush||!this.pipelineMandelbrot||!this.pipelineResolve||!this.pipelineColor||!this.bindGroupBrush||!this.bindGroupMandelbrot||!this.bindGroupResolve||!this.bindGroupColor||!this.previousMandelbrot)return;const e=this.width/Math.max(1,this.height),r=Pa(Ta),i=r,a=this.clearHistoryNextFrame?1:0;this.clearHistoryNextFrame&&this.invalidateCounterReadback();const o=++this.renderFrameSerial;let s=0,l=0;if(!this.clearHistoryNextFrame&&this.prevFrameMandelbrot){const M=this.previousMandelbrot.dx-this.prevFrameMandelbrot.dx,L=this.previousMandelbrot.dy-this.prevFrameMandelbrot.dy,C=this.neutralSize,x=Math.sqrt(e*e+1),D=this.zoomReprojectionActive&&this.liveScale>0?this.liveScale:this.previousMandelbrot.scale;s=-(M*C)/(2*D*x),l=L*C/(2*D*x)}this.clearHistoryNextFrame?(this.cumulativeShiftX=0,this.cumulativeShiftY=0):(this.cumulativeShiftX+=Math.round(s),this.cumulativeShiftY+=Math.round(l),(Math.round(s)!==0||Math.round(l)!==0)&&(this.frozenAligned=!1));const c=(this.cumulativeShiftX%i+i)%i,z=(this.cumulativeShiftY%i+i)%i,h=this.hasPendingCounterReadbackForCurrentGeneration(),b=!h&&(this.clearHistoryNextFrame||this.activePixelCount<0||this.iterationBatchSize>Xe||this.activePixelCount<La*this.gpuLoadMultiplier);b&&this.refinementWasGated&&(this.iterationBatchSize=Xe),this.refinementWasGated=!b;const y=b?1:0,_=new Float32Array([e,this.previousMandelbrot.angle,a,r,i,s,l,this.previousMandelbrot.mu,c,z,this.zoomReprojectionActive?ka:0,y]);this.device.queue.writeBuffer(this.uniformBufferBrush,0,_.buffer);const S=new Float32Array([this.previousMandelbrot.mu,c,z]);this.device.queue.writeBuffer(this.uniformBufferResolve,0,S.buffer);const u=!h&&(this.unfinishedPixelCount<0||this.activePixelCount<0||o-this.lastCounterDispatchFrame>=mt)?this.acquireCounterReadbackSlot():void 0;let m;const g=this.device.createCommandEncoder();if(this.needMergeSnapshot&&this.pipelineMerge&&this.bindGroupMerge&&this.resolvedTexture&&this.frozenTexture&&this.rawBrushTexture){const M=this.neutralSize;g.copyTextureToTexture({texture:this.frozenTexture},{texture:this.rawBrushTexture},{width:M,height:M,depthOrArrayLayers:Be});const L=new Float32Array([this.mergeUniforms.zf,this.mergeUniforms.lzf,this.mergeUniforms.frozenShiftU,this.mergeUniforms.frozenShiftV,this.mergeUniforms.aspect,this.mergeUniforms.angle]);this.device.queue.writeBuffer(this.uniformBufferMerge,0,L.buffer);const C=this.frozenLayerViews.map(D=>({view:D,clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store"})),x=g.beginRenderPass({colorAttachments:C});x.setPipeline(this.pipelineMerge),x.setBindGroup(0,this.bindGroupMerge),x.draw(6,1,0,0),x.end(),this.needMergeSnapshot=!1,this.frozenAligned=!0}if(this.needFreezeSnapshot&&this.resolvedTexture&&this.frozenTexture){const M=Be,L=this.neutralSize;g.copyTextureToTexture({texture:this.resolvedTexture},{texture:this.frozenTexture},{width:L,height:L,depthOrArrayLayers:M}),this.needFreezeSnapshot=!1,this.frozenAligned=!0}const R=(M,L="clear")=>M.map(C=>({view:C,clearValue:{r:0,g:0,b:0,a:0},loadOp:L,storeOp:"store"})),P=g.beginRenderPass({colorAttachments:R(this.rawBrushLayerViews)});P.setPipeline(this.pipelineBrush),P.setBindGroup(0,this.bindGroupBrush),P.draw(6,1,0,0),P.end(),g.copyTextureToTexture({texture:this.rawBrushTexture},{texture:this.rawTexture},{width:this.neutralSize,height:this.neutralSize,depthOrArrayLayers:Be});const G=g.beginRenderPass({colorAttachments:R(this.rawLayerViews,"load")});if(G.setPipeline(this.pipelineMandelbrot),G.setBindGroup(0,this.bindGroupMandelbrot),G.draw(6,1,0,0),G.end(),this.pipelineCount&&this.counterBindGroup&&this.counterBuffer&&u&&this.uniformBufferCount){const M=++this.counterReadbackSequence,L=this.counterReadbackGeneration,C=this.previousMandelbrot.mu;this.device.queue.writeBuffer(this.uniformBufferCount,0,new Float32Array([C,e,this.previousMandelbrot.angle])),g.clearBuffer(this.counterBuffer,0,8);const x=g.beginComputePass();x.setPipeline(this.pipelineCount),x.setBindGroup(0,this.counterBindGroup),x.dispatchWorkgroups(Math.ceil(this.neutralSize/16),Math.ceil(this.neutralSize/16)),x.end(),g.copyBufferToBuffer(this.counterBuffer,0,u.buffer,0,8),this.lastCounterDispatchFrame=o,m={slot:u,sequence:M,generation:L}}g.copyTextureToTexture({texture:this.rawTexture},{texture:this.resolvedTexture},{width:this.neutralSize,height:this.neutralSize,depthOrArrayLayers:Be});const A=g.beginRenderPass({colorAttachments:R(this.resolvedLayerViews,"load")});A.setPipeline(this.pipelineResolve),A.setBindGroup(0,this.bindGroupResolve),A.draw(6,1,0,0),A.end();const F=this.ctx.getCurrentTexture().createView(),k=g.beginRenderPass({colorAttachments:[{view:F,clearValue:{r:1,g:1,b:1,a:1},loadOp:"clear",storeOp:"store"}]});k.setPipeline(this.pipelineColor),k.setBindGroup(0,this.bindGroupColor),k.draw(6,1,0,0),k.end();const U=performance.now();if(this.device.queue.submit([g.finish()]),this.scheduleGpuTiming(U),m&&this.scheduleCounterReadback(m.slot,m.sequence,m.generation),this.clearHistoryNextFrame=!1,this.prevFrameMandelbrot={...this.previousMandelbrot},this.needRender=!1,this.snapshotCallback){try{const M=this.snapshotDestWidth??256,L=Math.round(M*9/16),C=this.device.createTexture({size:[M,L,1],format:this.format,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.COPY_SRC});{const q=this.device.createCommandEncoder(),X=q.beginRenderPass({colorAttachments:[{view:C.createView(),clearValue:{r:0,g:0,b:0,a:1},loadOp:"clear",storeOp:"store"}]});X.setPipeline(this.pipelineColor),X.setBindGroup(0,this.bindGroupColor),X.draw(6,1,0,0),X.end(),this.device.queue.submit([q.finish()])}const x=q=>q+255&-256,D=M*4,$=x(D),ae=$*L,V=this.device.createBuffer({size:ae,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});{const q=this.device.createCommandEncoder();q.copyTextureToBuffer({texture:C},{buffer:V,offset:0,bytesPerRow:$},{width:M,height:L,depthOrArrayLayers:1}),this.device.queue.submit([q.finish()])}await this.device.queue.onSubmittedWorkDone(),await V.mapAsync(GPUMapMode.READ);const K=V.getMappedRange(),j=new Uint8ClampedArray(M*L*4),J=new Uint8Array(K);for(let q=0;q<L;++q)for(let X=0;X<M;++X){const oe=q*$+X*4,Z=(q*M+X)*4;j[Z+0]=J[oe+2],j[Z+1]=J[oe+1],j[Z+2]=J[oe+0],j[Z+3]=J[oe+3]}const te=document.createElement("canvas");te.width=M,te.height=L,te.getContext("2d").putImageData(new ImageData(j,M,L),0,0),V.unmap(),this.snapshotCallback(te.toDataURL("image/png"))}catch{this.snapshotCallback("")}this.snapshotCallback=void 0,this.snapshotDestWidth=void 0}}destroy(){var e,r,i,a,o,s,l,c,z,h,b,y,_,S,u,m,g,R,P,G,A,F,k,U,M,L,C,x,D,$,ae,V,K,j,J;this.stopRenderLoop(),(r=(e=this.rawTexture)==null?void 0:e.destroy)==null||r.call(e),(a=(i=this.rawBrushTexture)==null?void 0:i.destroy)==null||a.call(i),(s=(o=this.resolvedTexture)==null?void 0:o.destroy)==null||s.call(o),(c=(l=this.frozenTexture)==null?void 0:l.destroy)==null||c.call(l),(h=(z=this.mandelbrotReferenceBuffer)==null?void 0:z.destroy)==null||h.call(z),(y=(b=this.mandelbrotBlaBuffer)==null?void 0:b.destroy)==null||y.call(b),(S=(_=this.mandelbrotBlaLevelBuffer)==null?void 0:_.destroy)==null||S.call(_),(m=(u=this.uniformBufferMandelbrot)==null?void 0:u.destroy)==null||m.call(u),(R=(g=this.uniformBufferColor)==null?void 0:g.destroy)==null||R.call(g),(G=(P=this.uniformBufferBrush)==null?void 0:P.destroy)==null||G.call(P),(F=(A=this.uniformBufferResolve)==null?void 0:A.destroy)==null||F.call(A),(U=(k=this.counterBuffer)==null?void 0:k.destroy)==null||U.call(k);for(const te of this.counterReadbackSlots)(L=(M=te.buffer).destroy)==null||L.call(M);this.counterReadbackSlots=[],(x=(C=this.uniformBufferCount)==null?void 0:C.destroy)==null||x.call(C),($=(D=this.uniformBufferMerge)==null?void 0:D.destroy)==null||$.call(D),(ae=this.webcamTexture)==null||ae.closeWebcam(),(K=(V=this.webcamTileTexture)==null?void 0:V.destroy)==null||K.call(V),(J=(j=this.paletteTexture)==null?void 0:j.destroy)==null||J.call(j)}needsMoreFrames(){let e="";return this.needRender?e="needRender":this.snapshotCallback?e="snapshot":this.zoomReprojectionActive?e="zoomActive":this.clearHistoryNextFrame?e="clearHistory":this.needFreezeSnapshot?e="freezeSnapshot":this.needMergeSnapshot?e="mergeSnapshot":this.orbitIncomplete?e="orbitIncomplete":(this.unfinishedPixelCount<0||this.unfinishedPixelCount>_t)&&(e=`unfinished=${this.unfinishedPixelCount}`),e!==""}getIterationBatchSize(){return this.iterationBatchSize}startRenderLoop(e){this._drawFn=e,this._rafId===null&&(this._rafId=requestAnimationFrame(async()=>this._loop()))}stopRenderLoop(){this._rafId!==null&&(cancelAnimationFrame(this._rafId),this._rafId=null),this._drawFn=null}async _loop(){if(this._drawFn){const e=this.needsMoreFrames();this.isRendering=e,await this._drawFn(),e&&this._fpsFrameCount++;const r=performance.now();this._fpsLastTime===0&&(this._fpsLastTime=r);const i=r-this._fpsLastTime;i>=1e3&&(this.fps=Math.round(this._fpsFrameCount*1e3/i),this._fpsFrameCount=0,this._fpsLastTime=r),this._rafId=requestAnimationFrame(async()=>this._loop())}else{this._rafId=null;return}}async updateTileTexture(e,r=e){var a,o;if(this.tileTextureSourceKey===r)return;const i=await this._loadTexture(e);(o=(a=this.tileTexture)==null?void 0:a.destroy)==null||o.call(a),this.tileTexture=i,this.tileTextureView=this.tileTexture.createView(),this.tileTextureSourceKey=r,this.rebuildColorBindGroup(),this.needRender=!0}isTileTextureSourceCurrent(e){return this.tileTextureSourceKey===e}async updateSkyboxTexture(e,r=e){var a,o;if(this.skyboxTextureSourceKey===r)return;const i=await this._loadTexture(e);(o=(a=this.skyboxTexture)==null?void 0:a.destroy)==null||o.call(a),this.skyboxTexture=i,this.skyboxTextureView=this.skyboxTexture.createView(),this.skyboxTextureSourceKey=r,this.rebuildColorBindGroup(),this.needRender=!0}isSkyboxTextureSourceCurrent(e){return this.skyboxTextureSourceKey===e}rebuildColorBindGroup(){if(this.pipelineColor&&this.resolvedArrayView&&this.frozenArrayView){const e=this.pipelineColor.getBindGroupLayout(0);this.bindGroupColor=this.device.createBindGroup({layout:e,entries:[{binding:0,resource:{buffer:this.uniformBufferColor}},{binding:1,resource:this.resolvedArrayView},{binding:2,resource:this.tileTextureView},{binding:3,resource:this.skyboxTextureView},{binding:4,resource:this.webcamTextureView},{binding:5,resource:this.paletteTextureView},{binding:6,resource:this.frozenArrayView},{binding:7,resource:this.paletteSampler},{binding:8,resource:this.skyboxSampler}],label:"Engine BindGroup Color"})}}async _loadTexture(e){const r=new Image;r.src=e;try{await r.decode()}catch(o){throw console.warn("\xC9chec du chargement de la texture : "+e,o),o}const i=await createImageBitmap(r),a=this.device.createTexture({size:[i.width,i.height,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT,label:"Engine LoadedTexture "+e});return this.device.queue.copyExternalImageToTexture({source:i},{texture:a},[i.width,i.height]),a}async readIterationDataAt(e,r,i,a){var oe;if(!this.resolvedTexture||!this.device)return null;const o=this.width/Math.max(1,this.height),s=((oe=this.previousMandelbrot)==null?void 0:oe.angle)??0,l=e/Math.max(1,i),c=1-r/Math.max(1,a),z=l*2-1,h=c*2-1,b=z*o,y=h,_=Math.sin(s),S=Math.cos(s),u=S*b-_*y,m=_*b+S*y,g=Math.sqrt(o*o+1),R=u/g,P=m/g,G=R*.5+.5,A=P*.5+.5,F=this.neutralSize,k=Math.floor(Math.max(0,Math.min(F-1,G*F))),U=Math.floor(Math.max(0,Math.min(F-1,(1-A)*F))),M=W.ITER_PIXEL_LAYERS,L=1,C=4,x=(Z=>Z+255&-256)(L*C),D=x*M.length,$=this.device.createBuffer({size:D,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ,label:"Engine IterPixel Readback"}),ae=this.device.createCommandEncoder();for(let Z=0;Z<M.length;Z++)ae.copyTextureToBuffer({texture:this.resolvedTexture,origin:{x:k,y:U,z:M[Z]}},{buffer:$,offset:x*Z,bytesPerRow:x},{width:1,height:1,depthOrArrayLayers:1});this.device.queue.submit([ae.finish()]),await $.mapAsync(GPUMapMode.READ);const V=new Float32Array($.getMappedRange()),K=x/C,j=V[0*K],J=V[1*K],te=V[2*K],q=V[3*K],X=V[4*K];return $.unmap(),$.destroy(),j<0?null:{iter:j,zx:J,zy:te,derX:q,derY:X}}async updateWebcamTexture(){var e,r;await((e=this.webcamTexture)==null?void 0:e.openWebcam()),await((r=this.webcamTexture)==null?void 0:r.drawWebGPUTexture(this.webcamTileTexture,this.device))}async getSnapshotPng(e=256){return await new Promise(r=>{this.snapshotCallback=r,this.snapshotDestWidth=e,this.needRender=!0})}};n(W,"_tileTexture"),n(W,"_tileTextureView"),n(W,"_skyboxTexture"),n(W,"_skyboxTextureView"),n(W,"_paletteTexture"),n(W,"_paletteTextureView"),n(W,"ITER_PIXEL_LAYERS",[0,2,3,4,5]);let vt=W,sr,lr,ur,cr,dr,fr,Ge,bt,hr,pr,gr;Mt=wt({__name:"Mandelbrot",props:Ue({mu:{default:4},epsilon:{default:1e-5},colorStops:{default:()=>[{color:"#002500",position:0},{color:"#175b3d",position:.16},{color:"#ffceb6",position:.26},{color:"#edffff",position:.42},{color:"#ff8fbc",position:.7016397849462366},{color:"#a6003e",position:.8575},{color:"#100000",position:1}]},palettePeriod:{default:100},paletteOffset:{default:0},antialiasLevel:{default:1},activateAnimate:{type:Boolean,default:!1},dprMultiplier:{default:.5},maxIterationMultiplier:{default:.1},targetFps:{default:60},gpuLoadMultiplier:{default:1},interpolationMode:{default:"lab"},tessellationLevel:{default:2},displacementAmount:{default:.01},animationSpeed:{default:1},ambientOcclusionStrength:{default:.5},microBumpStrength:{default:.25},clearcoatStrength:{default:.7},subsurfaceStrength:{default:0},reliefDepth:{default:.35},localShadowStrength:{default:.4}},{cx:{default:"-1.9771995110313272619112808106831597"},cxModifiers:{},cy:{default:"0.0"},cyModifiers:{},scale:{default:"2.5"},scaleModifiers:{},angle:{default:0},angleModifiers:{}}),emits:Ue(["ready"],["update:cx","update:cy","update:scale","update:angle"]),setup(t,{expose:e,emit:r}){const i=zt(null);let a=null,o=null,s,l=!1;const c=r,z=ne(t,"cx"),h=ne(t,"cy"),b=ne(t,"scale"),y=ne(t,"angle");Ze(()=>[z.value,h.value,b.value,y.value],([g,R,P,G],[A,F,k,U])=>{l||s&&(!g||!R||!P||((g!==A||R!==F)&&s.origin(g,R),P!==k&&s.scale(P),G!==U&&s.angle(Number(G))))},{flush:"sync"});const _=t;Ze(()=>_.dprMultiplier,g=>{o&&(o.dprMultiplier=g,m())}),Ze(()=>_.targetFps,g=>{o&&(o.targetFps=g)}),Ze(()=>_.gpuLoadMultiplier,g=>{o&&(o.gpuLoadMultiplier=g)});async function S(){if(!o||!s)return;const g=s.step();if(!g)return;const[R,P]=g,[G,A,F,k]=s.get_params();l=!0,z.value=G,h.value=A,b.value=F,y.value=parseFloat(k),await Va(),l=!1;const U=Math.min(Math.max(100,1e3*_.maxIterationMultiplier*Math.log2(1/parseFloat(F))),1e5);await o.update({cx:G,cy:A,dx:parseFloat(R),dy:parseFloat(P),mu:_.mu,scale:parseFloat(F),angle:parseFloat(k),maxIterations:U,epsilon:_.epsilon},{antialiasLevel:_.antialiasLevel,palettePeriod:_.palettePeriod,paletteOffset:_.paletteOffset,colorStops:Ha(_.colorStops),interpolationMode:_.interpolationMode,activateAnimate:_.activateAnimate,tessellationLevel:_.tessellationLevel,displacementAmount:_.displacementAmount,animationSpeed:_.animationSpeed,ambientOcclusionStrength:_.ambientOcclusionStrength,microBumpStrength:_.microBumpStrength,clearcoatStrength:_.clearcoatStrength,subsurfaceStrength:_.subsurfaceStrength,reliefDepth:_.reliefDepth,localShadowStrength:_.localShadowStrength}),await o.render()}async function u(){if(i.value)return a=i.value,s=new Qe(z.value,h.value,b.value,Number(y.value)),s.origin(z.value,h.value),s.scale(b.value),s.angle(Number(y.value)),o=new vt(a,{antialiasLevel:_.antialiasLevel,palettePeriod:_.palettePeriod,paletteOffset:_.paletteOffset,colorStops:_.colorStops,interpolationMode:_.interpolationMode,activateAnimate:_.activateAnimate,tessellationLevel:_.tessellationLevel,displacementAmount:_.displacementAmount,animationSpeed:_.animationSpeed,ambientOcclusionStrength:_.ambientOcclusionStrength,microBumpStrength:_.microBumpStrength,clearcoatStrength:_.clearcoatStrength,subsurfaceStrength:_.subsurfaceStrength,reliefDepth:_.reliefDepth,localShadowStrength:_.localShadowStrength}),o.initialize(s)}async function m(){if(!i.value||!o)return;const g=i.value.getBoundingClientRect();i.value.width=g.width,i.value.height=g.height,o.resize()}return _r(async()=>{await u(),window.addEventListener("resize",m),await m(),o&&(c("ready",o),o.startRenderLoop(S))}),mr(()=>{o==null||o.stopRenderLoop(),window.removeEventListener("resize",m)}),e({getCanvas:()=>i.value,getEngine:()=>o,getNavigator:()=>s,translate:(g,R)=>s==null?void 0:s.translate(g,R),translateDirect:(g,R)=>s==null?void 0:s.translate_direct(g,R),rotate:g=>s==null?void 0:s.rotate(g),angle:g=>s==null?void 0:s.angle(g),zoom:g=>s==null?void 0:s.zoom(g),step:()=>s==null?void 0:s.step(),getParams:()=>s==null?void 0:s.get_params(),drawOnce:async()=>S(),resize:async()=>m(),initialize:async()=>u(),useBla:()=>o==null?void 0:o.setApproximationMode("bla"),usePerturbation:()=>o==null?void 0:o.setApproximationMode("perturbation"),setApproximationMode:g=>o==null?void 0:o.setApproximationMode(g),getApproximationMode:()=>o==null?void 0:o.getApproximationMode(),setBlaEpsilon:g=>o==null?void 0:o.setBlaEpsilon(g)}),(g,R)=>(Fe(),De("canvas",{ref_key:"canvasRef",ref:i},null,512))}}),sr={class:"mobile-nav-controls"},lr={key:0,class:"directional-controls"},ur={width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",style:{"vertical-align":"middle","margin-right":"4px"}},cr=wt({__name:"MobileNavigationControls",props:Ue({mandelbrotRef:{}},{expanded:{type:Boolean,default:!1},expandedModifiers:{}}),emits:["update:expanded"],setup(t){const e=t,r=ne(t,"expanded"),i=zt(null);let a=null;const o=()=>{r.value=!r.value,r.value||l()},s=S=>{S.preventDefault(),S.stopPropagation(),o()},l=()=>{i.value=null,a!==null&&(clearInterval(a),a=null)},c=S=>{i.value=S;const u=.01,m=()=>{if(e.mandelbrotRef)switch(S){case"north":e.mandelbrotRef.translate(0,u);break;case"south":e.mandelbrotRef.translate(0,-u);break;case"west":e.mandelbrotRef.translate(-u,0);break;case"east":e.mandelbrotRef.translate(u,0);break}};m(),a=window.setInterval(m,16)},z=S=>{i.value=`rotate-${S}`;const u=.025,m=()=>{e.mandelbrotRef&&(S==="left"?e.mandelbrotRef.rotate(u):e.mandelbrotRef.rotate(-u))};m(),a=window.setInterval(m,16)},h=S=>{i.value=`zoom-${S}`;const u=.97,m=()=>{e.mandelbrotRef&&(S==="in"?e.mandelbrotRef.zoom(u):e.mandelbrotRef.zoom(1/u))};m(),a=window.setInterval(m,16)},b=(S,u)=>{S.preventDefault(),u()},y=S=>{S.preventDefault(),l()};function _(S){S.preventDefault(),S.stopPropagation(),window.location.href=new URL("./presentation/",window.location.href).href}return(S,u)=>(Fe(),De("div",sr,[T("button",{class:de(["nav-button compass-button",{active:r.value}]),onClick:o,onTouchend:s,"aria-label":"Toggle navigation"},[...u[16]||(u[16]=[qa('<svg width="32" height="32" viewBox="0 0 24 24" fill="none" class="nav-icon" data-v-1e35ba8c><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" data-v-1e35ba8c></circle><path d="M12 2 L12 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" data-v-1e35ba8c></path><path d="M12 18 L12 22" stroke="currentColor" stroke-width="2" stroke-linecap="round" data-v-1e35ba8c></path><path d="M2 12 L6 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" data-v-1e35ba8c></path><path d="M18 12 L22 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" data-v-1e35ba8c></path><path d="M12 7 L10 12 L12 14 L14 12 Z" fill="currentColor" data-v-1e35ba8c></path><text x="12" y="6" text-anchor="middle" font-size="6" fill="currentColor" font-weight="bold" data-v-1e35ba8c>N</text></svg>',1)])],34),St(Ya,{name:"fade"},{default:Wa(()=>[r.value?(Fe(),De("div",lr,[T("button",{class:de(["nav-button direction-button north",{active:i.value==="north"}]),onTouchstart:u[0]||(u[0]=m=>b(m,()=>c("north"))),onTouchend:y,onMousedown:u[1]||(u[1]=m=>c("north")),onMouseup:l,onMouseleave:l,"aria-label":"Move North"},[...u[17]||(u[17]=[T("svg",{width:"48",height:"48",viewBox:"0 0 24 24",fill:"none",class:"nav-icon"},[T("path",{d:"M12 5 L18 11 L15 11 L15 19 L9 19 L9 11 L6 11 Z",fill:"currentColor",stroke:"black","stroke-width":"1"})],-1)])],34),T("button",{class:de(["nav-button direction-button south",{active:i.value==="south"}]),onTouchstart:u[2]||(u[2]=m=>b(m,()=>c("south"))),onTouchend:y,onMousedown:u[3]||(u[3]=m=>c("south")),onMouseup:l,onMouseleave:l,"aria-label":"Move South"},[...u[18]||(u[18]=[T("svg",{width:"48",height:"48",viewBox:"0 0 24 24",fill:"none",class:"nav-icon"},[T("path",{d:"M12 19 L6 13 L9 13 L9 5 L15 5 L15 13 L18 13 Z",fill:"currentColor",stroke:"black","stroke-width":"1"})],-1)])],34),T("button",{class:de(["nav-button direction-button west",{active:i.value==="west"}]),onTouchstart:u[4]||(u[4]=m=>b(m,()=>c("west"))),onTouchend:y,onMousedown:u[5]||(u[5]=m=>c("west")),onMouseup:l,onMouseleave:l,"aria-label":"Move West"},[...u[19]||(u[19]=[T("svg",{width:"48",height:"48",viewBox:"0 0 24 24",fill:"none",class:"nav-icon"},[T("path",{d:"M5 12 L11 18 L11 15 L19 15 L19 9 L11 9 L11 6 Z",fill:"currentColor",stroke:"black","stroke-width":"1"})],-1)])],34),T("button",{class:de(["nav-button direction-button east",{active:i.value==="east"}]),onTouchstart:u[6]||(u[6]=m=>b(m,()=>c("east"))),onTouchend:y,onMousedown:u[7]||(u[7]=m=>c("east")),onMouseup:l,onMouseleave:l,"aria-label":"Move East"},[...u[20]||(u[20]=[T("svg",{width:"48",height:"48",viewBox:"0 0 24 24",fill:"none",class:"nav-icon"},[T("path",{d:"M19 12 L13 6 L13 9 L5 9 L5 15 L13 15 L13 18 Z",fill:"currentColor",stroke:"black","stroke-width":"1"})],-1)])],34),T("button",{class:de(["nav-button corner-button rotate-left",{active:i.value==="rotate-left"}]),onTouchstart:u[8]||(u[8]=m=>b(m,()=>z("left"))),onTouchend:y,onMousedown:u[9]||(u[9]=m=>z("left")),onMouseup:l,onMouseleave:l,"aria-label":"Rotate Left"},[...u[21]||(u[21]=[T("svg",{width:"40",height:"40",viewBox:"0 0 24 24",fill:"none",class:"nav-icon"},[T("path",{d:"M16 8 A6 6 0 1 0 8 16",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round"}),T("path",{d:"M5 16 L8 16 L8 13",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"})],-1)])],34),T("button",{class:de(["nav-button corner-button rotate-right",{active:i.value==="rotate-right"}]),onTouchstart:u[10]||(u[10]=m=>b(m,()=>z("right"))),onTouchend:y,onMousedown:u[11]||(u[11]=m=>z("right")),onMouseup:l,onMouseleave:l,"aria-label":"Rotate Right"},[...u[22]||(u[22]=[T("svg",{width:"40",height:"40",viewBox:"0 0 24 24",fill:"none",class:"nav-icon"},[T("path",{d:"M8 8 A6 6 0 1 1 16 16",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round"}),T("path",{d:"M19 16 L16 16 L16 13",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"})],-1)])],34),T("button",{class:de(["nav-button corner-button zoom-out",{active:i.value==="zoom-out"}]),onTouchstart:u[12]||(u[12]=m=>b(m,()=>h("out"))),onTouchend:y,onMousedown:u[13]||(u[13]=m=>h("out")),onMouseup:l,onMouseleave:l,"aria-label":"Zoom Out"},[...u[23]||(u[23]=[T("svg",{width:"40",height:"40",viewBox:"0 0 24 24",fill:"none",class:"nav-icon"},[T("circle",{cx:"11",cy:"11",r:"7",stroke:"currentColor","stroke-width":"2"}),T("path",{d:"M18 18 L22 22",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"}),T("path",{d:"M8 11 L14 11",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"})],-1)])],34),T("button",{class:de(["nav-button corner-button zoom-in",{active:i.value==="zoom-in"}]),onTouchstart:u[14]||(u[14]=m=>b(m,()=>h("in"))),onTouchend:y,onMousedown:u[15]||(u[15]=m=>h("in")),onMouseup:l,onMouseleave:l,"aria-label":"Zoom In"},[...u[24]||(u[24]=[T("svg",{width:"40",height:"40",viewBox:"0 0 24 24",fill:"none",class:"nav-icon"},[T("circle",{cx:"11",cy:"11",r:"7",stroke:"currentColor","stroke-width":"2"}),T("path",{d:"M18 18 L22 22",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"}),T("path",{d:"M11 8 L11 14",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"}),T("path",{d:"M8 11 L14 11",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"})],-1)])],34),T("button",{class:"presentation-button",onTouchend:ja(_,["prevent","stop"]),onClick:_,"aria-label":"Pr\xE9sentation"},[(Fe(),De("svg",ur,[...u[25]||(u[25]=[T("rect",{x:"2",y:"3",width:"20",height:"14",rx:"2",ry:"2"},null,-1),T("line",{x1:"8",y1:"21",x2:"16",y2:"21"},null,-1),T("line",{x1:"12",y1:"17",x2:"12",y2:"21"},null,-1)])])),u[26]||(u[26]=$a(" Pr\xE9sentation ",-1))],32)])):Xa("",!0)]),_:1})]))}}),dr=vr(cr,[["__scopeId","data-v-1e35ba8c"]]),fr={style:{position:"relative",width:"100%",height:"100%"}},Ge=.01,bt=.025,hr=300,pr=30,gr=wt({__name:"MandelbrotController",props:Ue({mu:{},epsilon:{},colorStops:{},antialiasLevel:{},palettePeriod:{},paletteOffset:{},activateAnimate:{type:Boolean},dprMultiplier:{},maxIterationMultiplier:{},targetFps:{},gpuLoadMultiplier:{},interpolationMode:{},pickerMode:{type:Boolean},tessellationLevel:{},displacementAmount:{},animationSpeed:{},ambientOcclusionStrength:{},microBumpStrength:{},clearcoatStrength:{},subsurfaceStrength:{},reliefDepth:{},localShadowStrength:{}},{cx:{},cxModifiers:{},cy:{},cyModifiers:{},scale:{},scaleModifiers:{},angle:{},angleModifiers:{},mobileNavExpanded:{type:Boolean,default:!1},mobileNavExpandedModifiers:{}}),emits:Ue(["palettePick","pickerDone","engineReady"],["update:cx","update:cy","update:scale","update:angle","update:mobileNavExpanded"]),setup(t,{expose:e,emit:r}){const i=ne(t,"cx"),a=ne(t,"cy"),o=ne(t,"scale"),s=ne(t,"angle"),l=ne(t,"mobileNavExpanded"),c=t,z=r,h=zt(null),b={};e({getCanvas:M,getEngine:()=>{var d;return((d=h.value)==null?void 0:d.getEngine())??null}});let y=!1,_=!1,S=0,u=0,m=0,g=0,R=0,P=!1,G=0,A=null,F=0,k=0,U=0;function M(){var d;return((d=h.value)==null?void 0:d.getCanvas())??null}function L(d){const v=M();if(!v)return{x:0,y:0,width:0,height:0};const w=v.getBoundingClientRect();return{x:d.clientX-w.left,y:d.clientY-w.top,width:w.width,height:w.height}}function C(d){var w,B,E;const v=(B=(w=d.target)==null?void 0:w.tagName)==null?void 0:B.toLowerCase();v==="input"||v==="textarea"||v==="select"||(E=d.target)!=null&&E.isContentEditable||(b[d.code]=!0)}function x(d){b[d.code]=!1}function D(d){var w,B;if(c.pickerMode){d.preventDefault();return}d.preventDefault();const v=.95;d.deltaY<0?(w=h.value)==null||w.zoom(v):(B=h.value)==null||B.zoom(1/v)}function $(d,v){var Le;const w=M();if(!w)return;const B=w.getBoundingClientRect(),E=d-B.left,O=v-B.top,N=B.width,H=B.height,Q=N/H,ue=(E-N/2)/N*2,ce=(O-H/2)/H*2;(Le=h.value)==null||Le.translateDirect(ue*Q,-ce)}function ae(d){if(c.pickerMode){d.preventDefault();return}d.preventDefault(),$(d.clientX,d.clientY)}function V(d){if(c.pickerMode||d.touches.length!==0)return;const v=Date.now(),w=d.changedTouches[0];if(!w)return;const B=w.clientX,E=w.clientY;v-F<hr&&Math.hypot(B-k,E-U)<pr?(d.preventDefault(),$(B,E),F=0):(F=v,k=B,U=E)}function K(d){if(c.pickerMode){d.preventDefault(),j(d);return}if(d.button===2)_=!0;else{y=!0;const v=L(d);S=v.x,u=v.y}}async function j(d){var v;try{const w=(v=h.value)==null?void 0:v.getEngine();if(!w)return;const B=M();if(!B)return;const E=B.getBoundingClientRect(),O=d.clientX-E.left,N=d.clientY-E.top,H=await w.readIterationDataAt(O,N,E.width,E.height);if(!H)return;z("palettePick",H,d.clientX,d.clientY)}finally{z("pickerDone")}}function J(d){var H,Q;if(c.pickerMode)return;const v=L(d);if(_){const ue=M();if(!ue)return;const ce=ue.getBoundingClientRect(),Le=ce.width/2,xt=ce.height/2,yt=v.x,Ga=v.y,Fa=Math.atan2(Ga-xt,yt-Le);(H=h.value)==null||H.angle(Fa);return}if(!y)return;const w=v.width,B=v.height,E=w/B,O=(v.x-S)/w*2,N=(v.y-u)/B*2;(Q=h.value)==null||Q.translateDirect(-O*E,N),S=v.x,u=v.y}function te(d){c.pickerMode||(d.button===2?_=!1:y=!1)}function q(d){var w;if(c.pickerMode)return;const v=M();if(v){if(d.touches.length===1){y=!0;const B=d.touches[0],E=v.getBoundingClientRect();S=B.clientX-E.left,u=B.clientY-E.top}else if(d.touches.length===2){y=!1,P=!0;const[B,E]=d.touches;m=Math.hypot(E.clientX-B.clientX,E.clientY-B.clientY),G=m,g=Math.atan2(E.clientY-B.clientY,E.clientX-B.clientX);const O=(w=h.value)==null?void 0:w.getParams();R=O?parseFloat(O[3]):0}}}function X(d){var w,B,E;if(c.pickerMode)return;const v=M();if(v){if(y&&d.touches.length===1){const O=d.touches[0],N=v.getBoundingClientRect(),H=O.clientX-N.left,Q=O.clientY-N.top,ue=N.width,ce=N.height,Le=ue/ce,xt=(H-S)/ue*2,yt=(Q-u)/ce*2;(w=h.value)==null||w.translateDirect(-xt*Le,yt),S=H,u=Q}else if(P&&d.touches.length===2){const[O,N]=d.touches,H=Math.hypot(N.clientX-O.clientX,N.clientY-O.clientY),Q=Math.atan2(N.clientY-O.clientY,N.clientX-O.clientX),ue=G/H;G=H,(B=h.value)==null||B.zoom(ue);const ce=Q-g;(E=h.value)==null||E.angle(R+ce)}}}function oe(d){d.touches.length===0&&(y=!1,P=!1)}function Z(){var d,v,w,B,E,O,N,H;if(!c.pickerMode){b.KeyW&&((d=h.value)==null||d.translate(0,Ge)),b.KeyS&&((v=h.value)==null||v.translate(0,-Ge)),b.KeyA&&((w=h.value)==null||w.translate(-Ge,0)),b.KeyD&&((B=h.value)==null||B.translate(Ge,0)),b.KeyQ&&((E=h.value)==null||E.rotate(bt)),b.KeyE&&((O=h.value)==null||O.rotate(-bt));const Q=.97;b.KeyR&&((N=h.value)==null||N.zoom(Q)),b.KeyF&&((H=h.value)==null||H.zoom(1/Q))}A=window.setTimeout(Z,16)}return _r(async()=>{const d=M();d&&(window.addEventListener("keydown",C),window.addEventListener("keyup",x),d.addEventListener("wheel",D,{passive:!1}),d.addEventListener("mousedown",K),d.addEventListener("dblclick",ae),d.addEventListener("contextmenu",v=>v.preventDefault()),window.addEventListener("mousemove",J),window.addEventListener("mouseup",te),d.addEventListener("touchstart",q,{passive:!1}),d.addEventListener("touchmove",X,{passive:!1}),d.addEventListener("touchend",oe,{passive:!1}),d.addEventListener("touchend",V,{passive:!1}),Z())}),mr(()=>{A!==null&&clearTimeout(A);const d=M();window.removeEventListener("keydown",C),window.removeEventListener("keyup",x),window.removeEventListener("mousemove",J),window.removeEventListener("mouseup",te),d&&(d.removeEventListener("wheel",D),d.removeEventListener("mousedown",K),d.removeEventListener("dblclick",ae),d.removeEventListener("contextmenu",v=>v.preventDefault()),d.removeEventListener("touchstart",q),d.removeEventListener("touchmove",X),d.removeEventListener("touchend",oe),d.removeEventListener("touchend",V))}),(d,v)=>(Fe(),De("div",fr,[St(Mt,{ref_key:"mandelbrotRef",ref:h,scale:o.value,"onUpdate:scale":v[0]||(v[0]=w=>o.value=w),angle:s.value,"onUpdate:angle":v[1]||(v[1]=w=>s.value=w),cx:i.value,"onUpdate:cx":v[2]||(v[2]=w=>i.value=w),cy:a.value,"onUpdate:cy":v[3]||(v[3]=w=>a.value=w),mu:c.mu,epsilon:c.epsilon,antialiasLevel:c.antialiasLevel,palettePeriod:c.palettePeriod,colorStops:c.colorStops,activateAnimate:c.activateAnimate,paletteOffset:c.paletteOffset,dprMultiplier:c.dprMultiplier,maxIterationMultiplier:c.maxIterationMultiplier,targetFps:c.targetFps,gpuLoadMultiplier:c.gpuLoadMultiplier,interpolationMode:c.interpolationMode,tessellationLevel:c.tessellationLevel,displacementAmount:c.displacementAmount,animationSpeed:c.animationSpeed,ambientOcclusionStrength:c.ambientOcclusionStrength,microBumpStrength:c.microBumpStrength,clearcoatStrength:c.clearcoatStrength,subsurfaceStrength:c.subsurfaceStrength,reliefDepth:c.reliefDepth,localShadowStrength:c.localShadowStrength,onReady:v[4]||(v[4]=w=>z("engineReady",w))},null,8,["scale","angle","cx","cy","mu","epsilon","antialiasLevel","palettePeriod","colorStops","activateAnimate","paletteOffset","dprMultiplier","maxIterationMultiplier","targetFps","gpuLoadMultiplier","interpolationMode","tessellationLevel","displacementAmount","animationSpeed","ambientOcclusionStrength","microBumpStrength","clearcoatStrength","subsurfaceStrength","reliefDepth","localShadowStrength"]),St(dr,{"mandelbrot-ref":h.value,expanded:l.value,"onUpdate:expanded":v[5]||(v[5]=w=>l.value=w)},null,8,["mandelbrot-ref","expanded"])]))}}),br=vr(gr,[["__scopeId","data-v-a8910c4b"]])})();export{br as M,Mt as _,Za as __tla};
