import{aq as mn,d as gt,ar as ne,z as Ie,p as qt,s as Yt,o as Ce,c as Be,j as B,e as Xt,as as Le,y as _t,U as vn,at as bn,n as oe,J as st,T as xn,w as yn,a as wn,a2 as Sn,_ as $t}from"./framework.HRO6m9zK.js";let da,na;let __tla=(async()=>{const zn=`// Mandelbrot progressive-iteration shader.
//
...
`,Mn=`// Resolve pass: replaces remaining sentinels with a snapped parent pixel.
//
// Uses a texture_2d_array<f32> with 8 r32float layers.
//
// Layer layout:
...
`,Cn=`// Compute pass: counts pixels that still need rendering work.
//
...
`,Bn=`// Merge pass: fuses the resolved (live) and frozen textures into a new frozen
