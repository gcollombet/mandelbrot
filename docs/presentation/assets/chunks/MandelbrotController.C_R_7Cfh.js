import{aq as fr,d as Yt,ar as de,z as Fe,p as Ln,s as Pn,o as ke,c as Be,j as E,e as Dt,Q as pr,as as He,y as Te,U as hr,at as gr,J as Ot,T as _r,w as mr,_ as Dn,a6 as vr,a7 as br}from"./framework.Dlw4ETio.js";let ps,ns;let __tla=(async()=>{const xr=`// Mandelbrot progressive-iteration shader.
//
...
struct BlaStep {
  ...
  alpha_exp: i32,
  radius_beta: f32,
  // Pad\xe9 [1/1] denominator coefficient D = (dx,dy)\xb72^d_exp. Zero in affine mode
...
// Complex reciprocal 1/z = conj(z)/|z|\xb2 (used by the Pad\xe9 block application).
fn cinv(z: vec2<f32>) -> vec2<f32> {
  return vec2<f32>(z.x, -z.y) / dot(z, z);
}

// Pad\xe9 pole guard: when |1 + D\xb7dz|\xb2 < PADE_POLE2 the rational map is near its pole,
// so the block is rejected (descend a level / fall back to an exact step). Within
// the √ε validity radius |D\xb7dz| ≤ √ε ⇒ |1+D\xb7dz| ≈ 1, so this fires very rarely.
      ...
      if (u32(slot) < levelInfo.count) {
        ...
        if (dzMag2 <= radius * radius) {
          if (mandelbrot.approximationMode >= 1.5) {
            // ── Pad\xe9 [1/1]: z ← (A\xb7z + B\xb7c)/(1 + D\xb7z) ──
            ...
            if (length(b) * dcMag < mandelbrot.blaEpsilon && bla.log2_min_a >= log2_mu && dot(m, m) >= PADE_POLE2) {
              ...
              if (!(skip > 1 && dot(candidateZ, candidateZ) > bailout)) {
                *dz = candidate;
                *zOut = candidateZ;
                // D4 derivative: der' = (A/M\xb2)\xb7der + B/M, reusing invM = 1/M.
      ...
      if (u32(slot) < levelInfo.count) {
        ...
        if (log_betaDc < log_alpha) {            // radius > 0
          ...
          if (log_dz <= log_radius) {
            // num = A\xb7dz + B\xb7dc  (a, b share exponent ab_exp)
...
fn mandelbrot_compute_deep(dc: fe, prev_iter: f32, prev_dz_m: vec2<f32>, prev_dz_e: i32, prev_ref_i_int: i32, prev_dzx: f32, prev_dzy: f32) -> FragOut {
  ...
  // BLA (affine) and Pad\xe9 (rational, floatexp) both run on the deep path;
...
`,yr=`// Fused brush + mandelbrot + count compute pass, working IN PLACE on the
...
`,wr=`// Brush pass: updates sentinel levels in the neutral square texture.
//
...
`,Rr=`// Merge pass: fuses the resolved (live) and frozen textures into a new frozen
...
`,Tr=`// AA present pass: resolve the linear-space accumulation texture to the swapchain.
//
...
`,kr=`// One-shot bake of the per-neutral-texel AA sample-count target, derived from
...
`,Br=`// Selective AA reseed (Stage B): stamp iter = -1 (a fresh-compute request) on the
...
`,Ar=async(t={},e)=>{let n;if(e.startsWith("data:")){const r=e.replace(/^data:.*?base64,/,"");let i;if(typeof Buffer=="function"&&typeof Buffer.from=="function")i=Buffer.from(r,"base64");else if(typeof atob=="function"){const a=atob(r);i=new Uint8Array(a.length);for(let o=0;o<a.length;o++)i[o]=a.charCodeAt(o)}else throw new Error("Cannot decode base64-encoded data URL");n=await WebAssembly.instantiate(i,t)}else{const r=await fetch(e),i=r.headers.get("Content-Type")||"";if("instantiateStreaming"in WebAssembly&&i.startsWith("application/wasm"))n=await WebAssembly.instantiateStreaming(r,t);else{const a=await r.arrayBuffer();n=await WebAssembly.instantiate(a,t)}}return n.instance.exports};let d;function Er(t){d=t}let Qe=null;function lt(){return(Qe===null||Qe.byteLength===0)&&(Qe=new Uint8Array(d.memory.buffer)),Qe}let ct=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});ct.decode();const Cr=0x7ff00000;let St=0;function Ir(t,e){return St+=e,St>=Cr&&(ct=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),ct.decode(),St=e),ct.decode(lt().subarray(t,t+e))}function On(t,e){return t=t>>>0,Ir(t,e)}let Me=null;function Lr(){return(Me===null||Me.buffer.detached===!0||Me.buffer.detached===void 0&&Me.buffer!==d.memory.buffer)&&(Me=new DataView(d.memory.buffer)),Me}function Ne(t,e){t=t>>>0;const n=Lr(),r=[];for(let i=t;i<t+4*e;i+=4)r.push(d.__wbindgen_export_0.get(n.getUint32(i,!0)));return d.__externref_drop_slice(t,e),r}let Q=0;const Ve=new TextEncoder;"encodeInto"in Ve||(Ve.encodeInto=function(t,e){const n=Ve.encode(t);return e.set(n),{read:t.length,written:n.length}});function ie(t,e,n){if(n===void 0){const s=Ve.encode(t),l=e(s.length,1)>>>0;return lt().subarray(l,l+s.length).set(s),Q=s.length,l}let r=t.length,i=e(r,1)>>>0;const a=lt();let o=0;for(;o<r;o++){const s=t.charCodeAt(o);if(s>127)break;a[i+o]=s}if(o!==r){o!==0&&(t=t.slice(o)),i=n(i,r,r=o+t.length*3,1)>>>0;const s=lt().subarray(i+o,i+r),l=Ve.encodeInto(t,s);o+=l.written,i=n(i,r,o,1)>>>0}return Q=o,i}function ge(t){return t==null}let et=null;function Pr(){return(et===null||et.byteLength===0)&&(et=new Float64Array(d.memory.buffer)),et}function Dr(t,e){return t=t>>>0,Pr().subarray(t/8,t/8+e)}const sn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>d.__wbg_blabufferinfo_free(t>>>0,1));class We{static __wrap(e){e=e>>>0;const n=Object.create(We.prototype);return n.__wbg_ptr=e,sn.register(n,n.__wbg_ptr,n),n}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,sn.unregister(this),e}free(){const e=this.__destroy_into_raw();d.__wbg_blabufferinfo_free(e,0)}get ptr(){return d.__wbg_get_blabufferinfo_ptr(this.__wbg_ptr)>>>0}set ptr(e){d.__wbg_set_blabufferinfo_ptr(this.__wbg_ptr,e)}get count(){return d.__wbg_get_blabufferinfo_count(this.__wbg_ptr)>>>0}set count(e){d.__wbg_set_blabufferinfo_count(this.__wbg_ptr,e)}get levels_ptr(){return d.__wbg_get_blabufferinfo_levels_ptr(this.__wbg_ptr)>>>0}set levels_ptr(e){d.__wbg_set_blabufferinfo_levels_ptr(this.__wbg_ptr,e)}get level_count(){return d.__wbg_get_blabufferinfo_level_count(this.__wbg_ptr)>>>0}set level_count(e){d.__wbg_set_blabufferinfo_level_count(this.__wbg_ptr,e)}}Symbol.dispose&&(We.prototype[Symbol.dispose]=We.prototype.free);typeof FinalizationRegistry>"u"||new FinalizationRegistry(t=>d.__wbg_blalevel_free(t>>>0,1));typeof FinalizationRegistry>"u"||new FinalizationRegistry(t=>d.__wbg_blastep_free(t>>>0,1));const ln=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>d.__wbg_mandelbrotnavigator_free(t>>>0,1));class Gt{__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,ln.unregister(this),e}free(){const e=this.__destroy_into_raw();d.__wbg_mandelbrotnavigator_free(e,0)}get_params(){const e=d.mandelbrotnavigator_get_params(this.__wbg_ptr);var n=Ne(e[0],e[1]).slice();return d.__wbindgen_free(e[0],e[1]*4,4),n}find_minibrot(e,n){const r=d.mandelbrotnavigator_find_minibrot(this.__wbg_ptr,e,n);var i=Ne(r[0],r[1]).slice();return d.__wbindgen_free(r[0],r[1]*4,4),i}rotate_direct(e){d.mandelbrotnavigator_rotate_direct(this.__wbg_ptr,e)}benchmark_pade(e){const n=d.mandelbrotnavigator_benchmark_pade(this.__wbg_ptr,e);return qe.__wrap(n)}get_bla_epsilon(){return d.mandelbrotnavigator_get_bla_epsilon(this.__wbg_ptr)}set_bla_epsilon(e){d.mandelbrotnavigator_set_bla_epsilon(this.__wbg_ptr,e)}get_max_bla_skip(){return d.mandelbrotnavigator_get_max_bla_skip(this.__wbg_ptr)>>>0}is_in_transition(){return d.mandelbrotnavigator_is_in_transition(this.__wbg_ptr)!==0}pixel_to_complex(e,n,r,i){const a=d.mandelbrotnavigator_pixel_to_complex(this.__wbg_ptr,e,n,r,i);var o=Ne(a[0],a[1]).slice();return d.__wbindgen_free(a[0],a[1]*4,4),o}reference_origin(e,n){const r=ie(e,d.__wbindgen_malloc,d.__wbindgen_realloc),i=Q,a=ie(n,d.__wbindgen_malloc,d.__wbindgen_realloc),o=Q;d.mandelbrotnavigator_reference_origin(this.__wbg_ptr,r,i,a,o)}set_max_bla_skip(e){d.mandelbrotnavigator_set_max_bla_skip(this.__wbg_ptr,e)}start_transition(e,n,r,i,a){const o=ie(e,d.__wbindgen_malloc,d.__wbindgen_realloc),s=Q,l=ie(n,d.__wbindgen_malloc,d.__wbindgen_realloc),b=Q,h=ie(r,d.__wbindgen_malloc,d.__wbindgen_realloc),S=Q;d.mandelbrotnavigator_start_transition(this.__wbg_ptr,o,s,l,b,h,S,i,a)}translate_direct(e,n,r,i){d.mandelbrotnavigator_translate_direct(this.__wbg_ptr,e,n,!ge(r),ge(r)?0:r,!ge(i),ge(i)?0:i)}use_perturbation(){d.mandelbrotnavigator_use_perturbation(this.__wbg_ptr)}cancel_transition(){d.mandelbrotnavigator_cancel_transition(this.__wbg_ptr)}coordinate_to_pixel(e,n,r,i){const a=ie(e,d.__wbindgen_malloc,d.__wbindgen_realloc),o=Q,s=ie(n,d.__wbindgen_malloc,d.__wbindgen_realloc),l=Q,b=d.mandelbrotnavigator_coordinate_to_pixel(this.__wbg_ptr,a,o,s,l,r,i);var h=Dr(b[0],b[1]).slice();return d.__wbindgen_free(b[0],b[1]*8,8),h}get_reference_params(){const e=d.mandelbrotnavigator_get_reference_params(this.__wbg_ptr);var n=Ne(e[0],e[1]).slice();return d.__wbindgen_free(e[0],e[1]*4,4),n}get_approximation_mode(){return d.mandelbrotnavigator_get_approximation_mode(this.__wbg_ptr)}get_reference_orbit_len(){return d.mandelbrotnavigator_get_reference_orbit_len(this.__wbg_ptr)>>>0}compute_bla_reference_ptr(e){const n=d.mandelbrotnavigator_compute_bla_reference_ptr(this.__wbg_ptr,e);return We.__wrap(n)}compute_reference_orbit_ptr(e){const n=d.mandelbrotnavigator_compute_reference_orbit_ptr(this.__wbg_ptr,e);return Ce.__wrap(n)}get_reference_orbit_capacity(){return d.mandelbrotnavigator_get_reference_orbit_capacity(this.__wbg_ptr)>>>0}compute_reference_orbit_chunk(e,n){const r=d.mandelbrotnavigator_compute_reference_orbit_chunk(this.__wbg_ptr,e,n);return Ce.__wrap(r)}constructor(e,n,r,i){const a=ie(e,d.__wbindgen_malloc,d.__wbindgen_realloc),o=Q,s=ie(n,d.__wbindgen_malloc,d.__wbindgen_realloc),l=Q,b=ie(r,d.__wbindgen_malloc,d.__wbindgen_realloc),h=Q,S=d.mandelbrotnavigator_new(a,o,s,l,b,h,i);return this.__wbg_ptr=S>>>0,ln.register(this,this.__wbg_ptr,this),this}step(e,n){const r=d.mandelbrotnavigator_step(this.__wbg_ptr,!ge(e),ge(e)?0:e,!ge(n),ge(n)?0:n);var i=Ne(r[0],r[1]).slice();return d.__wbindgen_free(r[0],r[1]*4,4),i}zoom(e){d.mandelbrotnavigator_zoom(this.__wbg_ptr,e)}angle(e){d.mandelbrotnavigator_angle(this.__wbg_ptr,e)}scale(e){const n=ie(e,d.__wbindgen_malloc,d.__wbindgen_realloc),r=Q;d.mandelbrotnavigator_scale(this.__wbg_ptr,n,r)}origin(e,n){const r=ie(e,d.__wbindgen_malloc,d.__wbindgen_realloc),i=Q,a=ie(n,d.__wbindgen_malloc,d.__wbindgen_realloc),o=Q;d.mandelbrotnavigator_origin(this.__wbg_ptr,r,i,a,o)}rotate(e){d.mandelbrotnavigator_rotate(this.__wbg_ptr,e)}use_bla(){d.mandelbrotnavigator_use_bla(this.__wbg_ptr)}use_pade(){d.mandelbrotnavigator_use_pade(this.__wbg_ptr)}translate(e,n){d.mandelbrotnavigator_translate(this.__wbg_ptr,e,n)}}Symbol.dispose&&(Gt.prototype[Symbol.dispose]=Gt.prototype.free);typeof FinalizationRegistry>"u"||new FinalizationRegistry(t=>d.__wbg_mandelbrotstep_free(t>>>0,1));const cn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>d.__wbg_orbitbufferinfo_free(t>>>0,1));class Ce{static __wrap(e){e=e>>>0;const n=Object.create(Ce.prototype);return n.__wbg_ptr=e,cn.register(n,n.__wbg_ptr,n),n}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,cn.unregister(this),e}free(){const e=this.__destroy_into_raw();d.__wbg_orbitbufferinfo_free(e,0)}get ptr(){return d.__wbg_get_blabufferinfo_ptr(this.__wbg_ptr)>>>0}set ptr(e){d.__wbg_set_blabufferinfo_ptr(this.__wbg_ptr,e)}get offset(){return d.__wbg_get_blabufferinfo_count(this.__wbg_ptr)>>>0}set offset(e){d.__wbg_set_blabufferinfo_count(this.__wbg_ptr,e)}get count(){return d.__wbg_get_blabufferinfo_levels_ptr(this.__wbg_ptr)>>>0}set count(e){d.__wbg_set_blabufferinfo_levels_ptr(this.__wbg_ptr,e)}}Symbol.dispose&&(Ce.prototype[Symbol.dispose]=Ce.prototype.free);const dn=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>d.__wbg_padebenchmark_free(t>>>0,1));class qe{static __wrap(e){e=e>>>0;const n=Object.create(qe.prototype);return n.__wbg_ptr=e,dn.register(n,n.__wbg_ptr,n),n}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,dn.unregister(this),e}free(){const e=this.__destroy_into_raw();d.__wbg_padebenchmark_free(e,0)}get pixels(){return d.__wbg_get_padebenchmark_pixels(this.__wbg_ptr)>>>0}set pixels(e){d.__wbg_set_padebenchmark_pixels(this.__wbg_ptr,e)}get max_iter(){return d.__wbg_get_padebenchmark_max_iter(this.__wbg_ptr)>>>0}set max_iter(e){d.__wbg_set_padebenchmark_max_iter(this.__wbg_ptr,e)}get steps_exact(){return d.__wbg_get_padebenchmark_steps_exact(this.__wbg_ptr)}set steps_exact(e){d.__wbg_set_padebenchmark_steps_exact(this.__wbg_ptr,e)}get steps_affine(){return d.__wbg_get_padebenchmark_steps_affine(this.__wbg_ptr)}set steps_affine(e){d.__wbg_set_padebenchmark_steps_affine(this.__wbg_ptr,e)}get steps_pade(){return d.__wbg_get_padebenchmark_steps_pade(this.__wbg_ptr)}set steps_pade(e){d.__wbg_set_padebenchmark_steps_pade(this.__wbg_ptr,e)}get pade_mismatches(){return d.__wbg_get_padebenchmark_pade_mismatches(this.__wbg_ptr)>>>0}set pade_mismatches(e){d.__wbg_set_padebenchmark_pade_mismatches(this.__wbg_ptr,e)}get max_iter_delta(){return d.__wbg_get_padebenchmark_max_iter_delta(this.__wbg_ptr)>>>0}set max_iter_delta(e){d.__wbg_set_blastep_d_exp(this.__wbg_ptr,e)}}Symbol.dispose&&(qe.prototype[Symbol.dispose]=qe.prototype.free);function Or(t){return Math.exp(t)}function Gr(){return Date.now()}function Fr(t,e){throw new Error(On(t,e))}function Nr(t,e){return On(t,e)}function Ur(){const t=d.__wbindgen_export_0,e=t.grow(4);t.set(0,void 0),t.set(e+0,void 0),t.set(e+1,null),t.set(e+2,!0),t.set(e+3,!1)}URL=globalThis.URL;const c=await Ar({"./mandelbrot_bg.js":{__wbg_now_1e80617bcee43265:Gr,__wbg_exp_9293ded1248e1bd3:Or,__wbg_wbindgenthrow_451ec1a8469d7eb6:Fr,__wbindgen_init_externref_table:Ur,__wbindgen_cast_2241b6af4c4b2941:Nr}},fr),Vr=c.memory,Hr=c.__wbg_blabufferinfo_free,Wr=c.__wbg_blalevel_free,qr=c.__wbg_blastep_free,Zr=c.__wbg_get_blabufferinfo_count,Yr=c.__wbg_get_blabufferinfo_level_count,Xr=c.__wbg_get_blabufferinfo_levels_ptr,jr=c.__wbg_get_blabufferinfo_ptr,$r=c.__wbg_get_blastep_ab_exp,Kr=c.__wbg_get_blastep_alpha_exp,Jr=c.__wbg_get_blastep_ax,Qr=c.__wbg_get_blastep_ay,ei=c.__wbg_get_blastep_bx,ti=c.__wbg_get_blastep_by,ni=c.__wbg_get_blastep_d_exp,ri=c.__wbg_get_blastep_dx,ii=c.__wbg_get_blastep_dy,ai=c.__wbg_get_blastep_log2_min_a,oi=c.__wbg_get_blastep_radius_alpha,si=c.__wbg_get_blastep_radius_beta,li=c.__wbg_get_padebenchmark_max_iter,ci=c.__wbg_get_padebenchmark_max_iter_delta,di=c.__wbg_get_padebenchmark_pade_mismatches,ui=c.__wbg_get_padebenchmark_pixels,fi=c.__wbg_get_padebenchmark_steps_affine,pi=c.__wbg_get_padebenchmark_steps_exact,hi=c.__wbg_get_padebenchmark_steps_pade,gi=c.__wbg_mandelbrotnavigator_free,_i=c.__wbg_mandelbrotstep_free,mi=c.__wbg_orbitbufferinfo_free,vi=c.__wbg_padebenchmark_free,bi=c.__wbg_set_blabufferinfo_count,xi=c.__wbg_set_blabufferinfo_level_count,yi=c.__wbg_set_blabufferinfo_levels_ptr,Si=c.__wbg_set_blabufferinfo_ptr,wi=c.__wbg_set_blastep_ab_exp,zi=c.__wbg_set_blastep_alpha_exp,Mi=c.__wbg_set_blastep_ax,Ri=c.__wbg_set_blastep_ay,Ti=c.__wbg_set_blastep_bx,ki=c.__wbg_set_blastep_by,Bi=c.__wbg_set_blastep_d_exp,Ai=c.__wbg_set_blastep_dx,Ei=c.__wbg_set_blastep_dy,Ci=c.__wbg_set_blastep_log2_min_a,Ii=c.__wbg_set_blastep_radius_alpha,Li=c.__wbg_set_blastep_radius_beta,Pi=c.__wbg_set_padebenchmark_max_iter,Di=c.__wbg_set_padebenchmark_pade_mismatches,Oi=c.__wbg_set_padebenchmark_pixels,Gi=c.__wbg_set_padebenchmark_steps_affine,Fi=c.__wbg_set_padebenchmark_steps_exact,Ni=c.__wbg_set_padebenchmark_steps_pade,Ui=c.mandelbrotnavigator_angle,Vi=c.mandelbrotnavigator_benchmark_pade,Hi=c.mandelbrotnavigator_cancel_transition,Wi=c.mandelbrotnavigator_compute_bla_reference_ptr,qi=c.mandelbrotnavigator_compute_reference_orbit_chunk,Zi=c.mandelbrotnavigator_compute_reference_orbit_ptr,Yi=c.mandelbrotnavigator_coordinate_to_pixel,Xi=c.mandelbrotnavigator_find_minibrot,ji=c.mandelbrotnavigator_get_approximation_mode,$i=c.mandelbrotnavigator_get_bla_epsilon,Ki=c.mandelbrotnavigator_get_max_bla_skip,Ji=c.mandelbrotnavigator_get_params,Qi=c.mandelbrotnavigator_get_reference_orbit_capacity,ea=c.mandelbrotnavigator_get_reference_orbit_len,ta=c.mandelbrotnavigator_get_reference_params,na=c.mandelbrotnavigator_is_in_transition,ra=c.mandelbrotnavigator_new,ia=c.mandelbrotnavigator_origin,aa=c.mandelbrotnavigator_pixel_to_complex,oa=c.mandelbrotnavigator_reference_origin,sa=c.mandelbrotnavigator_rotate,la=c.mandelbrotnavigator_rotate_direct,ca=c.mandelbrotnavigator_scale,da=c.mandelbrotnavigator_set_bla_epsilon,ua=c.mandelbrotnavigator_set_max_bla_skip,fa=c.mandelbrotnavigator_start_transition,pa=c.mandelbrotnavigator_step,ha=c.mandelbrotnavigator_translate,ga=c.mandelbrotnavigator_translate_direct,_a=c.mandelbrotnavigator_use_bla,ma=c.mandelbrotnavigator_use_pade,va=c.mandelbrotnavigator_use_perturbation,ba=c.mandelbrotnavigator_zoom,xa=c.__wbg_set_blalevel_count,ya=c.__wbg_set_blalevel_max_radius_bits,Sa=c.__wbg_set_blalevel_offset,wa=c.__wbg_set_blalevel_skip,za=c.__wbg_set_mandelbrotstep_pad0,Ma=c.__wbg_set_mandelbrotstep_pad1,Ra=c.__wbg_set_mandelbrotstep_zx,Ta=c.__wbg_set_mandelbrotstep_zy,ka=c.__wbg_set_orbitbufferinfo_count,Ba=c.__wbg_set_orbitbufferinfo_offset,Aa=c.__wbg_set_orbitbufferinfo_ptr,Ea=c.__wbg_set_padebenchmark_max_iter_delta,Ca=c.__wbg_get_blalevel_count,Ia=c.__wbg_get_blalevel_max_radius_bits,La=c.__wbg_get_blalevel_offset,Pa=c.__wbg_get_blalevel_skip,Da=c.__wbg_get_orbitbufferinfo_count,Oa=c.__wbg_get_orbitbufferinfo_offset,Ga=c.__wbg_get_orbitbufferinfo_ptr,Fa=c.__wbg_get_mandelbrotstep_pad0,Na=c.__wbg_get_mandelbrotstep_pad1,Ua=c.__wbg_get_mandelbrotstep_zx,Va=c.__wbg_get_mandelbrotstep_zy,Ha=c.__wbindgen_export_0,Wa=c.__externref_drop_slice,qa=c.__wbindgen_free,Za=c.__wbindgen_malloc,Ya=c.__wbindgen_realloc,Gn=c.__wbindgen_start,Xa=Object.freeze(Object.defineProperty({__proto__:null,__externref_drop_slice:Wa,__wbg_blabufferinfo_free:Hr,__wbg_blalevel_free:Wr,__wbg_blastep_free:qr,__wbg_get_blabufferinfo_count:Zr,__wbg_get_blabufferinfo_level_count:Yr,__wbg_get_blabufferinfo_levels_ptr:Xr,__wbg_get_blabufferinfo_ptr:jr,__wbg_get_blalevel_count:Ca,__wbg_get_blalevel_max_radius_bits:Ia,__wbg_get_blalevel_offset:La,__wbg_get_blalevel_skip:Pa,__wbg_get_blastep_ab_exp:$r,__wbg_get_blastep_alpha_exp:Kr,__wbg_get_blastep_ax:Jr,__wbg_get_blastep_ay:Qr,__wbg_get_blastep_bx:ei,__wbg_get_blastep_by:ti,__wbg_get_blastep_d_exp:ni,__wbg_get_blastep_dx:ri,__wbg_get_blastep_dy:ii,__wbg_get_blastep_log2_min_a:ai,__wbg_get_blastep_radius_alpha:oi,__wbg_get_blastep_radius_beta:si,__wbg_get_mandelbrotstep_pad0:Fa,__wbg_get_mandelbrotstep_pad1:Na,__wbg_get_mandelbrotstep_zx:Ua,__wbg_get_mandelbrotstep_zy:Va,__wbg_get_orbitbufferinfo_count:Da,__wbg_get_orbitbufferinfo_offset:Oa,__wbg_get_orbitbufferinfo_ptr:Ga,__wbg_get_padebenchmark_max_iter:li,__wbg_get_padebenchmark_max_iter_delta:ci,__wbg_get_padebenchmark_pade_mismatches:di,__wbg_get_padebenchmark_pixels:ui,__wbg_get_padebenchmark_steps_affine:fi,__wbg_get_padebenchmark_steps_exact:pi,__wbg_get_padebenchmark_steps_pade:hi,__wbg_mandelbrotnavigator_free:gi,__wbg_mandelbrotstep_free:_i,__wbg_orbitbufferinfo_free:mi,__wbg_padebenchmark_free:vi,__wbg_set_blabufferinfo_count:bi,__wbg_set_blabufferinfo_level_count:xi,__wbg_set_blabufferinfo_levels_ptr:yi,__wbg_set_blabufferinfo_ptr:Si,__wbg_set_blalevel_count:xa,__wbg_set_blalevel_max_radius_bits:ya,__wbg_set_blalevel_offset:Sa,__wbg_set_blalevel_skip:wa,__wbg_set_blastep_ab_exp:wi,__wbg_set_blastep_alpha_exp:zi,__wbg_set_blastep_ax:Mi,__wbg_set_blastep_ay:Ri,__wbg_set_blastep_bx:Ti,__wbg_set_blastep_by:ki,__wbg_set_blastep_d_exp:Bi,__wbg_set_blastep_dx:Ai,__wbg_set_blastep_dy:Ei,__wbg_set_blastep_log2_min_a:Ci,__wbg_set_blastep_radius_alpha:Ii,__wbg_set_blastep_radius_beta:Li,__wbg_set_mandelbrotstep_pad0:za,__wbg_set_mandelbrotstep_pad1:Ma,__wbg_set_mandelbrotstep_zx:Ra,__wbg_set_mandelbrotstep_zy:Ta,__wbg_set_orbitbufferinfo_count:ka,__wbg_set_orbitbufferinfo_offset:Ba,__wbg_set_orbitbufferinfo_ptr:Aa,__wbg_set_padebenchmark_max_iter:Pi,__wbg_set_padebenchmark_max_iter_delta:Ea,__wbg_set_padebenchmark_pade_mismatches:Di,__wbg_set_padebenchmark_pixels:Oi,__wbg_set_padebenchmark_steps_affine:Gi,__wbg_set_padebenchmark_steps_exact:Fi,__wbg_set_padebenchmark_steps_pade:Ni,__wbindgen_export_0:Ha,__wbindgen_free:qa,__wbindgen_malloc:Za,__wbindgen_realloc:Ya,__wbindgen_start:Gn,mandelbrotnavigator_angle:Ui,mandelbrotnavigator_benchmark_pade:Vi,mandelbrotnavigator_cancel_transition:Hi,mandelbrotnavigator_compute_bla_reference_ptr:Wi,mandelbrotnavigator_compute_reference_orbit_chunk:qi,mandelbrotnavigator_compute_reference_orbit_ptr:Zi,mandelbrotnavigator_coordinate_to_pixel:Yi,mandelbrotnavigator_find_minibrot:Xi,mandelbrotnavigator_get_approximation_mode:ji,mandelbrotnavigator_get_bla_epsilon:$i,mandelbrotnavigator_get_max_bla_skip:Ki,mandelbrotnavigator_get_params:Ji,mandelbrotnavigator_get_reference_orbit_capacity:Qi,mandelbrotnavigator_get_reference_orbit_len:ea,mandelbrotnavigator_get_reference_params:ta,mandelbrotnavigator_is_in_transition:na,mandelbrotnavigator_new:ra,mandelbrotnavigator_origin:ia,mandelbrotnavigator_pixel_to_complex:aa,mandelbrotnavigator_reference_origin:oa,mandelbrotnavigator_rotate:sa,mandelbrotnavigator_rotate_direct:la,mandelbrotnavigator_scale:ca,mandelbrotnavigator_set_bla_epsilon:da,mandelbrotnavigator_set_max_bla_skip:ua,mandelbrotnavigator_start_transition:fa,mandelbrotnavigator_step:pa,mandelbrotnavigator_translate:ha,mandelbrotnavigator_translate_direct:ga,mandelbrotnavigator_use_bla:_a,mandelbrotnavigator_use_pade:ma,mandelbrotnavigator_use_perturbation:va,mandelbrotnavigator_zoom:ba,memory:Vr},Symbol.toStringTag,{value:"Module"}));Er(Xa);Gn();class ja{video;stream=null;width;height;lastDrawTime=0;open=!1;constructor(e=1024,n=1024){this.width=e,this.height=n,this.video=document.createElement("video"),this.video.autoplay=!0,this.video.playsInline=!0,this.video.muted=!0,this.video.width=e,this.video.height=n}isOpen(){return this.open}async openWebcam(){if(!this.open)try{this.stream=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:this.width},height:{ideal:this.height}}}),this.video.srcObject=this.stream,await this.video.play(),this.width=this.video.videoWidth||this.width,this.height=this.video.videoHeight||this.height,this.open=!0}catch(e){this.stream=null,this.open=!1,console.warn("Webcam unavailable:",e)}}async drawWebGPUTexture(e,n){if(!this.open)return;const r=performance.now();if(r-this.lastDrawTime>15){if(this.video.readyState<HTMLMediaElement.HAVE_CURRENT_DATA)return;const i=Math.min(this.width,e.width),a=Math.min(this.height,e.height);n.queue.copyExternalImageToTexture({source:this.video},{texture:e},[i,a]),this.lastDrawTime=r}}closeWebcam(){this.stream&&(this.stream.getTracks().forEach(e=>e.stop()),this.stream=null),this.open=!1}}function Le(t,e,n){t.prototype=e.prototype=n,n.constructor=t}function je(t,e){var n=Object.create(t.prototype);for(var r in e)n[r]=e[r];return n}function ve(){}var we=.7,Ie=1/we,Ae="\\s*([+-]?\\d+)\\s*",Ze="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",ue="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",$a=/^#([0-9a-f]{3,8})$/,Ka=new RegExp(`^rgb\\(${Ae},${Ae},${Ae}\\)$`),Ja=new RegExp(`^rgb\\(${ue},${ue},${ue}\\)$`),Qa=new RegExp(`^rgba\\(${Ae},${Ae},${Ae},${Ze}\\)$`),eo=new RegExp(`^rgba\\(${ue},${ue},${ue},${Ze}\\)$`),to=new RegExp(`^hsl\\(${Ze},${ue},${ue}\\)$`),no=new RegExp(`^hsla\\(${Ze},${ue},${ue},${Ze}\\)$`),un={aliceblue:0xf0f8ff,antiquewhite:0xfaebd7,aqua:65535,aquamarine:8388564,azure:0xf0ffff,beige:0xf5f5dc,bisque:0xffe4c4,black:0,blanchedalmond:0xffebcd,blue:255,blueviolet:9055202,brown:0xa52a2a,burlywood:0xdeb887,cadetblue:6266528,chartreuse:8388352,chocolate:0xd2691e,coral:0xff7f50,cornflowerblue:6591981,cornsilk:0xfff8dc,crimson:0xdc143c,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:0xb8860b,darkgray:0xa9a9a9,darkgreen:25600,darkgrey:0xa9a9a9,darkkhaki:0xbdb76b,darkmagenta:9109643,darkolivegreen:5597999,darkorange:0xff8c00,darkorchid:0x9932cc,darkred:9109504,darksalmon:0xe9967a,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:0xff1493,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:0xb22222,floralwhite:0xfffaf0,forestgreen:2263842,fuchsia:0xff00ff,gainsboro:0xdcdcdc,ghostwhite:0xf8f8ff,gold:0xffd700,goldenrod:0xdaa520,gray:8421504,green:32768,greenyellow:0xadff2f,grey:8421504,honeydew:0xf0fff0,hotpink:0xff69b4,indianred:0xcd5c5c,indigo:4915330,ivory:0xfffff0,khaki:0xf0e68c,lavender:0xe6e6fa,lavenderblush:0xfff0f5,lawngreen:8190976,lemonchiffon:0xfffacd,lightblue:0xadd8e6,lightcoral:0xf08080,lightcyan:0xe0ffff,lightgoldenrodyellow:0xfafad2,lightgray:0xd3d3d3,lightgreen:9498256,lightgrey:0xd3d3d3,lightpink:0xffb6c1,lightsalmon:0xffa07a,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:0xb0c4de,lightyellow:0xffffe0,lime:65280,limegreen:3329330,linen:0xfaf0e6,magenta:0xff00ff,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:0xba55d3,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:0xc71585,midnightblue:1644912,mintcream:0xf5fffa,mistyrose:0xffe4e1,moccasin:0xffe4b5,navajowhite:0xffdead,navy:128,oldlace:0xfdf5e6,olive:8421376,olivedrab:7048739,orange:0xffa500,orangered:0xff4500,orchid:0xda70d6,palegoldenrod:0xeee8aa,palegreen:0x98fb98,paleturquoise:0xafeeee,palevioletred:0xdb7093,papayawhip:0xffefd5,peachpuff:0xffdab9,peru:0xcd853f,pink:0xffc0cb,plum:0xdda0dd,powderblue:0xb0e0e6,purple:8388736,rebeccapurple:6697881,red:0xff0000,rosybrown:0xbc8f8f,royalblue:4286945,saddlebrown:9127187,salmon:0xfa8072,sandybrown:0xf4a460,seagreen:3050327,seashell:0xfff5ee,sienna:0xa0522d,silver:0xc0c0c0,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:0xfffafa,springgreen:65407,steelblue:4620980,tan:0xd2b48c,teal:32896,thistle:0xd8bfd8,tomato:0xff6347,turquoise:4251856,violet:0xee82ee,wheat:0xf5deb3,white:0xffffff,whitesmoke:0xf5f5f5,yellow:0xffff00,yellowgreen:0x9acd32};Le(ve,Xt,{copy(t){return Object.assign(new this.constructor,this,t)},displayable(){return this.rgb().displayable()},hex:fn,formatHex:fn,formatHex8:ro,formatHsl:io,formatRgb:pn,toString:pn});function fn(){return this.rgb().formatHex()}function ro(){return this.rgb().formatHex8()}function io(){return Fn(this).formatHsl()}function pn(){return this.rgb().formatRgb()}function Xt(t){var e,n;return t=(t+"").trim().toLowerCase(),(e=$a.exec(t))?(n=e[1].length,e=parseInt(e[1],16),n===6?hn(e):n===3?new W(e>>8&15|e>>4&240,e>>4&15|e&240,(e&15)<<4|e&15,1):n===8?tt(e>>24&255,e>>16&255,e>>8&255,(e&255)/255):n===4?tt(e>>12&15|e>>8&240,e>>8&15|e>>4&240,e>>4&15|e&240,((e&15)<<4|e&15)/255):null):(e=Ka.exec(t))?new W(e[1],e[2],e[3],1):(e=Ja.exec(t))?new W(e[1]*255/100,e[2]*255/100,e[3]*255/100,1):(e=Qa.exec(t))?tt(e[1],e[2],e[3],e[4]):(e=eo.exec(t))?tt(e[1]*255/100,e[2]*255/100,e[3]*255/100,e[4]):(e=to.exec(t))?mn(e[1],e[2]/100,e[3]/100,1):(e=no.exec(t))?mn(e[1],e[2]/100,e[3]/100,e[4]):un.hasOwnProperty(t)?hn(un[t]):t==="transparent"?new W(NaN,NaN,NaN,0):null}function hn(t){return new W(t>>16&255,t>>8&255,t&255,1)}function tt(t,e,n,r){return r<=0&&(t=e=n=NaN),new W(t,e,n,r)}function jt(t){return t instanceof ve||(t=Xt(t)),t?(t=t.rgb(),new W(t.r,t.g,t.b,t.opacity)):new W}function me(t,e,n,r){return arguments.length===1?jt(t):new W(t,e,n,r??1)}function W(t,e,n,r){this.r=+t,this.g=+e,this.b=+n,this.opacity=+r}Le(W,me,je(ve,{brighter(t){return t=t==null?Ie:Math.pow(Ie,t),new W(this.r*t,this.g*t,this.b*t,this.opacity)},darker(t){return t=t==null?we:Math.pow(we,t),new W(this.r*t,this.g*t,this.b*t,this.opacity)},rgb(){return this},clamp(){return new W(ye(this.r),ye(this.g),ye(this.b),ft(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:gn,formatHex:gn,formatHex8:ao,formatRgb:_n,toString:_n}));function gn(){return`#${xe(this.r)}${xe(this.g)}${xe(this.b)}`}function ao(){return`#${xe(this.r)}${xe(this.g)}${xe(this.b)}${xe((isNaN(this.opacity)?1:this.opacity)*255)}`}function _n(){const t=ft(this.opacity);return`${t===1?"rgb(":"rgba("}${ye(this.r)}, ${ye(this.g)}, ${ye(this.b)}${t===1?")":`, ${t})`}`}function ft(t){return isNaN(t)?1:Math.max(0,Math.min(1,t))}function ye(t){return Math.max(0,Math.min(255,Math.round(t)||0))}function xe(t){return t=ye(t),(t<16?"0":"")+t.toString(16)}function mn(t,e,n,r){return r<=0?t=e=n=NaN:n<=0||n>=1?t=e=NaN:e<=0&&(t=NaN),new se(t,e,n,r)}function Fn(t){if(t instanceof se)return new se(t.h,t.s,t.l,t.opacity);if(t instanceof ve||(t=Xt(t)),!t)return new se;if(t instanceof se)return t;t=t.rgb();var e=t.r/255,n=t.g/255,r=t.b/255,i=Math.min(e,n,r),a=Math.max(e,n,r),o=NaN,s=a-i,l=(a+i)/2;return s?(e===a?o=(n-r)/s+(n<r)*6:n===a?o=(r-e)/s+2:o=(e-n)/s+4,s/=l<.5?a+i:2-a-i,o*=60):s=l>0&&l<1?0:o,new se(o,s,l,t.opacity)}function Ft(t,e,n,r){return arguments.length===1?Fn(t):new se(t,e,n,r??1)}function se(t,e,n,r){this.h=+t,this.s=+e,this.l=+n,this.opacity=+r}Le(se,Ft,je(ve,{brighter(t){return t=t==null?Ie:Math.pow(Ie,t),new se(this.h,this.s,this.l*t,this.opacity)},darker(t){return t=t==null?we:Math.pow(we,t),new se(this.h,this.s,this.l*t,this.opacity)},rgb(){var t=this.h%360+(this.h<0)*360,e=isNaN(t)||isNaN(this.s)?0:this.s,n=this.l,r=n+(n<.5?n:1-n)*e,i=2*n-r;return new W(wt(t>=240?t-240:t+120,i,r),wt(t,i,r),wt(t<120?t+240:t-120,i,r),this.opacity)},clamp(){return new se(vn(this.h),nt(this.s),nt(this.l),ft(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const t=ft(this.opacity);return`${t===1?"hsl(":"hsla("}${vn(this.h)}, ${nt(this.s)*100}%, ${nt(this.l)*100}%${t===1?")":`, ${t})`}`}}));function vn(t){return t=(t||0)%360,t<0?t+360:t}function nt(t){return Math.max(0,Math.min(1,t||0))}function wt(t,e,n){return(t<60?e+(n-e)*t/60:t<180?n:t<240?e+(n-e)*(240-t)/60:e)*255}const Nn=Math.PI/180,Un=180/Math.PI,pt=18,Vn=.96422,Hn=1,Wn=.82521,qn=4/29,Ee=6/29,Zn=3*Ee*Ee,oo=Ee*Ee*Ee;function Yn(t){if(t instanceof fe)return new fe(t.l,t.a,t.b,t.opacity);if(t instanceof he)return Xn(t);t instanceof W||(t=jt(t));var e=Tt(t.r),n=Tt(t.g),r=Tt(t.b),i=zt((.2225045*e+.7168786*n+.0606169*r)/Hn),a,o;return e===n&&n===r?a=o=i:(a=zt((.4360747*e+.3850649*n+.1430804*r)/Vn),o=zt((.0139322*e+.0971045*n+.7141733*r)/Wn)),new fe(116*i-16,500*(a-i),200*(i-o),t.opacity)}function Nt(t,e,n,r){return arguments.length===1?Yn(t):new fe(t,e,n,r??1)}function fe(t,e,n,r){this.l=+t,this.a=+e,this.b=+n,this.opacity=+r}Le(fe,Nt,je(ve,{brighter(t){return new fe(this.l+pt*(t??1),this.a,this.b,this.opacity)},darker(t){return new fe(this.l-pt*(t??1),this.a,this.b,this.opacity)},rgb(){var t=(this.l+16)/116,e=isNaN(this.a)?t:t+this.a/500,n=isNaN(this.b)?t:t-this.b/200;return e=Vn*Mt(e),t=Hn*Mt(t),n=Wn*Mt(n),new W(Rt(3.1338561*e-1.6168667*t-.4906146*n),Rt(-.9787684*e+1.9161415*t+.033454*n),Rt(.0719453*e-.2289914*t+1.4052427*n),this.opacity)}}));function zt(t){return t>oo?Math.pow(t,1/3):t/Zn+qn}function Mt(t){return t>Ee?t*t*t:Zn*(t-qn)}function Rt(t){return 255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)}function Tt(t){return(t/=255)<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)}function so(t){if(t instanceof he)return new he(t.h,t.c,t.l,t.opacity);if(t instanceof fe||(t=Yn(t)),t.a===0&&t.b===0)return new he(NaN,0<t.l&&t.l<100?0:NaN,t.l,t.opacity);var e=Math.atan2(t.b,t.a)*Un;return new he(e<0?e+360:e,Math.sqrt(t.a*t.a+t.b*t.b),t.l,t.opacity)}function Ut(t,e,n,r){return arguments.length===1?so(t):new he(t,e,n,r??1)}function he(t,e,n,r){this.h=+t,this.c=+e,this.l=+n,this.opacity=+r}function Xn(t){if(isNaN(t.h))return new fe(t.l,0,0,t.opacity);var e=t.h*Nn;return new fe(t.l,Math.cos(e)*t.c,Math.sin(e)*t.c,t.opacity)}Le(he,Ut,je(ve,{brighter(t){return new he(this.h,this.c,this.l+pt*(t??1),this.opacity)},darker(t){return new he(this.h,this.c,this.l-pt*(t??1),this.opacity)},rgb(){return Xn(this).rgb()}}));var jn=-.14861,$t=1.78277,Kt=-.29227,ht=-.90649,Ye=1.97294,bn=Ye*ht,xn=Ye*$t,yn=$t*Kt-ht*jn;function lo(t){if(t instanceof Se)return new Se(t.h,t.s,t.l,t.opacity);t instanceof W||(t=jt(t));var e=t.r/255,n=t.g/255,r=t.b/255,i=(yn*r+bn*e-xn*n)/(yn+bn-xn),a=r-i,o=(Ye*(n-i)-Kt*a)/ht,s=Math.sqrt(o*o+a*a)/(Ye*i*(1-i)),l=s?Math.atan2(o,a)*Un-120:NaN;return new Se(l<0?l+360:l,s,i,t.opacity)}function Vt(t,e,n,r){return arguments.length===1?lo(t):new Se(t,e,n,r??1)}function Se(t,e,n,r){this.h=+t,this.s=+e,this.l=+n,this.opacity=+r}Le(Se,Vt,je(ve,{brighter(t){return t=t==null?Ie:Math.pow(Ie,t),new Se(this.h,this.s,this.l*t,this.opacity)},darker(t){return t=t==null?we:Math.pow(we,t),new Se(this.h,this.s,this.l*t,this.opacity)},rgb(){var t=isNaN(this.h)?0:(this.h+120)*Nn,e=+this.l,n=isNaN(this.s)?0:this.s*e*(1-e),r=Math.cos(t),i=Math.sin(t);return new W(255*(e+n*(jn*r+$t*i)),255*(e+n*(Kt*r+ht*i)),255*(e+n*(Ye*r)),this.opacity)}}));const Jt=t=>()=>t;function $n(t,e){return function(n){return t+n*e}}function co(t,e,n){return t=Math.pow(t,n),e=Math.pow(e,n)-t,n=1/n,function(r){return Math.pow(t+r*e,n)}}function Qt(t,e){var n=e-t;return n?$n(t,n>180||n<-180?n-360*Math.round(n/360):n):Jt(isNaN(t)?e:t)}function uo(t){return(t=+t)==1?j:function(e,n){return n-e?co(e,n,t):Jt(isNaN(e)?n:e)}}function j(t,e){var n=e-t;return n?$n(t,n):Jt(isNaN(t)?e:t)}const fo=(function t(e){var n=uo(e);function r(i,a){var o=n((i=me(i)).r,(a=me(a)).r),s=n(i.g,a.g),l=n(i.b,a.b),b=j(i.opacity,a.opacity);return function(h){return i.r=o(h),i.g=s(h),i.b=l(h),i.opacity=b(h),i+""}}return r.gamma=t,r})(1);function po(t){return function(e,n){var r=t((e=Ft(e)).h,(n=Ft(n)).h),i=j(e.s,n.s),a=j(e.l,n.l),o=j(e.opacity,n.opacity);return function(s){return e.h=r(s),e.s=i(s),e.l=a(s),e.opacity=o(s),e+""}}}const ho=po(Qt);function Kn(t,e){var n=j((t=Nt(t)).l,(e=Nt(e)).l),r=j(t.a,e.a),i=j(t.b,e.b),a=j(t.opacity,e.opacity);return function(o){return t.l=n(o),t.a=r(o),t.b=i(o),t.opacity=a(o),t+""}}function go(t){return function(e,n){var r=t((e=Ut(e)).h,(n=Ut(n)).h),i=j(e.c,n.c),a=j(e.l,n.l),o=j(e.opacity,n.opacity);return function(s){return e.h=r(s),e.c=i(s),e.l=a(s),e.opacity=o(s),e+""}}}const _o=go(Qt);function Jn(t){return(function e(n){n=+n;function r(i,a){var o=t((i=Vt(i)).h,(a=Vt(a)).h),s=j(i.s,a.s),l=j(i.l,a.l),b=j(i.opacity,a.opacity);return function(h){return i.h=o(h),i.s=s(h),i.l=l(Math.pow(h,n)),i.opacity=b(h),i+""}}return r.gamma=e,r})(1)}const mo=Jn(Qt);Jn(j);const Qn=["palette","zebra","tessellation","shading","skybox","webcam","smoothness","stripeAverage","rotationMean","stripeRelief","directionCoherenceRelief","shadingLevel","specularPower","metallic","roughness","anisotropy","iridescencePower"],Xe={palette:{label:"Color Blend",defaultValue:1,min:0,max:1,step:.01,unit:"",textureRow:0,textureChannel:3,uiGroup:"color"},zebra:{label:"Iteration Bands",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:1,textureChannel:0,uiGroup:"iteration"},tessellation:{label:"Image Blend",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:1,textureChannel:1,uiGroup:"imageSources"},shading:{label:"Lighting Blend",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:1,textureChannel:2,uiGroup:"lighting"},skybox:{label:"Reflection Blend",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:1,textureChannel:3,uiGroup:"lighting"},webcam:{label:"Webcam Blend",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:2,textureChannel:0,uiGroup:"imageSources"},smoothness:{label:"Smooth Iterations",defaultValue:1,min:0,max:1,step:.01,unit:"",textureRow:2,textureChannel:1,uiGroup:"iteration"},stripeAverage:{label:"Stripe Average",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:5,textureChannel:0,uiGroup:"iteration"},rotationMean:{label:"Direction Coherence",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:5,textureChannel:1,uiGroup:"iteration"},stripeRelief:{label:"Stripe Relief",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:5,textureChannel:2,uiGroup:"iteration"},directionCoherenceRelief:{label:"Direction Relief",defaultValue:0,min:0,max:100,step:.1,unit:"",textureRow:5,textureChannel:3,uiGroup:"iteration"},shadingLevel:{label:"Light Intensity",defaultValue:0,min:0,max:3,step:.05,unit:"",textureRow:2,textureChannel:2,uiGroup:"lighting"},specularPower:{label:"Specular Strength",defaultValue:0,min:1,max:64,step:.5,unit:"",textureRow:2,textureChannel:3,uiGroup:"lighting"},metallic:{label:"Metalness",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:3,textureChannel:1,uiGroup:"lighting"},roughness:{label:"Roughness",defaultValue:0,min:.02,max:1,step:.01,unit:"",textureRow:3,textureChannel:2,uiGroup:"lighting"},anisotropy:{label:"Anisotropy",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:3,textureChannel:3,uiGroup:"lighting"},iridescencePower:{label:"Iridescence Strength",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:4,textureChannel:3,uiGroup:"iridescence"}},Ht=Object.fromEntries(Qn.map(t=>[t,Xe[t].defaultValue])),kt={};for(const t of Qn){const e=Xe[t].uiGroup;kt[e]||(kt[e]=[]),kt[e].push(t)}const vo=["linear","gaussian","square","exponential"];function bo(t){return typeof t=="string"&&vo.includes(t)}function Bt(t){return bo(t.transferCurve)?t.transferCurve:"linear"}function At(t,e){const n=xo(e);switch(t){case"gaussian":{if(n<=.28)return 0;if(n>=.72)return 1;const a=(n-.28)/(.72-.28);return a*a*(3-2*a)}case"square":return n<=0?0:1;case"exponential":return(Math.exp(3*n)-1)/(Math.exp(3)-1);default:return n}}function pe(t,e){return t[e]??Ht[e]}function xo(t){return Math.max(0,Math.min(1,t))}const yo={lab:Kn,rgb:fo,hcl:_o,hsl:ho,cubehelix:mo},Sn=4096,So=6,Wt=[];{const t=new Map;for(const e of Object.keys(Xe)){const{textureRow:n}=Xe[e];n===0||n===4||(t.has(n)||t.set(n,[]),t.get(n).push(e))}for(const[e,n]of t)Wt.push({row:e,fields:n});Wt.sort((e,n)=>e.row-n.row)}function wo(t,e,n,r){const i=pe(t,n),a=pe(e,n);return i+(a-i)*r}function wn(t,e){return t[e]??null}class zn{points;interpolate;constructor(e,n="lab"){this.points=e.slice().sort((r,i)=>r.position-i.position),this.interpolate=yo[n]??Kn}getColorAt(e){if(this.points.length===0)return"#000";if(e<=this.points[0].position)return this.points[0].color;if(e>=this.points[this.points.length-1].position)return this.points[this.points.length-1].color;for(let n=0;n<this.points.length-1;++n){const r=this.points[n],i=this.points[n+1];if(e>=r.position&&e<=i.position){const a=(e-r.position)/(i.position-r.position),o=At(Bt(r),a),s=this.interpolate(r.color,i.color);return me(s(o)).formatHex()}}return"#000"}getEffectAt(e,n){if(this.points.length===0)return Ht[n];if(e<=this.points[0].position)return pe(this.points[0],n);if(e>=this.points[this.points.length-1].position)return pe(this.points[this.points.length-1],n);for(let r=0;r<this.points.length-1;++r){const i=this.points[r],a=this.points[r+1];if(e>=i.position&&e<=a.position){const o=(e-i.position)/(a.position-i.position),s=At(Bt(i),o);return wo(i,a,n,s)}}return Ht[n]}getIridescenceAt(e){if(this.points.length===0)return{color:"#000000",strength:0};if(this.points.length===1)return{color:this.points[0].iridescenceColor??this.points[0].color,strength:this.points[0].iridescenceColor?pe(this.points[0],"iridescencePower"):0};const n=this.points[0],r=this.points[this.points.length-1];if(e<=n.position)return{color:n.iridescenceColor??n.color,strength:n.iridescenceColor?pe(n,"iridescencePower"):0};if(e>=r.position)return{color:r.iridescenceColor??r.color,strength:r.iridescenceColor?pe(r,"iridescencePower"):0};for(let i=0;i<this.points.length-1;++i){const a=this.points[i],o=this.points[i+1];if(e>=a.position&&e<=o.position){const s=(e-a.position)/(o.position-a.position),l=At(Bt(a),s),b=wn(a,"iridescenceColor"),h=wn(o,"iridescenceColor");if(!b&&!h)return{color:"#000000",strength:0};const S=b??a.color,z=h??o.color,x=b?pe(a,"iridescencePower"):0,f=h?pe(o,"iridescencePower"):0,m=x+(f-x)*l;return{color:me(this.interpolate(S,z)(l)).formatHex(),strength:m}}}return{color:"#000000",strength:0}}generateTexture(){const e=Sn,n=So,r=new Float32Array(e*n*4);for(let i=0;i<e;++i){const a=i/(e-1),o=me(this.getColorAt(a)),s=(0*e+i)*4;r[s]=(o.r??0)/255,r[s+1]=(o.g??0)/255,r[s+2]=(o.b??0)/255,r[s+3]=this.getEffectAt(a,"palette");for(const{row:S,fields:z}of Wt){const x=(S*e+i)*4;for(const f of z){const m=Xe[f].textureChannel;r[x+m]=this.getEffectAt(a,f)}}const l=this.getIridescenceAt(a),b=me(l.color),h=(4*e+i)*4;r[h]=(b.r??0)/255,r[h+1]=(b.g??0)/255,r[h+2]=(b.b??0)/255,r[h+3]=Math.max(0,Math.min(1,l.strength))}return{data:r,width:e,height:n}}generateThumbnailRow(){const e=Sn,n=new ImageData(e,1),r=n.data;for(let i=0;i<e;++i){const a=i/(e-1),o=me(this.getColorAt(a)),s=i*4;r[s]=Math.max(0,Math.min(255,Math.round(o.r??0))),r[s+1]=Math.max(0,Math.min(255,Math.round(o.g??0))),r[s+2]=Math.max(0,Math.min(255,Math.round(o.b??0))),r[s+3]=255}return n}}const zo=-116;function Et(t){if(!Number.isFinite(t)||t===0)return{mantissa:0,exponent:0};let e=t,n=0;Math.abs(e)<22250738585072014e-324&&(e*=2**64,n-=64);const r=Math.floor(Math.log2(Math.abs(e)))+1;for(e/=2**r,n+=r;Math.abs(e)>=1;)e*=.5,n+=1;for(;Math.abs(e)<.5;)e*=2,n-=1;let i=Math.fround(e);return Math.abs(i)>=1&&(i*=.5,n+=1),{mantissa:i,exponent:n}}const Mo=3.321928094887362;function Ro(t){if(t=t.trim(),t.length===0)return null;let e=1;t[0]==="-"?(e=-1,t=t.slice(1)):t[0]==="+"&&(t=t.slice(1));let n=0;const r=t.search(/[eE]/);if(r>=0){const x=parseInt(t.slice(r+1),10);if(!Number.isFinite(x))return null;n=x,t=t.slice(0,r)}const i=t.indexOf("."),a=i>=0?t.slice(0,i):t,o=i>=0?t.slice(i+1):"";if(!/^[0-9]*$/.test(a)||!/^[0-9]*$/.test(o)||a+o==="")return null;const s=a+o,l=a.length;let b=-1;for(let x=0;x<s.length;x++)if(s[x]!=="0"){b=x;break}if(b<0)return{sign:1,m10:0,d:0};const h=s.slice(b,b+18),S=parseFloat(h[0]+"."+h.slice(1)),z=l-1-b+n;return{sign:e,m10:S,d:z}}function Ct(t){const e=Ro(t);if(!e||e.m10===0)return{mantissa:0,exponent:0};const n=(Math.log10(e.m10)+e.d)*Mo;let r=Math.floor(n),i=2**(n-r);i*=.5,r+=1;let a=Math.fround(i*e.sign);return Math.abs(a)>=1&&(a*=.5,r+=1),{mantissa:a,exponent:r}}function X(t){return t.kind==="reprojecting"}function rt(t){return t.kind==="reprojecting"?t.frozenScale:0}function _e(t){return t.kind==="reprojecting"?t.liveScale:0}function To(t){return t.kind==="reprojecting"&&t.referenceResetDuringZoom}function ko(t,e,n){switch(t.kind){case"idle":return Bo(t,e,n);case"reprojecting":return Ao(t,e,n)}}function Bo(t,e,n){const r=[];switch(e.type){case"referenceReset":return e.orbitWasReset&&!e.muChanged&&r.push({type:"copyResolvedToFrozen"}),r.push({type:"clearHistoryNextFrame"}),{state:t,effects:r};case"scaleChanged":if(e.scale!==e.prevScale){const i=e.scale<e.prevScale,a=e.prevScale,o=i?a/n.threshold:a*n.threshold;return r.push({type:"copyResolvedToFrozen"}),r.push({type:"clearHistoryNextFrame"}),{state:{kind:"reprojecting",frozenScale:a,liveScale:o,zoomingIn:i,referenceResetDuringZoom:!1},effects:r}}return{state:t,effects:r};case"scaleStable":return{state:t,effects:r}}}function Ao(t,e,n){const r=[];switch(e.type){case"referenceReset":return e.muChanged?{state:{kind:"idle"},effects:[{type:"clearHistoryNextFrame"}]}:(r.push({type:"clearHistoryNextFrame"}),{state:{...t,referenceResetDuringZoom:!0},effects:r});case"scaleChanged":{let i=t;t.referenceResetDuringZoom&&(i={...t,referenceResetDuringZoom:!1});const a=i.frozenScale/e.scale;if((i.zoomingIn?a>=n.threshold:a<=1/n.threshold)&&!i.referenceResetDuringZoom){const s=i.liveScale,l=i.zoomingIn?e.scale/n.threshold:e.scale*n.threshold;return r.push({type:"copyResolvedToFrozen"}),r.push({type:"clearHistoryNextFrame"}),{state:{kind:"reprojecting",frozenScale:s,liveScale:l,zoomingIn:i.zoomingIn,referenceResetDuringZoom:!1},effects:r}}return{state:i,effects:r}}case"scaleStable":return t.referenceResetDuringZoom||r.push({type:"mergeResolvedAndFrozen"}),r.push({type:"clearHistoryNextFrame"}),{state:{kind:"idle"},effects:r}}}function Mn(){return{kind:"idle"}}function Rn(t,e,n,r){const i=typeof t=="number"&&Number.isFinite(t)?t:e,a=2**Math.floor(Math.log2(Math.max(1,Math.floor(i))));return Math.min(Math.max(a,n),r)}function Eo(t){if(t<=0)return{x:0,y:0};const e=1.2207440846057596,n=1/e,r=1/(e*e),i=t*n%1,a=t*r%1,o=s=>{const l=2*s-1;return l===0?0:l/Math.sqrt(Math.abs(l))-Math.sign(l)};return{x:o(i),y:o(a)}}const Co=.01,Io=100,Lo=["screenXWithDepth","screenYWithDepth","dragonScaleU","derivativeAngleSin","screenX","screenY","iterSmooth","distance"],Po={screenXWithDepth:0,screenYWithDepth:1,dragonScaleU:2,derivativeAngleSin:3,screenX:4,screenY:5,iterSmooth:7,distance:8},dt={xVariable:"screenXWithDepth",yVariable:"screenYWithDepth",xScale:1,yScale:1,mirrored:!1},Do={xVariable:"dragonScaleU",yVariable:"derivativeAngleSin",xScale:1,yScale:1,mirrored:!0},Oo=new Set(Lo);function qt(t){return{...t}}function Go(t){return typeof t=="string"&&Oo.has(t)}function Tn(t,e){return t==="argZ"?"derivativeAngleSin":t==="iterRaw"?"iterSmooth":Go(t)?t:e}function kn(t){const e=typeof t=="number"&&Number.isFinite(t)?t:1;return Math.min(Io,Math.max(Co,e))}function er(t){if(!t||typeof t!="object")return qt(dt);const e=t;return{xVariable:Tn(e.xVariable,dt.xVariable),yVariable:Tn(e.yVariable,dt.yVariable),xScale:kn(e.xScale),yScale:kn(e.yScale),mirrored:!!e.mirrored}}function Fo(t){return qt(t===1?Do:dt)}function It(t){return t.textureMapping?er(t.textureMapping):Fo(t.textureMappingMode)}function Bn(t){return Po[t]??0}const No=["loop","sine","pulse","stepped"],Uo=["paletteOffset","heightPaletteShift","lightAngle","textureDrift","skyReflectionDrift","phaseColoring","varnish","microBump","displacement","tessellation"],tr=[{id:"paletteOffset",label:"Palette Offset",defaultType:"loop",defaultSpeed:.8,defaultAmplitude:1,minAmplitude:0,maxAmplitude:1,amplitudeStep:.01,unit:"cycle"},{id:"heightPaletteShift",label:"Height Palette Shift",defaultType:"sine",defaultSpeed:.25,defaultAmplitude:20,minAmplitude:0,maxAmplitude:100,amplitudeStep:.5,unit:""},{id:"lightAngle",label:"Light Angle",defaultType:"loop",defaultSpeed:.15,defaultAmplitude:1,minAmplitude:0,maxAmplitude:1,amplitudeStep:.01,unit:"turn"},{id:"textureDrift",label:"Texture Drift",defaultType:"sine",defaultSpeed:1,defaultAmplitude:1,minAmplitude:0,maxAmplitude:2,amplitudeStep:.01,unit:""},{id:"skyReflectionDrift",label:"Sky Reflection Drift",defaultType:"sine",defaultSpeed:.6,defaultAmplitude:1,minAmplitude:0,maxAmplitude:2,amplitudeStep:.01,unit:""},{id:"phaseColoring",label:"Phase Coloring",defaultType:"pulse",defaultSpeed:.3,defaultAmplitude:25,minAmplitude:0,maxAmplitude:100,amplitudeStep:.5,unit:""},{id:"varnish",label:"Varnish",defaultType:"pulse",defaultSpeed:.22,defaultAmplitude:2,minAmplitude:0,maxAmplitude:10,amplitudeStep:.05,unit:""},{id:"microBump",label:"Micro Bump",defaultType:"pulse",defaultSpeed:.35,defaultAmplitude:.5,minAmplitude:0,maxAmplitude:2,amplitudeStep:.01,unit:""},{id:"displacement",label:"Displacement",defaultType:"sine",defaultSpeed:.2,defaultAmplitude:.02,minAmplitude:0,maxAmplitude:.1,amplitudeStep:.001,unit:""},{id:"tessellation",label:"Tessellation",defaultType:"sine",defaultSpeed:.18,defaultAmplitude:2,minAmplitude:0,maxAmplitude:10,amplitudeStep:.1,unit:""}];new Map(tr.map(t=>[t.id,t]));function Ue(t,e){return typeof t=="number"&&Number.isFinite(t)?t:e}function Vo(t,e){return No.includes(t)?t:e}function Ho(t){return{enabled:t.id==="paletteOffset",type:t.defaultType,speed:t.defaultSpeed,amplitude:t.defaultAmplitude,phase:0}}function Wo(t=1){const e=Object.fromEntries(tr.map(n=>[n.id,Ho(n)]));return{globalSpeed:Ue(t,1),tracks:e}}function ut(t,e){const n=Wo(e),r=t?.tracks,i=Object.fromEntries(Uo.map(a=>{const o=n.tracks[a],s=r?.[a];return[a,{enabled:typeof s?.enabled=="boolean"?s.enabled:o.enabled,type:Vo(s?.type,o.type),speed:Ue(s?.speed,o.speed),amplitude:Ue(s?.amplitude,o.amplitude),phase:Ue(s?.phase,o.phase??0)}]}));return{globalSpeed:Ue(t?.globalSpeed,n.globalSpeed),tracks:i}}const Re=8,it=100,qo=1e4,Zo=.001,at=12,Yo=60,Zt=Math.PI*2,Xo=5e6,Lt=10,An=.25,Pt=3,jo=3,ot=.001;function $o(t){return t.some(e=>(e.stripeAverage??0)>ot||(e.rotationMean??0)>ot||(e.stripeRelief??0)>ot||(e.directionCoherenceRelief??0)>ot)}const nr=new Float32Array(1),Ko=new Uint32Array(nr.buffer);function Jo(t){nr[0]=t;const e=Ko[0],n=e>>>16&32768,r=(e>>>23&255)-127,i=e&8388607;if(r>=16)return n|31744;if(r>=-14){const a=r+15;return n|a<<10|i>>>13}if(r>=-24){const a=-14-r;return n|(i|8388608)>>>13+a}return n}function En(t){const e=new Uint16Array(t.length);for(let n=0;n<t.length;++n)e[n]=Jo(t[n]);return e}function be(t,e,n){return Math.min(Math.max(t,e),n)}function Qo(t,e,n){const r=t.phase??0,i=e*t.speed*n+r;switch(t.type){case"loop":return i-Math.floor(i);case"pulse":return .5+.5*Math.sin(i*Zt);case"stepped":return Math.floor((i-Math.floor(i))*8)/Math.max(1,7)*2-1;default:return Math.sin(i*Zt)}}function oe(t,e,n){return t.enabled?Qo(t,e,n)*t.amplitude:0}function Cn(t,e,n,r){return oe({...t,phase:(t.phase??0)+r},e,n)}class en{snapshotCallback;snapshotDestWidth;canvas;device;queue;adapter;ctx;format;mandelbrotNavigator;rawTexture;rawArrayView;rawLayerViews=[];rawBrushTexture;rawBrushArrayView;rawBrushLayerViews=[];resolvedTexture;resolvedArrayView;resolvedLayerViews=[];frozenTexture;frozenArrayView;frozenLayerViews=[];pipelineMerge;bindGroupMerge;uniformBufferMerge;uniformBufferMandelbrot;uniformBufferColor;uniformBufferBrush;uniformBufferResolve;mandelbrotReferenceBuffer;mandelbrotBlaBuffer;mandelbrotBlaLevelBuffer;mandelbrotBlaBufferCapacity=0;mandelbrotBlaLevelBufferCapacity=0;pipelineBrush;bindGroupBrush;pipelineMandelbrot;bindGroupMandelbrot;pipelineResolve;bindGroupResolve;pipelineColor;bindGroupColor;pipelineColorAccumClear;pipelineColorAccum;pipelinePresent;bindGroupPresent;accumTexture;accumTextureView;aaTargetTexture;aaTargetTextureView;pipelineAaTarget;bindGroupAaTarget;uniformBufferAaTarget;pipelineAaReseed;bindGroupAaReseed;useAaSelectiveReseed=!0;useInplaceCompute=!0;pipelineInplace;bindGroupInplace;bindGroupColorRaw;resolveSkipped=!1;lastRawMutationFrame=0;counterSampleFrame=-1;pipelineCount;counterBuffer;workStatsBuffer;counterReadbackSlots=[];counterReadbackWriteIndex=0;counterReadbackSequence=0;latestAppliedCounterReadbackSequence=0;counterReadbackGeneration=0;renderFrameSerial=0;lastCounterDispatchFrame=-Pt;counterBindGroup;uniformBufferCount;unfinishedPixelCount=-1;activePixelCount=-1;realizedSkip=-1;workgroupWaste=-1;maxPixelSteps=-1;realLoopStepsApprox=-1;workStatsClearedGeneration=-1;_rafId=null;_drawFn=null;fps=0;isRendering=!1;gpuFrameTimeMs=0;smoothedGpuTimeMs=0;pendingGpuTiming=!1;refinementWasGated=!1;_fpsFrameCount=0;_fpsLastTime=0;_lastDrawMs=0;neutralSize=0;shaderPassCompute;shaderPassColor;width=0;height=0;antialiasLevel;palettePeriod;previousMandelbrot;previousRenderOptions;previousOrbitMetricsEnabled;needRender=!0;orbitIncomplete=!1;prevGuardedMaxIter=0;currentGuardedMaxIter=0;currentMaxIterations=0;currentReferenceAvailableIter=0;currentReferenceRemainingIter=0;isReferenceValidating=!1;referenceResetSerial=0;referenceResetFlashUntil=0;currentBlaLevelCount=0;approximationMode="perturbation";blaEpsilon=Zo;maxBlaSkip=65536;pendingBenchmarkResolve=null;pendingMinibrotResolve=null;lastCompletionWallMs=0;lastCompletionGpuMs=0;lastShaderApproxFlag=0;lastShaderBlaLevelCount=0;completionStartMs=0;completionAccumulatedGpuMs=0;completionTimerActive=!1;referenceWorker;referenceJobId=0;referenceAvailableOrbitLen=0;referenceBlaReadyMaxIterations=0;referenceWorkerFailed=!1;referenceWorkerReady=!1;pendingWorkerMessages=[];referenceViewKey="";referenceWorkerCx="";referenceWorkerCy="";floatExpActive=!1;debugShadingActive=!1;referenceOrbitWasReset=!1;pendingRefActive=!1;pendingRefCx="";pendingRefCy="";pendingRefOrbitBuffer=null;pendingRefOrbitLen=0;pendingRefMaxIterations=0;pendingRefBlaSteps=null;pendingRefBlaLevels=null;pendingRefBlaLevelCount=0;pendingRefBlaReadyMaxIterations=0;pendingRefReady=!1;skipRenderOnce=!1;prevFrameMandelbrot;clearHistoryNextFrame=!1;_prevFrameScaleChanged=!1;aaActive=!1;aaSampleIndex=0;aaAccumulatedSamples=0;aaOffsetX=0;aaOffsetY=0;aaReseedPending=!1;aaAuto=!1;cumulativeShiftX=0;cumulativeShiftY=0;zoomMagnificationThreshold=16;zoomState={kind:"idle"};needFreezeSnapshot=!1;needMergeSnapshot=!1;mergeUniforms={zf:1,lzf:1,frozenShiftU:0,frozenShiftV:0,aspect:1,angle:0};frozenBaseShiftX=0;frozenBaseShiftY=0;frozenPanShiftX=0;frozenPanShiftY=0;frozenAligned=!1;iterationBatchSize=it;tileTexture;tileTextureView;skyboxTexture;skyboxTextureView;tileTextureSourceKey;skyboxTextureSourceKey;paletteTexture;paletteTextureView;paletteSampler;skyboxSampler;webcamTexture;webcamTileTexture;webcamTextureView;webcamEnabled=!0;time=0;lastUpdateTime=0;dprMultiplier=1;targetFps=60;gpuLoadMultiplier=1;constructor(e,n){this.canvas=e,this.shaderPassCompute=xr,this.shaderPassColor=Sr,this.antialiasLevel=n.antialiasLevel,this.palettePeriod=n.palettePeriod,this.time=0}postReferenceWorker(e){return!this.referenceWorker||this.referenceWorkerFailed?!1:e.type==="dispose"?(this.referenceWorker.postMessage(e),!0):this.referenceWorkerReady?(this.referenceWorker.postMessage(e),!0):(this.pendingWorkerMessages.push(e),!0)}markReferenceReset(e=this.currentMaxIterations){this.referenceResetSerial++,this.referenceResetFlashUntil=performance.now()+900,this.referenceAvailableOrbitLen=0,this.currentReferenceAvailableIter=0,this.currentReferenceRemainingIter=e,this.currentGuardedMaxIter=0,this.orbitIncomplete=!0}discardPendingReference(){this.pendingRefActive&&(this.pendingRefActive=!1,this.pendingRefCx="",this.pendingRefCy="",this.pendingRefOrbitBuffer=null,this.pendingRefOrbitLen=0,this.pendingRefMaxIterations=0,this.pendingRefBlaSteps=null,this.pendingRefBlaLevels=null,this.pendingRefBlaLevelCount=0,this.pendingRefBlaReadyMaxIterations=0,this.pendingRefReady=!1)}markPendingReferenceReady(){this.pendingRefActive&&(this.pendingRefReady=!0,this.isReferenceValidating=!1,this.needRender=!0)}applyPendingReferenceSwitch(){if(!this.pendingRefActive||!this.pendingRefReady)return;const e=this.pendingRefOrbitBuffer;if(e&&this.mandelbrotReferenceBuffer){const r=this.pendingRefOrbitLen*2,i=Math.min(r,e.length);this.device.queue.writeBuffer(this.mandelbrotReferenceBuffer,0,e,0,i)}this.pendingRefBlaSteps&&this.pendingRefBlaSteps.length>0&&this.ensureBlaBufferCapacity(this.pendingRefBlaSteps.length/at),this.pendingRefBlaSteps&&this.mandelbrotBlaBuffer&&this.device.queue.writeBuffer(this.mandelbrotBlaBuffer,0,this.pendingRefBlaSteps,0,this.pendingRefBlaSteps.length),this.pendingRefBlaLevels&&this.mandelbrotBlaLevelBuffer&&this.device.queue.writeBuffer(this.mandelbrotBlaLevelBuffer,0,this.pendingRefBlaLevels,0,this.pendingRefBlaLevels.length),this.pendingRefBlaLevelCount>0&&(this.currentBlaLevelCount=this.pendingRefBlaLevelCount,this.referenceBlaReadyMaxIterations=this.pendingRefBlaReadyMaxIterations),this.referenceWorkerCx=this.pendingRefCx,this.referenceWorkerCy=this.pendingRefCy,this.mandelbrotNavigator.reference_origin(this.pendingRefCx,this.pendingRefCy),this.referenceAvailableOrbitLen=this.pendingRefOrbitLen;const n=Math.max(0,this.pendingRefOrbitLen-1);this.currentReferenceAvailableIter=n,this.currentReferenceRemainingIter=Math.max(0,this.currentMaxIterations-n),this.currentGuardedMaxIter=Math.min(this.currentMaxIterations,n),this.isReferenceValidating=!1,this.orbitIncomplete=!this.referenceWorkerFailed&&n<this.currentMaxIterations,this.referenceResetSerial++,this.referenceResetFlashUntil=performance.now()+900,this.referenceOrbitWasReset=!0,this.invalidateCounterReadback(),this.needRender=!0,this.skipRenderOnce=!0,this.discardPendingReference()}initializeReferenceWorker(){this.referenceWorker?.terminate(),this.referenceWorker=new Worker(new URL("/mandelbrot/presentation/assets/referenceWorker-B46HyU03.js",import.meta.url),{type:"module"}),this.referenceWorker.onmessage=e=>{this.handleReferenceWorkerMessage(e.data)},this.referenceWorker.onerror=e=>{console.error("Reference worker error:",e.message),this.referenceWorkerFailed=!0,this.orbitIncomplete=!1,this.currentBlaLevelCount=0},this.referenceWorkerFailed=!1,this.referenceWorkerReady=!1,this.pendingWorkerMessages=[],this.referenceAvailableOrbitLen=0,this.referenceBlaReadyMaxIterations=0,this.referenceJobId++}resetReference(e,n){console.log("[REF] Engine.resetReference",e.slice(0,14),"| prevKey?",this.referenceViewKey?"set":"empty"),this.mandelbrotNavigator&&this.mandelbrotNavigator.reference_origin(e,n),this.discardPendingReference(),this.referenceViewKey="",this.needRender=!0}resetReferenceJob(e,n,r){console.log("[REF] resetReferenceJob -> worker reset",e.cx.slice(0,14),"scale",n,"maxIter",r),this.discardPendingReference(),this.markReferenceReset(r),this.referenceBlaReadyMaxIterations=0,this.referenceOrbitWasReset=!0,this.isReferenceValidating=!0,this.currentBlaLevelCount=0,this.referenceViewKey="",this.referenceWorkerCx="",this.referenceWorkerCy="",this.referenceJobId++,this.postReferenceWorker({type:"reset",jobId:this.referenceJobId,cx:e.cx,cy:e.cy,scale:n.toString(),angle:e.angle,approximationMode:this.approximationMode,blaEpsilon:this.blaEpsilon,maxBlaSkip:this.maxBlaSkip,maxIterations:r})}syncReferenceWorkerView(e,n,r){const i=n.toString(),a=`${e.cx}
${e.cy}
${i}
${e.angle}
${r}`;a!==this.referenceViewKey&&(console.log("[REF] syncReferenceWorkerView -> updateView",e.cx.slice(0,14),"scale",i,"dx",e.dx,"dxStr",e.dxStr),this.discardPendingReference(),this.referenceViewKey=a,this.isReferenceValidating=!0,this.orbitIncomplete=!0,this.needRender=!0,this.postReferenceWorker({type:"updateView",jobId:this.referenceJobId,cx:e.cx,cy:e.cy,scale:i,angle:e.angle,maxIterations:r}))}handleReferenceWorkerMessage(e){if(e.type==="padeBenchmark"){const n=this.pendingBenchmarkResolve;this.pendingBenchmarkResolve=null,n?.(e.result);return}if(e.type==="minibrotFound"){const n=this.pendingMinibrotResolve;this.pendingMinibrotResolve=null,n?.({status:e.status,cx:e.cx,cy:e.cy,period:e.period});return}if(e.type==="ready"){this.referenceWorkerReady=!0;const n=this.pendingWorkerMessages;this.pendingWorkerMessages=[];for(const r of n)this.referenceWorker?.postMessage(r);return}if(e.jobId===this.referenceJobId){if(e.type==="error"){console.error("Reference worker error:",e.message),this.referenceWorkerFailed=!0,this.orbitIncomplete=!1,this.currentBlaLevelCount=0;return}if(e.type==="referenceReset"){if(this.pendingRefActive){if(e.referenceCx===this.pendingRefCx&&e.referenceCy===this.pendingRefCy)return;this.discardPendingReference()}this.pendingRefActive=!0,this.pendingRefCx=e.referenceCx,this.pendingRefCy=e.referenceCy,this.pendingRefMaxIterations=e.maxIterations;const n=Math.max(e.maxIterations,this.currentMaxIterations)*2;this.pendingRefOrbitBuffer=new Float32Array(n),this.pendingRefOrbitLen=0,this.pendingRefBlaSteps=null,this.pendingRefBlaLevels=null,this.pendingRefBlaLevelCount=0,this.pendingRefBlaReadyMaxIterations=0;return}if(e.type==="orbitChunk"){const n=this.pendingRefActive&&e.referenceCx===this.pendingRefCx&&e.referenceCy===this.pendingRefCy;if(n){const i=this.pendingRefOrbitBuffer;if(i&&e.orbit.length>0){const o=e.offset*2,s=Math.min(e.orbit.length,i.length-o);s>0&&i.set(e.orbit.slice(0,s),o)}this.pendingRefOrbitLen=e.count;const a=Math.min(this.pendingRefMaxIterations,this.currentMaxIterations);this.pendingRefOrbitLen>=a&&this.markPendingReferenceReady()}else if(e.referenceCx!==this.referenceWorkerCx||e.referenceCy!==this.referenceWorkerCy){this.pendingRefActive&&this.discardPendingReference(),this.pendingRefActive=!0,this.pendingRefCx=e.referenceCx,this.pendingRefCy=e.referenceCy,this.pendingRefMaxIterations=e.maxIterations;const i=Math.max(e.maxIterations,this.currentMaxIterations)*2;this.pendingRefOrbitBuffer=new Float32Array(i),this.pendingRefOrbitLen=0,this.pendingRefBlaSteps=null,this.pendingRefBlaLevels=null,this.pendingRefBlaLevelCount=0,this.pendingRefBlaReadyMaxIterations=0;const a=this.pendingRefOrbitBuffer;if(a&&e.orbit.length>0){const s=e.offset*2,l=Math.min(e.orbit.length,a.length-s);l>0&&a.set(e.orbit.slice(0,l),s)}this.pendingRefOrbitLen=e.count;const o=Math.min(this.pendingRefMaxIterations,this.currentMaxIterations);this.pendingRefOrbitLen>=o&&this.markPendingReferenceReady(),this.isReferenceValidating=!1,this.needRender=!0;return}else e.offset===0&&this.referenceAvailableOrbitLen>0&&(this.markReferenceReset(),this.referenceOrbitWasReset=!0,this.currentBlaLevelCount=0,this.referenceBlaReadyMaxIterations=0,this.invalidateCounterReadback());n||(e.orbit.length>0&&this.mandelbrotReferenceBuffer?(this.referenceAvailableOrbitLen=e.count,this.device.queue.writeBuffer(this.mandelbrotReferenceBuffer,e.offset*2*Float32Array.BYTES_PER_ELEMENT,e.orbit,0,e.orbit.length)):this.referenceAvailableOrbitLen=e.count);const r=Math.max(0,this.referenceAvailableOrbitLen-1);this.currentReferenceAvailableIter=r,this.currentReferenceRemainingIter=Math.max(0,this.currentMaxIterations-r),this.isReferenceValidating=!1,this.currentGuardedMaxIter=Math.min(this.currentMaxIterations,r),this.orbitIncomplete=!this.referenceWorkerFailed&&r<this.currentMaxIterations,this.needRender=!0;return}if(this.pendingRefActive){this.pendingRefBlaSteps=new Float32Array(e.steps),this.pendingRefBlaLevels=new Uint32Array(e.levels),this.pendingRefBlaLevelCount=e.levelCount,this.pendingRefBlaReadyMaxIterations=e.maxIterations;const n=Math.min(this.pendingRefMaxIterations,this.currentMaxIterations);this.pendingRefOrbitLen>=n&&this.markPendingReferenceReady();return}this.ensureBlaBufferCapacity(e.steps.length/at),this.ensureBlaLevelBufferCapacity(e.levelCount),e.steps.length>0&&this.mandelbrotBlaBuffer&&this.device.queue.writeBuffer(this.mandelbrotBlaBuffer,0,e.steps,0,e.steps.length),e.levels.length>0&&this.mandelbrotBlaLevelBuffer&&this.device.queue.writeBuffer(this.mandelbrotBlaLevelBuffer,0,e.levels,0,e.levels.length),this.currentBlaLevelCount=e.levelCount,this.referenceBlaReadyMaxIterations=e.maxIterations,this.isReferenceValidating=!1,this.needRender=!0,this.invalidateCounterReadback()}}async initialize(e){if(this.mandelbrotNavigator=e,this.approximationMode=this.mandelbrotNavigator.get_approximation_mode()===2?"pade":this.mandelbrotNavigator.get_approximation_mode()===1?"bla":"perturbation",this.blaEpsilon=this.mandelbrotNavigator.get_bla_epsilon(),this.initializeReferenceWorker(),!navigator.gpu)throw new Error("WebGPU non support\xe9");if(this.adapter=await navigator.gpu.requestAdapter(),!this.adapter)throw new Error("Adapter WebGPU introuvable");this.device=await this.adapter.requestDevice(),this.device.label="Engine Device",this.device.lost.then(a=>{console.warn(`GPU device lost: reason=${a.reason}, message=${a.message}`)}),this.queue=this.device.queue,this.queue.label="Engine Queue",this.ctx=this.canvas.getContext("webgpu"),this.format=navigator.gpu.getPreferredCanvasFormat(),this.ctx.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.tileTexture=this.device.createTexture({size:[1,1,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT,label:"Engine TileTexture 1x1 Placeholder"}),this.tileTextureView=this.tileTexture.createView(),this.skyboxTexture=this.device.createTexture({size:[1,1,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT,label:"Engine SkyboxTexture 1x1 Placeholder"}),this.skyboxTextureView=this.skyboxTexture.createView();const r=new zn([]).generateTexture(),i=En(r.data);this.paletteTexture=this.device.createTexture({size:[r.width,r.height,1],format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT,label:"Engine PaletteTexture"}),this.device.queue.writeTexture({texture:this.paletteTexture},i.buffer,{bytesPerRow:r.width*8},[r.width,r.height]),this.paletteTextureView=this.paletteTexture.createView(),this.paletteSampler=this.device.createSampler({magFilter:"linear",minFilter:"linear",addressModeU:"repeat",addressModeV:"clamp-to-edge"}),this.skyboxSampler=this.device.createSampler({magFilter:"linear",minFilter:"linear",addressModeU:"repeat",addressModeV:"repeat"}),this.webcamTexture=new ja(1920,1080),this.webcamTileTexture=this.device.createTexture({size:[1920,1080,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),this.webcamTextureView=this.webcamTileTexture.createView(),this.uniformBufferMandelbrot=this.device.createBuffer({size:80,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Mandelbrot"}),this.uniformBufferColor=this.device.createBuffer({size:4*Yo,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Color"}),this.uniformBufferBrush=this.device.createBuffer({size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Brush"}),this.uniformBufferResolve=this.device.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Resolve"}),this.mandelbrotReferenceBuffer=this.device.createBuffer({size:8*1e6,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot Orbit ReferenceStorage Buffer"}),this.mandelbrotBlaBuffer=this.device.createBuffer({size:4*at,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Storage Buffer"}),this.mandelbrotBlaLevelBuffer=this.device.createBuffer({size:16,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Level Storage Buffer"}),this.mandelbrotBlaBufferCapacity=1,this.mandelbrotBlaLevelBufferCapacity=1,this.counterBuffer=this.device.createBuffer({size:8,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST,label:"Engine Counter Storage"}),this.workStatsBuffer=this.device.createBuffer({size:16,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST,label:"Engine WorkStats Storage"}),this.counterReadbackSlots=Array.from({length:jo},(a,o)=>({buffer:this.device.createBuffer({size:24,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ,label:`Engine Counter Readback ${o}`}),pending:!1,sequence:0,generation:0})),this.uniformBufferCount=this.device.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Count"}),this.uniformBufferMerge=this.device.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Merge"}),await this._createPipelines(),this.resize()}async _createPipelines(){const e=this.device.createShaderModule({code:wr,label:"Engine ShaderModule Brush"}),n=this.device.createShaderModule({code:this.shaderPassCompute,label:"Engine ShaderModule Compute"}),r=this.device.createShaderModule({code:zr,label:"Engine ShaderModule Resolve"}),i=this.device.createShaderModule({code:this.shaderPassColor,label:"Engine ShaderModule Color"}),a=this.device.createShaderModule({code:Mr,label:"Engine ShaderModule Count"}),o=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Brush"}),s=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Mandelbrot"}),l=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Resolve"}),b=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:5,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:6,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:7,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:8,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:9,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d"}}],label:"Engine BindGroupLayout Color"}),h=Array.from({length:Re},()=>({format:"r32float"}));this.pipelineBrush=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[o]}),vertex:{module:e,entryPoint:"vs_main"},fragment:{module:e,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Brush"}),this.pipelineMandelbrot=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[s]}),vertex:{module:n,entryPoint:"vs_main"},fragment:{module:n,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Mandelbrot"}),this.pipelineResolve=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[l]}),vertex:{module:r,entryPoint:"vs_main"},fragment:{module:r,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Resolve"}),this.pipelineColor=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[b]}),vertex:{module:i,entryPoint:"vs_main"},fragment:{module:i,entryPoint:"fs_main_direct",targets:[{format:this.format}]},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Color (direct)"}),this.pipelineColorAccumClear=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[b]}),vertex:{module:i,entryPoint:"vs_main"},fragment:{module:i,entryPoint:"fs_main",targets:[{format:"rgba16float"}]},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline ColorAccumClear"}),this.pipelineColorAccum=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[b]}),vertex:{module:i,entryPoint:"vs_main"},fragment:{module:i,entryPoint:"fs_main",targets:[{format:"rgba16float",blend:{color:{srcFactor:"one",dstFactor:"one",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one",operation:"add"}}}]},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline ColorAccum"});const S=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}],label:"Engine BindGroupLayout Count"});this.pipelineCount=this.device.createComputePipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[S]}),compute:{module:a,entryPoint:"count_unfinished"},label:"Engine ComputePipeline Count"});const z=this.device.createShaderModule({code:yr,label:"Engine ShaderModule InplaceCompute"}),x=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:4,visibility:GPUShaderStage.COMPUTE,storageTexture:{access:"read-write",format:"r32float",viewDimension:"2d-array"}},{binding:5,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:6,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:7,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}],label:"Engine BindGroupLayout InplaceCompute"});this.pipelineInplace=this.device.createComputePipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[x]}),compute:{module:z,entryPoint:"cs_main"},label:"Engine ComputePipeline InplaceBrushMandelbrot"});const f=this.device.createShaderModule({code:Rr,label:"Engine ShaderModule Merge"}),m=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Merge"});this.pipelineMerge=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[m]}),vertex:{module:f,entryPoint:"vs_main"},fragment:{module:f,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Merge"});const L=this.device.createShaderModule({code:Tr,label:"Engine ShaderModule Present"}),N=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d"}}],label:"Engine BindGroupLayout Present"});this.pipelinePresent=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[N]}),vertex:{module:L,entryPoint:"vs_main"},fragment:{module:L,entryPoint:"fs_main",targets:[{format:this.format}]},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Present"});const p=this.device.createShaderModule({code:kr,label:"Engine ShaderModule AaTarget"}),V=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:1,visibility:GPUShaderStage.COMPUTE,storageTexture:{access:"write-only",format:"r32float",viewDimension:"2d"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}],label:"Engine BindGroupLayout AaTarget"});this.pipelineAaTarget=this.device.createComputePipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[V]}),compute:{module:p,entryPoint:"cs_main"},label:"Engine ComputePipeline AaTarget"}),this.uniformBufferAaTarget||(this.uniformBufferAaTarget=this.device.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer AaParams"}));const ee=this.device.createShaderModule({code:Br,label:"Engine ShaderModule AaReseed"}),D=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float",viewDimension:"2d"}},{binding:1,visibility:GPUShaderStage.COMPUTE,storageTexture:{access:"write-only",format:"r32float",viewDimension:"2d-array"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}],label:"Engine BindGroupLayout AaReseed"});this.pipelineAaReseed=this.device.createComputePipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[D]}),compute:{module:ee,entryPoint:"cs_main"},label:"Engine ComputePipeline AaReseed"}),this.bindGroupBrush=void 0,this.bindGroupMandelbrot=void 0,this.bindGroupResolve=void 0,this.bindGroupColor=void 0,this.bindGroupColorRaw=void 0,this.counterBindGroup=void 0,this.bindGroupMerge=void 0,this.bindGroupInplace=void 0,this.bindGroupPresent=void 0}rebuildInplaceBindGroup(){if(!this.pipelineInplace||!this.rawArrayView||!this.uniformBufferMandelbrot||!this.mandelbrotReferenceBuffer||!this.mandelbrotBlaBuffer||!this.mandelbrotBlaLevelBuffer||!this.uniformBufferBrush||!this.counterBuffer||!this.workStatsBuffer)return;const e=this.pipelineInplace.getBindGroupLayout(0);this.bindGroupInplace=this.device.createBindGroup({layout:e,entries:[{binding:0,resource:{buffer:this.uniformBufferMandelbrot}},{binding:1,resource:{buffer:this.mandelbrotReferenceBuffer}},{binding:2,resource:{buffer:this.mandelbrotBlaBuffer}},{binding:3,resource:{buffer:this.mandelbrotBlaLevelBuffer}},{binding:4,resource:this.rawArrayView},{binding:5,resource:{buffer:this.uniformBufferBrush}},{binding:6,resource:{buffer:this.counterBuffer}},{binding:7,resource:{buffer:this.workStatsBuffer}}],label:"Engine BindGroup InplaceCompute"})}rebuildMandelbrotBindGroup(){if(!this.pipelineMandelbrot||!this.rawBrushArrayView||!this.uniformBufferMandelbrot||!this.mandelbrotReferenceBuffer||!this.mandelbrotBlaBuffer||!this.mandelbrotBlaLevelBuffer)return;const e=this.pipelineMandelbrot.getBindGroupLayout(0);this.bindGroupMandelbrot=this.device.createBindGroup({layout:e,entries:[{binding:0,resource:{buffer:this.uniformBufferMandelbrot}},{binding:1,resource:{buffer:this.mandelbrotReferenceBuffer}},{binding:2,resource:{buffer:this.mandelbrotBlaBuffer}},{binding:3,resource:{buffer:this.mandelbrotBlaLevelBuffer}},{binding:4,resource:this.rawBrushArrayView}],label:"Engine BindGroup Mandelbrot"}),this.rebuildInplaceBindGroup()}ensureBlaBufferCapacity(e){const n=Math.max(1,Math.ceil(e));n<=this.mandelbrotBlaBufferCapacity||(this.mandelbrotBlaBuffer?.destroy?.(),this.mandelbrotBlaBuffer=this.device.createBuffer({size:n*4*at,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Storage Buffer"}),this.mandelbrotBlaBufferCapacity=n,this.rebuildMandelbrotBindGroup())}ensureBlaLevelBufferCapacity(e){const n=Math.max(1,Math.ceil(e));n<=this.mandelbrotBlaLevelBufferCapacity||(this.mandelbrotBlaLevelBuffer?.destroy?.(),this.mandelbrotBlaLevelBuffer=this.device.createBuffer({size:n*4*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Level Storage Buffer"}),this.mandelbrotBlaLevelBufferCapacity=n,this.rebuildMandelbrotBindGroup())}invalidateCounterReadback(){this.unfinishedPixelCount=-1,this.activePixelCount=-1,this.realizedSkip=-1,this.workgroupWaste=-1,this.maxPixelSteps=-1,this.realLoopStepsApprox=-1,this.counterReadbackGeneration++,this.lastCounterDispatchFrame=-Pt,this.counterSampleFrame=-1}hasPendingCounterReadbackForCurrentGeneration(){return this.counterReadbackSlots.some(e=>e.pending&&e.generation===this.counterReadbackGeneration)}acquireCounterReadbackSlot(){const e=this.counterReadbackSlots.length;for(let n=0;n<e;n++){const r=(this.counterReadbackWriteIndex+n)%e,i=this.counterReadbackSlots[r];if(!i.pending)return this.counterReadbackWriteIndex=(r+1)%e,i}}scheduleCounterReadback(e,n,r,i){e.pending=!0,e.sequence=n,e.generation=r,(async()=>{let a=!1;try{await e.buffer.mapAsync(GPUMapMode.READ),a=!0;const o=new Uint32Array(e.buffer.getMappedRange()),s=o[0],l=o[1],b=o[2],h=o[3],S=o[4],z=o[5];this.applyCounterReadback(n,r,i,s,l,b,h,S,z)}catch{}finally{a&&e.buffer.unmap(),e.pending=!1}})()}applyCounterReadback(e,n,r,i,a,o=0,s=0,l=0,b=0){if(n!==this.counterReadbackGeneration||e<=this.latestAppliedCounterReadbackSequence)return;this.latestAppliedCounterReadbackSequence=e;const h=this.unfinishedPixelCount;if(this.unfinishedPixelCount=i,this.activePixelCount=a,this.counterSampleFrame=r,o>0){const S=s/o,z=l/o;S>=1&&z>=1?(this.realizedSkip=S,this.workgroupWaste=z,this.maxPixelSteps=b,this.realLoopStepsApprox=o*256):(this.realizedSkip=-1,this.workgroupWaste=-1,this.maxPixelSteps=-1)}h>Lt&&i<=Lt&&!this.clearHistoryNextFrame&&!X(this.zoomState)&&(this.needFreezeSnapshot=!0)}scheduleGpuTiming(e){this.pendingGpuTiming||(this.pendingGpuTiming=!0,this.device.queue.onSubmittedWorkDone().then(()=>{this.pendingGpuTiming=!1,this.applyGpuFrameTiming(performance.now()-e)}).catch(()=>{this.pendingGpuTiming=!1}))}applyGpuFrameTiming(e){if(this.gpuFrameTimeMs=e,this.completionTimerActive&&e>0&&(this.completionAccumulatedGpuMs+=e),this.smoothedGpuTimeMs===0?this.smoothedGpuTimeMs=e:this.smoothedGpuTimeMs=this.smoothedGpuTimeMs*(1-An)+e*An,e<=0)return;const n=1e3/this.targetFps/e,r=this.iterationBatchSize*n,i=this.getEffectiveMaxBatchSize();this.iterationBatchSize=Math.round(Math.min(i,Math.max(it,this.iterationBatchSize*.7+r*.3)))}getEffectiveMaxBatchSize(){return qo}resize(){const e=(window.devicePixelRatio||1)*this.dprMultiplier,n=this.canvas.parentElement,r=n?.clientWidth||1,i=n?.clientHeight||1;this.width=Math.max(1,Math.round(r*e)),this.height=Math.max(1,Math.round(i*e));const a=this.device?.limits?.maxTextureDimension2D??8192;this.width=Math.min(this.width,a),this.height=Math.min(this.height,a),this.canvas.width=this.width,this.canvas.height=this.height,this.canvas.style.width=r+"px",this.canvas.style.height=i+"px",this.ctx.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.neutralSize=Math.ceil(Math.sqrt(this.width*this.width+this.height*this.height));const o=this.neutralSize;this.rawTexture?.destroy?.(),this.rawBrushTexture?.destroy?.(),this.resolvedTexture?.destroy?.(),this.frozenTexture?.destroy?.(),this.accumTexture?.destroy?.(),this.aaTargetTexture?.destroy?.();const s=Re,l=(x,f=0)=>{const m=this.device.createTexture({size:{width:o,height:o,depthOrArrayLayers:s},format:"r32float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC|GPUTextureUsage.COPY_DST|f,label:x}),L=m.createView({dimension:"2d-array",baseArrayLayer:0,arrayLayerCount:s,label:x+" ArrayView"}),N=[];for(let p=0;p<s;p++)N.push(m.createView({dimension:"2d",baseArrayLayer:p,arrayLayerCount:1,label:x+` Layer${p}`}));return{texture:m,arrayView:L,layerViews:N}},b=l("Engine RawTexture (A)",GPUTextureUsage.STORAGE_BINDING);this.rawTexture=b.texture,this.rawArrayView=b.arrayView,this.rawLayerViews=b.layerViews;const h=l("Engine RawBrushTexture (B)");this.rawBrushTexture=h.texture,this.rawBrushArrayView=h.arrayView,this.rawBrushLayerViews=h.layerViews;const S=l("Engine ResolvedTexture");this.resolvedTexture=S.texture,this.resolvedArrayView=S.arrayView,this.resolvedLayerViews=S.layerViews;const z=l("Engine FrozenTexture");if(this.frozenTexture=z.texture,this.frozenArrayView=z.arrayView,this.frozenLayerViews=z.layerViews,this.accumTexture=this.device.createTexture({size:{width:this.width,height:this.height,depthOrArrayLayers:1},format:"rgba16float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING,label:"Engine AccumTexture"}),this.accumTextureView=this.accumTexture.createView({label:"Engine AccumTexture View"}),this.pipelinePresent&&(this.bindGroupPresent=this.device.createBindGroup({layout:this.pipelinePresent.getBindGroupLayout(0),entries:[{binding:0,resource:this.accumTextureView}],label:"Engine BindGroup Present"})),this.aaTargetTexture=this.device.createTexture({size:{width:o,height:o,depthOrArrayLayers:1},format:"r32float",usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING,label:"Engine AaTargetTexture"}),this.aaTargetTextureView=this.aaTargetTexture.createView({label:"Engine AaTargetTexture View"}),this.pipelineAaTarget&&this.rawArrayView&&this.uniformBufferAaTarget&&(this.bindGroupAaTarget=this.device.createBindGroup({layout:this.pipelineAaTarget.getBindGroupLayout(0),entries:[{binding:0,resource:this.rawArrayView},{binding:1,resource:this.aaTargetTextureView},{binding:2,resource:{buffer:this.uniformBufferAaTarget}}],label:"Engine BindGroup AaTarget"})),this.pipelineAaReseed&&this.rawArrayView&&this.uniformBufferAaTarget&&(this.bindGroupAaReseed=this.device.createBindGroup({layout:this.pipelineAaReseed.getBindGroupLayout(0),entries:[{binding:0,resource:this.aaTargetTextureView},{binding:1,resource:this.rawArrayView},{binding:2,resource:{buffer:this.uniformBufferAaTarget}}],label:"Engine BindGroup AaReseed"})),this.resetAaState(),this.zoomState=Mn(),this.pipelineBrush){const x=this.pipelineBrush.getBindGroupLayout(0);this.bindGroupBrush=this.device.createBindGroup({layout:x,entries:[{binding:0,resource:{buffer:this.uniformBufferBrush}},{binding:1,resource:this.rawArrayView}],label:"Engine BindGroup Brush"})}if(this.pipelineMandelbrot&&this.rebuildMandelbrotBindGroup(),this.pipelineResolve){const x=this.pipelineResolve.getBindGroupLayout(0);this.bindGroupResolve=this.device.createBindGroup({layout:x,entries:[{binding:0,resource:{buffer:this.uniformBufferResolve}},{binding:1,resource:this.rawArrayView}],label:"Engine BindGroup Resolve"})}if(this.rebuildColorBindGroup(),this.pipelineCount&&this.counterBuffer&&this.uniformBufferCount){const x=this.pipelineCount.getBindGroupLayout(0);this.counterBindGroup=this.device.createBindGroup({layout:x,entries:[{binding:0,resource:this.rawArrayView},{binding:1,resource:{buffer:this.counterBuffer}},{binding:2,resource:{buffer:this.uniformBufferCount}}],label:"Engine BindGroup Count"})}if(this.pipelineMerge&&this.uniformBufferMerge){const x=this.pipelineMerge.getBindGroupLayout(0);this.bindGroupMerge=this.device.createBindGroup({layout:x,entries:[{binding:0,resource:{buffer:this.uniformBufferMerge}},{binding:1,resource:this.resolvedArrayView},{binding:2,resource:this.rawBrushArrayView}],label:"Engine BindGroup Merge"})}this.prevFrameMandelbrot=void 0,this.previousMandelbrot=void 0,this.previousRenderOptions=void 0,this.needRender=!0,this.invalidateCounterReadback()}areObjectsEqual(e,n){return e===void 0||n===void 0?!1:JSON.stringify(e)===JSON.stringify(n)}areColorStopsEqual(e,n){if(e.length!==n.length)return!1;for(const[r,i]of e.entries()){const a=n[r];if(!a||JSON.stringify(i)!==JSON.stringify(a))return!1}return!0}setApproximationMode(e){e!==this.approximationMode&&(e==="bla"?this.mandelbrotNavigator.use_bla():e==="pade"?this.mandelbrotNavigator.use_pade():this.mandelbrotNavigator.use_perturbation(),this.approximationMode=e,this.currentBlaLevelCount=0,this.postReferenceWorker({type:"setApproximationMode",jobId:this.referenceJobId,approximationMode:e}),this.clearHistoryNextFrame=!0,this.needRender=!0,this.invalidateCounterReadback())}getApproximationMode(){return this.approximationMode}setBlaEpsilon(e){const n=Math.max(Number.MIN_VALUE,e);n!==this.blaEpsilon&&(this.mandelbrotNavigator.set_bla_epsilon(n),this.blaEpsilon=n,this.postReferenceWorker({type:"setBlaEpsilon",jobId:this.referenceJobId,blaEpsilon:n}),(this.approximationMode==="bla"||this.approximationMode==="pade")&&(this.currentBlaLevelCount=0,this.clearHistoryNextFrame=!0,this.needRender=!0,this.invalidateCounterReadback()))}getMaxBlaSkip(){return this.maxBlaSkip}benchmarkPade(e=16){const n={pixels:0,maxIter:0,stepsExact:0,stepsAffine:0,stepsPade:0,mismatches:0,maxIterDelta:0};return this.pendingBenchmarkResolve?.(n),this.pendingBenchmarkResolve=null,new Promise(r=>{this.pendingBenchmarkResolve=r,this.postReferenceWorker({type:"benchmarkPade",jobId:this.referenceJobId,grid:e})})}findMinibrot(e=4){const n={status:"none",cx:null,cy:null,period:null};return this.pendingMinibrotResolve?.(n),this.pendingMinibrotResolve=null,new Promise(r=>{this.pendingMinibrotResolve=r,this.postReferenceWorker({type:"findMinibrot",jobId:this.referenceJobId,maxIter:this.currentMaxIterations,radiusFactor:e})})}setMaxBlaSkip(e){const n=Math.min(1048576,Math.max(2,Math.round(e))),r=1<<Math.round(Math.log2(n));r!==this.maxBlaSkip&&(this.mandelbrotNavigator.set_max_bla_skip(r),this.maxBlaSkip=r,this.postReferenceWorker({type:"setMaxBlaSkip",jobId:this.referenceJobId,maxBlaSkip:r}),(this.approximationMode==="bla"||this.approximationMode==="pade")&&(this.currentBlaLevelCount=0,this.clearHistoryNextFrame=!0,this.needRender=!0,this.invalidateCounterReadback()))}async update(e,n){const r=performance.now();this.lastUpdateTime===0&&(this.lastUpdateTime=r);const i=(r-this.lastUpdateTime)/1e3;this.time+=i,this.lastUpdateTime=r;const a=this.needsMoreFrames();if(a&&!this.completionTimerActive?(this.completionStartMs=r,this.completionAccumulatedGpuMs=0,this.completionTimerActive=!0):!a&&this.completionTimerActive&&(this.lastCompletionWallMs=r-this.completionStartMs,this.lastCompletionGpuMs=this.completionAccumulatedGpuMs,this.completionTimerActive=!1),this.debugShadingActive=n.debugShading,this.pendingRefReady){this.applyPendingReferenceSwitch();return}const o=this.mandelbrotNavigator.get_approximation_mode()===2?"pade":this.mandelbrotNavigator.get_approximation_mode()===1?"bla":"perturbation",s=this.mandelbrotNavigator.get_bla_epsilon();(o!==this.approximationMode||s!==this.blaEpsilon)&&(this.approximationMode=o,this.blaEpsilon=s,this.currentBlaLevelCount=0,this.postReferenceWorker({type:"setApproximationMode",jobId:this.referenceJobId,approximationMode:o}),this.postReferenceWorker({type:"setBlaEpsilon",jobId:this.referenceJobId,blaEpsilon:s}),this.clearHistoryNextFrame=!0,this.needRender=!0,this.invalidateCounterReadback());const l=!this.areObjectsEqual(e,this.previousMandelbrot),b=!this.areObjectsEqual(n,this.previousRenderOptions),h=n.stripeFrequency!==this.previousRenderOptions?.stripeFrequency,S=$o(n.colorStops),z=this.previousOrbitMetricsEnabled!==void 0&&S!==this.previousOrbitMetricsEnabled,x=h&&S;this.needRender=this.needRender||l||b,(l||b)&&this.resetAaState(),this.aaAuto=n.aaAuto??!1,(l||x||z)&&this.invalidateCounterReadback(),(x||z)&&(this.clearHistoryNextFrame=!0),this.previousOrbitMetricsEnabled=S,n.colorStops.some(ze=>(ze.webcam??0)>0)?(await this.updateWebcamTexture(),this.needRender=!0):this.webcamTexture?.closeWebcam(),n.activateAnimate&&(this.needRender=!0);const m=this.width/Math.max(1,this.height);let L=this.previousMandelbrot?.scale||1/e.scale;L<1&&(L=1/L),L=Math.sqrt(L)-1;const N=this.referenceOrbitWasReset&&!!this.prevFrameMandelbrot;this.referenceOrbitWasReset=!1;const p=!this.prevFrameMandelbrot||N,V=!!this.prevFrameMandelbrot&&this.prevFrameMandelbrot.mu!==e.mu,ee=X(this.zoomState)&&p&&!V;(p||V)&&(this.clearHistoryNextFrame=!0,ee||(this.zoomState=Mn(),this.frozenBaseShiftX=0,this.frozenBaseShiftY=0,this.frozenPanShiftX=0,this.frozenPanShiftY=0),this.needFreezeSnapshot=N&&!ee&&!V,this.needMergeSnapshot=!1);{const ze=this.prevFrameMandelbrot&&this.prevFrameMandelbrot.scale!==e.scale;let ce=null;p||V?ce={type:"referenceReset",muChanged:V,orbitWasReset:N}:ze?ce={type:"scaleChanged",scale:e.scale,prevScale:this.prevFrameMandelbrot.scale}:this.prevFrameMandelbrot&&(ce={type:"scaleStable"});const Ge=X(this.zoomState),Je=rt(this.zoomState),xt=_e(this.zoomState),or=To(this.zoomState),{state:sr,effects:lr}=ce?ko(this.zoomState,ce,{threshold:this.zoomMagnificationThreshold}):{state:this.zoomState,effects:[]};this.zoomState=sr,!Ge&&this._prevFrameScaleChanged&&!ze&&(this.clearHistoryNextFrame=!0),this._prevFrameScaleChanged=!!ze;for(const cr of lr)switch(cr.type){case"copyResolvedToFrozen":if(this.needFreezeSnapshot=!0,X(this.zoomState)){if(Ge)this.frozenBaseShiftX=0,this.frozenBaseShiftY=0;else{const dr=e.dx-this.prevFrameMandelbrot.dx,ur=e.dy-this.prevFrameMandelbrot.dy,on=Math.sqrt(m*m+1),yt=rt(this.zoomState);yt>0&&(this.frozenBaseShiftX=Math.round(-(dr*this.neutralSize)/(2*yt*on)),this.frozenBaseShiftY=Math.round(ur*this.neutralSize/(2*yt*on)))}this.frozenPanShiftX=0,this.frozenPanShiftY=0}break;case"mergeResolvedAndFrozen":this.needMergeSnapshot=!or,Ge&&Je>0&&(this.mergeUniforms={zf:Je/e.scale,lzf:xt/e.scale,frozenShiftU:(this.frozenBaseShiftX+this.frozenPanShiftX*(xt/Je))/this.neutralSize,frozenShiftV:-(this.frozenBaseShiftY+this.frozenPanShiftY*(xt/Je))/this.neutralSize,aspect:m,angle:e.angle});break;case"clearHistoryNextFrame":this.clearHistoryNextFrame=!0;break}}if(!this.areColorStopsEqual(n.colorStops,this.previousRenderOptions?.colorStops||[])||n.interpolationMode!==this.previousRenderOptions?.interpolationMode){const ce=new zn(n.colorStops,n.interpolationMode).generateTexture(),Ge=En(ce.data);this.device.queue.writeTexture({texture:this.paletteTexture},Ge.buffer,{bytesPerRow:ce.width*8},[ce.width,ce.height]),this.needRender=!0}const D=Math.sin(e.angle),_=Math.cos(e.angle),g=ut(n.animation,n.animationSpeed),M=be(g.globalSpeed,0,10),k=n.activateAnimate?this.time:0,U=oe(g.tracks.paletteOffset,k,M),Y=oe(g.tracks.heightPaletteShift,k,M),O=oe(g.tracks.lightAngle,k,M)*Zt,te=oe(g.tracks.textureDrift,k,M),q=Cn(g.tracks.textureDrift,k,M,.25),ae=oe(g.tracks.skyReflectionDrift,k,M),Z=Cn(g.tracks.skyReflectionDrift,k,M,.25),$=oe(g.tracks.phaseColoring,k,M),ne=oe(g.tracks.varnish,k,M),K=oe(g.tracks.microBump,k,M),v=oe(g.tracks.displacement,k,M),R=oe(g.tracks.tessellation,k,M),B=n.lightAngle+O,A=be(n.tessellationLevel+R,0,10),G=be(n.displacementAmount+v,0,.1),u=be(n.microBumpStrength+K,0,10),y=be(n.varnishStrength+ne,0,10),w=be(n.heightPaletteShift+Y,0,100),T=be(n.phaseColoringStrength+$,0,100),C=Math.hypot(Math.cos(B),Math.sin(B),1.85),F=er(n.textureMapping),P=X(this.zoomState),I=P?rt(this.zoomState)/e.scale:1,H=P?_e(this.zoomState)/e.scale:1,J=rt(this.zoomState),re=_e(this.zoomState),gt=Math.max(1,Math.round(n.antialiasLevel??1)),_t=new Float32Array([n.palettePeriod,n.paletteOffset+U,L,this.time,m,e.angle,n.activateAnimate?1:0,e.mu,I,P||this.frozenAligned||this.needFreezeSnapshot?1:0,H,P&&J>0?(this.frozenBaseShiftX+this.frozenPanShiftX*(re/J))/this.neutralSize:0,P&&J>0?-(this.frozenBaseShiftY+this.frozenPanShiftY*(re/J))/this.neutralSize:0,A,G,M,e.epsilon,n.ambientOcclusionStrength,u,n.subsurfaceStrength,n.reliefDepth,n.localShadowStrength,B,y,Math.log(e.mu),D,_,Math.cos(B)/C,Math.sin(B)/C,1.85/C,n.paletteMirror?1:0,n.debugShading?1:0,w,n.orbitTrapStrength,T,Bn(F.xVariable),Bn(F.yVariable),F.xScale,F.yScale,F.mirrored?1:0,parseFloat(e.cx),parseFloat(e.cy),e.scale,0,.03*te,.03*q,.02*ae,.02*Z,U,Y,O,te,ae,$,ne,K,v,R,this.aaSampleIndex,gt]);if(this.device.queue.writeBuffer(this.uniformBufferColor,0,_t.buffer),!this.needsMoreFrames())return;const le=Math.ceil(e.maxIterations);this.currentMaxIterations=le;const $e=X(this.zoomState)&&_e(this.zoomState)>0?_e(this.zoomState):e.scale,tn=!(X(this.zoomState)&&_e(this.zoomState)>0)&&e.scaleStr?Ct(e.scaleStr):Et($e),Pe=tn.exponent,De=Pe<=zo;this.floatExpActive=De;const mt=e.dxStr?Ct(e.dxStr):Et(e.dx),vt=e.dyStr?Ct(e.dyStr):Et(e.dy),rr=mt.mantissa===0?0:Math.fround(mt.mantissa*2**(mt.exponent-Pe)),ir=vt.mantissa===0?0:Math.fround(vt.mantissa*2**(vt.exponent-Pe));this.referenceViewKey||(console.log("[REF] update: reset branch (key empty) | deep",De,"expScale",Pe,"mode",this.approximationMode,"dx",e.dx,"dxStr",e.dxStr),this.resetReferenceJob(e,$e,le)),this.syncReferenceWorkerView(e,$e,le);const Oe=Math.max(0,this.referenceAvailableOrbitLen-1),Ke=Math.min(le,Oe);this.currentGuardedMaxIter=Ke,this.currentReferenceAvailableIter=Oe,this.currentReferenceRemainingIter=Math.max(0,le-Oe),this.orbitIncomplete=!this.referenceWorkerFailed&&Oe<le;const bt=Oe>=le,nn=(this.approximationMode==="bla"||this.approximationMode==="pade")&&bt&&this.currentBlaLevelCount>0&&this.referenceBlaReadyMaxIterations>=Ke,rn=nn?this.approximationMode==="pade"?2:1:0,an=nn?this.currentBlaLevelCount:0;this.lastShaderApproxFlag=rn,this.lastShaderBlaLevelCount=an;const ar=new Float32Array([De?rr:e.dx,De?ir:e.dy,e.mu,De?tn.mantissa:$e,m,e.angle,this.iterationBatchSize,e.epsilon,n.antialiasLevel,0,Ke,bt?1:0,rn,an,this.blaEpsilon,n.stripeFrequency,S?1:0,Pe,this.aaOffsetX,this.aaOffsetY]);this.device.queue.writeBuffer(this.uniformBufferMandelbrot,0,ar.buffer),!X(this.zoomState)&&!this.clearHistoryNextFrame&&!this.aaActive&&bt&&this.prevGuardedMaxIter<le&&this.prevGuardedMaxIter>0&&(this.needFreezeSnapshot=!0,this.clearHistoryNextFrame=!0),this.prevGuardedMaxIter=Ke,this.previousMandelbrot=structuredClone(e),this.previousRenderOptions=structuredClone(n)}resetAaState(){this.aaActive=!1,this.aaSampleIndex=0,this.aaAccumulatedSamples=0,this.aaOffsetX=0,this.aaOffsetY=0,this.aaReseedPending=!1}triggerAaAccumulation(){this.resetAaState(),this.aaActive=!0,this.needRender=!0}get aaProgress(){const e=Math.max(1,Math.round(this.previousRenderOptions?.antialiasLevel??1));return{active:this.aaActive,done:this.aaAccumulatedSamples,total:e}}async render(){if(this.skipRenderOnce){this.skipRenderOnce=!1;return}if(!this.needsMoreFrames()||!this.pipelineBrush||!this.pipelineMandelbrot||!this.pipelineResolve||!this.pipelineColor||!this.bindGroupBrush||!this.bindGroupMandelbrot||!this.bindGroupResolve||!this.bindGroupColor||!this.previousMandelbrot)return;const e=this.previousRenderOptions;if(!e)return;const n=this.width/Math.max(1,this.height),r=Rn(e.zoomMinBrushStep,1,1,64),i=Math.max(Rn(e.sentinelSeedStep,64,1,4096),r),a=i,o=this.clearHistoryNextFrame?1:0;this.clearHistoryNextFrame&&this.invalidateCounterReadback();const s=++this.renderFrameSerial;let l=0,b=0;if(!this.clearHistoryNextFrame&&this.prevFrameMandelbrot){const v=this.previousMandelbrot.dx-this.prevFrameMandelbrot.dx,R=this.previousMandelbrot.dy-this.prevFrameMandelbrot.dy,B=this.neutralSize,A=Math.sqrt(n*n+1),G=X(this.zoomState)&&_e(this.zoomState)>0?_e(this.zoomState):this.previousMandelbrot.scale;l=-(v*B)/(2*G*A),b=R*B/(2*G*A)}const h=Math.round(l),S=Math.round(b),z=h!==0||S!==0;this.clearHistoryNextFrame?(this.cumulativeShiftX=0,this.cumulativeShiftY=0):(this.cumulativeShiftX+=h,this.cumulativeShiftY+=S,X(this.zoomState)&&(this.frozenPanShiftX+=h,this.frozenPanShiftY+=S),z&&(this.frozenAligned=!1)),z&&!X(this.zoomState)&&(this.needFreezeSnapshot=!1);const x=(this.cumulativeShiftX%a+a)%a,f=(this.cumulativeShiftY%a+a)%a,m=this.hasPendingCounterReadbackForCurrentGeneration(),L=!m&&(this.clearHistoryNextFrame||this.activePixelCount<0||this.iterationBatchSize>it||this.activePixelCount<Xo*this.gpuLoadMultiplier);L&&this.refinementWasGated&&(this.iterationBatchSize=it),this.refinementWasGated=!L;const N=L?1:0,p=new Float32Array([n,this.previousMandelbrot.angle,o,i,a,l,b,this.previousMandelbrot.mu,x,f,X(this.zoomState)?r:0,N]);this.device.queue.writeBuffer(this.uniformBufferBrush,0,p.buffer);const V=new Float32Array([this.previousMandelbrot.mu,x,f]);this.device.queue.writeBuffer(this.uniformBufferResolve,0,V.buffer);const D=!m&&(this.unfinishedPixelCount<0||this.activePixelCount<0||s-this.lastCounterDispatchFrame>=Pt)?this.acquireCounterReadbackSlot():void 0;let _;const g=this.device.createCommandEncoder();if(this.needMergeSnapshot&&this.pipelineMerge&&this.bindGroupMerge&&this.resolvedTexture&&this.frozenTexture&&this.rawBrushTexture){const v=this.neutralSize;g.copyTextureToTexture({texture:this.frozenTexture},{texture:this.rawBrushTexture},{width:v,height:v,depthOrArrayLayers:Re});const R=new Float32Array([this.mergeUniforms.zf,this.mergeUniforms.lzf,this.mergeUniforms.frozenShiftU,this.mergeUniforms.frozenShiftV,this.mergeUniforms.aspect,this.mergeUniforms.angle]);this.device.queue.writeBuffer(this.uniformBufferMerge,0,R.buffer);const B=this.frozenLayerViews.map(G=>({view:G,clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store"})),A=g.beginRenderPass({colorAttachments:B});A.setPipeline(this.pipelineMerge),A.setBindGroup(0,this.bindGroupMerge),A.draw(6,1,0,0),A.end(),this.needMergeSnapshot=!1,this.frozenAligned=!0,this.frozenPanShiftX=0,this.frozenPanShiftY=0}if(this.needFreezeSnapshot&&this.resolvedTexture&&this.frozenTexture){const v=Re,R=this.neutralSize;g.copyTextureToTexture({texture:this.resolvedTexture},{texture:this.frozenTexture},{width:R,height:R,depthOrArrayLayers:v}),this.needFreezeSnapshot=!1,this.frozenAligned=!0,this.frozenPanShiftX=0,this.frozenPanShiftY=0,X(this.zoomState)||(this.frozenBaseShiftX=0,this.frozenBaseShiftY=0)}const M=(v,R="clear")=>v.map(B=>({view:B,clearValue:{r:0,g:0,b:0,a:0},loadOp:R,storeOp:"store"})),k=this.useInplaceCompute&&!this.clearHistoryNextFrame&&!z&&!!this.pipelineInplace&&!!this.bindGroupInplace&&!!this.counterBuffer;if((!k||this.unfinishedPixelCount!==0||this.activePixelCount!==0)&&(this.lastRawMutationFrame=s),k){if(this.aaReseedPending&&this.pipelineAaReseed&&this.bindGroupAaReseed&&this.uniformBufferAaTarget){const B=Math.max(1,Math.round(e.antialiasLevel??1));this.device.queue.writeBuffer(this.uniformBufferAaTarget,0,new Float32Array([B,this.aaSampleIndex,this.height,0]).buffer);const A=g.beginComputePass();A.setPipeline(this.pipelineAaReseed),A.setBindGroup(0,this.bindGroupAaReseed);const G=Math.ceil(this.neutralSize/16);A.dispatchWorkgroups(G,G),A.end(),this.aaReseedPending=!1}g.clearBuffer(this.counterBuffer,0,8),this.workStatsClearedGeneration!==this.counterReadbackGeneration&&(g.clearBuffer(this.workStatsBuffer,0,16),this.workStatsClearedGeneration=this.counterReadbackGeneration);const v=g.beginComputePass();v.setPipeline(this.pipelineInplace),v.setBindGroup(0,this.bindGroupInplace);const R=Math.ceil(this.neutralSize/8);if(v.dispatchWorkgroups(R,R),v.end(),D){const B=++this.counterReadbackSequence,A=this.counterReadbackGeneration;g.copyBufferToBuffer(this.counterBuffer,0,D.buffer,0,8),g.copyBufferToBuffer(this.workStatsBuffer,0,D.buffer,8,16),this.lastCounterDispatchFrame=s,_={slot:D,sequence:B,generation:A,frame:s}}}else{const v=g.beginRenderPass({colorAttachments:M(this.rawBrushLayerViews)});v.setPipeline(this.pipelineBrush),v.setBindGroup(0,this.bindGroupBrush),v.draw(6,1,0,0),v.end(),g.copyTextureToTexture({texture:this.rawBrushTexture},{texture:this.rawTexture},{width:this.neutralSize,height:this.neutralSize,depthOrArrayLayers:Re});const R=g.beginRenderPass({colorAttachments:M(this.rawLayerViews,"load")});if(R.setPipeline(this.pipelineMandelbrot),R.setBindGroup(0,this.bindGroupMandelbrot),R.draw(6,1,0,0),R.end(),this.pipelineCount&&this.counterBindGroup&&this.counterBuffer&&D&&this.uniformBufferCount){const B=++this.counterReadbackSequence,A=this.counterReadbackGeneration,G=this.previousMandelbrot.mu;this.device.queue.writeBuffer(this.uniformBufferCount,0,new Float32Array([G,n,this.previousMandelbrot.angle])),g.clearBuffer(this.counterBuffer,0,8);const u=g.beginComputePass();u.setPipeline(this.pipelineCount),u.setBindGroup(0,this.counterBindGroup),u.dispatchWorkgroups(Math.ceil(this.neutralSize/16),Math.ceil(this.neutralSize/16)),u.end(),g.copyBufferToBuffer(this.counterBuffer,0,D.buffer,0,8),this.lastCounterDispatchFrame=s,_={slot:D,sequence:B,generation:A,frame:s}}}const U=k&&!!this.bindGroupColorRaw&&!this.needFreezeSnapshot&&!this.needMergeSnapshot&&this.unfinishedPixelCount===0&&this.activePixelCount===0&&this.counterSampleFrame>=this.lastRawMutationFrame;this.resolveSkipped=U;const Y=!this.clearHistoryNextFrame&&!this.needFreezeSnapshot&&!this.needMergeSnapshot&&!X(this.zoomState)&&!this.orbitIncomplete&&this.unfinishedPixelCount===0&&this.activePixelCount===0&&!this.hasPendingCounterReadbackForCurrentGeneration();if(!U){g.copyTextureToTexture({texture:this.rawTexture},{texture:this.resolvedTexture},{width:this.neutralSize,height:this.neutralSize,depthOrArrayLayers:Re});const v=g.beginRenderPass({colorAttachments:M(this.resolvedLayerViews,"load")});v.setPipeline(this.pipelineResolve),v.setBindGroup(0,this.bindGroupResolve),v.draw(6,1,0,0),v.end()}const O=U?this.bindGroupColorRaw:this.bindGroupColor,te=this.ctx.getCurrentTexture().createView(),q=Math.max(1,Math.round(e.antialiasLevel??1)),ae=Math.sqrt(n*n+1);this.aaActive&&q<=1&&this.resetAaState(),this.aaAuto&&q>1&&!this.aaActive&&this.aaAccumulatedSamples===0&&Y&&this.triggerAaAccumulation();const Z=this.aaActive&&Y&&this.aaAccumulatedSamples<q&&!!this.accumTextureView&&!!this.pipelineColorAccum&&!!this.pipelineColorAccumClear,$=this.aaActive&&(this.aaAccumulatedSamples>=1||Z);if(Z){const v=this.aaSampleIndex===0,R=g.beginRenderPass({colorAttachments:[{view:this.accumTextureView,clearValue:{r:0,g:0,b:0,a:0},loadOp:v?"clear":"load",storeOp:"store"}]});R.setPipeline(v?this.pipelineColorAccumClear:this.pipelineColorAccum),R.setBindGroup(0,O),R.draw(6,1,0,0),R.end()}else if(!$){const v=g.beginRenderPass({colorAttachments:[{view:te,clearValue:{r:1,g:1,b:1,a:1},loadOp:"clear",storeOp:"store"}]});v.setPipeline(this.pipelineColor),v.setBindGroup(0,O),v.draw(6,1,0,0),v.end()}if($&&this.pipelinePresent&&this.bindGroupPresent){const v=g.beginRenderPass({colorAttachments:[{view:te,clearValue:{r:0,g:0,b:0,a:1},loadOp:"clear",storeOp:"store"}]});v.setPipeline(this.pipelinePresent),v.setBindGroup(0,this.bindGroupPresent),v.draw(6,1,0,0),v.end()}if(Z&&this.aaSampleIndex===0&&!!this.pipelineAaTarget&&!!this.bindGroupAaTarget&&!!this.uniformBufferAaTarget){this.device.queue.writeBuffer(this.uniformBufferAaTarget,0,new Float32Array([q,0,this.height,0]).buffer);const v=g.beginComputePass();v.setPipeline(this.pipelineAaTarget),v.setBindGroup(0,this.bindGroupAaTarget),v.dispatchWorkgroups(Math.ceil(this.neutralSize/16),Math.ceil(this.neutralSize/16)),v.end()}const K=performance.now();if(this.device.queue.submit([g.finish()]),this.scheduleGpuTiming(K),_&&this.scheduleCounterReadback(_.slot,_.sequence,_.generation,_.frame),this.clearHistoryNextFrame=!1,this.prevFrameMandelbrot={...this.previousMandelbrot},this.needRender=!1,Z)if(this.aaAccumulatedSamples++,this.aaAccumulatedSamples<q){this.aaSampleIndex++;const v=Eo(this.aaSampleIndex);this.aaOffsetX=v.x*ae/Math.max(1,this.neutralSize),this.aaOffsetY=v.y*ae/Math.max(1,this.neutralSize),this.useAaSelectiveReseed&&this.useInplaceCompute&&r<=1&&!!this.pipelineAaReseed&&!!this.bindGroupAaReseed?(this.aaReseedPending=!0,this.invalidateCounterReadback()):this.clearHistoryNextFrame=!0,this.needRender=!0}else this.aaActive=!1;if(this.snapshotCallback){try{const v=this.snapshotDestWidth??256,R=Math.round(v*9/16),B=this.device.createTexture({size:[v,R,1],format:this.format,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.COPY_SRC});{const I=this.device.createCommandEncoder(),H=I.beginRenderPass({colorAttachments:[{view:B.createView(),clearValue:{r:0,g:0,b:0,a:1},loadOp:"clear",storeOp:"store"}]});H.setPipeline(this.pipelineColor),H.setBindGroup(0,O),H.draw(6,1,0,0),H.end(),this.device.queue.submit([I.finish()])}const A=I=>I+255&-256,G=v*4,u=A(G),y=u*R,w=this.device.createBuffer({size:y,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});{const I=this.device.createCommandEncoder();I.copyTextureToBuffer({texture:B},{buffer:w,offset:0,bytesPerRow:u},{width:v,height:R,depthOrArrayLayers:1}),this.device.queue.submit([I.finish()])}await this.device.queue.onSubmittedWorkDone(),await w.mapAsync(GPUMapMode.READ);const T=w.getMappedRange(),C=new Uint8ClampedArray(v*R*4),F=new Uint8Array(T);for(let I=0;I<R;++I)for(let H=0;H<v;++H){const J=I*u+H*4,re=(I*v+H)*4;C[re+0]=F[J+2],C[re+1]=F[J+1],C[re+2]=F[J+0],C[re+3]=F[J+3]}const P=document.createElement("canvas");P.width=v,P.height=R,P.getContext("2d").putImageData(new ImageData(C,v,R),0,0),w.unmap(),this.snapshotCallback(P.toDataURL("image/png"))}catch{this.snapshotCallback("")}this.snapshotCallback=void 0,this.snapshotDestWidth=void 0}}destroy(){this.stopRenderLoop(),this.postReferenceWorker({type:"dispose"}),this.referenceWorker?.terminate(),this.referenceWorker=void 0,this.rawTexture?.destroy?.(),this.rawBrushTexture?.destroy?.(),this.resolvedTexture?.destroy?.(),this.frozenTexture?.destroy?.(),this.mandelbrotReferenceBuffer?.destroy?.(),this.mandelbrotBlaBuffer?.destroy?.(),this.mandelbrotBlaLevelBuffer?.destroy?.(),this.uniformBufferMandelbrot?.destroy?.(),this.uniformBufferColor?.destroy?.(),this.uniformBufferBrush?.destroy?.(),this.uniformBufferResolve?.destroy?.(),this.counterBuffer?.destroy?.();for(const e of this.counterReadbackSlots)e.buffer.destroy?.();this.counterReadbackSlots=[],this.uniformBufferCount?.destroy?.(),this.uniformBufferMerge?.destroy?.(),this.webcamTexture?.closeWebcam(),this.webcamTileTexture?.destroy?.(),this.paletteTexture?.destroy?.()}needsMoreFrames(){let e="";return this.needRender?e="needRender":this.snapshotCallback?e="snapshot":X(this.zoomState)?e="zoomActive":this.clearHistoryNextFrame?e="clearHistory":this.needFreezeSnapshot?e="freezeSnapshot":this.needMergeSnapshot?e="mergeSnapshot":this.isReferenceValidating?e="referenceValidating":this.orbitIncomplete?e="orbitIncomplete":this.unfinishedPixelCount<0||this.unfinishedPixelCount>Lt?e=`unfinished=${this.unfinishedPixelCount}`:this.aaActive?e="aaAccumulating":this.aaAuto&&!this.aaActive&&this.aaAccumulatedSamples===0&&this.unfinishedPixelCount===0&&this.activePixelCount===0&&!this.orbitIncomplete&&!X(this.zoomState)&&(e="aaAutoPending"),e!==""}getIterationBatchSize(){return this.iterationBatchSize}startRenderLoop(e){this._drawFn=e,this._rafId===null&&(this._rafId=requestAnimationFrame(async()=>this._loop()))}stopRenderLoop(){this._rafId!==null&&(cancelAnimationFrame(this._rafId),this._rafId=null),this._drawFn=null}async _loop(){if(!this._drawFn){this._rafId=null;return}const e=performance.now(),n=Math.min(this.smoothedGpuTimeMs,500);if(e-this._lastDrawMs>=n){this._lastDrawMs=e;const r=this.needsMoreFrames();this.isRendering=r,await this._drawFn(),r&&this._fpsFrameCount++;const i=performance.now();this._fpsLastTime===0&&(this._fpsLastTime=i);const a=i-this._fpsLastTime;a>=1e3&&(this.fps=Math.round(this._fpsFrameCount*1e3/a),this._fpsFrameCount=0,this._fpsLastTime=i)}this._rafId=requestAnimationFrame(async()=>this._loop())}async updateTileTexture(e,n=e){if(this.tileTextureSourceKey===n)return;const r=await this._loadTexture(e);this.tileTexture?.destroy?.(),this.tileTexture=r,this.tileTextureView=this.tileTexture.createView(),this.tileTextureSourceKey=n,this.rebuildColorBindGroup(),this.needRender=!0}isTileTextureSourceCurrent(e){return this.tileTextureSourceKey===e}async updateSkyboxTexture(e,n=e){if(this.skyboxTextureSourceKey===n)return;const r=await this._loadTexture(e);this.skyboxTexture?.destroy?.(),this.skyboxTexture=r,this.skyboxTextureView=this.skyboxTexture.createView(),this.skyboxTextureSourceKey=n,this.rebuildColorBindGroup(),this.needRender=!0}isSkyboxTextureSourceCurrent(e){return this.skyboxTextureSourceKey===e}rebuildColorBindGroup(){if(this.pipelineColor&&this.resolvedArrayView&&this.frozenArrayView){const e=this.pipelineColor.getBindGroupLayout(0),n=r=>[{binding:0,resource:{buffer:this.uniformBufferColor}},{binding:1,resource:r},{binding:2,resource:this.tileTextureView},{binding:3,resource:this.skyboxTextureView},{binding:4,resource:this.webcamTextureView},{binding:5,resource:this.paletteTextureView},{binding:6,resource:this.frozenArrayView},{binding:7,resource:this.paletteSampler},{binding:8,resource:this.skyboxSampler},{binding:9,resource:this.aaTargetTextureView}];this.bindGroupColor=this.device.createBindGroup({layout:e,entries:n(this.resolvedArrayView),label:"Engine BindGroup Color"}),this.bindGroupColorRaw=this.rawArrayView?this.device.createBindGroup({layout:e,entries:n(this.rawArrayView),label:"Engine BindGroup Color (raw)"}):void 0}}async _loadTexture(e){const n=new Image;n.src=e;try{await n.decode()}catch(a){throw console.warn("\xc9chec du chargement de la texture : "+e,a),a}const r=await createImageBitmap(n,{premultiplyAlpha:"none"}),i=this.device.createTexture({size:[r.width,r.height,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT,label:"Engine LoadedTexture "+e});return this.device.queue.copyExternalImageToTexture({source:r},{texture:i},[r.width,r.height]),i}static ITER_PIXEL_LAYERS=[0,2,3,4,5];async readIterationDataAt(e,n,r,i){if(!this.resolvedTexture||!this.device)return null;const a=this.resolveSkipped&&this.rawTexture?this.rawTexture:this.resolvedTexture,o=this.width/Math.max(1,this.height),s=this.previousMandelbrot?.angle??0,l=e/Math.max(1,r),b=1-n/Math.max(1,i),h=l*2-1,S=b*2-1,z=h*o,x=S,f=Math.sin(s),m=Math.cos(s),L=m*z-f*x,N=f*z+m*x,p=Math.sqrt(o*o+1),V=L/p,ee=N/p,D=V*.5+.5,_=ee*.5+.5,g=this.neutralSize,M=Math.floor(Math.max(0,Math.min(g-1,D*g))),k=Math.floor(Math.max(0,Math.min(g-1,(1-_)*g))),U=en.ITER_PIXEL_LAYERS,Y=1,O=4,q=(u=>u+255&-256)(Y*O),ae=q*U.length,Z=this.device.createBuffer({size:ae,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ,label:"Engine IterPixel Readback"}),$=this.device.createCommandEncoder();for(let u=0;u<U.length;u++)$.copyTextureToBuffer({texture:a,origin:{x:M,y:k,z:U[u]}},{buffer:Z,offset:q*u,bytesPerRow:q},{width:1,height:1,depthOrArrayLayers:1});this.device.queue.submit([$.finish()]),await Z.mapAsync(GPUMapMode.READ);const ne=new Float32Array(Z.getMappedRange()),K=q/O,v=ne[0*K],R=ne[1*K],B=ne[2*K],A=ne[3*K],G=ne[4*K];return Z.unmap(),Z.destroy(),v<0?null:{iter:v,zx:R,zy:B,derX:A,derY:G}}async updateWebcamTexture(){try{await this.webcamTexture?.openWebcam(),this.webcamTexture?.isOpen()&&await this.webcamTexture?.drawWebGPUTexture(this.webcamTileTexture,this.device)}catch(e){console.warn("Webcam texture update failed:",e)}}async getSnapshotPng(e=256){return await new Promise(n=>{this.snapshotCallback=n,this.snapshotDestWidth=e,this.needRender=!0})}}let es,ts,rs,is,as,os,ss,st,In,ls,cs,ds;es={class:"mandelbrot-canvas-wrap"};ts={key:0,class:"debug-legend","aria-hidden":"true"};ns=Yt({__name:"Mandelbrot",props:He({mu:{default:4},epsilon:{default:1e-9},colorStops:{default:()=>[{color:"#002500",position:0},{color:"#175b3d",position:.16},{color:"#ffceb6",position:.26},{color:"#edffff",position:.42},{color:"#ff8fbc",position:.7016397849462366},{color:"#a6003e",position:.8575},{color:"#100000",position:1}]},palettePeriod:{default:100},paletteOffset:{default:0},heightPaletteShift:{default:0},paletteMirror:{type:Boolean,default:!1},antialiasLevel:{default:1},aaAuto:{type:Boolean,default:!1},activateAnimate:{type:Boolean,default:!1},debugShading:{type:Boolean,default:!1},dprMultiplier:{default:1},maxIterationMultiplier:{default:.1},targetFps:{default:60},gpuLoadMultiplier:{default:1},zoomMinBrushStep:{default:1},sentinelSeedStep:{default:64},interpolationMode:{default:"lab"},tessellationLevel:{default:0},displacementAmount:{default:0},animation:{default:()=>ut(null,1)},animationSpeed:{default:1},ambientOcclusionStrength:{default:0},microBumpStrength:{default:0},subsurfaceStrength:{default:0},reliefDepth:{default:1},localShadowStrength:{default:0},lightAngle:{default:0},varnishStrength:{default:0},orbitTrapStrength:{default:0},phaseColoringStrength:{default:0},stripeFrequency:{default:8},textureMapping:{default:()=>It({textureMappingMode:0})},textureMappingMode:{}},{cx:{default:"-1.9771995110313272619112808106831597"},cxModifiers:{},cy:{default:"0.0"},cyModifiers:{},scale:{default:"2.5"},scaleModifiers:{},angle:{default:0},angleModifiers:{}}),emits:He(["ready"],["update:cx","update:cy","update:scale","update:angle"]),setup(t,{expose:e,emit:n}){const r=Te(null);let i=null,a=null,o,s=!1,l="";const b=Te(null),h=Te(null),S=Te(!1);function z(_){if(typeof _!="string")return!1;const g=_.trim();return g?/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)(?:[eE][+-]?\d+)?$/.test(g):!1}const x=n,f=de(t,"cx"),m=de(t,"cy"),L=de(t,"scale"),N=de(t,"angle");Fe(()=>[f.value,m.value,L.value,N.value],([_,g,M,k],[U,Y,O,te])=>{(_!==U||g!==Y)&&console.log("[REF] Mandelbrot.vue watcher cx change",String(_).slice(0,14),"isUpdating",s),!s&&o&&(!_||!g||!M||((_!==U||g!==Y)&&z(_)&&z(g)&&(o.cancel_transition(),o.origin(_,g),a?.resetReference(_,g)),M!==O&&(console.log("[REF] watcher scale change",String(M).slice(0,14),"type",typeof M,"valid",z(M)),z(M)&&o.scale(M)),k!==te&&o.angle(Number(k))))},{flush:"sync"});const p=t;Fe(()=>p.dprMultiplier,_=>{a&&(a.dprMultiplier=_,D())}),Fe(()=>p.targetFps,_=>{a&&(a.targetFps=_)}),Fe(()=>p.gpuLoadMultiplier,_=>{a&&(a.gpuLoadMultiplier=_)});async function V(){if(!a||!o)return;const _=r.value,g=o.step(_?_.width:void 0,_?_.height:void 0);if(!g)return;const[M,k]=g,[U,Y,O,te]=o.get_params();O!==l&&(l=O,console.log("[REF] draw scale",O,"dx",String(M).slice(0,12),"cx",String(U).slice(0,14))),s=!0,f.value=U,m.value=Y,L.value=O,N.value=parseFloat(te),await hr(),s=!1;const q=Math.max(p.mu,4),ae=Math.max(0,Math.ceil(Math.log2(Math.log(q)/Math.log(4)))),Z=Math.min(Math.max(100,1e3*p.maxIterationMultiplier*Math.log2(1/parseFloat(O)))+ae,1e7);if(await a.update({cx:U,cy:Y,dx:parseFloat(M),dy:parseFloat(k),dxStr:M,dyStr:k,mu:p.mu,scale:parseFloat(O),scaleStr:O,angle:parseFloat(te),maxIterations:Z,epsilon:p.epsilon},{antialiasLevel:p.antialiasLevel,aaAuto:p.aaAuto,palettePeriod:p.palettePeriod,paletteOffset:p.paletteOffset,heightPaletteShift:p.heightPaletteShift,paletteMirror:p.paletteMirror,colorStops:gr(p.colorStops),interpolationMode:p.interpolationMode,activateAnimate:p.activateAnimate,debugShading:p.debugShading,tessellationLevel:p.tessellationLevel,displacementAmount:p.displacementAmount,animation:ut(p.animation,p.animationSpeed),animationSpeed:p.animationSpeed,ambientOcclusionStrength:p.ambientOcclusionStrength,microBumpStrength:p.microBumpStrength,subsurfaceStrength:p.subsurfaceStrength,reliefDepth:p.reliefDepth,localShadowStrength:p.localShadowStrength,lightAngle:p.lightAngle,varnishStrength:p.varnishStrength,orbitTrapStrength:p.orbitTrapStrength,phaseColoringStrength:p.phaseColoringStrength,stripeFrequency:p.stripeFrequency,zoomMinBrushStep:p.zoomMinBrushStep,sentinelSeedStep:p.sentinelSeedStep,textureMapping:It(p),textureMappingMode:p.textureMappingMode}),await a.render(),p.debugShading&&o&&r.value){const $=o.get_reference_params();if($&&$.length>=2){const[ne,K]=$,v=r.value.width,R=r.value.height,B=o.coordinate_to_pixel(ne,K,v,R);if(B&&B.length===2){const A=B[0]*(r.value.clientWidth/v),G=B[1]*(r.value.clientHeight/R);b.value=A,h.value=G,S.value=A>=0&&A<=r.value.clientWidth&&G>=0&&G<=r.value.clientHeight}else S.value=!1}else S.value=!1}else S.value=!1}Fe(()=>p.debugShading,_=>{_&&a&&!a.isRendering&&V()});async function ee(){if(!r.value)return;i=r.value;let _=f.value,g=m.value,M=L.value;return z(_)||(_="-0.7",f.value=_),z(g)||(g="0.0",m.value=g),z(M)||(M="2.5",L.value=M),o=new Gt(_,g,M,Number(N.value)),o.origin(_,g),o.scale(M),o.angle(Number(N.value)),a=new en(i,{antialiasLevel:p.antialiasLevel,aaAuto:p.aaAuto,palettePeriod:p.palettePeriod,paletteOffset:p.paletteOffset,heightPaletteShift:p.heightPaletteShift,paletteMirror:p.paletteMirror,colorStops:p.colorStops,interpolationMode:p.interpolationMode,activateAnimate:p.activateAnimate,debugShading:p.debugShading,tessellationLevel:p.tessellationLevel,displacementAmount:p.displacementAmount,animation:ut(p.animation,p.animationSpeed),animationSpeed:p.animationSpeed,ambientOcclusionStrength:p.ambientOcclusionStrength,microBumpStrength:p.microBumpStrength,subsurfaceStrength:p.subsurfaceStrength,reliefDepth:p.reliefDepth,localShadowStrength:p.localShadowStrength,lightAngle:p.lightAngle,varnishStrength:p.varnishStrength,orbitTrapStrength:p.orbitTrapStrength,phaseColoringStrength:p.phaseColoringStrength,stripeFrequency:p.stripeFrequency,zoomMinBrushStep:p.zoomMinBrushStep,sentinelSeedStep:p.sentinelSeedStep,textureMapping:It(p),textureMappingMode:p.textureMappingMode}),a.dprMultiplier=p.dprMultiplier??1,a.targetFps=p.targetFps??60,a.gpuLoadMultiplier=p.gpuLoadMultiplier??1,a.initialize(o)}async function D(){if(!r.value||!a)return;const _=r.value.getBoundingClientRect();r.value.width=_.width,r.value.height=_.height,a.resize()}return Ln(async()=>{await ee(),window.addEventListener("resize",D),await D(),a&&(x("ready",a),a.startRenderLoop(V))}),Pn(()=>{a?.destroy(),a=null,window.removeEventListener("resize",D)}),e({getCanvas:()=>r.value,getEngine:()=>a,getNavigator:()=>o,translate:(_,g)=>o?.translate(_,g),translateDirect:(_,g)=>{if(!o)return;const M=r.value;o.translate_direct(_,g,M?M.width:void 0,M?M.height:void 0)},rotate:_=>o?.rotate(_),angle:_=>o?.angle(_),zoom:_=>{console.log("[REF] zoom() called factor",_),o?.zoom(_)},resetReferenceTo:(_,g,M,k)=>{console.log("[REF] resetReferenceTo (travel done)",_.slice(0,14),"scale",M,"engine?",!!a,"nav?",!!o),!(!o||!a)&&(o.cancel_transition(),o.origin(_,g),o.scale(M),o.angle(k),a.resetReference(_,g))},step:()=>{if(!o)return;const _=r.value;return o.step(_?_.width:void 0,_?_.height:void 0)},getParams:()=>o?.get_params(),drawOnce:async()=>V(),resize:async()=>D(),initialize:async()=>ee(),useBla:()=>a?.setApproximationMode("bla"),usePerturbation:()=>a?.setApproximationMode("perturbation"),setApproximationMode:_=>a?.setApproximationMode(_),getApproximationMode:()=>a?.getApproximationMode(),setBlaEpsilon:_=>a?.setBlaEpsilon(_)}),(_,g)=>(ke(),Be("div",es,[E("canvas",{ref_key:"canvasRef",ref:r},null,512),p.debugShading?(ke(),Be("div",ts,[...g[0]||(g[0]=[E("div",{class:"debug-legend-item debug-legend-top-left"},"Distance au bord",-1),E("div",{class:"debug-legend-item debug-legend-top-right"},"Palette / phase continue",-1),E("div",{class:"debug-legend-item debug-legend-bottom-left"},"Gradient du relief",-1),E("div",{class:"debug-legend-item debug-legend-bottom-right"},"Angle de la d\xe9riv\xe9e",-1)])])):Dt("",!0),p.debugShading&&S.value&&b.value!==null&&h.value!==null?(ke(),Be("div",{key:1,class:"debug-ref-marker",style:pr({left:b.value+"px",top:h.value+"px"})},[...g[1]||(g[1]=[E("div",{class:"debug-ref-crosshair"},null,-1),E("div",{class:"debug-ref-label"},"R\xe9f",-1)])],4)):Dt("",!0)]))}});rs={class:"mobile-nav-controls"};is={key:0,class:"directional-controls"};as=Yt({__name:"MobileNavigationControls",props:He({mandelbrotRef:{}},{expanded:{type:Boolean,default:!1},expandedModifiers:{}}),emits:["update:expanded"],setup(t){const e=t,n=de(t,"expanded"),r=Te(null);let i=null;const a=()=>{n.value=!n.value,n.value||s()},o=x=>{x.preventDefault(),x.stopPropagation(),a()},s=()=>{r.value=null,i!==null&&(clearInterval(i),i=null)},l=x=>{r.value=x;const f=.01,m=()=>{if(e.mandelbrotRef)switch(x){case"north":e.mandelbrotRef.translate(0,f);break;case"south":e.mandelbrotRef.translate(0,-f);break;case"west":e.mandelbrotRef.translate(-f,0);break;case"east":e.mandelbrotRef.translate(f,0);break}};m(),i=window.setInterval(m,16)},b=x=>{r.value=`rotate-${x}`;const f=.025,m=()=>{e.mandelbrotRef&&(x==="left"?e.mandelbrotRef.rotate(f):e.mandelbrotRef.rotate(-f))};m(),i=window.setInterval(m,16)},h=x=>{r.value=`zoom-${x}`;const f=.97,m=()=>{e.mandelbrotRef&&(x==="in"?e.mandelbrotRef.zoom(f):e.mandelbrotRef.zoom(1/f))};m(),i=window.setInterval(m,16)},S=(x,f)=>{x.preventDefault(),f()},z=x=>{x.preventDefault(),s()};return(x,f)=>(ke(),Be("div",rs,[E("button",{class:"nav-button compass-button",onClick:a,onTouchend:o,"aria-label":"Toggle navigation"},[...f[16]||(f[16]=[E("i",{class:"fa-solid fa-compass fa-2x nav-icon"},null,-1)])],32),Ot(_r,{name:"fade"},{default:mr(()=>[n.value?(ke(),Be("div",is,[E("button",{class:"nav-button direction-button north",onTouchstart:f[0]||(f[0]=m=>S(m,()=>l("north"))),onTouchend:z,onMousedown:f[1]||(f[1]=m=>l("north")),onMouseup:s,onMouseleave:s,"aria-label":"Move North"},[...f[17]||(f[17]=[E("i",{class:"fa-solid fa-arrow-up fa-3x nav-icon"},null,-1)])],32),E("button",{class:"nav-button direction-button south",onTouchstart:f[2]||(f[2]=m=>S(m,()=>l("south"))),onTouchend:z,onMousedown:f[3]||(f[3]=m=>l("south")),onMouseup:s,onMouseleave:s,"aria-label":"Move South"},[...f[18]||(f[18]=[E("i",{class:"fa-solid fa-arrow-down fa-3x nav-icon"},null,-1)])],32),E("button",{class:"nav-button direction-button west",onTouchstart:f[4]||(f[4]=m=>S(m,()=>l("west"))),onTouchend:z,onMousedown:f[5]||(f[5]=m=>l("west")),onMouseup:s,onMouseleave:s,"aria-label":"Move West"},[...f[19]||(f[19]=[E("i",{class:"fa-solid fa-arrow-left fa-3x nav-icon"},null,-1)])],32),E("button",{class:"nav-button direction-button east",onTouchstart:f[6]||(f[6]=m=>S(m,()=>l("east"))),onTouchend:z,onMousedown:f[7]||(f[7]=m=>l("east")),onMouseup:s,onMouseleave:s,"aria-label":"Move East"},[...f[20]||(f[20]=[E("i",{class:"fa-solid fa-arrow-right fa-3x nav-icon"},null,-1)])],32),E("button",{class:"nav-button corner-button rotate-left",onTouchstart:f[8]||(f[8]=m=>S(m,()=>b("left"))),onTouchend:z,onMousedown:f[9]||(f[9]=m=>b("left")),onMouseup:s,onMouseleave:s,"aria-label":"Rotate Left"},[...f[21]||(f[21]=[E("i",{class:"fa-solid fa-rotate-left fa-2x nav-icon"},null,-1)])],32),E("button",{class:"nav-button corner-button rotate-right",onTouchstart:f[10]||(f[10]=m=>S(m,()=>b("right"))),onTouchend:z,onMousedown:f[11]||(f[11]=m=>b("right")),onMouseup:s,onMouseleave:s,"aria-label":"Rotate Right"},[...f[22]||(f[22]=[E("i",{class:"fa-solid fa-rotate-right fa-2x nav-icon"},null,-1)])],32),E("button",{class:"nav-button corner-button zoom-out",onTouchstart:f[12]||(f[12]=m=>S(m,()=>h("out"))),onTouchend:z,onMousedown:f[13]||(f[13]=m=>h("out")),onMouseup:s,onMouseleave:s,"aria-label":"Zoom Out"},[...f[23]||(f[23]=[E("svg",{class:"nav-icon",viewBox:"0 0 24 24",width:"28",height:"28",fill:"none",stroke:"currentColor","stroke-width":"2.4","stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":"true"},[E("circle",{cx:"11",cy:"11",r:"7"}),E("path",{d:"M21 21l-5-5M8 11h6"})],-1)])],32),E("button",{class:"nav-button corner-button zoom-in",onTouchstart:f[14]||(f[14]=m=>S(m,()=>h("in"))),onTouchend:z,onMousedown:f[15]||(f[15]=m=>h("in")),onMouseup:s,onMouseleave:s,"aria-label":"Zoom In"},[...f[24]||(f[24]=[E("svg",{class:"nav-icon",viewBox:"0 0 24 24",width:"28",height:"28",fill:"none",stroke:"currentColor","stroke-width":"2.4","stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":"true"},[E("circle",{cx:"11",cy:"11",r:"7"}),E("path",{d:"M21 21l-5-5M8 11h6M11 8v6"})],-1)])],32)])):Dt("",!0)]),_:1})]))}});os=Dn(as,[["__scopeId","data-v-842a47c9"]]);ss={style:{position:"relative",width:"100%",height:"100%"}};st=.01;In=.025;ls=300;cs=30;ds=Yt({__name:"MandelbrotController",props:He({mu:{},epsilon:{},colorStops:{},antialiasLevel:{},aaAuto:{type:Boolean},palettePeriod:{},paletteOffset:{},heightPaletteShift:{},paletteMirror:{type:Boolean},activateAnimate:{type:Boolean},debugShading:{type:Boolean},dprMultiplier:{},maxIterationMultiplier:{},targetFps:{},gpuLoadMultiplier:{},zoomMinBrushStep:{},sentinelSeedStep:{},interpolationMode:{},pickerMode:{type:Boolean},uiHidden:{type:Boolean},tessellationLevel:{},displacementAmount:{},animation:{},animationSpeed:{},ambientOcclusionStrength:{},microBumpStrength:{},subsurfaceStrength:{},reliefDepth:{},localShadowStrength:{},lightAngle:{},varnishStrength:{},orbitTrapStrength:{},phaseColoringStrength:{},stripeFrequency:{},textureMapping:{},textureMappingMode:{}},{cx:{},cxModifiers:{},cy:{},cyModifiers:{},scale:{},scaleModifiers:{},angle:{},angleModifiers:{},mobileNavExpanded:{type:Boolean,default:!1},mobileNavExpandedModifiers:{}}),emits:He(["palettePick","pickerDone","engineReady","requestShowUi"],["update:cx","update:cy","update:scale","update:angle","update:mobileNavExpanded"]),setup(t,{expose:e,emit:n}){const r=de(t,"cx"),i=de(t,"cy"),a=de(t,"scale"),o=de(t,"angle"),s=de(t,"mobileNavExpanded"),l=t,b=n,h=Te(null),S={};e({getCanvas:k,getEngine:()=>h.value?.getEngine()??null,getNavigator:()=>h.value?.getNavigator()??null,resetReferenceTo:(u,y,w,T)=>{h.value?.resetReferenceTo?.(u,y,w,T)}});let z=!1,x=!1,f=0,m=0,L=0,N=0,p=0,V=!1,ee=0,D=null,_=0,g=0,M=0;function k(){return h.value?.getCanvas()??null}function U(u){const y=k();if(!y)return{x:0,y:0,width:0,height:0};const w=y.getBoundingClientRect();return{x:u.clientX-w.left,y:u.clientY-w.top,width:w.width,height:w.height}}function Y(u){const y=u.target?.tagName?.toLowerCase();y==="input"||y==="textarea"||y==="select"||u.target?.isContentEditable||(S[u.code]=!0)}function O(u){S[u.code]=!1}function te(u){if(l.pickerMode){u.preventDefault();return}u.preventDefault();const y=.95;u.deltaY<0?h.value?.zoom(y):h.value?.zoom(1/y)}function q(u,y){const w=k();if(!w)return;const T=w.getBoundingClientRect(),C=u-T.left,F=y-T.top,P=T.width,I=T.height,H=P/I,J=(C-P/2)/P*2,re=(F-I/2)/I*2;h.value?.translateDirect(J*H,-re)}function ae(u){if(l.pickerMode){u.preventDefault();return}if(u.preventDefault(),l.uiHidden){b("requestShowUi");return}q(u.clientX,u.clientY)}function Z(u){if(l.pickerMode||u.touches.length!==0)return;const y=Date.now(),w=u.changedTouches[0];if(!w)return;const T=w.clientX,C=w.clientY;if(y-_<ls&&Math.hypot(T-g,C-M)<cs){if(u.preventDefault(),_=0,l.uiHidden){b("requestShowUi");return}q(T,C)}else _=y,g=T,M=C}function $(u){if(l.pickerMode){u.preventDefault(),ne(u);return}if(u.button===2)x=!0;else{z=!0;const y=U(u);f=y.x,m=y.y}}async function ne(u){try{const y=h.value?.getEngine();if(!y)return;const w=k();if(!w)return;const T=w.getBoundingClientRect(),C=u.clientX-T.left,F=u.clientY-T.top,P=await y.readIterationDataAt(C,F,T.width,T.height);if(!P)return;b("palettePick",P,u.clientX,u.clientY)}finally{b("pickerDone")}}function K(u){if(l.pickerMode)return;const y=U(u);if(x){const I=k();if(!I)return;const H=I.getBoundingClientRect(),J=H.width/2,re=H.height/2,gt=y.x,_t=y.y,le=Math.atan2(_t-re,gt-J);h.value?.angle(le);return}if(!z)return;const w=y.width,T=y.height,C=w/T,F=(y.x-f)/w*2,P=(y.y-m)/T*2;h.value?.translateDirect(-F*C,P),f=y.x,m=y.y}function v(u){l.pickerMode||(u.button===2?x=!1:z=!1)}function R(u){if(l.pickerMode)return;const y=k();if(y){if(u.touches.length===1){z=!0;const w=u.touches[0],T=y.getBoundingClientRect();f=w.clientX-T.left,m=w.clientY-T.top}else if(u.touches.length===2){z=!1,V=!0;const[w,T]=u.touches;L=Math.hypot(T.clientX-w.clientX,T.clientY-w.clientY),ee=L,N=Math.atan2(T.clientY-w.clientY,T.clientX-w.clientX);const C=h.value?.getParams();p=C?parseFloat(C[3]):0}}}function B(u){if(l.pickerMode)return;const y=k();if(y){if(z&&u.touches.length===1){const w=u.touches[0],T=y.getBoundingClientRect(),C=w.clientX-T.left,F=w.clientY-T.top,P=T.width,I=T.height,H=P/I,J=(C-f)/P*2,re=(F-m)/I*2;h.value?.translateDirect(-J*H,re),f=C,m=F}else if(V&&u.touches.length===2){const[w,T]=u.touches,C=Math.hypot(T.clientX-w.clientX,T.clientY-w.clientY),F=Math.atan2(T.clientY-w.clientY,T.clientX-w.clientX),P=ee/C;ee=C,h.value?.zoom(P);const I=F-N;h.value?.angle(p+I)}}}function A(u){u.touches.length===0&&(z=!1,V=!1)}function G(){if(!l.pickerMode){S.KeyW&&h.value?.translate(0,st),S.KeyS&&h.value?.translate(0,-st),S.KeyA&&h.value?.translate(-st,0),S.KeyD&&h.value?.translate(st,0),S.KeyQ&&h.value?.rotate(In),S.KeyE&&h.value?.rotate(-In);const u=.97;S.KeyR&&h.value?.zoom(u),S.KeyF&&h.value?.zoom(1/u)}D=window.setTimeout(G,16)}return Ln(async()=>{const u=k();u&&(window.addEventListener("keydown",Y),window.addEventListener("keyup",O),u.addEventListener("wheel",te,{passive:!1}),u.addEventListener("mousedown",$),u.addEventListener("dblclick",ae),u.addEventListener("contextmenu",y=>y.preventDefault()),window.addEventListener("mousemove",K),window.addEventListener("mouseup",v),u.addEventListener("touchstart",R,{passive:!1}),u.addEventListener("touchmove",B,{passive:!1}),u.addEventListener("touchend",A,{passive:!1}),u.addEventListener("touchend",Z,{passive:!1}),G())}),Pn(()=>{D!==null&&clearTimeout(D);const u=k();window.removeEventListener("keydown",Y),window.removeEventListener("keyup",O),window.removeEventListener("mousemove",K),window.removeEventListener("mouseup",v),u&&(u.removeEventListener("wheel",te),u.removeEventListener("mousedown",$),u.removeEventListener("dblclick",ae),u.removeEventListener("contextmenu",y=>y.preventDefault()),u.removeEventListener("touchstart",R),u.removeEventListener("touchmove",B),u.removeEventListener("touchend",A),u.removeEventListener("touchend",Z))}),(u,y)=>(ke(),Be("div",ss,[Ot(ns,{ref_key:"mandelbrotRef",ref:h,scale:a.value,"onUpdate:scale":y[0]||(y[0]=w=>a.value=w),angle:o.value,"onUpdate:angle":y[1]||(y[1]=w=>o.value=w),cx:r.value,"onUpdate:cx":y[2]||(y[2]=w=>r.value=w),cy:i.value,"onUpdate:cy":y[3]||(y[3]=w=>i.value=w),mu:l.mu,epsilon:l.epsilon,antialiasLevel:l.antialiasLevel,aaAuto:l.aaAuto,palettePeriod:l.palettePeriod,heightPaletteShift:l.heightPaletteShift,paletteMirror:l.paletteMirror,colorStops:l.colorStops,activateAnimate:l.activateAnimate,debugShading:l.debugShading,paletteOffset:l.paletteOffset,dprMultiplier:l.dprMultiplier,maxIterationMultiplier:l.maxIterationMultiplier,targetFps:l.targetFps,gpuLoadMultiplier:l.gpuLoadMultiplier,zoomMinBrushStep:l.zoomMinBrushStep,sentinelSeedStep:l.sentinelSeedStep,interpolationMode:l.interpolationMode,tessellationLevel:l.tessellationLevel,displacementAmount:l.displacementAmount,animation:l.animation,animationSpeed:l.animationSpeed,ambientOcclusionStrength:l.ambientOcclusionStrength,microBumpStrength:l.microBumpStrength,subsurfaceStrength:l.subsurfaceStrength,reliefDepth:l.reliefDepth,localShadowStrength:l.localShadowStrength,lightAngle:l.lightAngle,varnishStrength:l.varnishStrength,orbitTrapStrength:l.orbitTrapStrength,phaseColoringStrength:l.phaseColoringStrength,stripeFrequency:l.stripeFrequency,textureMapping:l.textureMapping,textureMappingMode:l.textureMappingMode,onReady:y[4]||(y[4]=w=>b("engineReady",w))},null,8,["scale","angle","cx","cy","mu","epsilon","antialiasLevel","aaAuto","palettePeriod","heightPaletteShift","paletteMirror","colorStops","activateAnimate","debugShading","paletteOffset","dprMultiplier","maxIterationMultiplier","targetFps","gpuLoadMultiplier","zoomMinBrushStep","sentinelSeedStep","interpolationMode","tessellationLevel","displacementAmount","animation","animationSpeed","ambientOcclusionStrength","microBumpStrength","subsurfaceStrength","reliefDepth","localShadowStrength","lightAngle","varnishStrength","orbitTrapStrength","phaseColoringStrength","stripeFrequency","textureMapping","textureMappingMode"]),vr(Ot(os,{"mandelbrot-ref":h.value,expanded:s.value,"onUpdate:expanded":y[5]||(y[5]=w=>s.value=w)},null,8,["mandelbrot-ref","expanded"]),[[br,!l.uiHidden]])]))}});ps=Dn(ds,[["__scopeId","data-v-300050b7"]])})();export{ps as M,ns as _,__tla};