import{aq as jn,d as kt,ar as ie,z as Xe,p as vn,s as bn,o as Le,c as Pe,j as I,e as xn,as as Oe,y as Lt,U as Kn,at as Jn,n as le,J as zt,T as Qn,w as er,a as tr,a2 as nr,_ as yn}from"./framework.HRO6m9zK.js";let ro,Xa;let __tla=(async()=>{const rr=`// Mandelbrot progressive-iteration shader.
//
...
`,ar=`// Brush pass: updates sentinel levels in the neutral square texture.
//
...
`,or=`// Resolve pass: replaces remaining sentinels with a snapped parent pixel.
//
// Uses a texture_2d_array<f32> with 8 r32float layers.
//
// Layer layout:
...
`,lr=`// Merge pass: fuses the resolved (live) and frozen textures into a new frozen
...
`,cr=async(t={},e)=>{let n;if(e.startsWith("data:")){const r=e.replace(/^data:.*?base64,/,"");let i;if(typeof Buffer=="function"&&typeof Buffer.from=="function")i=Buffer.from(r,"base64");else if(typeof atob=="function"){const a=atob(r);i=new Uint8Array(a.length);for(let o=0;o<a.length;o++)i[o]=a.charCodeAt(o)}else throw new Error("Cannot decode base64-encoded data URL");n=await WebAssembly.instantiate(i,t)}else{const r=await fetch(e),i=r.headers.get("Content-Type")||"";if("instantiateStreaming"in WebAssembly&&i.startsWith("application/wasm"))n=await WebAssembly.instantiateStreaming(r,t);else{const a=await r.arrayBuffer();n=await WebAssembly.instantiate(a,t)}}return n.instance.exports};let p;function ur(t){p=t}let $e=null;function nt(){return($e===null||$e.byteLength===0)&&($e=new Uint8Array(p.memory.buffer)),$e}let rt=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});rt.decode();const fr=0x7ff00000;let dt=0;function dr(t,e){return dt+=e,dt>=fr&&(rt=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),rt.decode(),dt=e),rt.decode(nt().subarray(t,t+e))}function Sn(t,e){return t=t>>>0,dr(t,e)}let Me=null;function pr(){return(Me===null||Me.buffer.detached===!0||Me.buffer.detached===void 0&&Me.buffer!==p.memory.buffer)&&(Me=new DataView(p.memory.buffer)),Me}function Ze(t,e){t=t>>>0;const n=pr(),r=[];for(let i=t;i<t+4*e;i+=4)r.push(p.__wbindgen_export_0.get(n.getUint32(i,!0)));return p.__externref_drop_slice(t,e),r}let re=0;const ke=new TextEncoder;"encodeInto"in ke||(ke.encodeInto=function(t,e){const n=ke.encode(t);return e.set(n),{read:t.length,written:n.length}});function he(t,e,n){if(n===void 0){const s=ke.encode(t),c=e(s.length,1)>>>0;return nt().subarray(c,c+s.length).set(s),re=s.length,c}let r=t.length,i=e(r,1)>>>0;const a=nt();let o=0;for(;o<r;o++){const s=t.charCodeAt(o);if(s>127)break;a[i+o]=s}if(o!==r){o!==0&&(t=t.slice(o)),i=n(i,r,r=o+t.length*3,1)>>>0;const s=nt().subarray(i+o,i+r),c=ke.encodeInto(t,s);o+=c.written,i=n(i,r,o,1)>>>0}return re=o,i}const qt=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>p.__wbg_blabufferinfo_free(t>>>0,1));class Fe{static __wrap(e){e=e>>>0;const n=Object.create(Fe.prototype);return n.__wbg_ptr=e,qt.register(n,n.__wbg_ptr,n),n}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,qt.unregister(this),e}free(){const e=this.__destroy_into_raw();p.__wbg_blabufferinfo_free(e,0)}get ptr(){return p.__wbg_get_blabufferinfo_ptr(this.__wbg_ptr)>>>0}set ptr(e){p.__wbg_set_blabufferinfo_ptr(this.__wbg_ptr,e)}get count(){return p.__wbg_get_blabufferinfo_count(this.__wbg_ptr)>>>0}set count(e){p.__wbg_set_blabufferinfo_count(this.__wbg_ptr,e)}get levels_ptr(){return p.__wbg_get_blabufferinfo_levels_ptr(this.__wbg_ptr)>>>0}set levels_ptr(e){p.__wbg_set_blabufferinfo_levels_ptr(this.__wbg_ptr,e)}get level_count(){return p.__wbg_get_blabufferinfo_level_count(this.__wbg_ptr)>>>0}set level_count(e){p.__wbg_set_blabufferinfo_level_count(this.__wbg_ptr,e)}}Symbol.dispose&&(Fe.prototype[Symbol.dispose]=Fe.prototype.free);typeof FinalizationRegistry>"u"||new FinalizationRegistry(t=>p.__wbg_blalevel_free(t>>>0,1));typeof FinalizationRegistry>"u"||new FinalizationRegistry(t=>p.__wbg_blastep_free(t>>>0,1));const Yt=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>p.__wbg_mandelbrotnavigator_free(t>>>0,1));class Mt{__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,Yt.unregister(this),e}free(){const e=this.__destroy_into_raw();p.__wbg_mandelbrotnavigator_free(e,0)}get_params(){const e=p.mandelbrotnavigator_get_params(this.__wbg_ptr);var n=Ze(e[0],e[1]).slice();return p.__wbindgen_free(e[0],e[1]*4,4),n}rotate_direct(e){p.mandelbrotnavigator_rotate_direct(this.__wbg_ptr,e)}get_bla_epsilon(){return p.mandelbrotnavigator_get_bla_epsilon(this.__wbg_ptr)}set_bla_epsilon(e){p.mandelbrotnavigator_set_bla_epsilon(this.__wbg_ptr,e)}pixel_to_complex(e,n,r,i){const a=p.mandelbrotnavigator_pixel_to_complex(this.__wbg_ptr,e,n,r,i);var o=Ze(a[0],a[1]).slice();return p.__wbindgen_free(a[0],a[1]*4,4),o}reference_origin(e,n){const r=he(e,p.__wbindgen_malloc,p.__wbindgen_realloc),i=re,a=he(n,p.__wbindgen_malloc,p.__wbindgen_realloc),o=re;p.mandelbrotnavigator_reference_origin(this.__wbg_ptr,r,i,a,o)}translate_direct(e,n){p.mandelbrotnavigator_translate_direct(this.__wbg_ptr,e,n)}use_perturbation(){p.mandelbrotnavigator_use_perturbation(this.__wbg_ptr)}get_reference_params(){const e=p.mandelbrotnavigator_get_reference_params(this.__wbg_ptr);var n=Ze(e[0],e[1]).slice();return p.__wbindgen_free(e[0],e[1]*4,4),n}get_approximation_mode(){return p.mandelbrotnavigator_get_approximation_mode(this.__wbg_ptr)}get_reference_orbit_len(){return p.mandelbrotnavigator_get_reference_orbit_len(this.__wbg_ptr)>>>0}compute_bla_reference_ptr(e){const n=p.mandelbrotnavigator_compute_bla_reference_ptr(this.__wbg_ptr,e);return Fe.__wrap(n)}compute_reference_orbit_ptr(e){const n=p.mandelbrotnavigator_compute_reference_orbit_ptr(this.__wbg_ptr,e);return Be.__wrap(n)}get_reference_orbit_capacity(){return p.mandelbrotnavigator_get_reference_orbit_capacity(this.__wbg_ptr)>>>0}compute_reference_orbit_chunk(e,n){const r=p.mandelbrotnavigator_compute_reference_orbit_chunk(this.__wbg_ptr,e,n);return Be.__wrap(r)}constructor(e,n,r,i){const a=he(e,p.__wbindgen_malloc,p.__wbindgen_realloc),o=re,s=he(n,p.__wbindgen_malloc,p.__wbindgen_realloc),c=re,S=he(r,p.__wbindgen_malloc,p.__wbindgen_realloc),h=re,y=p.mandelbrotnavigator_new(a,o,s,c,S,h,i);return this.__wbg_ptr=y>>>0,Yt.register(this,this.__wbg_ptr,this),this}step(){const e=p.mandelbrotnavigator_step(this.__wbg_ptr);var n=Ze(e[0],e[1]).slice();return p.__wbindgen_free(e[0],e[1]*4,4),n}zoom(e){p.mandelbrotnavigator_zoom(this.__wbg_ptr,e)}angle(e){p.mandelbrotnavigator_angle(this.__wbg_ptr,e)}scale(e){const n=he(e,p.__wbindgen_malloc,p.__wbindgen_realloc),r=re;p.mandelbrotnavigator_scale(this.__wbg_ptr,n,r)}origin(e,n){const r=he(e,p.__wbindgen_malloc,p.__wbindgen_realloc),i=re,a=he(n,p.__wbindgen_malloc,p.__wbindgen_realloc),o=re;p.mandelbrotnavigator_origin(this.__wbg_ptr,r,i,a,o)}rotate(e){p.mandelbrotnavigator_rotate(this.__wbg_ptr,e)}use_bla(){p.mandelbrotnavigator_use_bla(this.__wbg_ptr)}translate(e,n){p.mandelbrotnavigator_translate(this.__wbg_ptr,e,n)}}Symbol.dispose&&(Mt.prototype[Symbol.dispose]=Mt.prototype.free);typeof FinalizationRegistry>"u"||new FinalizationRegistry(t=>p.__wbg_mandelbrotstep_free(t>>>0,1));const Xt=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>p.__wbg_orbitbufferinfo_free(t>>>0,1));class Be{static __wrap(e){e=e>>>0;const n=Object.create(Be.prototype);return n.__wbg_ptr=e,Xt.register(n,n.__wbg_ptr,n),n}__destroy_into_raw(){const e=this.__wbg_ptr;return this.__wbg_ptr=0,Xt.unregister(this),e}free(){const e=this.__destroy_into_raw();p.__wbg_orbitbufferinfo_free(e,0)}get ptr(){return p.__wbg_get_blabufferinfo_ptr(this.__wbg_ptr)>>>0}set ptr(e){p.__wbg_set_blabufferinfo_ptr(this.__wbg_ptr,e)}get offset(){return p.__wbg_get_blabufferinfo_count(this.__wbg_ptr)>>>0}set offset(e){p.__wbg_set_blabufferinfo_count(this.__wbg_ptr,e)}get count(){return p.__wbg_get_blabufferinfo_levels_ptr(this.__wbg_ptr)>>>0}set count(e){p.__wbg_set_blabufferinfo_levels_ptr(this.__wbg_ptr,e)}}Symbol.dispose&&(Be.prototype[Symbol.dispose]=Be.prototype.free);function hr(t){return Math.exp(t)}function gr(){return Date.now()}function mr(t,e){throw new Error(Sn(t,e))}function _r(t,e){return Sn(t,e)}function vr(){const t=p.__wbindgen_export_0,e=t.grow(4);t.set(0,void 0),t.set(e+0,void 0),t.set(e+1,null),t.set(e+2,!0),t.set(e+3,!1)}URL=globalThis.URL;const d=await cr({"./mandelbrot_bg.js":{__wbg_now_1e80617bcee43265:gr,__wbg_exp_9293ded1248e1bd3:hr,__wbg_wbindgenthrow_451ec1a8469d7eb6:mr,__wbindgen_init_externref_table:vr,__wbindgen_cast_2241b6af4c4b2941:_r}},jn),br=d.memory,xr=d.__wbg_blabufferinfo_free,yr=d.__wbg_blalevel_free,Sr=d.__wbg_blastep_free,wr=d.__wbg_get_blabufferinfo_count,zr=d.__wbg_get_blabufferinfo_level_count,Mr=d.__wbg_get_blabufferinfo_levels_ptr,Tr=d.__wbg_get_blabufferinfo_ptr,Rr=d.__wbg_get_blastep_ax,Cr=d.__wbg_get_blastep_ay,Br=d.__wbg_get_blastep_bx,Dr=d.__wbg_get_blastep_by,Er=d.__wbg_get_blastep_radius_alpha,Ir=d.__wbg_get_blastep_radius_beta,Ar=d.__wbg_mandelbrotnavigator_free,kr=d.__wbg_mandelbrotstep_free,Lr=d.__wbg_orbitbufferinfo_free,Pr=d.__wbg_set_blabufferinfo_count,Or=d.__wbg_set_blabufferinfo_level_count,Fr=d.__wbg_set_blabufferinfo_levels_ptr,Gr=d.__wbg_set_blabufferinfo_ptr,Nr=d.__wbg_set_blastep_ax,Ur=d.__wbg_set_blastep_ay,Vr=d.__wbg_set_blastep_bx,Hr=d.__wbg_set_blastep_by,Wr=d.__wbg_set_blastep_radius_alpha,qr=d.__wbg_set_blastep_radius_beta,Yr=d.mandelbrotnavigator_angle,Xr=d.mandelbrotnavigator_compute_bla_reference_ptr,$r=d.mandelbrotnavigator_compute_reference_orbit_chunk,Zr=d.mandelbrotnavigator_compute_reference_orbit_ptr,jr=d.mandelbrotnavigator_get_approximation_mode,Kr=d.mandelbrotnavigator_get_bla_epsilon,Jr=d.mandelbrotnavigator_get_params,Qr=d.mandelbrotnavigator_get_reference_orbit_capacity,ei=d.mandelbrotnavigator_get_reference_orbit_len,ti=d.mandelbrotnavigator_get_reference_params,ni=d.mandelbrotnavigator_new,ri=d.mandelbrotnavigator_origin,ii=d.mandelbrotnavigator_pixel_to_complex,ai=d.mandelbrotnavigator_reference_origin,oi=d.mandelbrotnavigator_rotate,si=d.mandelbrotnavigator_rotate_direct,li=d.mandelbrotnavigator_scale,ci=d.mandelbrotnavigator_set_bla_epsilon,ui=d.mandelbrotnavigator_step,fi=d.mandelbrotnavigator_translate,di=d.mandelbrotnavigator_translate_direct,pi=d.mandelbrotnavigator_use_bla,hi=d.mandelbrotnavigator_use_perturbation,gi=d.mandelbrotnavigator_zoom,mi=d.__wbg_set_blalevel__padding,_i=d.__wbg_set_blalevel_count,vi=d.__wbg_set_blalevel_offset,bi=d.__wbg_set_blalevel_skip,xi=d.__wbg_set_mandelbrotstep_dx,yi=d.__wbg_set_mandelbrotstep_dy,Si=d.__wbg_set_mandelbrotstep_zx,wi=d.__wbg_set_mandelbrotstep_zy,zi=d.__wbg_set_orbitbufferinfo_count,Mi=d.__wbg_set_orbitbufferinfo_offset,Ti=d.__wbg_set_orbitbufferinfo_ptr,Ri=d.__wbg_get_blalevel__padding,Ci=d.__wbg_get_blalevel_count,Bi=d.__wbg_get_blalevel_offset,Di=d.__wbg_get_blalevel_skip,Ei=d.__wbg_get_orbitbufferinfo_count,Ii=d.__wbg_get_orbitbufferinfo_offset,Ai=d.__wbg_get_orbitbufferinfo_ptr,ki=d.__wbg_get_mandelbrotstep_dx,Li=d.__wbg_get_mandelbrotstep_dy,Pi=d.__wbg_get_mandelbrotstep_zx,Oi=d.__wbg_get_mandelbrotstep_zy,Fi=d.__wbindgen_export_0,Gi=d.__externref_drop_slice,Ni=d.__wbindgen_free,Ui=d.__wbindgen_malloc,Vi=d.__wbindgen_realloc,wn=d.__wbindgen_start,Hi=Object.freeze(Object.defineProperty({__proto__:null,__externref_drop_slice:Gi,__wbg_blabufferinfo_free:xr,__wbg_blalevel_free:yr,__wbg_blastep_free:Sr,__wbg_get_blabufferinfo_count:wr,__wbg_get_blabufferinfo_level_count:zr,__wbg_get_blabufferinfo_levels_ptr:Mr,__wbg_get_blabufferinfo_ptr:Tr,__wbg_get_blalevel__padding:Ri,__wbg_get_blalevel_count:Ci,__wbg_get_blalevel_offset:Bi,__wbg_get_blalevel_skip:Di,__wbg_get_blastep_ax:Rr,__wbg_get_blastep_ay:Cr,__wbg_get_blastep_bx:Br,__wbg_get_blastep_by:Dr,__wbg_get_blastep_radius_alpha:Er,__wbg_get_blastep_radius_beta:Ir,__wbg_get_mandelbrotstep_dx:ki,__wbg_get_mandelbrotstep_dy:Li,__wbg_get_mandelbrotstep_zx:Pi,__wbg_get_mandelbrotstep_zy:Oi,__wbg_get_orbitbufferinfo_count:Ei,__wbg_get_orbitbufferinfo_offset:Ii,__wbg_get_orbitbufferinfo_ptr:Ai,__wbg_mandelbrotnavigator_free:Ar,__wbg_mandelbrotstep_free:kr,__wbg_orbitbufferinfo_free:Lr,__wbg_set_blabufferinfo_count:Pr,__wbg_set_blabufferinfo_level_count:Or,__wbg_set_blabufferinfo_levels_ptr:Fr,__wbg_set_blabufferinfo_ptr:Gr,__wbg_set_blalevel__padding:mi,__wbg_set_blalevel_count:_i,__wbg_set_blalevel_offset:vi,__wbg_set_blalevel_skip:bi,__wbg_set_blastep_ax:Nr,__wbg_set_blastep_ay:Ur,__wbg_set_blastep_bx:Vr,__wbg_set_blastep_by:Hr,__wbg_set_blastep_radius_alpha:Wr,__wbg_set_blastep_radius_beta:qr,__wbg_set_mandelbrotstep_dx:xi,__wbg_set_mandelbrotstep_dy:yi,__wbg_set_mandelbrotstep_zx:Si,__wbg_set_mandelbrotstep_zy:wi,__wbg_set_orbitbufferinfo_count:zi,__wbg_set_orbitbufferinfo_offset:Mi,__wbg_set_orbitbufferinfo_ptr:Ti,__wbindgen_export_0:Fi,__wbindgen_free:Ni,__wbindgen_malloc:Ui,__wbindgen_realloc:Vi,__wbindgen_start:wn,mandelbrotnavigator_angle:Yr,mandelbrotnavigator_compute_bla_reference_ptr:Xr,mandelbrotnavigator_compute_reference_orbit_chunk:$r,mandelbrotnavigator_compute_reference_orbit_ptr:Zr,mandelbrotnavigator_get_approximation_mode:jr,mandelbrotnavigator_get_bla_epsilon:Kr,mandelbrotnavigator_get_params:Jr,mandelbrotnavigator_get_reference_orbit_capacity:Qr,mandelbrotnavigator_get_reference_orbit_len:ei,mandelbrotnavigator_get_reference_params:ti,mandelbrotnavigator_new:ni,mandelbrotnavigator_origin:ri,mandelbrotnavigator_pixel_to_complex:ii,mandelbrotnavigator_reference_origin:ai,mandelbrotnavigator_rotate:oi,mandelbrotnavigator_rotate_direct:si,mandelbrotnavigator_scale:li,mandelbrotnavigator_set_bla_epsilon:ci,mandelbrotnavigator_step:ui,mandelbrotnavigator_translate:fi,mandelbrotnavigator_translate_direct:di,mandelbrotnavigator_use_bla:pi,mandelbrotnavigator_use_perturbation:hi,mandelbrotnavigator_zoom:gi,memory:br},Symbol.toStringTag,{value:"Module"}));ur(Hi);wn();class Wi{video;stream=null;width;height;lastDrawTime=0;open=!1;constructor(e=1024,n=1024){this.width=e,this.height=n,this.video=document.createElement("video"),this.video.autoplay=!0,this.video.playsInline=!0,this.video.muted=!0,this.video.width=e,this.video.height=n}isOpen(){return this.open}async openWebcam(){if(!this.open)try{this.stream=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:this.width},height:{ideal:this.height}}}),this.video.srcObject=this.stream,await this.video.play(),this.width=this.video.videoWidth||this.width,this.height=this.video.videoHeight||this.height,this.open=!0}catch(e){this.stream=null,this.open=!1,console.warn("Webcam unavailable:",e)}}async drawWebGPUTexture(e,n){if(!this.open)return;const r=performance.now();if(r-this.lastDrawTime>15){if(this.video.readyState<HTMLMediaElement.HAVE_CURRENT_DATA)return;const i=Math.min(this.width,e.width),a=Math.min(this.height,e.height);n.queue.copyExternalImageToTexture({source:this.video},{texture:e},[i,a]),this.lastDrawTime=r}}closeWebcam(){this.stream&&(this.stream.getTracks().forEach(e=>e.stop()),this.stream=null),this.open=!1}}function Ee(t,e,n){t.prototype=e.prototype=n,n.constructor=t}function Ve(t,e){var n=Object.create(t.prototype);for(var r in e)n[r]=e[r];return n}function me(){}var ze=.7,De=1/ze,Re="\\s*([+-]?\\d+)\\s*",Ge="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",ae="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",qi=/^#([0-9a-f]{3,8})$/,Yi=new RegExp(`^rgb\\(${Re},${Re},${Re}\\)$`),Xi=new RegExp(`^rgb\\(${ae},${ae},${ae}\\)$`),$i=new RegExp(`^rgba\\(${Re},${Re},${Re},${Ge}\\)$`),Zi=new RegExp(`^rgba\\(${ae},${ae},${ae},${Ge}\\)$`),ji=new RegExp(`^hsl\\(${Ge},${ae},${ae}\\)$`),Ki=new RegExp(`^hsla\\(${Ge},${ae},${ae},${Ge}\\)$`),$t={aliceblue:0xf0f8ff,antiquewhite:0xfaebd7,aqua:65535,aquamarine:8388564,azure:0xf0ffff,beige:0xf5f5dc,bisque:0xffe4c4,black:0,blanchedalmond:0xffebcd,blue:255,blueviolet:9055202,brown:0xa52a2a,burlywood:0xdeb887,cadetblue:6266528,chartreuse:8388352,chocolate:0xd2691e,coral:0xff7f50,cornflowerblue:6591981,cornsilk:0xfff8dc,crimson:0xdc143c,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:0xb8860b,darkgray:0xa9a9a9,darkgreen:25600,darkgrey:0xa9a9a9,darkkhaki:0xbdb76b,darkmagenta:9109643,darkolivegreen:5597999,darkorange:0xff8c00,darkorchid:0x9932cc,darkred:9109504,darksalmon:0xe9967a,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:0xff1493,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:0xb22222,floralwhite:0xfffaf0,forestgreen:2263842,fuchsia:0xff00ff,gainsboro:0xdcdcdc,ghostwhite:0xf8f8ff,gold:0xffd700,goldenrod:0xdaa520,gray:8421504,green:32768,greenyellow:0xadff2f,grey:8421504,honeydew:0xf0fff0,hotpink:0xff69b4,indianred:0xcd5c5c,indigo:4915330,ivory:0xfffff0,khaki:0xf0e68c,lavender:0xe6e6fa,lavenderblush:0xfff0f5,lawngreen:8190976,lemonchiffon:0xfffacd,lightblue:0xadd8e6,lightcoral:0xf08080,lightcyan:0xe0ffff,lightgoldenrodyellow:0xfafad2,lightgray:0xd3d3d3,lightgreen:9498256,lightgrey:0xd3d3d3,lightpink:0xffb6c1,lightsalmon:0xffa07a,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:0xb0c4de,lightyellow:0xffffe0,lime:65280,limegreen:3329330,linen:0xfaf0e6,magenta:0xff00ff,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:0xba55d3,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:0xc71585,midnightblue:1644912,mintcream:0xf5fffa,mistyrose:0xffe4e1,moccasin:0xffe4b5,navajowhite:0xffdead,navy:128,oldlace:0xfdf5e6,olive:8421376,olivedrab:7048739,orange:0xffa500,orangered:0xff4500,orchid:0xda70d6,palegoldenrod:0xeee8aa,palegreen:0x98fb98,paleturquoise:0xafeeee,palevioletred:0xdb7093,papayawhip:0xffefd5,peachpuff:0xffdab9,peru:0xcd853f,pink:0xffc0cb,plum:0xdda0dd,powderblue:0xb0e0e6,purple:8388736,rebeccapurple:6697881,red:0xff0000,rosybrown:0xbc8f8f,royalblue:4286945,saddlebrown:9127187,salmon:0xfa8072,sandybrown:0xf4a460,seagreen:3050327,seashell:0xfff5ee,sienna:0xa0522d,silver:0xc0c0c0,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:0xfffafa,springgreen:65407,steelblue:4620980,tan:0xd2b48c,teal:32896,thistle:0xd8bfd8,tomato:0xff6347,turquoise:4251856,violet:0xee82ee,wheat:0xf5deb3,white:0xffffff,whitesmoke:0xf5f5f5,yellow:0xffff00,yellowgreen:0x9acd32};Ee(me,Pt,{copy(t){return Object.assign(new this.constructor,this,t)},displayable(){return this.rgb().displayable()},hex:Zt,formatHex:Zt,formatHex8:Ji,formatHsl:Qi,formatRgb:jt,toString:jt});function Zt(){return this.rgb().formatHex()}function Ji(){return this.rgb().formatHex8()}function Qi(){return zn(this).formatHsl()}function jt(){return this.rgb().formatRgb()}function Pt(t){var e,n;return t=(t+"").trim().toLowerCase(),(e=qi.exec(t))?(n=e[1].length,e=parseInt(e[1],16),n===6?Kt(e):n===3?new P(e>>8&15|e>>4&240,e>>4&15|e&240,(e&15)<<4|e&15,1):n===8?je(e>>24&255,e>>16&255,e>>8&255,(e&255)/255):n===4?je(e>>12&15|e>>8&240,e>>8&15|e>>4&240,e>>4&15|e&240,((e&15)<<4|e&15)/255):null):(e=Yi.exec(t))?new P(e[1],e[2],e[3],1):(e=Xi.exec(t))?new P(e[1]*255/100,e[2]*255/100,e[3]*255/100,1):(e=$i.exec(t))?je(e[1],e[2],e[3],e[4]):(e=Zi.exec(t))?je(e[1]*255/100,e[2]*255/100,e[3]*255/100,e[4]):(e=ji.exec(t))?en(e[1],e[2]/100,e[3]/100,1):(e=Ki.exec(t))?en(e[1],e[2]/100,e[3]/100,e[4]):$t.hasOwnProperty(t)?Kt($t[t]):t==="transparent"?new P(NaN,NaN,NaN,0):null}function Kt(t){return new P(t>>16&255,t>>8&255,t&255,1)}function je(t,e,n,r){return r<=0&&(t=e=n=NaN),new P(t,e,n,r)}function Ot(t){return t instanceof me||(t=Pt(t)),t?(t=t.rgb(),new P(t.r,t.g,t.b,t.opacity)):new P}function ge(t,e,n,r){return arguments.length===1?Ot(t):new P(t,e,n,r??1)}function P(t,e,n,r){this.r=+t,this.g=+e,this.b=+n,this.opacity=+r}Ee(P,ge,Ve(me,{brighter(t){return t=t==null?De:Math.pow(De,t),new P(this.r*t,this.g*t,this.b*t,this.opacity)},darker(t){return t=t==null?ze:Math.pow(ze,t),new P(this.r*t,this.g*t,this.b*t,this.opacity)},rgb(){return this},clamp(){return new P(Se(this.r),Se(this.g),Se(this.b),ot(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:Jt,formatHex:Jt,formatHex8:ea,formatRgb:Qt,toString:Qt}));function Jt(){return`#${ye(this.r)}${ye(this.g)}${ye(this.b)}`}function ea(){return`#${ye(this.r)}${ye(this.g)}${ye(this.b)}${ye((isNaN(this.opacity)?1:this.opacity)*255)}`}function Qt(){const t=ot(this.opacity);return`${t===1?"rgb(":"rgba("}${Se(this.r)}, ${Se(this.g)}, ${Se(this.b)}${t===1?")":`, ${t})`}`}function ot(t){return isNaN(t)?1:Math.max(0,Math.min(1,t))}function Se(t){return Math.max(0,Math.min(255,Math.round(t)||0))}function ye(t){return t=Se(t),(t<16?"0":"")+t.toString(16)}function en(t,e,n,r){return r<=0?t=e=n=NaN:n<=0||n>=1?t=e=NaN:e<=0&&(t=NaN),new ee(t,e,n,r)}function zn(t){if(t instanceof ee)return new ee(t.h,t.s,t.l,t.opacity);if(t instanceof me||(t=Pt(t)),!t)return new ee;if(t instanceof ee)return t;t=t.rgb();var e=t.r/255,n=t.g/255,r=t.b/255,i=Math.min(e,n,r),a=Math.max(e,n,r),o=NaN,s=a-i,c=(a+i)/2;return s?(e===a?o=(n-r)/s+(n<r)*6:n===a?o=(r-e)/s+2:o=(e-n)/s+4,s/=c<.5?a+i:2-a-i,o*=60):s=c>0&&c<1?0:o,new ee(o,s,c,t.opacity)}function Tt(t,e,n,r){return arguments.length===1?zn(t):new ee(t,e,n,r??1)}function ee(t,e,n,r){this.h=+t,this.s=+e,this.l=+n,this.opacity=+r}Ee(ee,Tt,Ve(me,{brighter(t){return t=t==null?De:Math.pow(De,t),new ee(this.h,this.s,this.l*t,this.opacity)},darker(t){return t=t==null?ze:Math.pow(ze,t),new ee(this.h,this.s,this.l*t,this.opacity)},rgb(){var t=this.h%360+(this.h<0)*360,e=isNaN(t)||isNaN(this.s)?0:this.s,n=this.l,r=n+(n<.5?n:1-n)*e,i=2*n-r;return new P(pt(t>=240?t-240:t+120,i,r),pt(t,i,r),pt(t<120?t+240:t-120,i,r),this.opacity)},clamp(){return new ee(tn(this.h),Ke(this.s),Ke(this.l),ot(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const t=ot(this.opacity);return`${t===1?"hsl(":"hsla("}${tn(this.h)}, ${Ke(this.s)*100}%, ${Ke(this.l)*100}%${t===1?")":`, ${t})`}`}}));function tn(t){return t=(t||0)%360,t<0?t+360:t}function Ke(t){return Math.max(0,Math.min(1,t||0))}function pt(t,e,n){return(t<60?e+(n-e)*t/60:t<180?n:t<240?e+(n-e)*(240-t)/60:e)*255}const Mn=Math.PI/180,Tn=180/Math.PI,st=18,Rn=.96422,Cn=1,Bn=.82521,Dn=4/29,Ce=6/29,En=3*Ce*Ce,ta=Ce*Ce*Ce;function In(t){if(t instanceof oe)return new oe(t.l,t.a,t.b,t.opacity);if(t instanceof ue)return An(t);t instanceof P||(t=Ot(t));var e=_t(t.r),n=_t(t.g),r=_t(t.b),i=ht((.2225045*e+.7168786*n+.0606169*r)/Cn),a,o;return e===n&&n===r?a=o=i:(a=ht((.4360747*e+.3850649*n+.1430804*r)/Rn),o=ht((.0139322*e+.0971045*n+.7141733*r)/Bn)),new oe(116*i-16,500*(a-i),200*(i-o),t.opacity)}function Rt(t,e,n,r){return arguments.length===1?In(t):new oe(t,e,n,r??1)}function oe(t,e,n,r){this.l=+t,this.a=+e,this.b=+n,this.opacity=+r}Ee(oe,Rt,Ve(me,{brighter(t){return new oe(this.l+st*(t??1),this.a,this.b,this.opacity)},darker(t){return new oe(this.l-st*(t??1),this.a,this.b,this.opacity)},rgb(){var t=(this.l+16)/116,e=isNaN(this.a)?t:t+this.a/500,n=isNaN(this.b)?t:t-this.b/200;return e=Rn*gt(e),t=Cn*gt(t),n=Bn*gt(n),new P(mt(3.1338561*e-1.6168667*t-.4906146*n),mt(-.9787684*e+1.9161415*t+.033454*n),mt(.0719453*e-.2289914*t+1.4052427*n),this.opacity)}}));function ht(t){return t>ta?Math.pow(t,1/3):t/En+Dn}function gt(t){return t>Ce?t*t*t:En*(t-Dn)}function mt(t){return 255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)}function _t(t){return(t/=255)<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)}function na(t){if(t instanceof ue)return new ue(t.h,t.c,t.l,t.opacity);if(t instanceof oe||(t=In(t)),t.a===0&&t.b===0)return new ue(NaN,0<t.l&&t.l<100?0:NaN,t.l,t.opacity);var e=Math.atan2(t.b,t.a)*Tn;return new ue(e<0?e+360:e,Math.sqrt(t.a*t.a+t.b*t.b),t.l,t.opacity)}function Ct(t,e,n,r){return arguments.length===1?na(t):new ue(t,e,n,r??1)}function ue(t,e,n,r){this.h=+t,this.c=+e,this.l=+n,this.opacity=+r}function An(t){if(isNaN(t.h))return new oe(t.l,0,0,t.opacity);var e=t.h*Mn;return new oe(t.l,Math.cos(e)*t.c,Math.sin(e)*t.c,t.opacity)}Ee(ue,Ct,Ve(me,{brighter(t){return new ue(this.h,this.c,this.l+st*(t??1),this.opacity)},darker(t){return new ue(this.h,this.c,this.l-st*(t??1),this.opacity)},rgb(){return An(this).rgb()}}));var kn=-.14861,Ft=1.78277,Gt=-.29227,lt=-.90649,Ne=1.97294,nn=Ne*lt,rn=Ne*Ft,an=Ft*Gt-lt*kn;function ra(t){if(t instanceof we)return new we(t.h,t.s,t.l,t.opacity);t instanceof P||(t=Ot(t));var e=t.r/255,n=t.g/255,r=t.b/255,i=(an*r+nn*e-rn*n)/(an+nn-rn),a=r-i,o=(Ne*(n-i)-Gt*a)/lt,s=Math.sqrt(o*o+a*a)/(Ne*i*(1-i)),c=s?Math.atan2(o,a)*Tn-120:NaN;return new we(c<0?c+360:c,s,i,t.opacity)}function Bt(t,e,n,r){return arguments.length===1?ra(t):new we(t,e,n,r??1)}function we(t,e,n,r){this.h=+t,this.s=+e,this.l=+n,this.opacity=+r}Ee(we,Bt,Ve(me,{brighter(t){return t=t==null?De:Math.pow(De,t),new we(this.h,this.s,this.l*t,this.opacity)},darker(t){return t=t==null?ze:Math.pow(ze,t),new we(this.h,this.s,this.l*t,this.opacity)},rgb(){var t=isNaN(this.h)?0:(this.h+120)*Mn,e=+this.l,n=isNaN(this.s)?0:this.s*e*(1-e),r=Math.cos(t),i=Math.sin(t);return new P(255*(e+n*(kn*r+Ft*i)),255*(e+n*(Gt*r+lt*i)),255*(e+n*(Ne*r)),this.opacity)}}));const Nt=t=>()=>t;function Ln(t,e){return function(n){return t+n*e}}function ia(t,e,n){return t=Math.pow(t,n),e=Math.pow(e,n)-t,n=1/n,function(r){return Math.pow(t+r*e,n)}}function Ut(t,e){var n=e-t;return n?Ln(t,n>180||n<-180?n-360*Math.round(n/360):n):Nt(isNaN(t)?e:t)}function aa(t){return(t=+t)==1?N:function(e,n){return n-e?ia(e,n,t):Nt(isNaN(e)?n:e)}}function N(t,e){var n=e-t;return n?Ln(t,n):Nt(isNaN(t)?e:t)}const oa=(function t(e){var n=aa(e);function r(i,a){var o=n((i=ge(i)).r,(a=ge(a)).r),s=n(i.g,a.g),c=n(i.b,a.b),S=N(i.opacity,a.opacity);return function(h){return i.r=o(h),i.g=s(h),i.b=c(h),i.opacity=S(h),i+""}}return r.gamma=t,r})(1);function sa(t){return function(e,n){var r=t((e=Tt(e)).h,(n=Tt(n)).h),i=N(e.s,n.s),a=N(e.l,n.l),o=N(e.opacity,n.opacity);return function(s){return e.h=r(s),e.s=i(s),e.l=a(s),e.opacity=o(s),e+""}}}const la=sa(Ut);function Pn(t,e){var n=N((t=Rt(t)).l,(e=Rt(e)).l),r=N(t.a,e.a),i=N(t.b,e.b),a=N(t.opacity,e.opacity);return function(o){return t.l=n(o),t.a=r(o),t.b=i(o),t.opacity=a(o),t+""}}function ca(t){return function(e,n){var r=t((e=Ct(e)).h,(n=Ct(n)).h),i=N(e.c,n.c),a=N(e.l,n.l),o=N(e.opacity,n.opacity);return function(s){return e.h=r(s),e.c=i(s),e.l=a(s),e.opacity=o(s),e+""}}}const ua=ca(Ut);function On(t){return(function e(n){n=+n;function r(i,a){var o=t((i=Bt(i)).h,(a=Bt(a)).h),s=N(i.s,a.s),c=N(i.l,a.l),S=N(i.opacity,a.opacity);return function(h){return i.h=o(h),i.s=s(h),i.l=c(Math.pow(h,n)),i.opacity=S(h),i+""}}return r.gamma=e,r})(1)}const fa=On(Ut);On(N);const Fn=["palette","zebra","tessellation","shading","skybox","webcam","smoothness","stripeAverage","rotationMean","stripeRelief","directionCoherenceRelief","shadingLevel","specularPower","metallic","roughness","anisotropy","iridescencePower"],Ue={palette:{label:"Color Blend",defaultValue:1,min:0,max:1,step:.01,unit:"",textureRow:0,textureChannel:3,uiGroup:"color"},zebra:{label:"Iteration Bands",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:1,textureChannel:0,uiGroup:"iteration"},tessellation:{label:"Image Blend",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:1,textureChannel:1,uiGroup:"imageSources"},shading:{label:"Lighting Blend",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:1,textureChannel:2,uiGroup:"lighting"},skybox:{label:"Reflection Blend",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:1,textureChannel:3,uiGroup:"lighting"},webcam:{label:"Webcam Blend",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:2,textureChannel:0,uiGroup:"imageSources"},smoothness:{label:"Smooth Iterations",defaultValue:1,min:0,max:1,step:.01,unit:"",textureRow:2,textureChannel:1,uiGroup:"iteration"},stripeAverage:{label:"Stripe Average",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:5,textureChannel:0,uiGroup:"iteration"},rotationMean:{label:"Direction Coherence",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:5,textureChannel:1,uiGroup:"iteration"},stripeRelief:{label:"Stripe Relief",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:5,textureChannel:2,uiGroup:"iteration"},directionCoherenceRelief:{label:"Direction Relief",defaultValue:0,min:0,max:100,step:.1,unit:"",textureRow:5,textureChannel:3,uiGroup:"iteration"},shadingLevel:{label:"Light Intensity",defaultValue:0,min:0,max:3,step:.05,unit:"",textureRow:2,textureChannel:2,uiGroup:"lighting"},specularPower:{label:"Specular Strength",defaultValue:0,min:1,max:64,step:.5,unit:"",textureRow:2,textureChannel:3,uiGroup:"lighting"},metallic:{label:"Metalness",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:3,textureChannel:1,uiGroup:"lighting"},roughness:{label:"Roughness",defaultValue:0,min:.02,max:1,step:.01,unit:"",textureRow:3,textureChannel:2,uiGroup:"lighting"},anisotropy:{label:"Anisotropy",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:3,textureChannel:3,uiGroup:"lighting"},iridescencePower:{label:"Iridescence Strength",defaultValue:0,min:0,max:1,step:.01,unit:"",textureRow:4,textureChannel:3,uiGroup:"iridescence"}},Dt=Object.fromEntries(Fn.map(t=>[t,Ue[t].defaultValue])),vt={};for(const t of Fn){const e=Ue[t].uiGroup;vt[e]||(vt[e]=[]),vt[e].push(t)}const da=["linear","gaussian","square","exponential"];function pa(t){return typeof t=="string"&&da.includes(t)}function bt(t){return pa(t.transferCurve)?t.transferCurve:"linear"}function xt(t,e){const n=ha(e);switch(t){case"gaussian":{if(n<=.28)return 0;if(n>=.72)return 1;const a=(n-.28)/(.72-.28);return a*a*(3-2*a)}case"square":return n<=0?0:1;case"exponential":return(Math.exp(3*n)-1)/(Math.exp(3)-1);default:return n}}function ce(t,e){return t[e]??Dt[e]}function ha(t){return Math.max(0,Math.min(1,t))}const ga={lab:Pn,rgb:oa,hcl:ua,hsl:la,cubehelix:fa},on=4096,ma=6,Et=[];{const t=new Map;for(const e of Object.keys(Ue)){const{textureRow:n}=Ue[e];n===0||n===4||(t.has(n)||t.set(n,[]),t.get(n).push(e))}for(const[e,n]of t)Et.push({row:e,fields:n});Et.sort((e,n)=>e.row-n.row)}function _a(t,e,n,r){const i=ce(t,n),a=ce(e,n);return i+(a-i)*r}function sn(t,e){return t[e]??null}class ln{points;interpolate;constructor(e,n="lab"){this.points=e.slice().sort((r,i)=>r.position-i.position),this.interpolate=ga[n]??Pn}getColorAt(e){if(this.points.length===0)return"#000";if(e<=this.points[0].position)return this.points[0].color;if(e>=this.points[this.points.length-1].position)return this.points[this.points.length-1].color;for(let n=0;n<this.points.length-1;++n){const r=this.points[n],i=this.points[n+1];if(e>=r.position&&e<=i.position){const a=(e-r.position)/(i.position-r.position),o=xt(bt(r),a),s=this.interpolate(r.color,i.color);return ge(s(o)).formatHex()}}return"#000"}getEffectAt(e,n){if(this.points.length===0)return Dt[n];if(e<=this.points[0].position)return ce(this.points[0],n);if(e>=this.points[this.points.length-1].position)return ce(this.points[this.points.length-1],n);for(let r=0;r<this.points.length-1;++r){const i=this.points[r],a=this.points[r+1];if(e>=i.position&&e<=a.position){const o=(e-i.position)/(a.position-i.position),s=xt(bt(i),o);return _a(i,a,n,s)}}return Dt[n]}getIridescenceAt(e){if(this.points.length===0)return{color:"#000000",strength:0};if(this.points.length===1)return{color:this.points[0].iridescenceColor??this.points[0].color,strength:this.points[0].iridescenceColor?ce(this.points[0],"iridescencePower"):0};const n=this.points[0],r=this.points[this.points.length-1];if(e<=n.position)return{color:n.iridescenceColor??n.color,strength:n.iridescenceColor?ce(n,"iridescencePower"):0};if(e>=r.position)return{color:r.iridescenceColor??r.color,strength:r.iridescenceColor?ce(r,"iridescencePower"):0};for(let i=0;i<this.points.length-1;++i){const a=this.points[i],o=this.points[i+1];if(e>=a.position&&e<=o.position){const s=(e-a.position)/(o.position-a.position),c=xt(bt(a),s),S=sn(a,"iridescenceColor"),h=sn(o,"iridescenceColor");if(!S&&!h)return{color:"#000000",strength:0};const y=S??a.color,w=h??o.color,l=S?ce(a,"iridescencePower"):0,v=h?ce(o,"iridescencePower"):0,u=l+(v-l)*c;return{color:ge(this.interpolate(y,w)(c)).formatHex(),strength:u}}}return{color:"#000000",strength:0}}generateTexture(){const e=on,n=ma,r=new Float32Array(e*n*4);for(let i=0;i<e;++i){const a=i/(e-1),o=ge(this.getColorAt(a)),s=(0*e+i)*4;r[s]=(o.r??0)/255,r[s+1]=(o.g??0)/255,r[s+2]=(o.b??0)/255,r[s+3]=this.getEffectAt(a,"palette");for(const{row:y,fields:w}of Et){const l=(y*e+i)*4;for(const v of w){const u=Ue[v].textureChannel;r[l+u]=this.getEffectAt(a,v)}}const c=this.getIridescenceAt(a),S=ge(c.color),h=(4*e+i)*4;r[h]=(S.r??0)/255,r[h+1]=(S.g??0)/255,r[h+2]=(S.b??0)/255,r[h+3]=Math.max(0,Math.min(1,c.strength))}return{data:r,width:e,height:n}}generateThumbnailRow(){const e=on,n=new ImageData(e,1),r=n.data;for(let i=0;i<e;++i){const a=i/(e-1),o=ge(this.getColorAt(a)),s=i*4;r[s]=Math.max(0,Math.min(255,Math.round(o.r??0))),r[s+1]=Math.max(0,Math.min(255,Math.round(o.g??0))),r[s+2]=Math.max(0,Math.min(255,Math.round(o.b??0))),r[s+3]=255}return n}}function $(t){return t.kind==="reprojecting"}function Je(t){return t.kind==="reprojecting"?t.frozenScale:0}function be(t){return t.kind==="reprojecting"?t.liveScale:0}function va(t){return t.kind==="reprojecting"&&t.referenceResetDuringZoom}function ba(t,e,n){switch(t.kind){case"idle":return xa(t,e,n);case"reprojecting":return ya(t,e,n)}}function xa(t,e,n){const r=[];switch(e.type){case"referenceReset":return e.orbitWasReset&&!e.muChanged&&r.push({type:"copyResolvedToFrozen"}),r.push({type:"clearHistoryNextFrame"}),{state:t,effects:r};case"scaleChanged":if(e.scale!==e.prevScale){const i=e.scale<e.prevScale,a=e.prevScale,o=i?a/n.threshold:a*n.threshold;return r.push({type:"copyResolvedToFrozen"}),r.push({type:"clearHistoryNextFrame"}),{state:{kind:"reprojecting",frozenScale:a,liveScale:o,zoomingIn:i,referenceResetDuringZoom:!1},effects:r}}return{state:t,effects:r};case"scaleStable":return{state:t,effects:r}}}function ya(t,e,n){const r=[];switch(e.type){case"referenceReset":return e.muChanged?{state:{kind:"idle"},effects:[{type:"clearHistoryNextFrame"}]}:(r.push({type:"clearHistoryNextFrame"}),{state:{...t,referenceResetDuringZoom:!0},effects:r});case"scaleChanged":{let i=t;t.referenceResetDuringZoom&&(i={...t,referenceResetDuringZoom:!1});const a=i.frozenScale/e.scale;if((i.zoomingIn?a>=n.threshold:a<=1/n.threshold)&&!i.referenceResetDuringZoom){const s=i.liveScale,c=i.zoomingIn?e.scale/n.threshold:e.scale*n.threshold;return r.push({type:"copyResolvedToFrozen"}),r.push({type:"clearHistoryNextFrame"}),{state:{kind:"reprojecting",frozenScale:s,liveScale:c,zoomingIn:i.zoomingIn,referenceResetDuringZoom:!1},effects:r}}return{state:i,effects:r}}case"scaleStable":return t.referenceResetDuringZoom||r.push({type:"mergeResolvedAndFrozen"}),r.push({type:"clearHistoryNextFrame"}),{state:{kind:"idle"},effects:r}}}function cn(){return{kind:"idle"}}function un(t,e,n,r){const i=typeof t=="number"&&Number.isFinite(t)?t:e,a=2**Math.floor(Math.log2(Math.max(1,Math.floor(i))));return Math.min(Math.max(a,n),r)}const Sa=.01,wa=100,za=["screenXWithDepth","screenYWithDepth","dragonScaleU","derivativeAngleSin","screenX","screenY","iterSmooth","distance"],Ma={screenXWithDepth:0,screenYWithDepth:1,dragonScaleU:2,derivativeAngleSin:3,screenX:4,screenY:5,iterSmooth:7,distance:8},it={xVariable:"screenXWithDepth",yVariable:"screenYWithDepth",xScale:1,yScale:1,mirrored:!1},Ta={xVariable:"dragonScaleU",yVariable:"derivativeAngleSin",xScale:1,yScale:1,mirrored:!0},Ra=new Set(za);function It(t){return{...t}}function Ca(t){return typeof t=="string"&&Ra.has(t)}function fn(t,e){return t==="argZ"?"derivativeAngleSin":t==="iterRaw"?"iterSmooth":Ca(t)?t:e}function dn(t){const e=typeof t=="number"&&Number.isFinite(t)?t:1;return Math.min(wa,Math.max(Sa,e))}function Gn(t){if(!t||typeof t!="object")return It(it);const e=t;return{xVariable:fn(e.xVariable,it.xVariable),yVariable:fn(e.yVariable,it.yVariable),xScale:dn(e.xScale),yScale:dn(e.yScale),mirrored:!!e.mirrored}}function Ba(t){return It(t===1?Ta:it)}function yt(t){return t.textureMapping?Gn(t.textureMapping):Ba(t.textureMappingMode)}function pn(t){return Ma[t]??0}const Da=["loop","sine","pulse","stepped"],Ea=["paletteOffset","heightPaletteShift","lightAngle","textureDrift","skyReflectionDrift","phaseColoring","varnish","microBump","displacement","tessellation"],Nn=[{id:"paletteOffset",label:"Palette Offset",defaultType:"loop",defaultSpeed:.8,defaultAmplitude:1,minAmplitude:0,maxAmplitude:1,amplitudeStep:.01,unit:"cycle"},{id:"heightPaletteShift",label:"Height Palette Shift",defaultType:"sine",defaultSpeed:.25,defaultAmplitude:20,minAmplitude:0,maxAmplitude:100,amplitudeStep:.5,unit:""},{id:"lightAngle",label:"Light Angle",defaultType:"loop",defaultSpeed:.15,defaultAmplitude:1,minAmplitude:0,maxAmplitude:1,amplitudeStep:.01,unit:"turn"},{id:"textureDrift",label:"Texture Drift",defaultType:"sine",defaultSpeed:1,defaultAmplitude:1,minAmplitude:0,maxAmplitude:2,amplitudeStep:.01,unit:""},{id:"skyReflectionDrift",label:"Sky Reflection Drift",defaultType:"sine",defaultSpeed:.6,defaultAmplitude:1,minAmplitude:0,maxAmplitude:2,amplitudeStep:.01,unit:""},{id:"phaseColoring",label:"Phase Coloring",defaultType:"pulse",defaultSpeed:.3,defaultAmplitude:25,minAmplitude:0,maxAmplitude:100,amplitudeStep:.5,unit:""},{id:"varnish",label:"Varnish",defaultType:"pulse",defaultSpeed:.22,defaultAmplitude:2,minAmplitude:0,maxAmplitude:10,amplitudeStep:.05,unit:""},{id:"microBump",label:"Micro Bump",defaultType:"pulse",defaultSpeed:.35,defaultAmplitude:.5,minAmplitude:0,maxAmplitude:2,amplitudeStep:.01,unit:""},{id:"displacement",label:"Displacement",defaultType:"sine",defaultSpeed:.2,defaultAmplitude:.02,minAmplitude:0,maxAmplitude:.1,amplitudeStep:.001,unit:""},{id:"tessellation",label:"Tessellation",defaultType:"sine",defaultSpeed:.18,defaultAmplitude:2,minAmplitude:0,maxAmplitude:10,amplitudeStep:.1,unit:""}];new Map(Nn.map(t=>[t.id,t]));function Ae(t,e){return typeof t=="number"&&Number.isFinite(t)?t:e}function Ia(t,e){return Da.includes(t)?t:e}function Aa(t){return{enabled:t.id==="paletteOffset",type:t.defaultType,speed:t.defaultSpeed,amplitude:t.defaultAmplitude,phase:0}}function ka(t=1){const e=Object.fromEntries(Nn.map(n=>[n.id,Aa(n)]));return{globalSpeed:Ae(t,1),tracks:e}}function at(t,e){const n=ka(e),r=t?.tracks,i=Object.fromEntries(Ea.map(a=>{const o=n.tracks[a],s=r?.[a];return[a,{enabled:typeof s?.enabled=="boolean"?s.enabled:o.enabled,type:Ia(s?.type,o.type),speed:Ae(s?.speed,o.speed),amplitude:Ae(s?.amplitude,o.amplitude),phase:Ae(s?.phase,o.phase??0)}]}));return{globalSpeed:Ae(t?.globalSpeed,n.globalSpeed),tracks:i}}const Te=8,Qe=100,La=1e4,Pa=1e5,Oa=1e-6,Fa=60,At=Math.PI*2,Ga=5e6,St=10,hn=.25,wt=3,Na=3,et=.001;function Ua(t){return t.some(e=>(e.stripeAverage??0)>et||(e.rotationMean??0)>et||(e.stripeRelief??0)>et||(e.directionCoherenceRelief??0)>et)}const Un=new Float32Array(1),Va=new Uint32Array(Un.buffer);function Ha(t){Un[0]=t;const e=Va[0],n=e>>>16&32768,r=(e>>>23&255)-127,i=e&8388607;if(r>=16)return n|31744;if(r>=-14){const a=r+15;return n|a<<10|i>>>13}if(r>=-24){const a=-14-r;return n|(i|8388608)>>>13+a}return n}function gn(t){const e=new Uint16Array(t.length);for(let n=0;n<t.length;++n)e[n]=Ha(t[n]);return e}function xe(t,e,n){return Math.min(Math.max(t,e),n)}function Wa(t,e,n){const r=t.phase??0,i=e*t.speed*n+r;switch(t.type){case"loop":return i-Math.floor(i);case"pulse":return .5+.5*Math.sin(i*At);case"stepped":return Math.floor((i-Math.floor(i))*8)/Math.max(1,7)*2-1;default:return Math.sin(i*At)}}function Q(t,e,n){return t.enabled?Wa(t,e,n)*t.amplitude:0}function mn(t,e,n,r){return Q({...t,phase:(t.phase??0)+r},e,n)}class Vt{snapshotCallback;snapshotDestWidth;canvas;device;queue;adapter;ctx;format;mandelbrotNavigator;rawTexture;rawArrayView;rawLayerViews=[];rawBrushTexture;rawBrushArrayView;rawBrushLayerViews=[];resolvedTexture;resolvedArrayView;resolvedLayerViews=[];frozenTexture;frozenArrayView;frozenLayerViews=[];pipelineMerge;bindGroupMerge;uniformBufferMerge;uniformBufferMandelbrot;uniformBufferColor;uniformBufferBrush;uniformBufferResolve;mandelbrotReferenceBuffer;mandelbrotBlaBuffer;mandelbrotBlaLevelBuffer;mandelbrotBlaBufferCapacity=0;mandelbrotBlaLevelBufferCapacity=0;pipelineBrush;bindGroupBrush;pipelineMandelbrot;bindGroupMandelbrot;pipelineResolve;bindGroupResolve;pipelineColor;bindGroupColor;pipelineCount;counterBuffer;counterReadbackSlots=[];counterReadbackWriteIndex=0;counterReadbackSequence=0;latestAppliedCounterReadbackSequence=0;counterReadbackGeneration=0;renderFrameSerial=0;lastCounterDispatchFrame=-wt;counterBindGroup;uniformBufferCount;unfinishedPixelCount=-1;activePixelCount=-1;_rafId=null;_drawFn=null;fps=0;isRendering=!1;gpuFrameTimeMs=0;smoothedGpuTimeMs=0;pendingGpuTiming=!1;refinementWasGated=!1;_fpsFrameCount=0;_fpsLastTime=0;neutralSize=0;shaderPassCompute;shaderPassColor;width=0;height=0;antialiasLevel;palettePeriod;previousMandelbrot;previousRenderOptions;previousOrbitMetricsEnabled;needRender=!0;orbitIncomplete=!1;prevGuardedMaxIter=0;currentGuardedMaxIter=0;currentMaxIterations=0;currentReferenceAvailableIter=0;currentReferenceRemainingIter=0;isReferenceValidating=!1;referenceResetSerial=0;referenceResetFlashUntil=0;currentBlaLevelCount=0;mandelbrotReference=new Float32Array(1e6);approximationMode="perturbation";blaEpsilon=Oa;referenceWorker;referenceJobId=0;referenceAvailableOrbitLen=0;referenceBlaReadyMaxIterations=0;referenceWorkerFailed=!1;referenceWorkerReady=!1;pendingWorkerMessages=[];referenceViewKey="";referenceWorkerCx="";referenceWorkerCy="";referenceOrbitWasReset=!1;pendingRefActive=!1;pendingRefCx="";pendingRefCy="";pendingRefOrbitBuffer=null;pendingRefOrbitLen=0;pendingRefMaxIterations=0;pendingRefBlaSteps=null;pendingRefBlaLevels=null;pendingRefBlaLevelCount=0;pendingRefBlaReadyMaxIterations=0;pendingRefReady=!1;skipRenderOnce=!1;prevFrameMandelbrot;clearHistoryNextFrame=!1;cumulativeShiftX=0;cumulativeShiftY=0;zoomMagnificationThreshold=16;zoomState={kind:"idle"};needFreezeSnapshot=!1;needMergeSnapshot=!1;mergeUniforms={zf:1,lzf:1,frozenShiftU:0,frozenShiftV:0,aspect:1,angle:0};frozenBaseShiftX=0;frozenBaseShiftY=0;frozenPanShiftX=0;frozenPanShiftY=0;frozenAligned=!1;iterationBatchSize=Qe;tileTexture;tileTextureView;skyboxTexture;skyboxTextureView;tileTextureSourceKey;skyboxTextureSourceKey;paletteTexture;paletteTextureView;paletteSampler;skyboxSampler;webcamTexture;webcamTileTexture;webcamTextureView;webcamEnabled=!0;time=0;lastUpdateTime=0;dprMultiplier=1;targetFps=60;gpuLoadMultiplier=1;constructor(e,n){this.canvas=e,this.shaderPassCompute=rr,this.shaderPassColor=ir,this.antialiasLevel=n.antialiasLevel,this.palettePeriod=n.palettePeriod,this.time=0}postReferenceWorker(e){return!this.referenceWorker||this.referenceWorkerFailed?!1:e.type==="dispose"?(this.referenceWorker.postMessage(e),!0):this.referenceWorkerReady?(this.referenceWorker.postMessage(e),!0):(this.pendingWorkerMessages.push(e),!0)}markReferenceReset(e=this.currentMaxIterations){this.referenceResetSerial++,this.referenceResetFlashUntil=performance.now()+900,this.referenceAvailableOrbitLen=0,this.currentReferenceAvailableIter=0,this.currentReferenceRemainingIter=e,this.currentGuardedMaxIter=0,this.orbitIncomplete=!0}discardPendingReference(){this.pendingRefActive&&(this.pendingRefActive=!1,this.pendingRefCx="",this.pendingRefCy="",this.pendingRefOrbitBuffer=null,this.pendingRefOrbitLen=0,this.pendingRefMaxIterations=0,this.pendingRefBlaSteps=null,this.pendingRefBlaLevels=null,this.pendingRefBlaLevelCount=0,this.pendingRefBlaReadyMaxIterations=0,this.pendingRefReady=!1)}markPendingReferenceReady(){this.pendingRefActive&&(this.pendingRefReady=!0,this.isReferenceValidating=!1,this.needRender=!0)}applyPendingReferenceSwitch(){if(!this.pendingRefActive||!this.pendingRefReady)return;const e=this.pendingRefOrbitBuffer;if(e&&this.mandelbrotReferenceBuffer){const r=this.pendingRefOrbitLen*4,i=Math.min(r,e.length);this.device.queue.writeBuffer(this.mandelbrotReferenceBuffer,0,e,0,i)}this.pendingRefBlaSteps&&this.mandelbrotBlaBuffer&&this.device.queue.writeBuffer(this.mandelbrotBlaBuffer,0,this.pendingRefBlaSteps,0,this.pendingRefBlaSteps.length),this.pendingRefBlaLevels&&this.mandelbrotBlaLevelBuffer&&this.device.queue.writeBuffer(this.mandelbrotBlaLevelBuffer,0,this.pendingRefBlaLevels,0,this.pendingRefBlaLevels.length),this.pendingRefBlaLevelCount>0&&(this.currentBlaLevelCount=this.pendingRefBlaLevelCount,this.referenceBlaReadyMaxIterations=this.pendingRefBlaReadyMaxIterations),this.referenceWorkerCx=this.pendingRefCx,this.referenceWorkerCy=this.pendingRefCy,this.mandelbrotNavigator.reference_origin(this.pendingRefCx,this.pendingRefCy),this.referenceAvailableOrbitLen=this.pendingRefOrbitLen;const n=Math.max(0,this.pendingRefOrbitLen-1);this.currentReferenceAvailableIter=n,this.currentReferenceRemainingIter=Math.max(0,this.currentMaxIterations-n),this.currentGuardedMaxIter=Math.min(this.currentMaxIterations,n),this.isReferenceValidating=!1,this.orbitIncomplete=!this.referenceWorkerFailed&&n<this.currentMaxIterations,this.referenceResetSerial++,this.referenceResetFlashUntil=performance.now()+900,this.referenceOrbitWasReset=!0,this.invalidateCounterReadback(),this.needRender=!0,this.skipRenderOnce=!0,this.discardPendingReference()}initializeReferenceWorker(){this.referenceWorker?.terminate(),this.referenceWorker=new Worker(new URL("/mandelbrot/presentation/assets/referenceWorker-BPm9g5UB.js",import.meta.url),{type:"module"}),this.referenceWorker.onmessage=e=>{this.handleReferenceWorkerMessage(e.data)},this.referenceWorker.onerror=e=>{console.error("Reference worker error:",e.message),this.referenceWorkerFailed=!0,this.orbitIncomplete=!1,this.currentBlaLevelCount=0},this.referenceWorkerFailed=!1,this.referenceWorkerReady=!1,this.pendingWorkerMessages=[],this.referenceAvailableOrbitLen=0,this.referenceBlaReadyMaxIterations=0,this.referenceJobId++}resetReferenceJob(e,n,r){this.discardPendingReference(),this.markReferenceReset(r),this.referenceBlaReadyMaxIterations=0,this.referenceOrbitWasReset=!0,this.isReferenceValidating=!0,this.currentBlaLevelCount=0,this.referenceViewKey="",this.referenceWorkerCx="",this.referenceWorkerCy="",this.referenceJobId++,this.postReferenceWorker({type:"reset",jobId:this.referenceJobId,cx:e.cx,cy:e.cy,scale:n.toString(),angle:e.angle,approximationMode:this.approximationMode,blaEpsilon:this.blaEpsilon,maxIterations:r})}syncReferenceWorkerView(e,n,r){const i=n.toString(),a=`${e.cx}
${e.cy}
${i}
${e.angle}
${r}`;a!==this.referenceViewKey&&(this.discardPendingReference(),this.referenceViewKey=a,this.isReferenceValidating=!0,this.orbitIncomplete=!0,this.needRender=!0,this.postReferenceWorker({type:"updateView",jobId:this.referenceJobId,cx:e.cx,cy:e.cy,scale:i,angle:e.angle,maxIterations:r}))}handleReferenceWorkerMessage(e){if(e.type==="ready"){this.referenceWorkerReady=!0;const n=this.pendingWorkerMessages;this.pendingWorkerMessages=[];for(const r of n)this.referenceWorker?.postMessage(r);return}if(e.jobId===this.referenceJobId){if(e.type==="error"){console.error("Reference worker error:",e.message),this.referenceWorkerFailed=!0,this.orbitIncomplete=!1,this.currentBlaLevelCount=0;return}if(e.type==="referenceReset"){if(this.pendingRefActive){if(e.referenceCx===this.pendingRefCx&&e.referenceCy===this.pendingRefCy)return;this.discardPendingReference()}this.pendingRefActive=!0,this.pendingRefCx=e.referenceCx,this.pendingRefCy=e.referenceCy,this.pendingRefMaxIterations=e.maxIterations;const n=Math.max(e.maxIterations,this.currentMaxIterations)*4;this.pendingRefOrbitBuffer=new Float32Array(n),this.pendingRefOrbitLen=0,this.pendingRefBlaSteps=null,this.pendingRefBlaLevels=null,this.pendingRefBlaLevelCount=0,this.pendingRefBlaReadyMaxIterations=0;return}if(e.type==="orbitChunk"){const n=this.pendingRefActive&&e.referenceCx===this.pendingRefCx&&e.referenceCy===this.pendingRefCy;if(n){const i=this.pendingRefOrbitBuffer;if(i&&e.orbit.length>0){const o=e.offset*4,s=Math.min(e.orbit.length,i.length-o);s>0&&i.set(e.orbit.slice(0,s),o)}this.pendingRefOrbitLen=e.count;const a=Math.min(this.pendingRefMaxIterations,this.currentMaxIterations);this.pendingRefOrbitLen>=a&&this.markPendingReferenceReady()}else if(e.referenceCx!==this.referenceWorkerCx||e.referenceCy!==this.referenceWorkerCy){this.pendingRefActive&&this.discardPendingReference(),this.pendingRefActive=!0,this.pendingRefCx=e.referenceCx,this.pendingRefCy=e.referenceCy,this.pendingRefMaxIterations=e.maxIterations;const i=Math.max(e.maxIterations,this.currentMaxIterations)*4;this.pendingRefOrbitBuffer=new Float32Array(i),this.pendingRefOrbitLen=0,this.pendingRefBlaSteps=null,this.pendingRefBlaLevels=null,this.pendingRefBlaLevelCount=0,this.pendingRefBlaReadyMaxIterations=0;const a=this.pendingRefOrbitBuffer;if(a&&e.orbit.length>0){const s=e.offset*4,c=Math.min(e.orbit.length,a.length-s);c>0&&a.set(e.orbit.slice(0,c),s)}this.pendingRefOrbitLen=e.count;const o=Math.min(this.pendingRefMaxIterations,this.currentMaxIterations);this.pendingRefOrbitLen>=o&&this.markPendingReferenceReady(),this.isReferenceValidating=!1,this.needRender=!0;return}else e.offset===0&&this.referenceAvailableOrbitLen>0&&(this.markReferenceReset(),this.referenceOrbitWasReset=!0,this.currentBlaLevelCount=0,this.referenceBlaReadyMaxIterations=0,this.invalidateCounterReadback());n||(e.orbit.length>0&&this.mandelbrotReferenceBuffer?(this.referenceAvailableOrbitLen=e.count,this.device.queue.writeBuffer(this.mandelbrotReferenceBuffer,e.offset*4*Float32Array.BYTES_PER_ELEMENT,e.orbit,0,e.orbit.length)):this.referenceAvailableOrbitLen=e.count);const r=Math.max(0,this.referenceAvailableOrbitLen-1);this.currentReferenceAvailableIter=r,this.currentReferenceRemainingIter=Math.max(0,this.currentMaxIterations-r),this.isReferenceValidating=!1,this.currentGuardedMaxIter=Math.min(this.currentMaxIterations,r),this.orbitIncomplete=!this.referenceWorkerFailed&&r<this.currentMaxIterations,this.needRender=!0;return}if(this.pendingRefActive){this.pendingRefBlaSteps=new Float32Array(e.steps),this.pendingRefBlaLevels=new Uint32Array(e.levels),this.pendingRefBlaLevelCount=e.levelCount,this.pendingRefBlaReadyMaxIterations=e.maxIterations;const n=Math.min(this.pendingRefMaxIterations,this.currentMaxIterations);this.pendingRefOrbitLen>=n&&this.markPendingReferenceReady();return}this.ensureBlaBufferCapacity(e.steps.length/6),this.ensureBlaLevelBufferCapacity(e.levelCount),e.steps.length>0&&this.mandelbrotBlaBuffer&&this.device.queue.writeBuffer(this.mandelbrotBlaBuffer,0,e.steps,0,e.steps.length),e.levels.length>0&&this.mandelbrotBlaLevelBuffer&&this.device.queue.writeBuffer(this.mandelbrotBlaLevelBuffer,0,e.levels,0,e.levels.length),this.currentBlaLevelCount=e.levelCount,this.referenceBlaReadyMaxIterations=e.maxIterations,this.isReferenceValidating=!1,this.clearHistoryNextFrame=!0,this.needRender=!0,this.invalidateCounterReadback()}}async initialize(e){if(this.mandelbrotNavigator=e,this.approximationMode=this.mandelbrotNavigator.get_approximation_mode()===1?"bla":"perturbation",this.blaEpsilon=this.mandelbrotNavigator.get_bla_epsilon(),this.initializeReferenceWorker(),!navigator.gpu)throw new Error("WebGPU non support\xe9");if(this.adapter=await navigator.gpu.requestAdapter(),!this.adapter)throw new Error("Adapter WebGPU introuvable");this.device=await this.adapter.requestDevice(),this.device.label="Engine Device",this.device.lost.then(a=>{console.warn(`GPU device lost: reason=${a.reason}, message=${a.message}`)}),this.queue=this.device.queue,this.queue.label="Engine Queue",this.ctx=this.canvas.getContext("webgpu"),this.format=navigator.gpu.getPreferredCanvasFormat(),this.ctx.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.tileTexture=this.device.createTexture({size:[1,1,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT,label:"Engine TileTexture 1x1 Placeholder"}),this.tileTextureView=this.tileTexture.createView(),this.skyboxTexture=this.device.createTexture({size:[1,1,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT,label:"Engine SkyboxTexture 1x1 Placeholder"}),this.skyboxTextureView=this.skyboxTexture.createView();const r=new ln([]).generateTexture(),i=gn(r.data);this.paletteTexture=this.device.createTexture({size:[r.width,r.height,1],format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT,label:"Engine PaletteTexture"}),this.device.queue.writeTexture({texture:this.paletteTexture},i.buffer,{bytesPerRow:r.width*8},[r.width,r.height]),this.paletteTextureView=this.paletteTexture.createView(),this.paletteSampler=this.device.createSampler({magFilter:"linear",minFilter:"linear",addressModeU:"repeat",addressModeV:"clamp-to-edge"}),this.skyboxSampler=this.device.createSampler({magFilter:"linear",minFilter:"linear",addressModeU:"repeat",addressModeV:"repeat"}),this.webcamTexture=new Wi(1920,1080),this.webcamTileTexture=this.device.createTexture({size:[1920,1080,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),this.webcamTextureView=this.webcamTileTexture.createView(),this.uniformBufferMandelbrot=this.device.createBuffer({size:80,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Mandelbrot"}),this.uniformBufferColor=this.device.createBuffer({size:4*Fa,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Color"}),this.uniformBufferBrush=this.device.createBuffer({size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Brush"}),this.uniformBufferResolve=this.device.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Resolve"}),this.mandelbrotReferenceBuffer=this.device.createBuffer({size:4*1e6,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot Orbit ReferenceStorage Buffer"}),this.mandelbrotBlaBuffer=this.device.createBuffer({size:24,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Storage Buffer"}),this.mandelbrotBlaLevelBuffer=this.device.createBuffer({size:16,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Level Storage Buffer"}),this.mandelbrotBlaBufferCapacity=1,this.mandelbrotBlaLevelBufferCapacity=1,this.counterBuffer=this.device.createBuffer({size:8,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST,label:"Engine Counter Storage"}),this.counterReadbackSlots=Array.from({length:Na},(a,o)=>({buffer:this.device.createBuffer({size:8,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ,label:`Engine Counter Readback ${o}`}),pending:!1,sequence:0,generation:0})),this.uniformBufferCount=this.device.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Count"}),this.uniformBufferMerge=this.device.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:"Engine UniformBuffer Merge"}),await this._createPipelines(),this.resize()}async _createPipelines(){const e=this.device.createShaderModule({code:ar,label:"Engine ShaderModule Brush"}),n=this.device.createShaderModule({code:this.shaderPassCompute,label:"Engine ShaderModule Compute"}),r=this.device.createShaderModule({code:or,label:"Engine ShaderModule Resolve"}),i=this.device.createShaderModule({code:this.shaderPassColor,label:"Engine ShaderModule Color"}),a=this.device.createShaderModule({code:sr,label:"Engine ShaderModule Count"}),o=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Brush"}),s=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Mandelbrot"}),c=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Resolve"}),S=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:5,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:6,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:7,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:8,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}],label:"Engine BindGroupLayout Color"}),h=Array.from({length:Te},()=>({format:"r32float"}));this.pipelineBrush=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[o]}),vertex:{module:e,entryPoint:"vs_main"},fragment:{module:e,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Brush"}),this.pipelineMandelbrot=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[s]}),vertex:{module:n,entryPoint:"vs_main"},fragment:{module:n,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Mandelbrot"}),this.pipelineResolve=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[c]}),vertex:{module:r,entryPoint:"vs_main"},fragment:{module:r,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Resolve"}),this.pipelineColor=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[S]}),vertex:{module:i,entryPoint:"vs_main"},fragment:{module:i,entryPoint:"fs_main",targets:[{format:this.format}]},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Color"});const y=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}],label:"Engine BindGroupLayout Count"});this.pipelineCount=this.device.createComputePipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[y]}),compute:{module:a,entryPoint:"count_unfinished"},label:"Engine ComputePipeline Count"});const w=this.device.createShaderModule({code:lr,label:"Engine ShaderModule Merge"}),l=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float",viewDimension:"2d-array"}}],label:"Engine BindGroupLayout Merge"});this.pipelineMerge=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[l]}),vertex:{module:w,entryPoint:"vs_main"},fragment:{module:w,entryPoint:"fs_main",targets:h},primitive:{topology:"triangle-list"},label:"Engine RenderPipeline Merge"}),this.bindGroupBrush=void 0,this.bindGroupMandelbrot=void 0,this.bindGroupResolve=void 0,this.bindGroupColor=void 0,this.counterBindGroup=void 0,this.bindGroupMerge=void 0}rebuildMandelbrotBindGroup(){if(!this.pipelineMandelbrot||!this.rawBrushArrayView||!this.uniformBufferMandelbrot||!this.mandelbrotReferenceBuffer||!this.mandelbrotBlaBuffer||!this.mandelbrotBlaLevelBuffer)return;const e=this.pipelineMandelbrot.getBindGroupLayout(0);this.bindGroupMandelbrot=this.device.createBindGroup({layout:e,entries:[{binding:0,resource:{buffer:this.uniformBufferMandelbrot}},{binding:1,resource:{buffer:this.mandelbrotReferenceBuffer}},{binding:2,resource:{buffer:this.mandelbrotBlaBuffer}},{binding:3,resource:{buffer:this.mandelbrotBlaLevelBuffer}},{binding:4,resource:this.rawBrushArrayView}],label:"Engine BindGroup Mandelbrot"})}ensureBlaBufferCapacity(e){const n=Math.max(1,Math.ceil(e));n<=this.mandelbrotBlaBufferCapacity||(this.mandelbrotBlaBuffer?.destroy?.(),this.mandelbrotBlaBuffer=this.device.createBuffer({size:n*4*6,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Storage Buffer"}),this.mandelbrotBlaBufferCapacity=n,this.rebuildMandelbrotBindGroup())}ensureBlaLevelBufferCapacity(e){const n=Math.max(1,Math.ceil(e));n<=this.mandelbrotBlaLevelBufferCapacity||(this.mandelbrotBlaLevelBuffer?.destroy?.(),this.mandelbrotBlaLevelBuffer=this.device.createBuffer({size:n*4*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:"Engine Mandelbrot BLA Level Storage Buffer"}),this.mandelbrotBlaLevelBufferCapacity=n,this.rebuildMandelbrotBindGroup())}invalidateCounterReadback(){this.unfinishedPixelCount=-1,this.activePixelCount=-1,this.counterReadbackGeneration++,this.lastCounterDispatchFrame=-wt}hasPendingCounterReadbackForCurrentGeneration(){return this.counterReadbackSlots.some(e=>e.pending&&e.generation===this.counterReadbackGeneration)}acquireCounterReadbackSlot(){const e=this.counterReadbackSlots.length;for(let n=0;n<e;n++){const r=(this.counterReadbackWriteIndex+n)%e,i=this.counterReadbackSlots[r];if(!i.pending)return this.counterReadbackWriteIndex=(r+1)%e,i}}scheduleCounterReadback(e,n,r){e.pending=!0,e.sequence=n,e.generation=r,(async()=>{let i=!1;try{await e.buffer.mapAsync(GPUMapMode.READ),i=!0;const a=new Uint32Array(e.buffer.getMappedRange()),o=a[0],s=a[1];this.applyCounterReadback(n,r,o,s)}catch{}finally{i&&e.buffer.unmap(),e.pending=!1}})()}applyCounterReadback(e,n,r,i){if(n!==this.counterReadbackGeneration||e<=this.latestAppliedCounterReadbackSequence)return;this.latestAppliedCounterReadbackSequence=e;const a=this.unfinishedPixelCount;this.unfinishedPixelCount=r,this.activePixelCount=i,a>St&&r<=St&&!this.clearHistoryNextFrame&&!$(this.zoomState)&&(this.needFreezeSnapshot=!0)}scheduleGpuTiming(e){this.pendingGpuTiming||(this.pendingGpuTiming=!0,this.device.queue.onSubmittedWorkDone().then(()=>{this.pendingGpuTiming=!1,this.applyGpuFrameTiming(performance.now()-e)}).catch(()=>{this.pendingGpuTiming=!1}))}applyGpuFrameTiming(e){if(this.gpuFrameTimeMs=e,this.smoothedGpuTimeMs===0?this.smoothedGpuTimeMs=e:this.smoothedGpuTimeMs=this.smoothedGpuTimeMs*(1-hn)+e*hn,e<=0)return;const n=1e3/this.targetFps/e,r=this.iterationBatchSize*n,i=this.getEffectiveMaxBatchSize();this.iterationBatchSize=Math.round(Math.min(i,Math.max(Qe,this.iterationBatchSize*.7+r*.3)))}getEffectiveMaxBatchSize(){return this.approximationMode==="bla"&&this.currentBlaLevelCount>0?Pa:La}resize(){const e=(window.devicePixelRatio||1)*this.dprMultiplier,n=this.canvas.parentElement,r=n?.clientWidth||1,i=n?.clientHeight||1;this.width=Math.max(1,Math.round(r*e)),this.height=Math.max(1,Math.round(i*e));const a=this.device?.limits?.maxTextureDimension2D??8192;this.width=Math.min(this.width,a),this.height=Math.min(this.height,a),this.canvas.width=this.width,this.canvas.height=this.height,this.canvas.style.width=r+"px",this.canvas.style.height=i+"px",this.ctx.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.neutralSize=Math.ceil(Math.sqrt(this.width*this.width+this.height*this.height));const o=this.neutralSize;this.rawTexture?.destroy?.(),this.rawBrushTexture?.destroy?.(),this.resolvedTexture?.destroy?.(),this.frozenTexture?.destroy?.();const s=Te,c=l=>{const v=this.device.createTexture({size:{width:o,height:o,depthOrArrayLayers:s},format:"r32float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC|GPUTextureUsage.COPY_DST,label:l}),u=v.createView({dimension:"2d-array",baseArrayLayer:0,arrayLayerCount:s,label:l+" ArrayView"}),_=[];for(let x=0;x<s;x++)_.push(v.createView({dimension:"2d",baseArrayLayer:x,arrayLayerCount:1,label:l+` Layer${x}`}));return{texture:v,arrayView:u,layerViews:_}},S=c("Engine RawTexture (A)");this.rawTexture=S.texture,this.rawArrayView=S.arrayView,this.rawLayerViews=S.layerViews;const h=c("Engine RawBrushTexture (B)");this.rawBrushTexture=h.texture,this.rawBrushArrayView=h.arrayView,this.rawBrushLayerViews=h.layerViews;const y=c("Engine ResolvedTexture");this.resolvedTexture=y.texture,this.resolvedArrayView=y.arrayView,this.resolvedLayerViews=y.layerViews;const w=c("Engine FrozenTexture");if(this.frozenTexture=w.texture,this.frozenArrayView=w.arrayView,this.frozenLayerViews=w.layerViews,this.zoomState=cn(),this.pipelineBrush){const l=this.pipelineBrush.getBindGroupLayout(0);this.bindGroupBrush=this.device.createBindGroup({layout:l,entries:[{binding:0,resource:{buffer:this.uniformBufferBrush}},{binding:1,resource:this.rawArrayView}],label:"Engine BindGroup Brush"})}if(this.pipelineMandelbrot&&this.rebuildMandelbrotBindGroup(),this.pipelineResolve){const l=this.pipelineResolve.getBindGroupLayout(0);this.bindGroupResolve=this.device.createBindGroup({layout:l,entries:[{binding:0,resource:{buffer:this.uniformBufferResolve}},{binding:1,resource:this.rawArrayView}],label:"Engine BindGroup Resolve"})}if(this.pipelineColor){const l=this.pipelineColor.getBindGroupLayout(0),v=[{binding:0,resource:{buffer:this.uniformBufferColor}},{binding:1,resource:this.resolvedArrayView},{binding:2,resource:this.tileTextureView},{binding:3,resource:this.skyboxTextureView},{binding:4,resource:this.webcamTextureView},{binding:5,resource:this.paletteTextureView},{binding:6,resource:this.frozenArrayView},{binding:7,resource:this.paletteSampler},{binding:8,resource:this.skyboxSampler}];this.bindGroupColor=this.device.createBindGroup({layout:l,entries:v,label:"Engine BindGroup Color"})}if(this.pipelineCount&&this.counterBuffer&&this.uniformBufferCount){const l=this.pipelineCount.getBindGroupLayout(0);this.counterBindGroup=this.device.createBindGroup({layout:l,entries:[{binding:0,resource:this.rawArrayView},{binding:1,resource:{buffer:this.counterBuffer}},{binding:2,resource:{buffer:this.uniformBufferCount}}],label:"Engine BindGroup Count"})}if(this.pipelineMerge&&this.uniformBufferMerge){const l=this.pipelineMerge.getBindGroupLayout(0);this.bindGroupMerge=this.device.createBindGroup({layout:l,entries:[{binding:0,resource:{buffer:this.uniformBufferMerge}},{binding:1,resource:this.resolvedArrayView},{binding:2,resource:this.rawBrushArrayView}],label:"Engine BindGroup Merge"})}this.prevFrameMandelbrot=void 0,this.previousMandelbrot=void 0,this.previousRenderOptions=void 0,this.needRender=!0,this.invalidateCounterReadback()}areObjectsEqual(e,n){return e===void 0||n===void 0?!1:JSON.stringify(e)===JSON.stringify(n)}areColorStopsEqual(e,n){if(e.length!==n.length)return!1;for(const[r,i]of e.entries()){const a=n[r];if(!a||JSON.stringify(i)!==JSON.stringify(a))return!1}return!0}setApproximationMode(e){e!==this.approximationMode&&(e==="bla"?this.mandelbrotNavigator.use_bla():this.mandelbrotNavigator.use_perturbation(),this.approximationMode=e,this.currentBlaLevelCount=0,this.postReferenceWorker({type:"setApproximationMode",jobId:this.referenceJobId,approximationMode:e}),this.clearHistoryNextFrame=!0,this.needRender=!0,this.invalidateCounterReadback())}getApproximationMode(){return this.approximationMode}setBlaEpsilon(e){const n=Math.max(Number.MIN_VALUE,e);n!==this.blaEpsilon&&(this.mandelbrotNavigator.set_bla_epsilon(n),this.blaEpsilon=n,this.postReferenceWorker({type:"setBlaEpsilon",jobId:this.referenceJobId,blaEpsilon:n}),this.approximationMode==="bla"&&(this.currentBlaLevelCount=0,this.clearHistoryNextFrame=!0,this.needRender=!0,this.invalidateCounterReadback()))}async update(e,n){const r=performance.now();this.lastUpdateTime===0&&(this.lastUpdateTime=r);const i=(r-this.lastUpdateTime)/1e3;if(this.time+=i,this.lastUpdateTime=r,this.pendingRefReady){this.applyPendingReferenceSwitch();return}const a=this.mandelbrotNavigator.get_approximation_mode()===1?"bla":"perturbation",o=this.mandelbrotNavigator.get_bla_epsilon();(a!==this.approximationMode||o!==this.blaEpsilon)&&(this.approximationMode=a,this.blaEpsilon=o,this.currentBlaLevelCount=0,this.postReferenceWorker({type:"setApproximationMode",jobId:this.referenceJobId,approximationMode:a}),this.postReferenceWorker({type:"setBlaEpsilon",jobId:this.referenceJobId,blaEpsilon:o}),this.clearHistoryNextFrame=!0,this.needRender=!0,this.invalidateCounterReadback());const s=!this.areObjectsEqual(e,this.previousMandelbrot),c=!this.areObjectsEqual(n,this.previousRenderOptions),S=n.stripeFrequency!==this.previousRenderOptions?.stripeFrequency,h=Ua(n.colorStops),y=this.previousOrbitMetricsEnabled!==void 0&&h!==this.previousOrbitMetricsEnabled,w=S&&h;this.needRender=this.needRender||s||c,(s||w||y)&&this.invalidateCounterReadback(),(w||y)&&(this.clearHistoryNextFrame=!0),this.previousOrbitMetricsEnabled=h,n.colorStops.some(We=>(We.webcam??0)>0)?(await this.updateWebcamTexture(),this.needRender=!0):this.webcamTexture?.closeWebcam(),n.activateAnimate&&(this.needRender=!0);const v=this.width/Math.max(1,this.height);let u=this.previousMandelbrot?.scale||1/e.scale;u<1&&(u=1/u),u=Math.sqrt(u)-1;const _=this.referenceOrbitWasReset&&!!this.prevFrameMandelbrot;this.referenceOrbitWasReset=!1;const x=!this.prevFrameMandelbrot||_,B=!!this.prevFrameMandelbrot&&this.prevFrameMandelbrot.mu!==e.mu,F=$(this.zoomState)&&x&&!B;(x||B)&&(this.clearHistoryNextFrame=!0,F||(this.zoomState=cn(),this.frozenBaseShiftX=0,this.frozenBaseShiftY=0,this.frozenPanShiftX=0,this.frozenPanShiftY=0),this.needFreezeSnapshot=_&&!F&&!B,this.needMergeSnapshot=!1);{const We=this.prevFrameMandelbrot&&this.prevFrameMandelbrot.scale!==e.scale;let ne=null;x||B?ne={type:"referenceReset",muChanged:B,orbitWasReset:_}:We?ne={type:"scaleChanged",scale:e.scale,prevScale:this.prevFrameMandelbrot.scale}:this.prevFrameMandelbrot&&(ne={type:"scaleStable"});const qe=$(this.zoomState),Ye=Je(this.zoomState),ut=be(this.zoomState),Wn=va(this.zoomState),{state:qn,effects:Yn}=ne?ba(this.zoomState,ne,{threshold:this.zoomMagnificationThreshold}):{state:this.zoomState,effects:[]};this.zoomState=qn;for(const Xn of Yn)switch(Xn.type){case"copyResolvedToFrozen":if(this.needFreezeSnapshot=!0,$(this.zoomState)){if(qe)this.frozenBaseShiftX=0,this.frozenBaseShiftY=0;else{const $n=e.dx-this.prevFrameMandelbrot.dx,Zn=e.dy-this.prevFrameMandelbrot.dy,Wt=Math.sqrt(v*v+1),ft=Je(this.zoomState);ft>0&&(this.frozenBaseShiftX=Math.round(-($n*this.neutralSize)/(2*ft*Wt)),this.frozenBaseShiftY=Math.round(Zn*this.neutralSize/(2*ft*Wt)))}this.frozenPanShiftX=0,this.frozenPanShiftY=0}break;case"mergeResolvedAndFrozen":this.needMergeSnapshot=!Wn,qe&&Ye>0&&(this.mergeUniforms={zf:Ye/e.scale,lzf:ut/e.scale,frozenShiftU:(this.frozenBaseShiftX+this.frozenPanShiftX*(ut/Ye))/this.neutralSize,frozenShiftV:-(this.frozenBaseShiftY+this.frozenPanShiftY*(ut/Ye))/this.neutralSize,aspect:v,angle:e.angle});break;case"clearHistoryNextFrame":this.clearHistoryNextFrame=!0;break}}if(!this.areColorStopsEqual(n.colorStops,this.previousRenderOptions?.colorStops||[])||n.interpolationMode!==this.previousRenderOptions?.interpolationMode){const ne=new ln(n.colorStops,n.interpolationMode).generateTexture(),qe=gn(ne.data);this.device.queue.writeTexture({texture:this.paletteTexture},qe.buffer,{bytesPerRow:ne.width*8},[ne.width,ne.height]),this.needRender=!0}const H=Math.sin(e.angle),G=Math.cos(e.angle),M=at(n.animation,n.animationSpeed),z=xe(M.globalSpeed,0,10),D=n.activateAnimate?this.time:0,A=Q(M.tracks.paletteOffset,D,z),W=Q(M.tracks.heightPaletteShift,D,z),Y=Q(M.tracks.lightAngle,D,z)*At,fe=Q(M.tracks.textureDrift,D,z),q=mn(M.tracks.textureDrift,D,z,.25),se=Q(M.tracks.skyReflectionDrift,D,z),T=mn(M.tracks.skyReflectionDrift,D,z,.25),C=Q(M.tracks.phaseColoring,D,z),k=Q(M.tracks.varnish,D,z),E=Q(M.tracks.microBump,D,z),U=Q(M.tracks.displacement,D,z),j=Q(M.tracks.tessellation,D,z),Z=n.lightAngle+Y,K=xe(n.tessellationLevel+j,0,10),de=xe(n.displacementAmount+U,0,.1),O=xe(n.microBumpStrength+E,0,10),f=xe(n.varnishStrength+k,0,10),m=xe(n.heightPaletteShift+W,0,100),g=xe(n.phaseColoringStrength+C,0,100),b=Math.hypot(Math.cos(Z),Math.sin(Z),1.85),R=Gn(n.textureMapping),L=$(this.zoomState),V=L?Je(this.zoomState)/e.scale:1,X=L?be(this.zoomState)/e.scale:1,J=Je(this.zoomState),pe=be(this.zoomState),_e=new Float32Array([n.palettePeriod,n.paletteOffset+A,u,this.time,v,e.angle,n.activateAnimate?1:0,e.mu,V,L||this.frozenAligned||this.needFreezeSnapshot?1:0,X,L&&J>0?(this.frozenBaseShiftX+this.frozenPanShiftX*(pe/J))/this.neutralSize:0,L&&J>0?-(this.frozenBaseShiftY+this.frozenPanShiftY*(pe/J))/this.neutralSize:0,K,de,z,e.epsilon,n.ambientOcclusionStrength,O,n.subsurfaceStrength,n.reliefDepth,n.localShadowStrength,Z,f,Math.log(e.mu),H,G,Math.cos(Z)/b,Math.sin(Z)/b,1.85/b,n.paletteMirror?1:0,n.debugShading?1:0,m,n.orbitTrapStrength,g,pn(R.xVariable),pn(R.yVariable),R.xScale,R.yScale,R.mirrored?1:0,parseFloat(e.cx),parseFloat(e.cy),e.scale,0,.03*fe,.03*q,.02*se,.02*T,A,W,Y,fe,se,C,k,E,U,j,0,0]);if(this.device.queue.writeBuffer(this.uniformBufferColor,0,_e.buffer),!this.needsMoreFrames())return;const te=Math.ceil(e.maxIterations);this.currentMaxIterations=te;const Ie=$(this.zoomState)&&be(this.zoomState)>0?be(this.zoomState):e.scale;this.referenceViewKey||this.resetReferenceJob(e,Ie,te),this.syncReferenceWorkerView(e,Ie,te);const ve=Math.max(0,this.referenceAvailableOrbitLen-1),He=Math.min(te,ve);this.currentGuardedMaxIter=He,this.currentReferenceAvailableIter=ve,this.currentReferenceRemainingIter=Math.max(0,te-ve),this.orbitIncomplete=!this.referenceWorkerFailed&&ve<te;const ct=ve>=te,Ht=this.approximationMode==="bla"&&ct&&this.currentBlaLevelCount>0&&this.referenceBlaReadyMaxIterations>=He?1:0,Vn=Ht?this.currentBlaLevelCount:0,Hn=new Float32Array([e.dx,e.dy,e.mu,Ie,v,e.angle,this.iterationBatchSize,e.epsilon,n.antialiasLevel,0,He,ct?1:0,Ht,Vn,this.blaEpsilon,n.stripeFrequency,h?1:0,0,0,0]);this.device.queue.writeBuffer(this.uniformBufferMandelbrot,0,Hn.buffer),!$(this.zoomState)&&!this.clearHistoryNextFrame&&ct&&this.prevGuardedMaxIter<te&&this.prevGuardedMaxIter>0&&(this.needFreezeSnapshot=!0,this.clearHistoryNextFrame=!0),this.prevGuardedMaxIter=He,this.previousMandelbrot=structuredClone(e),this.previousRenderOptions=structuredClone(n)}async render(){if(this.skipRenderOnce){this.skipRenderOnce=!1;return}if(!this.needsMoreFrames()||!this.pipelineBrush||!this.pipelineMandelbrot||!this.pipelineResolve||!this.pipelineColor||!this.bindGroupBrush||!this.bindGroupMandelbrot||!this.bindGroupResolve||!this.bindGroupColor||!this.previousMandelbrot)return;const e=this.previousRenderOptions;if(!e)return;const n=this.width/Math.max(1,this.height),r=un(e.zoomMinBrushStep,1,1,64),i=Math.max(un(e.sentinelSeedStep,64,1,4096),r),a=i,o=this.clearHistoryNextFrame?1:0;this.clearHistoryNextFrame&&this.invalidateCounterReadback();const s=++this.renderFrameSerial;let c=0,S=0;if(!this.clearHistoryNextFrame&&this.prevFrameMandelbrot){const T=this.previousMandelbrot.dx-this.prevFrameMandelbrot.dx,C=this.previousMandelbrot.dy-this.prevFrameMandelbrot.dy,k=this.neutralSize,E=Math.sqrt(n*n+1),U=$(this.zoomState)&&be(this.zoomState)>0?be(this.zoomState):this.previousMandelbrot.scale;c=-(T*k)/(2*U*E),S=C*k/(2*U*E)}const h=Math.round(c),y=Math.round(S),w=h!==0||y!==0;this.clearHistoryNextFrame?(this.cumulativeShiftX=0,this.cumulativeShiftY=0):(this.cumulativeShiftX+=h,this.cumulativeShiftY+=y,$(this.zoomState)&&(this.frozenPanShiftX+=h,this.frozenPanShiftY+=y),w&&(this.frozenAligned=!1)),w&&!$(this.zoomState)&&(this.needFreezeSnapshot=!1);const l=(this.cumulativeShiftX%a+a)%a,v=(this.cumulativeShiftY%a+a)%a,u=this.hasPendingCounterReadbackForCurrentGeneration(),_=!u&&(this.clearHistoryNextFrame||this.activePixelCount<0||this.iterationBatchSize>Qe||this.activePixelCount<Ga*this.gpuLoadMultiplier);_&&this.refinementWasGated&&(this.iterationBatchSize=Qe),this.refinementWasGated=!_;const x=_?1:0,B=new Float32Array([n,this.previousMandelbrot.angle,o,i,a,c,S,this.previousMandelbrot.mu,l,v,$(this.zoomState)?r:0,x]);this.device.queue.writeBuffer(this.uniformBufferBrush,0,B.buffer);const F=new Float32Array([this.previousMandelbrot.mu,l,v]);this.device.queue.writeBuffer(this.uniformBufferResolve,0,F.buffer);const G=!u&&(this.unfinishedPixelCount<0||this.activePixelCount<0||s-this.lastCounterDispatchFrame>=wt)?this.acquireCounterReadbackSlot():void 0;let M;const z=this.device.createCommandEncoder();if(this.needMergeSnapshot&&this.pipelineMerge&&this.bindGroupMerge&&this.resolvedTexture&&this.frozenTexture&&this.rawBrushTexture){const T=this.neutralSize;z.copyTextureToTexture({texture:this.frozenTexture},{texture:this.rawBrushTexture},{width:T,height:T,depthOrArrayLayers:Te});const C=new Float32Array([this.mergeUniforms.zf,this.mergeUniforms.lzf,this.mergeUniforms.frozenShiftU,this.mergeUniforms.frozenShiftV,this.mergeUniforms.aspect,this.mergeUniforms.angle]);this.device.queue.writeBuffer(this.uniformBufferMerge,0,C.buffer);const k=this.frozenLayerViews.map(U=>({view:U,clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store"})),E=z.beginRenderPass({colorAttachments:k});E.setPipeline(this.pipelineMerge),E.setBindGroup(0,this.bindGroupMerge),E.draw(6,1,0,0),E.end(),this.needMergeSnapshot=!1,this.frozenAligned=!0,this.frozenPanShiftX=0,this.frozenPanShiftY=0}if(this.needFreezeSnapshot&&this.resolvedTexture&&this.frozenTexture){const T=Te,C=this.neutralSize;z.copyTextureToTexture({texture:this.resolvedTexture},{texture:this.frozenTexture},{width:C,height:C,depthOrArrayLayers:T}),this.needFreezeSnapshot=!1,this.frozenAligned=!0,this.frozenPanShiftX=0,this.frozenPanShiftY=0,$(this.zoomState)||(this.frozenBaseShiftX=0,this.frozenBaseShiftY=0)}const D=(T,C="clear")=>T.map(k=>({view:k,clearValue:{r:0,g:0,b:0,a:0},loadOp:C,storeOp:"store"})),A=z.beginRenderPass({colorAttachments:D(this.rawBrushLayerViews)});A.setPipeline(this.pipelineBrush),A.setBindGroup(0,this.bindGroupBrush),A.draw(6,1,0,0),A.end(),z.copyTextureToTexture({texture:this.rawBrushTexture},{texture:this.rawTexture},{width:this.neutralSize,height:this.neutralSize,depthOrArrayLayers:Te});const W=z.beginRenderPass({colorAttachments:D(this.rawLayerViews,"load")});if(W.setPipeline(this.pipelineMandelbrot),W.setBindGroup(0,this.bindGroupMandelbrot),W.draw(6,1,0,0),W.end(),this.pipelineCount&&this.counterBindGroup&&this.counterBuffer&&G&&this.uniformBufferCount){const T=++this.counterReadbackSequence,C=this.counterReadbackGeneration,k=this.previousMandelbrot.mu;this.device.queue.writeBuffer(this.uniformBufferCount,0,new Float32Array([k,n,this.previousMandelbrot.angle])),z.clearBuffer(this.counterBuffer,0,8);const E=z.beginComputePass();E.setPipeline(this.pipelineCount),E.setBindGroup(0,this.counterBindGroup),E.dispatchWorkgroups(Math.ceil(this.neutralSize/16),Math.ceil(this.neutralSize/16)),E.end(),z.copyBufferToBuffer(this.counterBuffer,0,G.buffer,0,8),this.lastCounterDispatchFrame=s,M={slot:G,sequence:T,generation:C}}z.copyTextureToTexture({texture:this.rawTexture},{texture:this.resolvedTexture},{width:this.neutralSize,height:this.neutralSize,depthOrArrayLayers:Te});const Y=z.beginRenderPass({colorAttachments:D(this.resolvedLayerViews,"load")});Y.setPipeline(this.pipelineResolve),Y.setBindGroup(0,this.bindGroupResolve),Y.draw(6,1,0,0),Y.end();const fe=this.ctx.getCurrentTexture().createView(),q=z.beginRenderPass({colorAttachments:[{view:fe,clearValue:{r:1,g:1,b:1,a:1},loadOp:"clear",storeOp:"store"}]});q.setPipeline(this.pipelineColor),q.setBindGroup(0,this.bindGroupColor),q.draw(6,1,0,0),q.end();const se=performance.now();if(this.device.queue.submit([z.finish()]),this.scheduleGpuTiming(se),M&&this.scheduleCounterReadback(M.slot,M.sequence,M.generation),this.clearHistoryNextFrame=!1,this.prevFrameMandelbrot={...this.previousMandelbrot},this.needRender=!1,this.snapshotCallback){try{const T=this.snapshotDestWidth??256,C=Math.round(T*9/16),k=this.device.createTexture({size:[T,C,1],format:this.format,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.COPY_SRC});{const g=this.device.createCommandEncoder(),b=g.beginRenderPass({colorAttachments:[{view:k.createView(),clearValue:{r:0,g:0,b:0,a:1},loadOp:"clear",storeOp:"store"}]});b.setPipeline(this.pipelineColor),b.setBindGroup(0,this.bindGroupColor),b.draw(6,1,0,0),b.end(),this.device.queue.submit([g.finish()])}const E=g=>g+255&-256,U=T*4,j=E(U),Z=j*C,K=this.device.createBuffer({size:Z,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});{const g=this.device.createCommandEncoder();g.copyTextureToBuffer({texture:k},{buffer:K,offset:0,bytesPerRow:j},{width:T,height:C,depthOrArrayLayers:1}),this.device.queue.submit([g.finish()])}await this.device.queue.onSubmittedWorkDone(),await K.mapAsync(GPUMapMode.READ);const de=K.getMappedRange(),O=new Uint8ClampedArray(T*C*4),f=new Uint8Array(de);for(let g=0;g<C;++g)for(let b=0;b<T;++b){const R=g*j+b*4,L=(g*T+b)*4;O[L+0]=f[R+2],O[L+1]=f[R+1],O[L+2]=f[R+0],O[L+3]=f[R+3]}const m=document.createElement("canvas");m.width=T,m.height=C,m.getContext("2d").putImageData(new ImageData(O,T,C),0,0),K.unmap(),this.snapshotCallback(m.toDataURL("image/png"))}catch{this.snapshotCallback("")}this.snapshotCallback=void 0,this.snapshotDestWidth=void 0}}destroy(){this.stopRenderLoop(),this.postReferenceWorker({type:"dispose"}),this.referenceWorker?.terminate(),this.referenceWorker=void 0,this.rawTexture?.destroy?.(),this.rawBrushTexture?.destroy?.(),this.resolvedTexture?.destroy?.(),this.frozenTexture?.destroy?.(),this.mandelbrotReferenceBuffer?.destroy?.(),this.mandelbrotBlaBuffer?.destroy?.(),this.mandelbrotBlaLevelBuffer?.destroy?.(),this.uniformBufferMandelbrot?.destroy?.(),this.uniformBufferColor?.destroy?.(),this.uniformBufferBrush?.destroy?.(),this.uniformBufferResolve?.destroy?.(),this.counterBuffer?.destroy?.();for(const e of this.counterReadbackSlots)e.buffer.destroy?.();this.counterReadbackSlots=[],this.uniformBufferCount?.destroy?.(),this.uniformBufferMerge?.destroy?.(),this.webcamTexture?.closeWebcam(),this.webcamTileTexture?.destroy?.(),this.paletteTexture?.destroy?.()}needsMoreFrames(){let e="";return this.needRender?e="needRender":this.snapshotCallback?e="snapshot":$(this.zoomState)?e="zoomActive":this.clearHistoryNextFrame?e="clearHistory":this.needFreezeSnapshot?e="freezeSnapshot":this.needMergeSnapshot?e="mergeSnapshot":this.isReferenceValidating?e="referenceValidating":this.orbitIncomplete?e="orbitIncomplete":(this.unfinishedPixelCount<0||this.unfinishedPixelCount>St)&&(e=`unfinished=${this.unfinishedPixelCount}`),e!==""}getIterationBatchSize(){return this.iterationBatchSize}startRenderLoop(e){this._drawFn=e,this._rafId===null&&(this._rafId=requestAnimationFrame(async()=>this._loop()))}stopRenderLoop(){this._rafId!==null&&(cancelAnimationFrame(this._rafId),this._rafId=null),this._drawFn=null}async _loop(){if(this._drawFn){const e=this.needsMoreFrames();this.isRendering=e,await this._drawFn(),e&&this._fpsFrameCount++;const n=performance.now();this._fpsLastTime===0&&(this._fpsLastTime=n);const r=n-this._fpsLastTime;r>=1e3&&(this.fps=Math.round(this._fpsFrameCount*1e3/r),this._fpsFrameCount=0,this._fpsLastTime=n),this._rafId=requestAnimationFrame(async()=>this._loop())}else{this._rafId=null;return}}async updateTileTexture(e,n=e){if(this.tileTextureSourceKey===n)return;const r=await this._loadTexture(e);this.tileTexture?.destroy?.(),this.tileTexture=r,this.tileTextureView=this.tileTexture.createView(),this.tileTextureSourceKey=n,this.rebuildColorBindGroup(),this.needRender=!0}isTileTextureSourceCurrent(e){return this.tileTextureSourceKey===e}async updateSkyboxTexture(e,n=e){if(this.skyboxTextureSourceKey===n)return;const r=await this._loadTexture(e);this.skyboxTexture?.destroy?.(),this.skyboxTexture=r,this.skyboxTextureView=this.skyboxTexture.createView(),this.skyboxTextureSourceKey=n,this.rebuildColorBindGroup(),this.needRender=!0}isSkyboxTextureSourceCurrent(e){return this.skyboxTextureSourceKey===e}rebuildColorBindGroup(){if(this.pipelineColor&&this.resolvedArrayView&&this.frozenArrayView){const e=this.pipelineColor.getBindGroupLayout(0);this.bindGroupColor=this.device.createBindGroup({layout:e,entries:[{binding:0,resource:{buffer:this.uniformBufferColor}},{binding:1,resource:this.resolvedArrayView},{binding:2,resource:this.tileTextureView},{binding:3,resource:this.skyboxTextureView},{binding:4,resource:this.webcamTextureView},{binding:5,resource:this.paletteTextureView},{binding:6,resource:this.frozenArrayView},{binding:7,resource:this.paletteSampler},{binding:8,resource:this.skyboxSampler}],label:"Engine BindGroup Color"})}}async _loadTexture(e){const n=new Image;n.src=e;try{await n.decode()}catch(a){throw console.warn("\xc9chec du chargement de la texture : "+e,a),a}const r=await createImageBitmap(n,{premultiplyAlpha:"none"}),i=this.device.createTexture({size:[r.width,r.height,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT,label:"Engine LoadedTexture "+e});return this.device.queue.copyExternalImageToTexture({source:r},{texture:i},[r.width,r.height]),i}static ITER_PIXEL_LAYERS=[0,2,3,4,5];async readIterationDataAt(e,n,r,i){if(!this.resolvedTexture||!this.device)return null;const a=this.width/Math.max(1,this.height),o=this.previousMandelbrot?.angle??0,s=e/Math.max(1,r),c=1-n/Math.max(1,i),S=s*2-1,h=c*2-1,y=S*a,w=h,l=Math.sin(o),v=Math.cos(o),u=v*y-l*w,_=l*y+v*w,x=Math.sqrt(a*a+1),B=u/x,F=_/x,H=B*.5+.5,G=F*.5+.5,M=this.neutralSize,z=Math.floor(Math.max(0,Math.min(M-1,H*M))),D=Math.floor(Math.max(0,Math.min(M-1,(1-G)*M))),A=Vt.ITER_PIXEL_LAYERS,W=1,Y=4,q=(O=>O+255&-256)(W*Y),se=q*A.length,T=this.device.createBuffer({size:se,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ,label:"Engine IterPixel Readback"}),C=this.device.createCommandEncoder();for(let O=0;O<A.length;O++)C.copyTextureToBuffer({texture:this.resolvedTexture,origin:{x:z,y:D,z:A[O]}},{buffer:T,offset:q*O,bytesPerRow:q},{width:1,height:1,depthOrArrayLayers:1});this.device.queue.submit([C.finish()]),await T.mapAsync(GPUMapMode.READ);const k=new Float32Array(T.getMappedRange()),E=q/Y,U=k[0*E],j=k[1*E],Z=k[2*E],K=k[3*E],de=k[4*E];return T.unmap(),T.destroy(),U<0?null:{iter:U,zx:j,zy:Z,derX:K,derY:de}}async updateWebcamTexture(){try{await this.webcamTexture?.openWebcam(),this.webcamTexture?.isOpen()&&await this.webcamTexture?.drawWebGPUTexture(this.webcamTileTexture,this.device)}catch(e){console.warn("Webcam texture update failed:",e)}}async getSnapshotPng(e=256){return await new Promise(n=>{this.snapshotCallback=n,this.snapshotDestWidth=e,this.needRender=!0})}}let qa,Ya,$a,Za,ja,Ka,Ja,tt,_n,Qa,eo,to;qa={class:"mandelbrot-canvas-wrap"};Ya={key:0,class:"debug-legend","aria-hidden":"true"};Xa=kt({__name:"Mandelbrot",props:Oe({mu:{default:4},epsilon:{default:1e-9},colorStops:{default:()=>[{color:"#002500",position:0},{color:"#175b3d",position:.16},{color:"#ffceb6",position:.26},{color:"#edffff",position:.42},{color:"#ff8fbc",position:.7016397849462366},{color:"#a6003e",position:.8575},{color:"#100000",position:1}]},palettePeriod:{default:100},paletteOffset:{default:0},heightPaletteShift:{default:0},paletteMirror:{type:Boolean,default:!1},antialiasLevel:{default:1},activateAnimate:{type:Boolean,default:!1},debugShading:{type:Boolean,default:!1},dprMultiplier:{default:1},maxIterationMultiplier:{default:.1},targetFps:{default:60},gpuLoadMultiplier:{default:1},zoomMinBrushStep:{default:1},sentinelSeedStep:{default:64},interpolationMode:{default:"lab"},tessellationLevel:{default:0},displacementAmount:{default:0},animation:{default:()=>at(null,1)},animationSpeed:{default:1},ambientOcclusionStrength:{default:0},microBumpStrength:{default:0},subsurfaceStrength:{default:0},reliefDepth:{default:1},localShadowStrength:{default:0},lightAngle:{default:0},varnishStrength:{default:0},orbitTrapStrength:{default:0},phaseColoringStrength:{default:0},stripeFrequency:{default:8},textureMapping:{default:()=>yt({textureMappingMode:0})},textureMappingMode:{}},{cx:{default:"-1.9771995110313272619112808106831597"},cxModifiers:{},cy:{default:"0.0"},cyModifiers:{},scale:{default:"2.5"},scaleModifiers:{},angle:{default:0},angleModifiers:{}}),emits:Oe(["ready"],["update:cx","update:cy","update:scale","update:angle"]),setup(t,{expose:e,emit:n}){const r=Lt(null);let i=null,a=null,o,s=!1;const c=n,S=ie(t,"cx"),h=ie(t,"cy"),y=ie(t,"scale"),w=ie(t,"angle");Xe(()=>[S.value,h.value,y.value,w.value],([x,B,F,H],[G,M,z,D])=>{s||o&&(!x||!B||!F||((x!==G||B!==M)&&o.origin(x,B),F!==z&&o.scale(F),H!==D&&o.angle(Number(H))))},{flush:"sync"});const l=t;Xe(()=>l.dprMultiplier,x=>{a&&(a.dprMultiplier=x,_())}),Xe(()=>l.targetFps,x=>{a&&(a.targetFps=x)}),Xe(()=>l.gpuLoadMultiplier,x=>{a&&(a.gpuLoadMultiplier=x)});async function v(){if(!a||!o)return;const x=o.step();if(!x)return;const[B,F]=x,[H,G,M,z]=o.get_params();s=!0,S.value=H,h.value=G,y.value=M,w.value=parseFloat(z),await Kn(),s=!1;const D=Math.max(l.mu,4),A=Math.max(0,Math.ceil(Math.log2(Math.log(D)/Math.log(4)))),W=Math.min(Math.max(100,1e3*l.maxIterationMultiplier*Math.log2(1/parseFloat(M)))+A,1e5);await a.update({cx:H,cy:G,dx:parseFloat(B),dy:parseFloat(F),mu:l.mu,scale:parseFloat(M),angle:parseFloat(z),maxIterations:W,epsilon:l.epsilon},{antialiasLevel:l.antialiasLevel,palettePeriod:l.palettePeriod,paletteOffset:l.paletteOffset,heightPaletteShift:l.heightPaletteShift,paletteMirror:l.paletteMirror,colorStops:Jn(l.colorStops),interpolationMode:l.interpolationMode,activateAnimate:l.activateAnimate,debugShading:l.debugShading,tessellationLevel:l.tessellationLevel,displacementAmount:l.displacementAmount,animation:at(l.animation,l.animationSpeed),animationSpeed:l.animationSpeed,ambientOcclusionStrength:l.ambientOcclusionStrength,microBumpStrength:l.microBumpStrength,subsurfaceStrength:l.subsurfaceStrength,reliefDepth:l.reliefDepth,localShadowStrength:l.localShadowStrength,lightAngle:l.lightAngle,varnishStrength:l.varnishStrength,orbitTrapStrength:l.orbitTrapStrength,phaseColoringStrength:l.phaseColoringStrength,stripeFrequency:l.stripeFrequency,zoomMinBrushStep:l.zoomMinBrushStep,sentinelSeedStep:l.sentinelSeedStep,textureMapping:yt(l),textureMappingMode:l.textureMappingMode}),await a.render()}async function u(){if(r.value)return i=r.value,o=new Mt(S.value,h.value,y.value,Number(w.value)),o.origin(S.value,h.value),o.scale(y.value),o.angle(Number(w.value)),a=new Vt(i,{antialiasLevel:l.antialiasLevel,palettePeriod:l.palettePeriod,paletteOffset:l.paletteOffset,heightPaletteShift:l.heightPaletteShift,paletteMirror:l.paletteMirror,colorStops:l.colorStops,interpolationMode:l.interpolationMode,activateAnimate:l.activateAnimate,debugShading:l.debugShading,tessellationLevel:l.tessellationLevel,displacementAmount:l.displacementAmount,animation:at(l.animation,l.animationSpeed),animationSpeed:l.animationSpeed,ambientOcclusionStrength:l.ambientOcclusionStrength,microBumpStrength:l.microBumpStrength,subsurfaceStrength:l.subsurfaceStrength,reliefDepth:l.reliefDepth,localShadowStrength:l.localShadowStrength,lightAngle:l.lightAngle,varnishStrength:l.varnishStrength,orbitTrapStrength:l.orbitTrapStrength,phaseColoringStrength:l.phaseColoringStrength,stripeFrequency:l.stripeFrequency,zoomMinBrushStep:l.zoomMinBrushStep,sentinelSeedStep:l.sentinelSeedStep,textureMapping:yt(l),textureMappingMode:l.textureMappingMode}),a.dprMultiplier=l.dprMultiplier??1,a.targetFps=l.targetFps??60,a.gpuLoadMultiplier=l.gpuLoadMultiplier??1,a.initialize(o)}async function _(){if(!r.value||!a)return;const x=r.value.getBoundingClientRect();r.value.width=x.width,r.value.height=x.height,a.resize()}return vn(async()=>{await u(),window.addEventListener("resize",_),await _(),a&&(c("ready",a),a.startRenderLoop(v))}),bn(()=>{a?.destroy(),a=null,window.removeEventListener("resize",_)}),e({getCanvas:()=>r.value,getEngine:()=>a,getNavigator:()=>o,translate:(x,B)=>o?.translate(x,B),translateDirect:(x,B)=>o?.translate_direct(x,B),rotate:x=>o?.rotate(x),angle:x=>o?.angle(x),zoom:x=>o?.zoom(x),step:()=>o?.step(),getParams:()=>o?.get_params(),drawOnce:async()=>v(),resize:async()=>_(),initialize:async()=>u(),useBla:()=>a?.setApproximationMode("bla"),usePerturbation:()=>a?.setApproximationMode("perturbation"),setApproximationMode:x=>a?.setApproximationMode(x),getApproximationMode:()=>a?.getApproximationMode(),setBlaEpsilon:x=>a?.setBlaEpsilon(x)}),(x,B)=>(Le(),Pe("div",qa,[I("canvas",{ref_key:"canvasRef",ref:r},null,512),l.debugShading?(Le(),Pe("div",Ya,[...B[0]||(B[0]=[I("div",{class:"debug-legend-item debug-legend-top-left"},"Distance au bord",-1),I("div",{class:"debug-legend-item debug-legend-top-right"},"Palette / phase continue",-1),I("div",{class:"debug-legend-item debug-legend-bottom-left"},"Gradient du relief",-1),I("div",{class:"debug-legend-item debug-legend-bottom-right"},"Angle de la d\xe9riv\xe9e",-1)])])):xn("",!0)]))}});$a={class:"mobile-nav-controls"};Za={key:0,class:"directional-controls"};ja=kt({__name:"MobileNavigationControls",props:Oe({mandelbrotRef:{}},{expanded:{type:Boolean,default:!1},expandedModifiers:{}}),emits:["update:expanded"],setup(t){const e=t,n=ie(t,"expanded"),r=Lt(null);let i=null;const a=()=>{n.value=!n.value,n.value||s()},o=v=>{v.preventDefault(),v.stopPropagation(),a()},s=()=>{r.value=null,i!==null&&(clearInterval(i),i=null)},c=v=>{r.value=v;const u=.01,_=()=>{if(e.mandelbrotRef)switch(v){case"north":e.mandelbrotRef.translate(0,u);break;case"south":e.mandelbrotRef.translate(0,-u);break;case"west":e.mandelbrotRef.translate(-u,0);break;case"east":e.mandelbrotRef.translate(u,0);break}};_(),i=window.setInterval(_,16)},S=v=>{r.value=`rotate-${v}`;const u=.025,_=()=>{e.mandelbrotRef&&(v==="left"?e.mandelbrotRef.rotate(u):e.mandelbrotRef.rotate(-u))};_(),i=window.setInterval(_,16)},h=v=>{r.value=`zoom-${v}`;const u=.97,_=()=>{e.mandelbrotRef&&(v==="in"?e.mandelbrotRef.zoom(u):e.mandelbrotRef.zoom(1/u))};_(),i=window.setInterval(_,16)},y=(v,u)=>{v.preventDefault(),u()},w=v=>{v.preventDefault(),s()};function l(v){v.preventDefault(),v.stopPropagation(),window.location.href=new URL("./presentation/",window.location.href).href}return(v,u)=>(Le(),Pe("div",$a,[I("button",{class:le(["nav-button compass-button",{active:n.value}]),onClick:a,onTouchend:o,"aria-label":"Toggle navigation"},[...u[16]||(u[16]=[I("i",{class:"fa-solid fa-compass fa-2x nav-icon"},null,-1)])],34),zt(Qn,{name:"fade"},{default:er(()=>[n.value?(Le(),Pe("div",Za,[I("button",{class:le(["nav-button direction-button north",{active:r.value==="north"}]),onTouchstart:u[0]||(u[0]=_=>y(_,()=>c("north"))),onTouchend:w,onMousedown:u[1]||(u[1]=_=>c("north")),onMouseup:s,onMouseleave:s,"aria-label":"Move North"},[...u[17]||(u[17]=[I("i",{class:"fa-solid fa-arrow-up fa-3x nav-icon"},null,-1)])],34),I("button",{class:le(["nav-button direction-button south",{active:r.value==="south"}]),onTouchstart:u[2]||(u[2]=_=>y(_,()=>c("south"))),onTouchend:w,onMousedown:u[3]||(u[3]=_=>c("south")),onMouseup:s,onMouseleave:s,"aria-label":"Move South"},[...u[18]||(u[18]=[I("i",{class:"fa-solid fa-arrow-down fa-3x nav-icon"},null,-1)])],34),I("button",{class:le(["nav-button direction-button west",{active:r.value==="west"}]),onTouchstart:u[4]||(u[4]=_=>y(_,()=>c("west"))),onTouchend:w,onMousedown:u[5]||(u[5]=_=>c("west")),onMouseup:s,onMouseleave:s,"aria-label":"Move West"},[...u[19]||(u[19]=[I("i",{class:"fa-solid fa-arrow-left fa-3x nav-icon"},null,-1)])],34),I("button",{class:le(["nav-button direction-button east",{active:r.value==="east"}]),onTouchstart:u[6]||(u[6]=_=>y(_,()=>c("east"))),onTouchend:w,onMousedown:u[7]||(u[7]=_=>c("east")),onMouseup:s,onMouseleave:s,"aria-label":"Move East"},[...u[20]||(u[20]=[I("i",{class:"fa-solid fa-arrow-right fa-3x nav-icon"},null,-1)])],34),I("button",{class:le(["nav-button corner-button rotate-left",{active:r.value==="rotate-left"}]),onTouchstart:u[8]||(u[8]=_=>y(_,()=>S("left"))),onTouchend:w,onMousedown:u[9]||(u[9]=_=>S("left")),onMouseup:s,onMouseleave:s,"aria-label":"Rotate Left"},[...u[21]||(u[21]=[I("i",{class:"fa-solid fa-rotate-left fa-2x nav-icon"},null,-1)])],34),I("button",{class:le(["nav-button corner-button rotate-right",{active:r.value==="rotate-right"}]),onTouchstart:u[10]||(u[10]=_=>y(_,()=>S("right"))),onTouchend:w,onMousedown:u[11]||(u[11]=_=>S("right")),onMouseup:s,onMouseleave:s,"aria-label":"Rotate Right"},[...u[22]||(u[22]=[I("i",{class:"fa-solid fa-rotate-right fa-2x nav-icon"},null,-1)])],34),I("button",{class:le(["nav-button corner-button zoom-out",{active:r.value==="zoom-out"}]),onTouchstart:u[12]||(u[12]=_=>y(_,()=>h("out"))),onTouchend:w,onMousedown:u[13]||(u[13]=_=>h("out")),onMouseup:s,onMouseleave:s,"aria-label":"Zoom Out"},[...u[23]||(u[23]=[I("i",{class:"fa-solid fa-magnifying-glass-minus fa-2x nav-icon"},null,-1)])],34),I("button",{class:le(["nav-button corner-button zoom-in",{active:r.value==="zoom-in"}]),onTouchstart:u[14]||(u[14]=_=>y(_,()=>h("in"))),onTouchend:w,onMousedown:u[15]||(u[15]=_=>h("in")),onMouseup:s,onMouseleave:s,"aria-label":"Zoom In"},[...u[24]||(u[24]=[I("i",{class:"fa-solid fa-magnifying-glass-plus fa-2x nav-icon"},null,-1)])],34),I("button",{class:"presentation-button",onTouchend:nr(l,["prevent","stop"]),onClick:l,"aria-label":"Pr\xe9sentation"},[...u[25]||(u[25]=[I("i",{class:"fa-solid fa-display fa-fw",style:{"vertical-align":"middle","margin-right":"4px"}},null,-1),tr(" Pr\xe9sentation ",-1)])],32)])):xn("",!0)]),_:1})]))}});Ka=yn(ja,[["__scopeId","data-v-500c48c0"]]);Ja={style:{position:"relative",width:"100%",height:"100%"}};tt=.01;_n=.025;Qa=300;eo=30;to=kt({__name:"MandelbrotController",props:Oe({mu:{},epsilon:{},colorStops:{},antialiasLevel:{},palettePeriod:{},paletteOffset:{},heightPaletteShift:{},paletteMirror:{type:Boolean},activateAnimate:{type:Boolean},debugShading:{type:Boolean},dprMultiplier:{},maxIterationMultiplier:{},targetFps:{},gpuLoadMultiplier:{},zoomMinBrushStep:{},sentinelSeedStep:{},interpolationMode:{},pickerMode:{type:Boolean},tessellationLevel:{},displacementAmount:{},animation:{},animationSpeed:{},ambientOcclusionStrength:{},microBumpStrength:{},subsurfaceStrength:{},reliefDepth:{},localShadowStrength:{},lightAngle:{},varnishStrength:{},orbitTrapStrength:{},phaseColoringStrength:{},stripeFrequency:{},textureMapping:{},textureMappingMode:{}},{cx:{},cxModifiers:{},cy:{},cyModifiers:{},scale:{},scaleModifiers:{},angle:{},angleModifiers:{},mobileNavExpanded:{type:Boolean,default:!1},mobileNavExpandedModifiers:{}}),emits:Oe(["palettePick","pickerDone","engineReady"],["update:cx","update:cy","update:scale","update:angle","update:mobileNavExpanded"]),setup(t,{expose:e,emit:n}){const r=ie(t,"cx"),i=ie(t,"cy"),a=ie(t,"scale"),o=ie(t,"angle"),s=ie(t,"mobileNavExpanded"),c=t,S=n,h=Lt(null),y={};e({getCanvas:A,getEngine:()=>h.value?.getEngine()??null});let w=!1,l=!1,v=0,u=0,_=0,x=0,B=0,F=!1,H=0,G=null,M=0,z=0,D=0;function A(){return h.value?.getCanvas()??null}function W(f){const m=A();if(!m)return{x:0,y:0,width:0,height:0};const g=m.getBoundingClientRect();return{x:f.clientX-g.left,y:f.clientY-g.top,width:g.width,height:g.height}}function Y(f){const m=f.target?.tagName?.toLowerCase();m==="input"||m==="textarea"||m==="select"||f.target?.isContentEditable||(y[f.code]=!0)}function fe(f){y[f.code]=!1}function q(f){if(c.pickerMode){f.preventDefault();return}f.preventDefault();const m=.95;f.deltaY<0?h.value?.zoom(m):h.value?.zoom(1/m)}function se(f,m){const g=A();if(!g)return;const b=g.getBoundingClientRect(),R=f-b.left,L=m-b.top,V=b.width,X=b.height,J=V/X,pe=(R-V/2)/V*2,_e=(L-X/2)/X*2;h.value?.translateDirect(pe*J,-_e)}function T(f){if(c.pickerMode){f.preventDefault();return}f.preventDefault(),se(f.clientX,f.clientY)}function C(f){if(c.pickerMode||f.touches.length!==0)return;const m=Date.now(),g=f.changedTouches[0];if(!g)return;const b=g.clientX,R=g.clientY;m-M<Qa&&Math.hypot(b-z,R-D)<eo?(f.preventDefault(),se(b,R),M=0):(M=m,z=b,D=R)}function k(f){if(c.pickerMode){f.preventDefault(),E(f);return}if(f.button===2)l=!0;else{w=!0;const m=W(f);v=m.x,u=m.y}}async function E(f){try{const m=h.value?.getEngine();if(!m)return;const g=A();if(!g)return;const b=g.getBoundingClientRect(),R=f.clientX-b.left,L=f.clientY-b.top,V=await m.readIterationDataAt(R,L,b.width,b.height);if(!V)return;S("palettePick",V,f.clientX,f.clientY)}finally{S("pickerDone")}}function U(f){if(c.pickerMode)return;const m=W(f);if(l){const X=A();if(!X)return;const J=X.getBoundingClientRect(),pe=J.width/2,_e=J.height/2,te=m.x,Ie=m.y,ve=Math.atan2(Ie-_e,te-pe);h.value?.angle(ve);return}if(!w)return;const g=m.width,b=m.height,R=g/b,L=(m.x-v)/g*2,V=(m.y-u)/b*2;h.value?.translateDirect(-L*R,V),v=m.x,u=m.y}function j(f){c.pickerMode||(f.button===2?l=!1:w=!1)}function Z(f){if(c.pickerMode)return;const m=A();if(m){if(f.touches.length===1){w=!0;const g=f.touches[0],b=m.getBoundingClientRect();v=g.clientX-b.left,u=g.clientY-b.top}else if(f.touches.length===2){w=!1,F=!0;const[g,b]=f.touches;_=Math.hypot(b.clientX-g.clientX,b.clientY-g.clientY),H=_,x=Math.atan2(b.clientY-g.clientY,b.clientX-g.clientX);const R=h.value?.getParams();B=R?parseFloat(R[3]):0}}}function K(f){if(c.pickerMode)return;const m=A();if(m){if(w&&f.touches.length===1){const g=f.touches[0],b=m.getBoundingClientRect(),R=g.clientX-b.left,L=g.clientY-b.top,V=b.width,X=b.height,J=V/X,pe=(R-v)/V*2,_e=(L-u)/X*2;h.value?.translateDirect(-pe*J,_e),v=R,u=L}else if(F&&f.touches.length===2){const[g,b]=f.touches,R=Math.hypot(b.clientX-g.clientX,b.clientY-g.clientY),L=Math.atan2(b.clientY-g.clientY,b.clientX-g.clientX),V=H/R;H=R,h.value?.zoom(V);const X=L-x;h.value?.angle(B+X)}}}function de(f){f.touches.length===0&&(w=!1,F=!1)}function O(){if(!c.pickerMode){y.KeyW&&h.value?.translate(0,tt),y.KeyS&&h.value?.translate(0,-tt),y.KeyA&&h.value?.translate(-tt,0),y.KeyD&&h.value?.translate(tt,0),y.KeyQ&&h.value?.rotate(_n),y.KeyE&&h.value?.rotate(-_n);const f=.97;y.KeyR&&h.value?.zoom(f),y.KeyF&&h.value?.zoom(1/f)}G=window.setTimeout(O,16)}return vn(async()=>{const f=A();f&&(window.addEventListener("keydown",Y),window.addEventListener("keyup",fe),f.addEventListener("wheel",q,{passive:!1}),f.addEventListener("mousedown",k),f.addEventListener("dblclick",T),f.addEventListener("contextmenu",m=>m.preventDefault()),window.addEventListener("mousemove",U),window.addEventListener("mouseup",j),f.addEventListener("touchstart",Z,{passive:!1}),f.addEventListener("touchmove",K,{passive:!1}),f.addEventListener("touchend",de,{passive:!1}),f.addEventListener("touchend",C,{passive:!1}),O())}),bn(()=>{G!==null&&clearTimeout(G);const f=A();window.removeEventListener("keydown",Y),window.removeEventListener("keyup",fe),window.removeEventListener("mousemove",U),window.removeEventListener("mouseup",j),f&&(f.removeEventListener("wheel",q),f.removeEventListener("mousedown",k),f.removeEventListener("dblclick",T),f.removeEventListener("contextmenu",m=>m.preventDefault()),f.removeEventListener("touchstart",Z),f.removeEventListener("touchmove",K),f.removeEventListener("touchend",de),f.removeEventListener("touchend",C))}),(f,m)=>(Le(),Pe("div",Ja,[zt(Xa,{ref_key:"mandelbrotRef",ref:h,scale:a.value,"onUpdate:scale":m[0]||(m[0]=g=>a.value=g),angle:o.value,"onUpdate:angle":m[1]||(m[1]=g=>o.value=g),cx:r.value,"onUpdate:cx":m[2]||(m[2]=g=>r.value=g),cy:i.value,"onUpdate:cy":m[3]||(m[3]=g=>i.value=g),mu:c.mu,epsilon:c.epsilon,antialiasLevel:c.antialiasLevel,palettePeriod:c.palettePeriod,heightPaletteShift:c.heightPaletteShift,paletteMirror:c.paletteMirror,colorStops:c.colorStops,activateAnimate:c.activateAnimate,debugShading:c.debugShading,paletteOffset:c.paletteOffset,dprMultiplier:c.dprMultiplier,maxIterationMultiplier:c.maxIterationMultiplier,targetFps:c.targetFps,gpuLoadMultiplier:c.gpuLoadMultiplier,zoomMinBrushStep:c.zoomMinBrushStep,sentinelSeedStep:c.sentinelSeedStep,interpolationMode:c.interpolationMode,tessellationLevel:c.tessellationLevel,displacementAmount:c.displacementAmount,animation:c.animation,animationSpeed:c.animationSpeed,ambientOcclusionStrength:c.ambientOcclusionStrength,microBumpStrength:c.microBumpStrength,subsurfaceStrength:c.subsurfaceStrength,reliefDepth:c.reliefDepth,localShadowStrength:c.localShadowStrength,lightAngle:c.lightAngle,varnishStrength:c.varnishStrength,orbitTrapStrength:c.orbitTrapStrength,phaseColoringStrength:c.phaseColoringStrength,stripeFrequency:c.stripeFrequency,textureMapping:c.textureMapping,textureMappingMode:c.textureMappingMode,onReady:m[4]||(m[4]=g=>S("engineReady",g))},null,8,["scale","angle","cx","cy","mu","epsilon","antialiasLevel","palettePeriod","heightPaletteShift","paletteMirror","colorStops","activateAnimate","debugShading","paletteOffset","dprMultiplier","maxIterationMultiplier","targetFps","gpuLoadMultiplier","zoomMinBrushStep","sentinelSeedStep","interpolationMode","tessellationLevel","displacementAmount","animation","animationSpeed","ambientOcclusionStrength","microBumpStrength","subsurfaceStrength","reliefDepth","localShadowStrength","lightAngle","varnishStrength","orbitTrapStrength","phaseColoringStrength","stripeFrequency","textureMapping","textureMappingMode"]),zt(Ka,{"mandelbrot-ref":h.value,expanded:s.value,"onUpdate:expanded":m[5]||(m[5]=g=>s.value=g)},null,8,["mandelbrot-ref","expanded"])]))}});ro=yn(to,[["__scopeId","data-v-919f34b4"]])})();export{ro as M,Xa as _,__tla};