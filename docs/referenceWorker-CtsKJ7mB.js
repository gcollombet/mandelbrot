(async ()=>{
    var X = "" + new URL("mandelbrot_bg-BJ-0Wmla.wasm", import.meta.url).href, Z = async (_ = {}, e)=>{
        let n;
    ...
    N();
    const C = self;
    let s, c = 0, z = !1, u = 0, v = 0, I = !1, y = !1, S = "", U = "";
    const k_ = 1e3;
    function E(_, e) {
        C.postMessage(_, e ?? []);
    }
    ...
    function E_(_) {
        s?.free(), s = new T(_.cx, _.cy, _.scale, _.angle), c = _.jobId, u = 0, v = _.maxIterations, y = !1, S = "", U = "", J(_.approximationMode), s.set_bla_epsilon(_.blaEpsilon), h(_.jobId);
    }
    function B_(_, e, n) {
    ...
    async function h(_) {
        if (!I) {
            ...
            try {
                ...
                I = !1, !z && s && _ === c && (Math.max(0, s.get_reference_orbit_len()) < v || y) && h(_);
            }
        }
    }
    C.onmessage = (_)=>{
        ...
        try {
            switch(e.type){
                case "reset":
                    ...
                    break;
                case "updateView":
                    s && e.jobId === c && (s.origin(e.cx, e.cy), s.scale(e.scale), s.angle(e.angle), v = e.maxIterations, y = !0, h(e.jobId));
                    break;
