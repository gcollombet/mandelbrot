...
(function() {
  ...
  (async () => {
    var X = "" + new URL("mandelbrot_bg-BJ-0Wmla.wasm", _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("_virtual_referenceWorker-CtsKJ7mB.js", document.baseURI).href).href, Z = async (_ = {}, e) => {
      let n;
    ...
    let B = 0;
    function G(_, e) {
      return B += e, B >= q && (M = new TextDecoder("utf-8", {
        ignoreBOM: true,
        fatal: true
      }), M.decode(), B = e), M.decode(F().subarray(_, _ + e));
    }
    function V(_, e) {
      return _ = _ >>> 0, G(_, e);
    }
    let d = null;
    function Q() {
      return (d === null || d.buffer.detached === true || d.buffer.detached === void 0 && d.buffer !== r.memory.buffer) && (d = new DataView(r.memory.buffer)), d;
    }
    function A(_, e) {
      _ = _ >>> 0;
      const n = Q(), o = [];
      for (let b = _; b < _ + 4 * e; b += 4) o.push(r.__wbindgen_export_0.get(n.getUint32(b, true)));
    ...
    function f(_, e, n) {
      if (n === void 0) {
        ...
        return F().subarray(p, p + l.length).set(l), g = l.length, p;
      }
      ...
      if (a !== o) {
        ...
        const l = F().subarray(b + a, b + o), p = m.encodeInto(_, l);
    ...
    class T {
      ...
      reference_origin(e, n) {
        const o = f(e, r.__wbindgen_malloc, r.__wbindgen_realloc), b = g, i = f(n, r.__wbindgen_malloc, r.__wbindgen_realloc), a = g;
      ...
      constructor(e, n, o, b) {
        const i = f(e, r.__wbindgen_malloc, r.__wbindgen_realloc), a = g, l = f(n, r.__wbindgen_malloc, r.__wbindgen_realloc), p = g, Y = f(o, r.__wbindgen_malloc, r.__wbindgen_realloc), H = g, K = r.mandelbrotnavigator_new(i, a, l, p, Y, H, b);
      ...
      scale(e) {
        const n = f(e, r.__wbindgen_malloc, r.__wbindgen_realloc), o = g;
    ...
    function ne() {
      ...
      _.set(0, void 0), _.set(e + 0, void 0), _.set(e + 1, null), _.set(e + 2, true), _.set(e + 3, false);
    }
    URL = globalThis.URL;
    const t = await Z({
      "./mandelbrot_bg.js": {
    ...
    N();
    const C = self;
    let s, c = 0, z = false, u = 0, v = 0, I = false, y = false, S = "", U = "";
    const k_ = 1e3;
    function E(_, e) {
      C.postMessage(_, e ?? []);
    }
    ...
    function E_(_) {
      s?.free(), s = new T(_.cx, _.cy, _.scale, _.angle), c = _.jobId, u = 0, v = _.maxIterations, y = false, S = "", U = "", J(_.approximationMode), s.set_bla_epsilon(_.blaEpsilon), h(_.jobId);
    }
    function B_(_, e, n) {
      const b = Math.max(0, n - e), i = new Float32Array(k.buffer, _ + e * 4 * Float32Array.BYTES_PER_ELEMENT, b * 4), a = new Float32Array(i.length);
      return a.set(i), a;
    }
    function j(_, e, n) {
      if (!s || _ !== c || z || u >= e || n < e || s.get_approximation_mode() !== 1) return;
      const o = s.compute_bla_reference_ptr(e), b = new Float32Array(k.buffer, o.ptr, o.count * 6), i = new Float32Array(b.length);
      i.set(b);
      const a = new Uint32Array(k.buffer, o.levels_ptr, o.level_count * 4), l = new Uint32Array(a.length);
      l.set(a), u = e, E({
        type: "blaReady",
        jobId: _,
        maxIterations: e,
    ...
    async function h(_) {
      if (!I) {
        ...
        try {
          ...
          I = false, !z && s && _ === c && (Math.max(0, s.get_reference_orbit_len()) < v || y) && h(_);
        }
      }
    }
    C.onmessage = (_) => {
      ...
      try {
        switch (e.type) {
          case "reset":
            ...
            break;
          case "updateView":
            s && e.jobId === c && (s.origin(e.cx, e.cy), s.scale(e.scale), s.angle(e.angle), v = e.maxIterations, y = true, h(e.jobId));
            break;
          case "setApproximationMode":
            e.jobId === c && (J(e.approximationMode), u = 0, h(e.jobId));
            break;
          case "setBlaEpsilon":
            s && e.jobId === c && (s.set_bla_epsilon(e.blaEpsilon), u = 0, h(e.jobId));
            break;
          case "dispose":
            z = true, s?.free(), s = void 0, C.close();
            break;
        }
      } catch (n) {
        P("jobId" in e ? e.jobId : c, n);
      }
    };
  })();
})();
