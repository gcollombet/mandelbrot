(async ()=>{
    var X = "" + new URL("mandelbrot_bg-BLG1jeGH.wasm", import.meta.url).href, Z = async (t = {}, e)=>{
        let n;
        if (e.startsWith("data:")) {
            ...
            n = await WebAssembly.instantiate(b, t);
        } else {
            const o = await fetch(e), b = o.headers.get("Content-Type") || "";
            if ("instantiateStreaming" in WebAssembly && b.startsWith("application/wasm")) n = await WebAssembly.instantiateStreaming(o, t);
            else {
    ...
    function Q(t, e) {
        return U += e, U >= q && (B = new TextDecoder("utf-8", {
            ignoreBOM: !0,
            fatal: !0
        }), B.decode(), U = e), B.decode(E().subarray(t, t + e));
    }
    function H(t, e) {
        return t = t >>> 0, Q(t, e);
    }
    ...
    function S(t, e) {
        t = t >>> 0;
        const n = ee(), o = [];
        for(let b = t; b < t + 4 * e; b += 4)o.push(_.__wbindgen_export_0.get(n.getUint32(b, !0)));
    ...
    function c(t, e, n) {
        if (n === void 0) {
            ...
            return E().subarray(f, f + l.length).set(l), g = l.length, f;
        }
        ...
        if (a !== o) {
            a !== 0 && (t = t.slice(a)), b = n(b, o, o = a + t.length * 3, 1) >>> 0;
            const l = E().subarray(b + a, b + o), f = y.encodeInto(t, l);
            a += f.written, b = n(b, o, a, 1) >>> 0;
        }
        return g = a, b;
    }
    let k = null;
    ...
    class L {
        ...
        pixel_to_complex(e, n, o, b) {
            const i = _.mandelbrotnavigator_pixel_to_complex(this.__wbg_ptr, e, n, o, b);
            var a = S(i[0], i[1]).slice();
            return _.__wbindgen_free(i[0], i[1] * 4, 4), a;
        }
        reference_origin(e, n) {
            const o = c(e, _.__wbindgen_malloc, _.__wbindgen_realloc), b = g, i = c(n, _.__wbindgen_malloc, _.__wbindgen_realloc), a = g;
            _.mandelbrotnavigator_reference_origin(this.__wbg_ptr, o, b, i, a);
        }
        start_transition(e, n, o, b, i) {
            const a = c(e, _.__wbindgen_malloc, _.__wbindgen_realloc), l = g, f = c(n, _.__wbindgen_malloc, _.__wbindgen_realloc), p = g, v = c(o, _.__wbindgen_malloc, _.__wbindgen_realloc), C = g;
            _.mandelbrotnavigator_start_transition(this.__wbg_ptr, a, l, f, p, v, C, b, i);
        }
        translate_direct(e, n) {
            _.mandelbrotnavigator_translate_direct(this.__wbg_ptr, e, n);
        }
        use_perturbation() {
        ...
        coordinate_to_pixel(e, n, o, b) {
            const i = c(e, _.__wbindgen_malloc, _.__wbindgen_realloc), a = g, l = c(n, _.__wbindgen_malloc, _.__wbindgen_realloc), f = g, p = _.mandelbrotnavigator_coordinate_to_pixel(this.__wbg_ptr, i, a, l, f, o, b);
        ...
        constructor(e, n, o, b){
            const i = c(e, _.__wbindgen_malloc, _.__wbindgen_realloc), a = g, l = c(n, _.__wbindgen_malloc, _.__wbindgen_realloc), f = g, p = c(o, _.__wbindgen_malloc, _.__wbindgen_realloc), v = g, C = _.mandelbrotnavigator_new(i, a, l, f, p, v, b);
            return this.__wbg_ptr = C >>> 0, V.register(this, this.__wbg_ptr, this), this;
        }
        step() {
        ...
        scale(e) {
            const n = c(e, _.__wbindgen_malloc, _.__wbindgen_realloc), o = g;
    ...
    const r = await Z({
        "./mandelbrot_bg.js": {
            __wbg_now_1e80617bcee43265: ne,
            __wbg_exp_9293ded1248e1bd3: re,
            __wbg_wbindgenthrow_451ec1a8469d7eb6: oe,
            __wbindgen_init_externref_table: be,
            __wbindgen_cast_2241b6af4c4b2941: ae
        }
    }, X), T = r.memory, ie = r.__wbg_blabufferinfo_free, se = r.__wbg_blalevel_free, le = r.__wbg_blastep_free, ge = r.__wbg_get_blabufferinfo_count, ce = r.__wbg_get_blabufferinfo_level_count, fe = r.__wbg_get_blabufferinfo_levels_ptr, de = r.__wbg_get_blabufferinfo_ptr, pe = r.__wbg_get_blastep_ax, we = r.__wbg_get_blastep_ay, ue = r.__wbg_get_blastep_bx, me = r.__wbg_get_blastep_by, ve = r.__wbg_get_blastep_radius_alpha, ye = r.__wbg_get_blastep_radius_beta, he = r.__wbg_mandelbrotnavigator_free, xe = r.__wbg_mandelbrotstep_free, ze = r.__wbg_orbitbufferinfo_free, Fe = r.__wbg_set_blabufferinfo_count, Ae = r.__wbg_set_blabufferinfo_level_count, Re = r.__wbg_set_blabufferinfo_levels_ptr, Me = r.__wbg_set_blabufferinfo_ptr, Se = r.__wbg_set_blastep_ax, ke = r.__wbg_set_blastep_ay, Ee = r.__wbg_set_blastep_bx, Be = r.__wbg_set_blastep_by, Ie = r.__wbg_set_blastep_radius_alpha, Te = r.__wbg_set_blastep_radius_beta, Ce = r.mandelbrotnavigator_angle, Ue = r.mandelbrotnavigator_cancel_transition, We = r.mandelbrotnavigator_compute_bla_reference_ptr, Le = r.mandelbrotnavigator_compute_reference_orbit_chunk, je = r.mandelbrotnavigator_compute_reference_orbit_ptr, De = r.mandelbrotnavigator_coordinate_to_pixel, Oe = r.mandelbrotnavigator_get_approximation_mode, Ve = r.mandelbrotnavigator_get_bla_epsilon, Ne = r.mandelbrotnavigator_get_params, Pe = r.mandelbrotnavigator_get_reference_orbit_capacity, Ge = r.mandelbrotnavigator_get_reference_orbit_len, He = r.mandelbrotnavigator_get_reference_params, Je = r.mandelbrotnavigator_is_in_transition, Ye = r.mandelbrotnavigator_new, Ke = r.mandelbrotnavigator_origin, Xe = r.mandelbrotnavigator_pixel_to_complex, Ze = r.mandelbrotnavigator_reference_origin, $e = r.mandelbrotnavigator_rotate, qe = r.mandelbrotnavigator_rotate_direct, Qe = r.mandelbrotnavigator_scale, et = r.mandelbrotnavigator_set_bla_epsilon, tt = r.mandelbrotnavigator_start_transition, _t = r.mandelbrotnavigator_step, rt = r.mandelbrotnavigator_translate, nt = r.mandelbrotnavigator_translate_direct, ot = r.mandelbrotnavigator_use_bla, at = r.mandelbrotnavigator_use_perturbation, bt = r.mandelbrotnavigator_zoom, it = r.__wbg_set_blalevel_count, st = r.__wbg_set_blalevel_max_radius_bits, lt = r.__wbg_set_blalevel_offset, gt = r.__wbg_set_blalevel_skip, ct = r.__wbg_set_mandelbrotstep_dx, ft = r.__wbg_set_mandelbrotstep_dy, dt = r.__wbg_set_mandelbrotstep_zx, pt = r.__wbg_set_mandelbrotstep_zy, wt = r.__wbg_set_orbitbufferinfo_count, ut = r.__wbg_set_orbitbufferinfo_offset, mt = r.__wbg_set_orbitbufferinfo_ptr, vt = r.__wbg_get_blalevel_count, yt = r.__wbg_get_blalevel_max_radius_bits, ht = r.__wbg_get_blalevel_offset, xt = r.__wbg_get_blalevel_skip, zt = r.__wbg_get_orbitbufferinfo_count, Ft = r.__wbg_get_orbitbufferinfo_offset, At = r.__wbg_get_orbitbufferinfo_ptr, Rt = r.__wbg_get_mandelbrotstep_dx, Mt = r.__wbg_get_mandelbrotstep_dy, St = r.__wbg_get_mandelbrotstep_zx, kt = r.__wbg_get_mandelbrotstep_zy, Et = r.__wbindgen_export_0, Bt = r.__externref_drop_slice, It = r.__wbindgen_free, Tt = r.__wbindgen_malloc, Ct = r.__wbindgen_realloc, J = r.__wbindgen_start;
    var Ut = Object.freeze({
        ...
        __wbg_get_blalevel_count: vt,
        __wbg_get_blalevel_max_radius_bits: yt,
        ...
        __wbg_get_mandelbrotstep_zx: St,
        __wbg_get_mandelbrotstep_zy: kt,
        __wbg_get_orbitbufferinfo_count: zt,
        __wbg_get_orbitbufferinfo_offset: Ft,
        ...
        __wbg_set_blabufferinfo_count: Fe,
        __wbg_set_blabufferinfo_level_count: Ae,
        __wbg_set_blabufferinfo_levels_ptr: Re,
        __wbg_set_blabufferinfo_ptr: Me,
        __wbg_set_blalevel_count: it,
        __wbg_set_blalevel_max_radius_bits: st,
        __wbg_set_blalevel_offset: lt,
        __wbg_set_blalevel_skip: gt,
        __wbg_set_blastep_ax: Se,
        __wbg_set_blastep_ay: ke,
        __wbg_set_blastep_bx: Ee,
        __wbg_set_blastep_by: Be,
        __wbg_set_blastep_radius_alpha: Ie,
        ...
        mandelbrotnavigator_get_reference_orbit_len: Ge,
        mandelbrotnavigator_get_reference_params: He,
        mandelbrotnavigator_is_in_transition: Je,
        mandelbrotnavigator_new: Ye,
        mandelbrotnavigator_origin: Ke,
    ...
    J();
    const j = self;
    let s, d = 0, A = !1, m = 0, h = 0, W = !1, x = !1, I = "", D = "";
    const Wt = 1e3;
    function R(t, e) {
        j.postMessage(t, e ?? []);
    }
    ...
    function Lt(t) {
        s?.free(), s = new L(t.cx, t.cy, t.scale, t.angle), d = t.jobId, m = 0, h = t.maxIterations, x = !1, I = "", D = "", K(t.approximationMode), s.set_bla_epsilon(t.blaEpsilon), z(t.jobId);
    }
    function jt(t, e, n) {
        const b = Math.max(0, n - e), i = new Float32Array(T.buffer, t + e * 4 * Float32Array.BYTES_PER_ELEMENT, b * 4), a = new Float32Array(i.length);
        return a.set(i), a;
    }
    function G(t, e, n) {
        if (!s || t !== d || A || m >= e || n < e || s.get_approximation_mode() !== 1) return;
        const o = s.compute_bla_reference_ptr(e), b = new Float32Array(T.buffer, o.ptr, o.count * 6), i = new Float32Array(b.length);
        i.set(b);
        const a = new Uint32Array(T.buffer, o.levels_ptr, o.level_count * 4), l = new Uint32Array(a.length);
        l.set(a), m = e, R({
            type: "blaReady",
            jobId: t,
            maxIterations: e,
    ...
    async function z(t) {
        if (!W) {
            ...
            try {
                for(; !A && s && t === d;){
                    const e = h, n = Math.max(0, s.get_reference_orbit_len());
                    if (n >= e && !x) {
                        if (G(t, e, n), await P(), h <= e) break;
                        continue;
                    }
                    const o = s.compute_reference_orbit_chunk(Wt, e);
                    x = !1;
                    const b = jt(o.ptr, o.offset, o.count), [i, a] = s.get_reference_params();
                    I && (i !== I || a !== D) && (m = 0, R({
                        type: "referenceReset",
                        jobId: t,
                        maxIterations: e,
        ...
        try {
            switch(e.type){
                ...
                case "setApproximationMode":
                    e.jobId === d && (K(e.approximationMode), m = 0, z(e.jobId));
                    break;
                case "setBlaEpsilon":
                    s && e.jobId === d && (s.set_bla_epsilon(e.blaEpsilon), m = 0, z(e.jobId));
                    break;
                case "dispose":
                    A = !0, s?.free(), s = void 0, j.close();
                    break;
            }
        } catch (n) {
            Y("jobId" in e ? e.jobId : d, n);
        }
    };
    R({
        type: "ready"
