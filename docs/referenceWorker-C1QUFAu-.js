(async ()=>{
    var K = "" + new URL("mandelbrot_bg-YwAvk50W.wasm", import.meta.url).href, X = async (t = {}, e)=>{
        let r;
        if (e.startsWith("data:")) {
            ...
            if (typeof Buffer == "function" && typeof Buffer.from == "function") a = Buffer.from(n, "base64");
                ...
                for(let o = 0; o < b.length; o++)a[o] = b.charCodeAt(o);
    ...
    class I {
        ...
        constructor(e, r, n, a){
            const b = f(e, _.__wbindgen_malloc, _.__wbindgen_realloc), o = l, s = f(r, _.__wbindgen_malloc, _.__wbindgen_realloc), c = l, Y = f(n, _.__wbindgen_malloc, _.__wbindgen_realloc), J = l, H = _.mandelbrotnavigator_new(b, o, s, c, Y, J, a);
            return this.__wbg_ptr = H, W.register(this, this.__wbg_ptr, this), this;
        }
        origin(e, r) {
            const n = f(e, _.__wbindgen_malloc, _.__wbindgen_realloc), a = l, b = f(r, _.__wbindgen_malloc, _.__wbindgen_realloc), o = l;
            _.mandelbrotnavigator_origin(this.__wbg_ptr, n, a, b, o);
        }
        pixel_to_complex(e, r, n, a) {
            const b = _.mandelbrotnavigator_pixel_to_complex(this.__wbg_ptr, e, r, n, a);
            var o = z(b[0], b[1]).slice();
            return _.__wbindgen_free(b[0], b[1] * 4, 4), o;
        }
        reference_origin(e, r) {
            const n = f(e, _.__wbindgen_malloc, _.__wbindgen_realloc), a = l, b = f(r, _.__wbindgen_malloc, _.__wbindgen_realloc), o = l;
            _.mandelbrotnavigator_reference_origin(this.__wbg_ptr, n, a, b, o);
        }
        rotate(e) {
        ...
        scale(e) {
            const r = f(e, _.__wbindgen_malloc, _.__wbindgen_realloc), n = l;
    ...
    var St = Object.freeze({
        ...
        mandelbrotnavigator_reference_origin: Ye,
        mandelbrotnavigator_rotate: Je,
    ...
    V();
    const T = self;
    let i, g = 0, x = !1, d = 0, m = 0, B = !1, v = !1, M = "", C = "";
    const Et = 1e3;
    function E(t, e) {
        T.postMessage(t, e ?? []);
    }
    ...
    function P(t) {
        i && (t === "bla" ? i.use_bla() : i.use_perturbation());
    }
    function kt(t) {
        i?.free(), i = new I(t.cx, t.cy, t.scale, t.angle), g = t.jobId, d = 0, m = t.maxIterations, v = !1, M = "", C = "", P(t.approximationMode), i.set_bla_epsilon(t.blaEpsilon), y(t.jobId);
    }
    function Bt(t, e, r) {
        const a = Math.max(0, r - e), b = new Float32Array(S.buffer, t + e * 4 * Float32Array.BYTES_PER_ELEMENT, a * 4), o = new Float32Array(b.length);
        return o.set(b), o;
    }
    function j(t, e, r) {
        if (!i || t !== g || x || d >= e || r < e || i.get_approximation_mode() !== 1) return;
        const n = i.compute_bla_reference_ptr(e), a = new Float32Array(S.buffer, n.ptr, n.count * 6), b = new Float32Array(a.length);
        b.set(a);
    ...
    async function y(t) {
        if (!B) {
            ...
            try {
                for(; !x && i && t === g;){
                    const e = m, r = Math.max(0, i.get_reference_orbit_len());
                    if (r >= e && !v) {
                        if (j(t, e, r), await O(), m <= e) break;
                        continue;
                    }
                    const n = i.compute_reference_orbit_chunk(Et, e);
                    v = !1;
                    const a = Bt(n.ptr, n.offset, n.count), [b, o] = i.get_reference_params();
                    M && (b !== M || o !== C) && (d = 0, E({
                        type: "referenceReset",
                        jobId: t,
                        maxIterations: e,
                ...
                if (B = !1, !x && i) {
                    const e = Math.max(0, i.get_reference_orbit_len());
                    (t !== g || e < m || v) && y(g);
                }
            }
        }
        ...
        try {
            switch(e.type){
                case "reset":
                    ...
                    break;
                case "updateView":
                    i && e.jobId === g && (i.origin(e.cx, e.cy), i.scale(e.scale), i.angle(e.angle), m = e.maxIterations, v = !0, y(e.jobId));
                    break;
                case "setApproximationMode":
                    e.jobId === g && (P(e.approximationMode), d = 0, y(e.jobId));
                    break;
                case "setBlaEpsilon":
                    i && e.jobId === g && (i.set_bla_epsilon(e.blaEpsilon), d = 0, y(e.jobId));
                    break;
                case "dispose":
                    x = !0, i?.free(), i = void 0, T.close();
                    break;
            }
        } catch (r) {
            N("jobId" in e ? e.jobId : g, r);
        }
    };
})();
