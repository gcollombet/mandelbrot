...
(async () => {
  ...
  const oe = {}, un = [], at = () => {
  }, ra = () => false, Qr = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && (e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), ds = (e) => e.startsWith("onUpdate:"), Se = Object.assign, hs = (e, t) => {
    const n = e.indexOf(t);
    n > -1 && e.splice(n, 1);
  ...
  }, iu = /-\w/g, xt = ti((e) => e.replace(iu, (t) => t.slice(1).toUpperCase())), su = /\B([A-Z])/g, Bt = ti((e) => e.replace(su, "-$1").toLowerCase()), aa = ti((e) => e.charAt(0).toUpperCase() + e.slice(1)), vi = ti((e) => e ? `on${aa(e)}` : ""), Be = (e, t) => !Object.is(e, t), _r = (e, ...t) => {
  ...
  const _u = {
    __proto__: null,
    [Symbol.iterator]() {
      return yi(this, Symbol.iterator, (e) => Lt(this, e));
    },
    concat(...e) {
      return tn(this).concat(...e.map((t) => j(t) ? tn(t) : t));
    },
    entries() {
      return yi(this, "entries", (e) => (e[1] = Lt(this, e[1]), e));
    },
    every(e, t) {
      return ht(this, "every", e, t, void 0, arguments);
    },
    filter(e, t) {
      return ht(this, "filter", e, t, (n) => n.map((r) => Lt(this, r)), arguments);
    },
    find(e, t) {
      return ht(this, "find", e, t, (n) => Lt(this, n), arguments);
    },
    findIndex(e, t) {
      return ht(this, "findIndex", e, t, void 0, arguments);
    },
    findLast(e, t) {
      return ht(this, "findLast", e, t, (n) => Lt(this, n), arguments);
    },
    findLastIndex(e, t) {
    ...
    values() {
      return yi(this, "values", (e) => Lt(this, e));
    }
  };
  function yi(e, t, n) {
    const r = si(e), i = r[t]();
  ...
  function Ks(e, t, n, r) {
    ...
    return i !== e && (We(e) ? n.length > 3 && (s = function(o, a, l) {
      ...
      return n.call(this, o, Lt(e, a), l, e);
    }), i[t](s, ...r);
  }
  function wi(e, t, n) {
    const r = re(e);
  ...
  class xa {
    ...
    get(t, n, r) {
      ...
      if (n === "__v_raw") return r === (i ? s ? Ru : Ca : s ? Ma : Ta).get(t) || Object.getPrototypeOf(t) === Object.getPrototypeOf(r) ? t : void 0;
      const o = j(t);
      if (!i) {
        let l;
  ...
  class Sa extends xa {
    ...
    set(t, n, r, i) {
      ...
      if (!this._isShallow) {
        const c = Mt(s);
        if (!We(r) && !Mt(r) && (s = re(s), r = re(r)), !o && Ee(s) && !Ee(r)) return c || (s.value = r), true;
      }
      const a = o ? Number(n) < t.length : ae(t, n), l = Reflect.set(t, n, r, Ee(t) ? t : i);
      return t === re(i) && (a ? Be(r, s) && bt(t, "set", n, r) : bt(t, "add", n, r)), l;
    }
    deleteProperty(t, n) {
      const r = ae(t, n);
      t[n];
  ...
  function Cu(e, t, n) {
    return function(...r) {
      ...
      return !t && Me(s, "iterate", l ? Vi : qt), Se(Object.create(c), {
        next() {
  ...
  function Eu(e, t) {
    const n = {
      get(i) {
        ...
        e || (Be(i, a) && Me(o, "get", i), Me(o, "get", a));
      ...
      has(i) {
        const s = this.__v_raw, o = re(s), a = re(i);
        return e || (Be(i, a) && Me(o, "has", i), Me(o, "has", a)), i === a ? s.has(i) : s.has(i) || s.has(a);
      },
      forEach(i, s) {
    ...
    return Se(n, e ? {
      ...
      set(i, s) {
        ...
        const u = l.call(o, i);
        return o.set(i, s), c ? Be(s, u) && bt(o, "set", i, s) : bt(o, "add", i, s), this;
      },
      delete(i) {
  ...
  const Ta = /* @__PURE__ */ new WeakMap(), Ma = /* @__PURE__ */ new WeakMap(), Ca = /* @__PURE__ */ new WeakMap(), Ru = /* @__PURE__ */ new WeakMap();
  function Lu(e) {
    switch (e) {
      case "Object":
      case "Array":
  ...
  function Iu(e) {
    return ws(e, false, Mu, Au, Ma);
  }
  function Gi(e) {
    return ws(e, true, Tu, Pu, Ca);
  }
  ...
  class $u {
    ...
    set value(t) {
      ...
      t = r ? t : re(t), Be(t, n) && (this._rawValue = t, this._value = r ? t : Xe(t), this.dep.trigger());
    }
  }
  function Du(e) {
  ...
  function Wu(e, t, n = oe) {
    const { immediate: r, deep: i, once: s, scheduler: o, augmentJob: a, call: l } = n, c = (y) => i ? y : We(y) || i === false || i === 0 ? yt(y, 1) : yt(y);
    let u, f, h, d, g = false, _ = false;
    if (Ee(e) ? (f = () => e.value, g = We(e)) : Kt(e) ? (f = () => c(e), g = true) : j(e) ? (_ = true, g = e.some((y) => Kt(y) || We(y)), f = () => e.map((y) => {
    ...
    const B = gu(), G = () => {
      u.stop(), B && B.active && hs(B.effects, u);
    };
    if (s && t) {
      const y = t;
      t = (...S) => {
    ...
    const U = (y) => {
      if (!(!(u.flags & 1) || !u.dirty && !y)) if (t) {
        const S = u.run();
        if (i || g || (_ ? S.some((P, H) => Be(P, O[H])) : Be(S, O))) {
          h && h();
          const P = Vt;
          Vt = u;
          try {
    ...
    return a && a(U), u = new ha(f), u.scheduler = o ? () => o(U, false) : U, d = (y) => Hu(y, false, u), h = u.onStop = () => {
      const y = Ar.get(u);
      if (y) {
        if (l) l(y, 4);
  ...
  function yt(e, t = 1 / 0, n) {
    ...
    if (n.set(e, t), t--, Ee(e)) yt(e.value, t, n);
  ...
  function Ra(e) {
    try {
      ...
      rt = -1, Ae.length = 0, Pa(), Pr = null, (Ae.length || fn.length) && Ra();
    }
  }
  let He = null, La = null;
  function Rr(e) {
  ...
  function Ts(e, t, n = oe) {
    const { immediate: r, deep: i, flush: s, once: o } = n, a = Se({}, n), l = t && r || !t && s !== "post";
    let c;
    if (qn) {
      if (s === "sync") {
        const d = Zu();
  ...
  const Ge = [
    ...
    const t = e.subTree;
    return t.component ? $a(t.component) : t;
  }, nc = {
    name: "BaseTransition",
    props: Ba,
    setup(e, { slots: t }) {
      ...
      return () => {
        ...
        if (u && u.type !== Pe && !zt(u, l) && $a(n).type !== Pe) {
          let f = Hi(u, o, r, n);
          if (Hn(u, f), a === "out-in" && l.type !== Pe) return r.isLeaving = true, f.afterLeave = () => {
  ...
  function Hi(e, t, n, r, i) {
    const { appear: s, mode: o, persisted: a = false, onBeforeEnter: l, onEnter: c, onAfterEnter: u, onEnterCancelled: f, onBeforeLeave: h, onLeave: d, onAfterLeave: g, onLeaveCancelled: _, onBeforeAppear: B, onAppear: G, onAfterAppear: O, onAppearCancelled: U } = t, y = String(e.key), S = Ua(n, e), P = ($, V) => {
      $ && Ye($, r, 9, V);
    }, H = ($, V) => {
      const W = V[1];
      P($, V), j($) ? $.every((x) => x.length <= 1) && W() : $.length <= 1 && W();
    }, X = {
      mode: o,
      persisted: a,
      beforeEnter($) {
        let V = l;
        if (!n.isMounted) if (s) V = B || l;
        else return;
        $[it] && $[it](true);
        const W = S[y];
        W && zt(e, W) && W.el[it] && W.el[it](), P(V, [
          $
        ]);
      },
      enter($) {
        ...
        $[Mn] = (ge) => {
          q || (q = true, ge ? P(x, [
            ...
            $
          ]), X.delayedLeave && X.delayedLeave(), $[Mn] = void 0);
        };
        const ee = $[Mn].bind(null, false);
        V ? H(V, [
          $,
          ee
        ]) : ee();
      ...
      leave($, V) {
        ...
        if ($[Mn] && $[Mn](true), n.isUnmounting) return V();
        P(h, [
          $
        ]);
        let x = false;
        $[it] = (ee) => {
          x || (x = true, V(), ee ? P(_, [
            ...
            $
          ]), $[it] = void 0, S[W] === e && delete S[W]);
        };
        const q = $[it].bind(null, false);
        S[W] = e, d ? H(d, [
          $,
          q
        ]) : q();
  ...
  function Fa(e, t = false, n) {
    ...
    for (let s = 0; s < e.length; s++) {
      ...
      o.type === Ue ? (o.patchFlag & 128 && i++, r = r.concat(Fa(o.children, t, a))) : (t || o.type !== Pe) && r.push(a != null ? Ot(o, {
        key: a
      }) : o);
    }
  ...
  function Bn(e, t, n, r, i = false) {
    if (j(e)) {
      e.forEach((_, B) => Bn(_, t && (j(t) ? t[B] : t), n, r, i));
      return;
    }
    if ($n(r) && !i) {
    ...
    const s = r.shapeFlag & 4 ? di(r.component) : r.el, o = i ? null : s, { i: a, r: l } = e, c = t && t.r, u = a.refs === oe ? a.refs = {} : a.refs, f = a.setupState, h = re(f), d = f === oe ? ra : (_) => Ys(u, _) ? false : ae(h, _), g = (_, B) => !(B && Ys(u, B));
    if (c != null && c !== l) {
    ...
    if (Q(l)) tr(l, a, 12, [
      ...
      if (_ || B) {
        const G = () => {
          ...
          } else _ ? (u[l] = o, d(l) && (f[l] = o)) : B && (g(l, e.k) && (l.value = o), e.k && (u[e.k] = o));
        };
        if (o) {
          const O = () => {
            G(), Lr.delete(e);
  ...
  const $n = (e) => !!e.type.__asyncLoader, li = (e) => e.type.__isKeepAlive;
  function ic(e, t) {
    za(e, "a", t);
  }
  function sc(e, t) {
  ...
  }, ac = kt("bm"), At = kt("m"), lc = kt("bu"), uc = kt("u"), Ga = kt("bum"), nr = kt("um"), cc = kt("sp"), fc = kt("rtg"), dc = kt("rtc");
  function hc(e, t = Re) {
    ui("ec", e, t);
  }
  ...
  const qi = (e) => e ? fl(e) ? di(e) : qi(e.parent) : null, Dn = Se(/* @__PURE__ */ Object.create(null), {
    $: (e) => e,
    $el: (e) => e.vnode.el,
    $data: (e) => e.data,
    $props: (e) => e.props,
  ...
  function Ms(e, t) {
    return !e || !t ? e || t : j(e) && j(t) ? e.concat(t) : Se({}, Nr(e), Nr(t));
  }
  let Ki = true;
  function mc(e) {
    const t = Wa(e), n = e.proxy, r = e.ctx;
    Ki = false, t.beforeCreate && Js(t.beforeCreate, e, "bc");
    const { data: i, computed: s, methods: o, watch: a, provide: l, inject: c, created: u, beforeMount: f, mounted: h, beforeUpdate: d, updated: g, activated: _, deactivated: B, beforeDestroy: G, beforeUnmount: O, destroyed: U, unmounted: y, render: S, renderTracked: P, renderTriggered: H, errorCaptured: X, serverPrefetch: $, expose: V, inheritAttrs: W, components: x, directives: q, filters: ee } = t;
    ...
    if (Ki = true, s) for (const R in s) {
      const z = s[R], te = Q(z) ? z.bind(n, n) : Q(z.get) ? z.get.bind(n, n) : at, A = !Q(z) && Q(z.set) ? z.set.bind(n) : at, b = Te({
        get: te,
        set: A
      });
    ...
    if (N(ac, f), N(At, h), N(lc, d), N(uc, g), N(ic, _), N(sc, B), N(hc, X), N(dc, P), N(fc, H), N(Ga, O), N(nr, y), N(cc, $), j(V)) if (V.length) {
    ...
    S && e.render === at && (e.render = S), W != null && (e.inheritAttrs = W), x && (e.components = x), q && (e.directives = q), $ && Va(e);
  }
  function vc(e, t, n = at) {
    ...
    for (const r in e) {
      const i = e[r];
      let s;
      ue(i) ? "default" in i ? s = br(i.from || r, i.default, true) : s = br(i.from || r) : s = br(i), Ee(s) ? Object.defineProperty(t, r, {
        enumerable: true,
        configurable: true,
        get: () => s.value,
        set: (o) => s.value = o
  ...
  function eo(e, t) {
    ...
    ] : Se(/* @__PURE__ */ Object.create(null), Nr(e), Nr(t ?? {})) : t;
  }
  function yc(e, t) {
    if (!e) return t;
    if (!t) return e;
  ...
  function wt(e, t, n = oe) {
    const r = As(), i = xt(t), s = Bt(t), o = Ka(e, i), a = Vu((l, c) => {
      let u, f = oe, h;
      return Ju(() => {
        const d = e[i];
        Be(u, d) && (u = d, c());
        ...
        set(d) {
          ...
          if (!Be(g, u) && !(f !== oe && Be(d, f))) return;
          const _ = r.vnode.props;
          _ && (t in _ || i in _ || s in _) && (`onUpdate:${t}` in _ || `onUpdate:${i}` in _ || `onUpdate:${s}` in _) || (u = d, c()), r.emit(`update:${t}`, g), Be(d, g) && Be(d, f) && !Be(g, h) && c(), f = d, h = g;
        }
      };
    });
  ...
  const Ka = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${xt(t)}Modifiers`] || e[`${Bt(t)}Modifiers`];
  function Sc(e, t, ...n) {
    ...
    !l && s && (l = r[a = vi(Bt(t))]), l && Ye(l, e, 6, i);
    const c = r[a + "Once"];
    if (c) {
  ...
  function ja(e, t, n = false) {
    ...
    return !s && !a ? (ue(e) && r.set(e, null), null) : (j(s) ? s.forEach((l) => o[l] = null) : Se(o, s), ue(e) && r.set(e, o), o);
  }
  function ci(e, t) {
    return !e || !Qr(t) ? false : (t = t.slice(2).replace(/Once$/, ""), ae(e, t[0].toLowerCase() + t.slice(1)) || ae(e, Bt(t)) || ae(e, t));
  }
  function to(e) {
    const { type: t, vnode: n, proxy: r, withProxy: i, propsOptions: [s], slots: o, attrs: a, emit: l, render: c, renderCache: u, props: f, data: h, setupState: d, ctx: g, inheritAttrs: _ } = e, B = Rr(e);
    let G, O;
    try {
      if (n.shapeFlag & 4) {
        const y = i || r, S = y;
        G = st(c.call(S, y, u, f, d, h, g)), O = a;
      } else {
        const y = t;
        G = st(y.length > 1 ? y(f, {
          attrs: a,
          slots: o,
          emit: l
        }) : y(f, null)), O = t.props ? a : Mc(a);
      }
    } catch (y) {
      Un.length = 0, oi(y, e, 1), G = ye(Pe);
    }
    let U = G;
    if (O && _ !== false) {
      const y = Object.keys(O), { shapeFlag: S } = U;
      y.length && S & 7 && (s && y.some(ds) && (O = Cc(O, s)), U = Ot(U, O, false, true));
    }
    return n.dirs && (U = Ot(U, null, false, true), U.dirs = U.dirs ? U.dirs.concat(n.dirs) : n.dirs), n.transition && Hn(U, n.transition), G = U, Rr(B), G;
  }
  const Mc = (e) => {
    let t;
  ...
  function Pc(e, t, n, r) {
    ...
    if ((r || o > 0) && !(o & 16)) {
      ...
      Qa(e, t, i, s) && (c = true);
      let u;
      for (const f in a) (!t || !ae(t, f) && ((u = Bt(f)) === f || !ae(t, u))) && (l ? n && (n[f] !== void 0 || n[u] !== void 0) && (i[f] = Xi(l, a, f, void 0, e, true)) : delete i[f]);
  ...
  function Xi(e, t, n, r, i, s) {
    ...
    if (o != null) {
      ...
      o[0] && (s && !a ? r = false : o[1] && (r === "" || r === Bt(n)) && (r = true));
    }
    return r;
  }
  ...
  function el(e, t, n = false) {
    ...
    if (j(s)) for (let u = 0; u < s.length; u++) {
      ...
      if (ro(f)) {
        ...
        d[0] = _, d[1] = B, (_ || ae(d, "default")) && a.push(f);
      }
    }
    const c = [
      o,
  ...
  const Cs = (e) => e === "_" || e === "_ctx" || e === "$stable", Es = (e) => j(e) ? e.map(st) : [
    st(e)
  ], Lc = (e, t, n) => {
    if (t._n) return t;
    const r = Na((...i) => Es(t(...i)), n);
    return r._c = false, r;
  }, tl = (e, t, n) => {
    const r = e._ctx;
    for (const i in e) {
    ...
    for (const r in t) (n || !Cs(r)) && (e[r] = t[r]);
  }, Nc = (e, t, n) => {
    const r = e.slots = Za();
    ...
    if (s) for (const a in i) !Cs(a) && o[a] == null && delete i[a];
  }, Ie = Uc;
  function Oc(e) {
    return Bc(e);
  }
  function Bc(e, t) {
    const n = ni();
    n.__VUE__ = true;
    const { insert: r, remove: i, patchProp: s, createElement: o, createText: a, createComment: l, setText: c, setElementText: u, parentNode: f, nextSibling: h, setScopeId: d = at, insertStaticContent: g } = e, _ = (p, m, w, k = null, T = null, C = null, D = void 0, I = null, L = !!m.dynamicChildren) => {
      if (p === m) return;
      p && !zt(p, m) && (k = en(p), M(p, T, C, true), p = null), m.patchFlag === -2 && (L = false, m.dynamicChildren = null);
      ...
      switch (E) {
        ...
        case Ue:
          ...
          break;
        default:
          F & 1 ? S(p, m, w, k, T, C, D, I, L) : F & 6 ? q(p, m, w, k, T, C, D, I, L) : (F & 64 || F & 128) && E.process(p, m, w, k, T, C, D, I, L, xn);
      }
      Y != null && T ? Bn(Y, p && p.ref, C, m || p, !m) : Y == null && p && p.ref != null && Bn(p.ref, null, C, p, true);
    }, B = (p, m, w, k) => {
      ...
      if (m.type === "svg" ? D = "svg" : m.type === "math" && (D = "mathml"), p == null) P(m, w, k, T, C, D, I, L);
      else {
        const E = p.el && p.el._isVueCE ? p.el : null;
        try {
          E && E._beginPatch(), $(p, m, T, C, D, I, L);
        } finally {
          E && E._endPatch();
        }
      }
      ...
      if (L = p.el = o(p.type, C, Y && Y.is, Y), F & 8 ? u(L, p.children) : F & 16 && X(p.children, L, null, k, T, Ti(p, C), D, I), J && $t(p, null, k, "created"), H(L, p, p.scopeId, D, k), Y) {
        for (const de in Y) de !== "value" && !Nn(de) && s(L, de, null, Y[de], C, k);
        "value" in Y && s(L, "value", null, Y.value, C), (E = Y.onVnodeBeforeMount) && nt(E, k, p);
      }
      ...
      if (w && d(p, w), k) for (let C = 0; C < k.length; C++) d(p, k[C]);
      if (T) {
        let C = T.subTree;
      ...
      let J;
      if (w && Dt(w, false), (J = K.onVnodeBeforeUpdate) && nt(J, w, m, p), Y && $t(m, p, w, "beforeUpdate"), w && Dt(w, true), (F.innerHTML && K.innerHTML == null || F.textContent && K.textContent == null) && u(I, ""), E ? V(p.dynamicChildren, E, I, w, k, Ti(m, T), C) : D || z(p, m, I, null, w, k, Ti(m, T), C, false), L > 0) {
        if (L & 16) W(I, F, K, w, T);
      ...
      for (let I = 0; I < m.length; I++) {
        ...
        _(L, E, Y, null, k, T, C, D, true);
      }
    }, W = (p, m, w, k, T) => {
      if (m !== w) {
        if (m !== oe) for (const C in m) !Nn(C) && !(C in w) && s(p, C, m[C], null, T, k);
        for (const C in w) {
          if (Nn(C)) continue;
          const D = w[C], I = m[C];
          D !== I && C !== "value" && s(p, C, I, D, T, k);
        }
      ...
      J && (I = I ? I.concat(J) : J), p == null ? (r(E, w, k), r(Y, w, k), X(m.children || [], w, Y, T, C, D, I, L)) : F > 0 && F & 64 && K && p.dynamicChildren && p.dynamicChildren.length === K.length ? (V(p.dynamicChildren, K, w, T, C, D, I), (m.key != null || T && m === T.subTree) && il(p, m, true)) : z(p, m, w, Y, T, C, D, I, L);
    }, q = (p, m, w, k, T, C, D, I, L) => {
      m.slotScopeIds = I, p == null ? m.shapeFlag & 512 ? T.ctx.activate(m, w, k, D, L) : ee(m, w, k, T, C, D, L) : ge(p, m, L);
    }, ee = (p, m, w, k, T, C, D) => {
      const I = p.component = Kc(p, k, T);
      if (li(p) && (I.ctx.renderer = xn), jc(I, false, D), I.asyncDep) {
        if (T && T.registerDep(I, N, D), !p.el) {
          const L = I.subTree = ye(Pe);
          G(null, L, m, w), p.placeholder = L.el;
        }
      } else N(I, p, m, w, T, C, D);
    }, ge = (p, m, w) => {
      const k = m.component = p.component;
      if (Ec(p, m, w)) if (k.asyncDep && !k.asyncResolved) {
        R(k, m, w);
        return;
      ...
      const I = () => {
        if (p.isMounted) {
          ...
          let ce = F, Le;
          Dt(p, false), F ? (F.el = de.el, R(p, F, D)) : F = de, K && _r(K), (Le = F.props && F.props.onVnodeBeforeUpdate) && nt(Le, ie, F, de), Dt(p, true);
          const Ne = to(p), Qe = p.subTree;
          p.subTree = Ne, _(Qe, Ne, f(Qe.el), en(Qe), p, T, C), F.el = Ne.el, ce === null && kc(p, Ne.el), J && Ie(J, T), (Le = F.props && F.props.onVnodeUpdated) && Ie(() => nt(Le, ie, F, de), T);
        } else {
          let F;
          const { el: K, props: J } = m, { bm: ie, m: de, parent: ce, root: Le, type: Ne } = p, Qe = $n(m);
          Dt(p, false), ie && _r(ie), !Qe && (F = J && J.onVnodeBeforeMount) && nt(F, ce, m), Dt(p, true);
          {
            Le.ce && Le.ce._hasShadowRoot() && Le.ce._injectChildStyle(Ne);
            const et = p.subTree = to(p);
            _(null, et, w, k, p, T, C), m.el = et.el;
          }
          if (de && Ie(de, T), !Qe && (F = J && J.onVnodeMounted)) {
            const et = m;
            Ie(() => nt(F, ce, et), T);
          }
          (m.shapeFlag & 256 || ce && $n(ce.vnode) && ce.vnode.shapeFlag & 256) && p.a && Ie(p.a, T), p.isMounted = true, m = w = k = null;
        }
      };
      p.scope.on();
      ...
      Y.i = p, Y.id = p.uid, L.scheduler = () => Ss(Y), Dt(p, true), E();
    }, R = (p, m, w) => {
      m.component = p;
      const k = p.vnode.props;
      p.vnode = m, p.next = null, Pc(p, m.props, k, w), Ic(p, m.children, w), St(), js(p), Tt();
    }, z = (p, m, w, k, T, C, D, I, L = false) => {
      ...
      if (K > 0) {
        if (K & 128) {
          ...
          te(E, F, w, k, T, C, D, I, L);
          return;
        }
      }
      J & 8 ? (Y & 16 && ze(E, T, C), F !== E && u(w, F)) : Y & 16 ? J & 16 ? A(E, F, w, k, T, C, D, I, L) : ze(E, T, C, true) : (Y & 8 && u(w, ""), J & 16 && X(F, w, k, T, C, D, I, L));
    }, te = (p, m, w, k, T, C, D, I, L) => {
      p = p || un, m = m || un;
      const E = p.length, Y = m.length, F = Math.min(E, Y);
      let K;
      for (K = 0; K < F; K++) {
        const J = m[K] = L ? _t(m[K]) : st(m[K]);
        _(p[K], J, w, null, T, C, D, I, L);
      }
      E > Y ? ze(p, T, C, true, false, F) : X(m, w, k, T, C, D, I, L, F);
    }, A = (p, m, w, k, T, C, D, I, L) => {
      let E = 0;
      const Y = m.length;
      ...
      for (; E <= F && E <= K; ) {
        ...
        if (zt(J, ie)) _(J, ie, w, null, T, C, D, I, L);
        else break;
        E++;
      }
      for (; E <= F && E <= K; ) {
      ...
      if (E > F) {
        if (E <= K) {
          ...
          for (; E <= K; ) _(null, m[E] = L ? _t(m[E]) : st(m[E]), w, ie, T, C, D, I, L), E++;
        }
      } else if (E > K) for (; E <= F; ) M(p[E], T, C, true), E++;
      else {
        ...
        for (E = J; E <= F; E++) {
          ...
          tt === void 0 ? M(De, T, C, true) : (Sn[tt - ie] = E + 1, tt >= et ? et = tt : Qe = true, _(De, m[tt], w, null, T, C, D, I, L), Le++);
        }
        const Vs = Qe ? Dc(Sn) : un;
        for (ce = Vs.length - 1, E = Ne - 1; E >= 0; E--) {
          const De = ie + E, tt = m[De], zs = m[De + 1], Gs = De + 1 < Y ? zs.el || ol(zs) : k;
          Sn[E] === 0 ? _(null, tt, w, Gs, T, C, D, I, L) : Qe && (ce < 0 || E !== Vs[ce] ? b(tt, w, Gs, 2) : ce--);
        }
      }
    }, b = (p, m, w, k, T = null) => {
      const { el: C, type: D, transition: I, children: L, shapeFlag: E } = p;
      if (E & 6) {
        b(p.component.subTree, m, w, k);
        return;
      }
      if (E & 128) {
      ...
      if (D === Ue) {
        r(C, m, w);
        for (let F = 0; F < L.length; F++) b(L[F], m, w, k);
        r(p.anchor, m, w);
        return;
      }
      if (D === yr) {
      ...
      if (k !== 2 && E & 1 && I) if (k === 0) I.beforeEnter(C), r(C, m, w), Ie(() => I.enter(C), T);
      else {
        const { leave: F, delayLeave: K, afterLeave: J } = I, ie = () => {
          p.ctx.isUnmounted ? i(C) : r(C, m, w);
        }, de = () => {
          C._isLeaving && C[it](true), F(C, () => {
            ie(), J && J();
          });
        };
        K ? K(C, ie, de) : de();
    ...
    }, M = (p, m, w, k = false, T = false) => {
      const { type: C, props: D, ref: I, children: L, dynamicChildren: E, shapeFlag: Y, patchFlag: F, dirs: K, cacheIndex: J } = p;
      if (F === -2 && (T = false), I != null && (St(), Bn(I, null, w, p, true), Tt()), J != null && (m.renderCache[J] = void 0), Y & 256) {
        m.ctx.deactivate(p);
        return;
      }
      const ie = Y & 1 && K, de = !$n(p);
      let ce;
      if (de && (ce = D && D.onVnodeBeforeUnmount) && nt(ce, m, p), Y & 6) Je(p.component, w, k);
        ...
        ie && $t(p, null, m, "beforeUnmount"), Y & 64 ? p.type.remove(p, m, w, xn, k) : E && !E.hasOnce && (C !== Ue || F > 0 && F & 64) ? ze(E, m, w, false, true) : (C === Ue && F & 384 || !T && Y & 16) && ze(L, m, w), k && _e(p);
      }
      ...
      if (p.shapeFlag & 1 && T && !T.persisted) {
        const { leave: D, delayLeave: I } = T, L = () => D(w, C);
        I ? I(p.el, C, L) : L();
      } else C();
    }, $e = (p, m) => {
      let w;
      ...
      const { bum: k, scope: T, job: C, subTree: D, um: I, m: L, a: E } = p;
      io(L), io(E), k && _r(k), T.stop(), C && (C.flags |= 8, M(D, p, m, w)), I && Ie(I, m), Ie(() => {
        p.isUnmounted = true;
      }, m);
    }, ze = (p, m, w, k = false, T = false, C = 0) => {
      for (let D = C; D < p.length; D++) M(p[D], m, w, k, T);
    }, en = (p) => {
    ...
    const ar = (p, m, w) => {
      let k;
      p == null ? m._vnode && (M(m._vnode, null, null, true), k = m._vnode.component) : _(m._vnode || null, p, m, null, null, null, w), m._vnode = p, wn || (wn = true, js(k), Pa(), wn = false);
    }, xn = {
      p: _,
      um: M,
      m: b,
  ...
  function il(e, t, n = false) {
    ...
    if (j(r) && j(i)) for (let s = 0; s < r.length; s++) {
      const o = r[s];
      let a = i[s];
      a.shapeFlag & 1 && !a.dynamicChildren && ((a.patchFlag <= 0 || a.patchFlag === 32) && (a = i[s] = _t(i[s]), a.el = o.el), !n && a.patchFlag !== -2 && il(o, a)), a.type === fi && (a.patchFlag === -1 && (a = i[s] = _t(a)), a.el = o.el), a.type === Pe && !a.el && (a.el = o.el);
    }
  }
  function Dc(e) {
    const t = e.slice(), n = [
  ...
  const Ue = /* @__PURE__ */ Symbol.for("v-fgt"), fi = /* @__PURE__ */ Symbol.for("v-txt"), Pe = /* @__PURE__ */ Symbol.for("v-cmt"), yr = /* @__PURE__ */ Symbol.for("v-stc"), Un = [];
  let Fe = null;
  function le(e = false) {
    Un.push(Fe = e ? null : []);
  }
  ...
  const cl = ({ key: e }) => e ?? null, wr = ({ ref: e, ref_key: t, ref_for: n }) => (typeof e == "number" && (e = "" + e), e != null ? we(e) || Ee(e) || Q(e) ? {
    i: He,
    r: e,
    k: t,
    f: !!n
  ...
  function Vc(e, t = null, n = null, r = 0, i = null, s = false) {
    ...
    if (Jc(e) && (e = e.__vccOpts), t) {
      ...
      a && !we(a) && (t.class = ve(a)), ue(l) && (xs(l) && !j(l) && (l = Se({}, l)), t.style = ri(l));
    }
    const o = we(e) ? 1 : al(e) ? 128 : Oa(e) ? 64 : ue(e) ? 4 : Q(e) ? 2 : 0;
    return v(e, t, n, r, i, o, s, true);
  }
  function zc(e) {
    return e ? xs(e) || Ja(e) ? Se({}, e) : e : null;
  }
  ...
  function st(e) {
    return e == null || typeof e == "boolean" ? ye(Pe) : j(e) ? ye(Ue, null, e.slice()) : Br(e) ? _t(e) : ye(fi, null, String(e));
  }
  function _t(e) {
  ...
  let $r, Yi;
  {
    ...
    $r = t("__VUE_INSTANCE_SETTERS__", (n) => Re = n), Yi = t("__VUE_SSR_SETTERS__", (n) => qn = n);
  }
  const rr = (e) => {
    const t = Re;
  ...
  function oo(e, t, n) {
    Q(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : ue(t) && (e.setupState = Ea(t)), dl(e);
  }
  function dl(e, t, n) {
    const r = e.type;
  ...
  function di(e) {
    return e.exposed ? e.exposeProxy || (e.exposeProxy = new Proxy(Ea(Ou(e.exposed)), {
      get(t, n) {
  ...
  function Qc(e, t, n) {
    try {
      ...
      return r === 2 ? ue(t) && !j(t) ? Br(t) ? ye(e, null, [
        t
      ]) : ye(e, t) : ye(e, null, t) : (r > 3 ? n = Array.prototype.slice.call(arguments, 2) : r === 3 && Br(n) && (n = [
        n
      ]), ye(e, t, n));
    } finally {
      Or(1);
  ...
  const hl = Zi ? (e) => Zi.createHTML(e) : (e) => e, tf = "http://www.w3.org/2000/svg", nf = "http://www.w3.org/1998/Math/MathML", vt = typeof document < "u" ? document : null, lo = vt && vt.createElement("template"), rf = {
  ...
  }, Pt = "transition", Cn = "animation", Kn = /* @__PURE__ */ Symbol("_vtc"), pl = {
    name: String,
    type: String,
    css: {
      type: Boolean,
    ...
    leaveToClass: String
  }, sf = Se({}, Ba, pl), of = (e) => (e.displayName = "Transition", e.props = sf, e), af = of((e, { slots: t }) => Qc(rc, lf(e), t)), Ut = (e, t = []) => {
  ...
  function lf(e) {
    ...
    const { name: n = "v", type: r, duration: i, enterFromClass: s = `${n}-enter-from`, enterActiveClass: o = `${n}-enter-active`, enterToClass: a = `${n}-enter-to`, appearFromClass: l = s, appearActiveClass: c = o, appearToClass: u = a, leaveFromClass: f = `${n}-leave-from`, leaveActiveClass: h = `${n}-leave-active`, leaveToClass: d = `${n}-leave-to` } = e, g = uf(i), _ = g && g[0], B = g && g[1], { onBeforeEnter: G, onEnter: O, onEnterCancelled: U, onLeave: y, onLeaveCancelled: S, onBeforeAppear: P = G, onAppear: H = O, onAppearCancelled: X = U } = t, $ = (x, q, ee, ge) => {
      x._enterCancelled = ge, Ft(x, q ? u : a), Ft(x, q ? c : o), ee && ee();
    }, V = (x, q) => {
      x._isLeaving = false, Ft(x, f), Ft(x, d), Ft(x, h), q && q();
    }, W = (x) => (q, ee) => {
      const ge = x ? H : O, N = () => $(q, x, ee);
      Ut(ge, [
        q,
        N
      ]), co(() => {
        Ft(q, x ? l : s), pt(q, x ? u : a), uo(ge) || fo(q, r, _, N);
      });
    };
    return Se(t, {
      onBeforeEnter(x) {
      ...
      onLeave(x, q) {
        ...
        pt(x, f), x._enterCancelled ? (pt(x, h), go(x)) : (go(x), pt(x, h)), co(() => {
          x._isLeaving && (Ft(x, f), pt(x, d), uo(y) || fo(x, r, B, ee));
        }), Ut(y, [
          x,
          ee
        ]);
      ...
      onEnterCancelled(x) {
        $(x, false, void 0, true), Ut(U, [
          x
        ]);
      },
      onAppearCancelled(x) {
        $(x, true, void 0, true), Ut(X, [
          x
        ]);
      },
      onLeaveCancelled(x) {
  ...
  function ff(e, t) {
    const n = window.getComputedStyle(e), r = (g) => (n[g] || "").split(", "), i = r(`${Pt}Delay`), s = r(`${Pt}Duration`), o = ho(i, s), a = r(`${Cn}Delay`), l = r(`${Cn}Duration`), c = ho(a, l);
    let u = null, f = 0, h = 0;
    t === Pt ? o > 0 && (u = Pt, f = o, h = s.length) : t === Cn ? c > 0 && (u = Cn, f = c, h = l.length) : (f = Math.max(o, c), u = f > 0 ? o > c ? Pt : Cn : null, h = u ? u === Pt ? s.length : l.length : 0);
    const d = u === Pt && /\b(?:transform|all)(?:,|$)/.test(r(`${Pt}Property`).toString());
    return {
      type: u,
      timeout: f,
      propCount: h,
  ...
  const Dr = /* @__PURE__ */ Symbol("_vod"), gl = /* @__PURE__ */ Symbol("_vsh"), Ci = {
    name: "show",
    beforeMount(e, { value: t }, { transition: n }) {
      e[Dr] = e.style.display === "none" ? "" : e.style.display, n && t ? n.beforeEnter(e) : En(e, t);
    },
    mounted(e, { value: t }, { transition: n }) {
      n && t && n.enter(e);
    },
    updated(e, { value: t, oldValue: n }, { transition: r }) {
      !t != !n && (r ? t ? (r.beforeEnter(e), En(e, true), r.enter(e)) : r.leave(e, () => {
        En(e, false);
      }) : En(e, t));
    },
  ...
  function xr(e, t, n) {
    if (j(n)) n.forEach((r) => xr(e, t, r));
      ...
      const r = mf(e, t);
      mo.test(n) ? e.setProperty(Bt(r), n.replace(mo, ""), "important") : e[r] = n;
    }
  }
  const vo = [
    "Webkit",
  ...
  const gt = {
    created(e, { modifiers: { lazy: t, trim: n, number: r } }, i) {
      ...
      }), t || (Ht(e, "compositionstart", Cf), Ht(e, "compositionend", To), Ht(e, "change", To));
    },
    mounted(e, { value: t }) {
      e.value = t ?? "";
    },
    ...
    created(e, t, n) {
      e[hn] = Ur(n), Ht(e, "change", () => {
        const r = e._modelValue, i = Ef(e), s = e.checked, o = e[hn];
        if (j(r)) {
...
`, $f = `// Brush pass: updates sentinel levels in the neutral square texture.
//
...
`, Uf = "" + new URL("mandelbrot_bg-CCbbBD6M.wasm", import.meta.url).href, Ff = async (e = {}, t) => {
    let n;
...
${n.stack}` : n.toString();
  ...
  let Ai = 0;
  function Gf(e, t) {
    return Ai += t, Ai >= zf && (Tr = new TextDecoder("utf-8", {
      ignoreBOM: true,
      fatal: true
  ...
  class Ji {
    ...
    constructor(t, n, r, i) {
      const s = rn(t, Z.__wbindgen_malloc, Z.__wbindgen_realloc), o = It, a = rn(n, Z.__wbindgen_malloc, Z.__wbindgen_realloc), l = It, c = rn(r, Z.__wbindgen_malloc, Z.__wbindgen_realloc), u = It, f = Z.mandelbrotnavigator_new(s, o, a, l, c, u, i);
    ...
    scale(t) {
      if (this.__wbg_ptr == 0) throw new Error("Attempt to use a moved value");
      me(this.__wbg_ptr);
      const n = rn(t, Z.__wbindgen_malloc, Z.__wbindgen_realloc), r = It;
      Z.mandelbrotnavigator_scale(this.__wbg_ptr, n, r);
    }
    origin(t, n) {
      if (this.__wbg_ptr == 0) throw new Error("Attempt to use a moved value");
      me(this.__wbg_ptr);
      const r = rn(t, Z.__wbindgen_malloc, Z.__wbindgen_realloc), i = It, s = rn(n, Z.__wbindgen_malloc, Z.__wbindgen_realloc), o = It;
  ...
  var Xn = 0.7, Fr = 1 / Xn, pn = "\\s*([+-]?\\d+)\\s*", Yn = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", lt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", Id = /^#([0-9a-f]{3,8})$/, Od = new RegExp(`^rgb\\(${pn},${pn},${pn}\\)$`), Bd = new RegExp(`^rgb\\(${lt},${lt},${lt}\\)$`), $d = new RegExp(`^rgba\\(${pn},${pn},${pn},${Yn}\\)$`), Dd = new RegExp(`^rgba\\(${lt},${lt},${lt},${Yn}\\)$`), Ud = new RegExp(`^hsl\\(${Yn},${lt},${lt}\\)$`), Fd = new RegExp(`^hsla\\(${Yn},${lt},${lt},${Yn}\\)$`), Lo = {
    aliceblue: 15792383,
  ...
  function Yt(e) {
    var t, n;
    return e = (e + "").trim().toLowerCase(), (t = Id.exec(e)) ? (n = t[1].length, t = parseInt(t[1], 16), n === 6 ? Oo(t) : n === 3 ? new Ce(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : n === 8 ? dr(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : n === 4 ? dr(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = Od.exec(e)) ? new Ce(t[1], t[2], t[3], 1) : (t = Bd.exec(e)) ? new Ce(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = $d.exec(e)) ? dr(t[1], t[2], t[3], t[4]) : (t = Dd.exec(e)) ? dr(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = Ud.exec(e)) ? Do(t[1], t[2] / 100, t[3] / 100, 1) : (t = Fd.exec(e)) ? Do(t[1], t[2] / 100, t[3] / 100, t[4]) : Lo.hasOwnProperty(e) ? Oo(Lo[e]) : e === "transparent" ? new Ce(NaN, NaN, NaN, 0) : null;
  }
  function Oo(e) {
  ...
  function yl(e) {
    return e instanceof Qt || (e = Yt(e)), e ? (e = e.rgb(), new Ce(e.r, e.g, e.b, e.opacity)) : new Ce();
  }
  function ut(e, t, n, r) {
  ...
  ir(Ce, ut, hi(Qt, {
    brighter(e) {
      return e = e == null ? Fr : Math.pow(Fr, e), new Ce(this.r * e, this.g * e, this.b * e, this.opacity);
    },
    darker(e) {
    ...
    clamp() {
      return new Ce(Xt(this.r), Xt(this.g), Xt(this.b), Vr(this.opacity));
    },
    displayable() {
  ...
  const Wd = Math.PI / 180, qd = 180 / Math.PI, zr = 18, xl = 0.96422, Sl = 1, Tl = 0.82521, Ml = 4 / 29, gn = 6 / 29, Cl = 3 * gn * gn, Kd = gn * gn * gn;
  function El(e) {
    if (e instanceof ct) return new ct(e.l, e.a, e.b, e.opacity);
    if (e instanceof ot) return Al(e);
  ...
  function Qi(e, t, n, r) {
    return arguments.length === 1 ? El(e) : new ct(e, t, n, r ?? 1);
  }
  function ct(e, t, n, r) {
  ...
  ir(ct, Qi, hi(Qt, {
    ...
    rgb() {
      ...
      return t = xl * Li(t), e = Sl * Li(e), n = Tl * Li(n), new Ce(Ni(3.1338561 * t - 1.6168667 * e - 0.4906146 * n), Ni(-0.9787684 * t + 1.9161415 * e + 0.033454 * n), Ni(0.0719453 * t - 0.2289914 * e + 1.4052427 * n), this.opacity);
    }
  }));
  function Ri(e) {
  ...
  function kl(e) {
    ...
    if (e instanceof ct || (e = El(e)), e.a === 0 && e.b === 0) return new ot(NaN, 0 < e.l && e.l < 100 ? 0 : NaN, e.l, e.opacity);
  ...
  function Ls(e, t) {
    var n = typeof t, r;
    return t == null || n === "boolean" ? Rs(t) : (n === "number" ? qe : n === "string" ? (r = Yt(t)) ? (t = r, Gr) : Pl : t instanceof Yt ? Gr : t instanceof Date ? th : Qd(t) ? Jd : Array.isArray(t) ? eh : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? nh : qe)(e, t);
  }
  function sh(e, t) {
    return e = +e, t = +t, function(n) {
  ...
  function Ll(e, t, n, r) {
    ...
    return function(c, u) {
      ...
      return c = e(c), u = e(u), s(c.translateX, c.translateY, u.translateX, u.translateY, f, h), o(c.rotate, u.rotate, f, h), a(c.skewX, u.skewX, f, h), l(c.scaleX, c.scaleY, u.scaleX, u.scaleY, f, h), c = u = null, function(d) {
        for (var g = -1, _ = h.length, B; ++g < _; ) f[(B = h[g]).i] = B.x(d);
        return f.join("");
      };
    };
  }
  ...
  const _an = class _an {
    constructor(t, n) {
      ...
      this.canvas = t, this.shaderPassCompute = Of, this.shaderPassColor = Bf, this.antialiasLevel = n.antialiasLevel, this.palettePeriod = n.palettePeriod, this.time = 0;
    }
    async initialize(t) {
    ...
    async render() {
      ...
      if (!this.clearHistoryNextFrame && this.prevFrameMandelbrot) {
        const g = this.previousMandelbrot.dx - this.prevFrameMandelbrot.dx, _ = this.previousMandelbrot.dy - this.prevFrameMandelbrot.dy, B = this.neutralSize, G = Math.sqrt(t * t + 1);
        s = -(g * B) / (2 * this.previousMandelbrot.scale * G), o = _ * B / (2 * this.previousMandelbrot.scale * G);
      }
      ...
      if (d.setPipeline(this.pipelineColor), d.setBindGroup(0, this.bindGroupColor), d.draw(6, 1, 0, 0), d.end(), this.device.queue.submit([
        ...
        try {
          const g = this.snapshotDestWidth ?? 256, _ = Math.round(g * 9 / 16), B = this.device.createTexture({
            size: [
              g,
              _,
              1
          ...
          const G = (V) => V + 255 & -256, O = g * 4, U = G(O), y = U * _, S = this.device.createBuffer({
            size: y,
          ...
          const P = S.getMappedRange(), H = new Uint8ClampedArray(g * _ * 4), X = new Uint8Array(P);
          ...
          $.width = g, $.height = _, $.getContext("2d").putImageData(new ImageData(H, g, _), 0, 0), S.unmap(), this.snapshotCallback($.toDataURL("image/png"));
        } catch {
          this.snapshotCallback("");
        }
  ...
  const hh = Et({
    ...
    setup(e, { expose: t }) {
      ...
      jt(() => [
        ...
        o || s && (!_ || !B || !G || ((_ !== U || B !== y) && s.origin(_, B), G !== S && s.scale(G), O !== P && s.angle(O)));
      }, {
        flush: "sync"
      });
      const f = e;
      async function h() {
        ...
        const _ = s.step();
        if (!_) return;
        const [B, G] = _, [O, U, y, S] = s.get_params();
        o = true, a.value = O, l.value = U, c.value = y, u.value = parseFloat(S), await ai(), o = false;
        const P = Math.min(Math.max(100, 200 * Math.log2(1 / parseFloat(y))), 1e5);
      ...
      return At(async () => (await d(), window.addEventListener("resize", g), g())), nr(() => {
        window.removeEventListener("resize", g);
      }), t({
        getCanvas: () => n.value,
        getEngine: () => i,
        getNavigator: () => s,
        translate: (_, B) => s == null ? void 0 : s.translate(_, B),
        translateDirect: (_, B) => s == null ? void 0 : s.translate_direct(_, B),
    ...
    setup(e, { expose: t }) {
      ...
      let c = false, u = false, f = 0, h = 0, d = 0, g = 0, _ = 0, B = false, G = null, O = null;
      function U() {
        var _a2;
      ...
      function $(N) {
        ...
        if (u) {
          const _e = U();
          if (!_e) return;
          const $e = _e.getBoundingClientRect(), Je = $e.width / 2, ze = $e.height / 2, en = R.x, wn = R.y, ar = Math.atan2(wn - ze, en - Je);
          (_a2 = a.value) == null ? void 0 : _a2.angle(ar);
          return;
        }
        if (!c) return;
        const z = R.width, te = R.height, A = z / te, b = (R.x - f) / z * 2, M = (R.y - h) / te * 2;
        (_b = a.value) == null ? void 0 : _b.translateDirect(-b * A, M), f = R.x, h = R.y;
      }
      function V(N) {
      ...
      function W(N) {
        ...
        if (R) {
          if (N.touches.length === 1) {
            ...
            const A = (_a2 = a.value) == null ? void 0 : _a2.getParams();
            _ = A ? parseFloat(A[3]) : 0;
          }
        }
      }
      function x(N) {
        ...
        if (R) {
          if (c && N.touches.length === 1) {
            const z = N.touches[0], te = R.getBoundingClientRect(), A = z.clientX - te.left, b = z.clientY - te.top, M = te.width, _e = te.height, $e = M / _e, Je = (A - f) / M * 2, ze = (b - h) / _e * 2;
            (_a2 = a.value) == null ? void 0 : _a2.translateDirect(-Je * $e, ze), f = A, h = b;
          } else if (B && N.touches.length === 2) {
            const [z, te] = N.touches, A = Math.hypot(te.clientX - z.clientX, te.clientY - z.clientY), b = Math.atan2(te.clientY - z.clientY, te.clientX - z.clientX), M = d / A;
      ...
      function q(N) {
        N.touches.length === 0 && (c = false, B = false);
      }
      function ee() {
      ...
      return At(async () => {
        ...
        const N = U();
        N && (window.addEventListener("keydown", S), window.addEventListener("keyup", P), N.addEventListener("wheel", H, {
          passive: false
        }), N.addEventListener("mousedown", X), N.addEventListener("contextmenu", (R) => R.preventDefault()), window.addEventListener("mousemove", $), window.addEventListener("mouseup", V), N.addEventListener("touchstart", W, {
          passive: false
        ...
        const N = U();
        window.removeEventListener("keydown", S), window.removeEventListener("keyup", P), window.removeEventListener("mousemove", $), window.removeEventListener("mouseup", V), N && (N.removeEventListener("wheel", H), N.removeEventListener("mousedown", X), N.removeEventListener("contextmenu", (R) => R.preventDefault()), N.removeEventListener("touchstart", W), N.removeEventListener("touchmove", x), N.removeEventListener("touchend", q));
      }), (N, R) => (le(), fe("div", _h, [
        ye(hh, {
  ...
  const Ch = Nl(Mr), Eh = Ch.right;
  Nl(Mh).center;
  const kh = Math.sqrt(50), Ah = Math.sqrt(10), Ph = Math.sqrt(2);
  function Wr(e, t, n) {
    const r = (t - e) / Math.max(0, n), i = Math.floor(Math.log10(r)), s = r / Math.pow(10, i), o = s >= kh ? 10 : s >= Ah ? 5 : s >= Ph ? 2 : 1;
    let a, l, c;
  ...
  function Uh(e, t) {
    ...
    function h(d) {
      var g = r ?? (t.ticks ? t.ticks.apply(t, n) : t.domain()), _ = i ?? (t.tickFormat ? t.tickFormat.apply(t, n) : Nh), B = Math.max(s, 0) + a, G = t.range(), O = +G[0] + l, U = +G[G.length - 1] + l, y = (t.bandwidth ? $h : Bh)(t.copy(), l), S = d.selection ? d.selection() : d, P = S.selectAll(".domain").data([
        null
      ]), H = S.selectAll(".tick").data(g, t).order(), X = H.exit(), $ = H.enter().append("g").attr("class", "tick"), V = H.select("line"), W = H.select("text");
      P = P.merge(P.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), H = H.merge($), V = V.merge($.append("line").attr("stroke", "currentColor").attr(u + "2", c * s)), W = W.merge($.append("text").attr("fill", "currentColor").attr(u, c * B).attr("dy", "0.71em")), d !== S && (P = P.transition(d), H = H.transition(d), V = V.transition(d), W = W.transition(d), X = X.transition(d).attr("opacity", zo).attr("transform", function(x) {
        return isFinite(x = y(x)) ? f(x + l) : this.getAttribute("transform");
      }), $.attr("opacity", zo).attr("transform", function(x) {
        var q = this.parentNode.__axis;
        return f((q && isFinite(q = q(x)) ? q : y(x)) + l);
      })), X.remove(), P.attr("d", o ? "M" + O + "," + c * o + "V" + l + "H" + U + "V" + c * o : "M" + O + "," + l + "H" + U), H.attr("opacity", 1).attr("transform", function(x) {
        return f(y(x) + l);
      }), V.attr(u + "2", c * s), W.attr(u, c * B).text(_), S.filter(Dh).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", "middle"), S.each(function() {
        this.__axis = y;
      });
    }
  ...
  function tp(e) {
    return this.select(e == null ? ep : Qh(typeof e == "function" ? e : Bl(e)));
  }
  ...
  function sp(e) {
    return this.selectAll(e == null ? rp : ip(typeof e == "function" ? e : Bl(e)));
  }
  function op(e) {
  ...
  function ap() {
    return new Ve(this._enter || this._groups.map($l), this._parents);
  }
  function qr(e, t) {
  ...
  function dp(e, t) {
    ...
    for (var s = i.length, o = new Array(s), a = new Array(s), l = new Array(s), c = 0; c < s; ++c) {
      var u = r[c], f = i[c], h = f.length, d = hp(e.call(u, u && u.__data__, c, r)), g = d.length, _ = a[c] = new Array(g), B = o[c] = new Array(g), G = l[c] = new Array(h);
      n(u, f, _, B, G, d, t);
      for (var O = 0, U = 0, y, S; O < g; ++O) if (y = _[O]) {
        for (O >= U && (U = O + 1); !(S = B[U]) && ++U < g; ) ;
        y._next = S || null;
      }
    }
  ...
  function pp() {
    return new Ve(this._exit || this._groups.map($l), this._parents);
  }
  function gp(e, t, n) {
  ...
  function Lp(e, t) {
    ...
    return this.each((t == null ? n.local ? Ep : Cp : typeof t == "function" ? n.local ? Rp : Pp : n.local ? Ap : kp)(n, t));
  }
  function Dl(e) {
  ...
  function Fp(e, t) {
    return arguments.length > 1 ? this.each((t == null ? $p : typeof t == "function" ? Up : Dp)(e, t)) : this.node()[e];
  }
  function Ul(e) {
  ...
  function Hp(e, t) {
    var n = Ul(e + "");
    if (arguments.length < 2) {
      for (var r = Bs(this.node()), i = -1, s = n.length; ++i < s; ) if (!r.contains(n[i])) return false;
      return true;
    }
  ...
  function Lg() {
    var e = kg, t = Ag, n = Pg, r = Rg, i = {}, s = Ns("start", "drag", "end"), o = 0, a, l, c, u, f = 0;
    function h(y) {
      y.on("mousedown.drag", d).filter(r).on("touchstart.drag", B).on("touchmove.drag", G, Mg).on("touchend.drag touchcancel.drag", O).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
    }
    function d(y, S) {
      if (!(u || !e.call(this, y, S))) {
        var P = U(this, t.call(this, y, S), y, S, "mouse");
        P && (Zt(y.view).on("mousemove.drag", g, Zn).on("mouseup.drag", _, Zn), Cg(y.view), Bi(y), c = false, a = y.clientX, l = y.clientY, P("start", y));
      }
    }
    function g(y) {
      if (mn(y), !c) {
    ...
    function _(y) {
      Zt(y.view).on("mousemove.drag mouseup.drag", null), Eg(y.view, c), mn(y), i.mouse("end", y);
    }
    function B(y, S) {
      if (e.call(this, y, S)) {
        var P = y.changedTouches, H = t.call(this, y, S), X = P.length, $, V;
        for ($ = 0; $ < X; ++$) (V = U(this, H, y, S, P[$].identifier, P[$])) && (Bi(y), V("start", y, P[$]));
      }
    }
    function G(y) {
      var S = y.changedTouches, P = S.length, H, X;
      for (H = 0; H < P; ++H) (X = i[S[H].identifier]) && (mn(y), X("drag", y, S[H]));
    }
    function O(y) {
      var S = y.changedTouches, P = S.length, H, X;
      for (u && clearTimeout(u), u = setTimeout(function() {
        u = null;
      }, 500), H = 0; H < P; ++H) (X = i[S[H].identifier]) && (Bi(y), X("end", y, S[H]));
    }
    function U(y, S, P, H, X, $) {
      var V = s.copy(), W = Wo($ || P, S), x, q, ee;
      if ((ee = n.call(y, new os("beforestart", {
        sourceEvent: P,
        target: h,
        identifier: X,
        active: o,
  ...
  var bn = 0, Pn = 0, kn = 0, ql = 1e3, Kr, Rn, jr = 0, Jt = 0, gi = 0, Jn = typeof performance == "object" && performance.now ? performance : Date, Kl = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
    setTimeout(e, 17);
  };
  function $s() {
  ...
  Xr.prototype = jl.prototype = {
    ...
    restart: function(e, t, n) {
      ...
      n = (n == null ? $s() : +n) + (t == null ? 0 : +t), !this._next && Rn !== this && (Rn ? Rn._next = this : Kr = this, Rn = this), this._call = e, this._time = n, as();
    },
    stop: function() {
  ...
  function as(e) {
    if (!bn) {
      ...
      var t = e - Jt;
      t > 24 ? (e < 1 / 0 && (Pn = setTimeout(qo, e - Jn.now() - gi)), kn && (kn = clearInterval(kn))) : (kn || (jr = Jn.now(), kn = setInterval(Og, ql)), bn = 1, Kl(qo));
    }
  }
  function Ko(e, t, n) {
    var r = new Xr();
  ...
  var $g = Ns("start", "end", "cancel", "interrupt"), Dg = [], Xl = 0, jo = 1, ls = 2, Er = 3, Xo = 4, us = 5, kr = 6;
  ...
  function Ug(e, t, n) {
    ...
    function o(c) {
      ...
      if (Ko(function() {
        n.state === Er && (n.state = Xo, n.timer.restart(a, n.delay, n.time), a(c));
      }), n.state = ls, n.on.call("start", e, e.__data__, n.index, n.group), n.state === ls) {
        for (n.state = Er, i = new Array(h = n.tween.length), u = 0, f = -1; u < h; ++u) (d = n.tween[u].value.call(e, e.__data__, n.index, n.group)) && (i[++f] = d);
        i.length = f + 1;
      }
    }
    function a(c) {
  ...
  function Yl(e, t) {
    var n;
    return (typeof t == "number" ? qe : t instanceof Yt ? Gr : (n = Yt(t)) ? (t = n, Gr) : Pl)(e, t);
  }
  function Wg(e) {
    return function() {
      this.removeAttribute(e);
  ...
  function wm(e) {
    ...
    for (var r = this._groups, i = r.length, s = [], o = [], a = 0; a < i; ++a) for (var l = r[a], c = l.length, u, f = 0; f < c; ++f) if (u = l[f]) {
      for (var h = e.call(u, u.__data__, f, l), d, g = Ze(u, n), _ = 0, B = h.length; _ < B; ++_) (d = h[_]) && mi(d, t, n, _, h, g);
      s.push(h), o.push(u);
    }
    return new Ct(s, o, t, n);
  }
  ...
  function km(e, t, n) {
    ...
    return t == null ? this.styleTween(e, Tm(e, r)).on("end.style." + e, Zl(e)) : typeof t == "function" ? this.styleTween(e, Cm(e, r, Us(this, "style." + e, t))).each(Em(this._id, e)) : this.styleTween(e, Mm(e, r, t), n).on("end.style." + e, null);
  }
  function Am(e, t, n) {
    return function(r) {
  ...
  function Dm() {
    ...
    return new Ct(r, this._parents, e, n);
  }
  function Um() {
  ...
  function Zm(e) {
    ...
    function c(f, h) {
      f = Zr(f);
      var d = f.fill, g = f.align, _ = f.sign, B = f.symbol, G = f.zero, O = f.width, U = f.comma, y = f.precision, S = f.trim, P = f.type;
      P === "n" ? (U = true, P = "g") : Zo[P] || (y === void 0 && (y = 12), S = true, P = "g"), (G || d === "0" && g === "=") && (G = true, d = "0", g = "=");
      var H = (h && h.prefix !== void 0 ? h.prefix : "") + (B === "$" ? n : B === "#" && /[boxX]/.test(P) ? "0" + P.toLowerCase() : ""), X = (B === "$" ? r : /[%p]/.test(P) ? o : "") + (h && h.suffix !== void 0 ? h.suffix : ""), $ = Zo[P], V = /[defgprs%]/.test(P);
      ...
      function W(x) {
        ...
        if (P === "c") ee = $(x) + ee, x = "";
          ...
          x = +x;
          var z = x < 0 || 1 / x < 0;
          if (x = isNaN(x) ? l : $(Math.abs(x), y), S && (x = Xm(x)), z && +x == 0 && _ !== "+" && (z = false), q = (z ? _ === "(" ? _ : a : _ === "-" || _ === "(" ? "" : _) + q, ee = (P === "s" && !isNaN(x) && Jr !== void 0 ? ea[8 + Jr / 3] : "") + ee + (z && _ === "(" ? ")" : ""), V) {
        ...
        U && !G && (x = t(x, 1 / 0));
        var te = q.length + x.length + ee.length, A = te < O ? new Array(O - te + 1).join(d) : "";
        switch (U && G && (x = t(A + x, A.length ? O - ee.length : 1 / 0), A = ""), g) {
          case "<":
            x = q + x + ee + A;
            break;
          case "=":
            ...
            break;
          case "^":
            x = A.slice(0, te = A.length >> 1) + q + x + ee + A.slice(te);
            break;
          default:
            x = A + q + x + ee;
            break;
  ...
  const h0 = 30, p0 = Et({
    ...
    setup(e, { emit: t }) {
      ...
      function a(l, c, u, f, h) {
        ...
        const g = xg("div"), _ = ut("white"), B = ut("black"), G = g.selectAll("div").data(l).join("div"), O = Wl(), U = G.append("canvas").attr("width", u).attr("height", 1).style("max-width", "100%").style("width", `${u}px`).style("height", `${f}px`).each(function() {
          const S = this.getContext("2d"), P = S.createImageData(u, 1);
          O.set(this, {
            context: S,
            image: P,
            data: P.data
          ...
          P.x = Math.max(0, Math.min(u - 1, X)), d[P.name] = P.scale.invert(P.x), U.each(function($) {
            y.call(this, $);
          }), h({
            ...d
          }, false, P.name);
        ...
        function y(S) {
          const P = O.get(this), { context: H, image: X, data: $ } = P;
          for (let V = 0, W = -1; V < u; ++V) {
            let x;
            if (V === Math.round(S.x)) x = _;
            else if (V === Math.round(S.x) - 1) x = B;
            else {
              const q = {
                ...d
              };
    ...
    setup(e, { emit: t }) {
      ...
      function o(h) {
        ...
        const B = a.value !== null && ((_a2 = n.colorStops[a.value]) == null ? void 0 : _a2.color) || "#ffffff";
        n.colorStops.push({
          color: B,
          position: _
        ...
        v("div", {
          ...
          v("div", m0, [
            (le(true), fe(Ue, null, Wi(e.colorStops, (g, _) => (le(), ul(xh, {
              ...
              stop: g,
              index: _,
              "onUpdate:position": (B) => e.colorStops[_].position = B,
              onClick: (B) => l(_)
            }, null, 8, [
              "stop",
              "index",
    ...
    class: "checkbox"
  }, $i = "mandelbrot_presets", Di = "mandelbrot_palettes", Lv = Et({
    __name: "Settings",
    props: Ms({
      engine: {},
      suspendShortcuts: {
    ...
    setup(e) {
      const t = e, n = wt(e, "modelValue"), r = Te(() => ((n.value.angle * 180 / Math.PI % 360 + 360) % 360).toFixed(2)), i = Te({
        ...
        set: (A) => {
          n.value.angle = A % 360 * Math.PI / 180;
        }
      }), s = Te({
        get: () => (Math.log10(n.value.palettePeriod || 0.01) + 2) / 5,
        set: (A) => {
          n.value.palettePeriod = Number((10 ** (A * 5 - 2)).toPrecision(6));
        }
      }), o = Te({
        get: () => {
          const A = Number(n.value.scale), b = A > 0 ? -Math.log2(A) : 126;
          return isFinite(b) ? Math.min(Math.max(Math.round(b), 1), 126) : 1;
        },
        set: (A) => {
          const b = Math.min(Math.max(Math.round(A), 1), 126);
      ...
      function l(A) {
        ...
        if (!M) return "";
        if (A.length === 0) return M.fillStyle = "#000", M.fillRect(0, 0, b.width, b.height), b.toDataURL("image/png");
        const $e = new Hr(A).generateTexture(), Je = document.createElement("canvas");
        Je.width = $e.width, Je.height = 1;
        const ze = Je.getContext("2d");
        return ze ? (ze.putImageData($e, 0, 0), M.drawImage(Je, 0, 0, b.width, b.height), b.toDataURL("image/png")) : "";
      }
      const c = pe(null), u = pe(""), f = pe([]), h = pe(""), d = pe([]), g = pe(""), _ = pe(false);
      function B() {
        const A = u.value.trim();
        if (A && window.confirm(`Supprimer le preset "${A}" ? Cette action est irr\xE9versible.`)) {
          const b = f.value.findIndex((M) => M.name === A);
          b >= 0 && (f.value.splice(b, 1), localStorage.setItem($i, JSON.stringify(f.value)), O.value = "", u.value = "");
        }
      }
      async function G() {
        t.engine && (c.value = await t.engine.getSnapshotPng(256));
      }
      const O = pe(""), U = pe(false), y = Te(() => f.value.find((A) => A.name === O.value)), S = Te(() => {
        var _a2;
        return (_a2 = y.value) == null ? void 0 : _a2.thumbnail;
      });
      function P(A) {
        ee(A.name), U.value = false;
      }
      async function H() {
        if (!u.value.trim()) return;
        let A, b = (/* @__PURE__ */ new Date()).toISOString();
        try {
          t.engine && (A = await t.engine.getSnapshotPng(256));
        } catch {
        }
        const M = {
          name: u.value.trim(),
          ...
          thumbnail: A,
          date: b
        }, _e = f.value.findIndex(($e) => $e.name === M.name);
        _e >= 0 ? f.value[_e] = M : f.value.push(M), localStorage.setItem($i, JSON.stringify(f.value)), u.value = "";
      }
      function X() {
        const A = localStorage.getItem($i);
        if (A) try {
          f.value = JSON.parse(A);
        } catch {
        }
      }
      function $() {
        const A = localStorage.getItem(Di);
        if (A) try {
          d.value = JSON.parse(A);
        } catch {
        }
      }
      async function V() {
        ...
        const M = {
          ...
          thumbnail: A,
          date: b
        }, _e = d.value.findIndex(($e) => $e.name === M.name);
        _e >= 0 ? d.value[_e] = M : d.value.push(M), localStorage.setItem(Di, JSON.stringify(d.value)), h.value = "";
      }
      function W(A) {
        const b = d.value.find((M) => M.name === A);
        b && (g.value = A, h.value = b.name, n.value.colorStops = structuredClone(re(b.colorStops)));
      }
      function x(A) {
        W(A.name), _.value = false;
      }
      function q() {
        const A = h.value.trim();
        if (A && window.confirm(`Supprimer la palette "${A}" ? Cette action est irr\xE9versible.`)) {
          const b = d.value.findIndex((M) => M.name === A);
          b >= 0 && (d.value.splice(b, 1), localStorage.setItem(Di, JSON.stringify(d.value)), g.value = "", h.value = "");
        }
      }
      function ee(A) {
        const b = f.value.find((M) => M.name === A);
        b && (O.value = A, u.value = b.name, n.value = structuredClone(re(b.value)));
      }
      const ge = Te({
        get: () => Math.log10(n.value.mu ?? 1),
        set: (A) => {
          n.value.mu = Math.pow(10, A);
        }
      }), N = Te({
        get: () => Math.log10(n.value.epsilon ?? 1e-8),
        set: (A) => {
          n.value.epsilon = Math.pow(10, A);
        }
      });
      At(() => {
        X(), $();
      });
      const R = pe("navigation"), z = Te(() => d.value.find((A) => A.name === g.value)), te = Te(() => {
        var _a2;
      ...
      return jt([
        ...
        v("div", x0, [
          R.value === "navigation" ? (le(), fe("div", S0, [
            ...
            v("div", M0, [
              v("span", null, [
                b[30] || (b[30] = se("\xC9chelle\xA0: ", -1)),
                v("span", C0, be(Number(n.value.scale).toExponential(2)), 1)
              ]),
              xe(v("input", {
                ...
                max: "126",
                step: "1",
                "onUpdate:modelValue": b[4] || (b[4] = (M) => o.value = M)
              }, null, 512), [
                [
                  gt,
                  o.value,
            ...
            v("div", P0, [
              ...
              v("div", {
                ...
                v("div", O0, [
                  v("div", B0, [
                    (le(true), fe(Ue, null, Wi(f.value, (M) => (le(), fe("a", {
                      key: M.name,
                      class: ve([
                        "dropdown-item",
                        {
                          "is-active": O.value === M.name
                        }
                      ]),
                      onClick: Eo((_e) => P(M), [
                        "prevent"
              ...
              v("div", F0, [
                v("div", V0, [
                  xe(v("input", {
                    class: "input",
                    "onUpdate:modelValue": b[7] || (b[7] = (M) => u.value = M),
                    type: "text",
                    placeholder: "Nom...",
            ...
            v("div", q0, [
              ...
              xe(v("input", {
                ...
                max: "1",
                step: "0.001",
                "onUpdate:modelValue": b[10] || (b[10] = (M) => s.value = M)
              }, null, 512), [
                [
                  gt,
                  s.value,
            ...
            v("div", j0, [
              ...
              v("div", {
                ...
                v("div", ev, [
                  v("div", tv, [
                    (le(true), fe(Ue, null, Wi(d.value, (M) => (le(), fe("a", {
                      key: M.name,
                      class: ve([
                        "dropdown-item",
                        {
            ...
            v("div", cv, [
              ...
              v("div", fv, [
                xe(v("input", {
                  ...
                  max: "5",
                  step: "0.01",
                  "onUpdate:modelValue": b[16] || (b[16] = (M) => ge.value = M)
                }, null, 512), [
                  [
                    gt,
                    ge.value
            ...
            v("div", dv, [
              ...
              v("div", hv, [
                xe(v("input", {
                  ...
                  max: "0",
                  step: "0.01",
                  "onUpdate:modelValue": b[17] || (b[17] = (M) => N.value = M)
                }, null, 512), [
                  [
                    gt,
                    N.value
            ...
            v("div", mv, [
              v("label", vv, [
                ...
                b[42] || (b[42] = se(" \xA0Activer la webcam ", -1))
              ])
            ]),
            v("div", _v, [
              v("label", bv, [
                ...
                b[43] || (b[43] = se(" \xA0Tessellation GPU ", -1))
              ])
            ]),
            v("div", yv, [
              v("label", wv, [
                ...
                b[44] || (b[44] = se(" \xA0Shading avanc\xE9 ", -1))
              ])
            ]),
            v("div", xv, [
              v("label", Sv, [
  ...
  }, na = "mandelbrot_last_settings", qv = Et({
    ...
    setup(e) {
      ...
      return (h, d) => (le(), fe("div", Iv, [
        ...
        ye(yh, {
          ...
          activateAnimate: o.value.activateAnimate
        }, null, 8, [
          "scale",
          "angle",
          "cx",
        ...
        xe(v("div", {
          ...
          d[8] || (d[8] = se("\xA0 ", -1)),
          v("span", Bv, be(f.value.up), 1),
          d[9] || (d[9] = se("\xA0 ", -1)),
          v("span", $v, be(f.value.left), 1),
          d[10] || (d[10] = se("\xA0 ", -1)),
          v("span", Dv, be(f.value.down), 1),
          d[11] || (d[11] = se("\xA0 ", -1)),
          v("span", Uv, be(f.value.right), 1),
          d[12] || (d[12] = se("\xA0 |\xA0Rotate\xA0 ", -1)),
          d[13] || (d[13] = v("span", {
            class: "tag is-black"
          }, "Right clic", -1)),
          d[14] || (d[14] = se("\xA0 ", -1)),
          v("span", Fv, be(f.value.rotateLeft), 1),
          d[15] || (d[15] = se("\xA0 ", -1)),
          v("span", Vv, be(f.value.rotateRight), 1),
          d[16] || (d[16] = se("\xA0 |\xA0Zoom\xA0 ", -1)),
          d[17] || (d[17] = v("span", {
            class: "tag is-black"
          }, "Wheel", -1)),
          d[18] || (d[18] = se("\xA0 ", -1)),
          v("span", zv, be(f.value.zoomIn), 1),
          d[19] || (d[19] = se("\xA0 ", -1)),
          v("span", Gv, be(f.value.zoomOut), 1),
    ...
    setup(e) {
      ...
      return At(() => {
        ...
        v("div", Yv, [
          ...
          v("h1", Zv, be(n.value ? "WebGPU non support\xE9" : "WebGPU not supported"), 1),
          v("p", null, [
            n.value ? (le(), fe("span", Jv, [
              ...i[0] || (i[0] = [
