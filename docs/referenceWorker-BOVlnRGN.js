(async ()=>{
    ...
    function G(_, e) {
        return B += e, B >= q && (M = new TextDecoder("utf-8", {
            ignoreBOM: !0,
            fatal: !0
        }), M.decode(), B = e), M.decode(A().subarray(_, _ + e));
    }
    function V(_, e) {
        return _ = _ >>> 0, G(_, e);
    }
    ...
    function c(_, e, n) {
        if (n === void 0) {
            ...
            return A().subarray(p, p + l.length).set(l), g = l.length, p;
        }
        ...
        if (a !== o) {
            ...
            const l = A().subarray(b + a, b + o), p = m.encodeInto(_, l);
    ...
    N();
    const C = self;
    let s, f = 0, z = !1, u = 0, v = 0, I = !1, y = !1, S = "", U = "";
    const k_ = 1e3;
    function E(_, e) {
        C.postMessage(_, e ?? []);
    }
    ...
    function E_(_) {
        s?.free(), s = new T(_.cx, _.cy, _.scale, _.angle), f = _.jobId, u = 0, v = _.maxIterations, y = !1, S = "", U = "", J(_.approximationMode), s.set_bla_epsilon(_.blaEpsilon), h(_.jobId);
    }
    function B_(_, e, n) {
