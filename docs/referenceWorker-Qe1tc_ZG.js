(async ()=>{
    var qe = "" + new URL("mandelbrot_bg-BrGcguQw.wasm", import.meta.url).href, e_ = async (n = {}, e)=>{
        let i;
    ...
    class re {
        static __wrap(e) {
            ...
            return i.__wbg_ptr = e, Be.register(i, i.__wbg_ptr, i), i;
        }
        __destroy_into_raw() {
            const e = this.__wbg_ptr;
    ...
    var mo = Object.freeze({
        ...
        __wbg_get_incrementalunifiedbufferinfo_ranges_ptr: Q_,
        __wbg_get_incrementalunifiedbufferinfo_reference_log2_dc: Y_,
        ...
        __wbg_get_unifiedbufferinfo_validity_diagnostics_count: Yr,
        ...
        __wbg_set_unifiedbufferinfo_level_count: Yi,
        ...
        __wbg_set_unifiedbufferinfo_validity_version: Qt,
        __wbg_set_unifiedbufferinfo_validity_words_per_block: Yt,
        ...
        mandelbrotnavigator_unified_last_band_log2: Yn,
    ...
    __(mo);
    He();
    const vo = 4, $e = 19, ho = 6, Pe = 27, yo = 4;
    function ko(n, e) {
    ...
    const Re = self;
    let f, y = 0, Q = !1, d = 0, F = !1, p = 0, G = 0, ye = !1, J = !1, So = 0, L = 0, _e = Number.NaN, ue = -1, de = -1, Ao = 0, V = 0, H = 0, Fe = 0, Je = 0, Se = "none", S = "none", j = "";
    ...
    function ce(n, e) {
        ...
        try {
            ...
            const c = new Uint32Array(k.buffer, o.ranges_ptr, o.range_count * 6), l = new Uint32Array(c), g = new Float32Array(k.buffer, o.coeffs_ptr, o.coeffs_count * 27), w = new Float32Array(g), u = new Float32Array(k.buffer, o.radii_ptr, o.radii_count * 4), Y = new Float32Array(u);
            if (!Fo({
                version: o.certificate_version,
                wordsPerBlock: o.certificate_words_per_block,
                rangesWords: l.length,
                coefficientFloats: w.length,
                sidecarFloats: Y.length,
    ...
    function Ge(n, e, i) {
        ...
        const l = L, g = r === 3, w = r === 4, u = r === 5, Y = u ? "unified" : w ? "mobius" : g ? "jet" : "bla", I = (R, E)=>{
            A({
                type: "tableProgress",
                jobId: n,
                refId: l,
        ...
        const M = u ? Ye(b, f.current_log2_c_max()) : void 0;
    ...
    function ke(n, e, i) {
        ...
        J = !1;
        const a = Co(r.ptr, r.offset, r.count), [s, o] = f.get_reference_params();
        ...
        try {
            switch(e.type){
                ...
                case "setApproximationMode":
                    e.jobId === y && (Qe(e.approximationMode), f?.get_incremental_reference_table() && (f.set_incremental_reference_table(!1), f.set_incremental_reference_table(!0)), d = 0, F = !1, j = "", S = "epoch-reset", p = e.tableGeneration, C(e.jobId));
                    break;
                case "setBlaEpsilon":
                    f && e.jobId === y && (f.set_bla_epsilon(e.blaEpsilon), d = 0, F = !1, j = "", S = "epoch-reset", p = e.tableGeneration, C(e.jobId));
                    break;
                case "setGateEmission":
                    f && e.jobId === y && (f.set_gate_emission(e.on), d = 0, F = !1, j = "", p = e.tableGeneration, C(e.jobId));
                    break;
                case "setDynamicBlockValidity":
                    f && e.jobId === y && (f.set_dynamic_block_validity(e.on), d = 0, F = !1, j = "", S = "epoch-reset", p = e.tableGeneration, C(e.jobId));
                    break;
                case "setIncrementalReferenceTable":
                    f && e.jobId === y && (f.set_incremental_reference_table(e.on), d = 0, F = !1, j = "", S = "epoch-reset", p = e.tableGeneration, C(e.jobId));
                    break;
                case "setMaxBlaSkip":
                    f && e.jobId === y && (f.set_max_bla_skip(e.maxBlaSkip), d = 0, F = !1, j = "", S = "epoch-reset", p = e.tableGeneration, C(e.jobId));
                    break;
                case "findMinibrot":
                    if (f && e.jobId === y) {
