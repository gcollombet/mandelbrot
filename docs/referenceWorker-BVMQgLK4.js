(async ()=>{
    var qe = "" + new URL("mandelbrot_bg-BSfPOsWk.wasm", import.meta.url).href, e_ = async (n = {}, e)=>{
        let i;
    ...
    class ne {
        static __wrap(e) {
            ...
            return i.__wbg_ptr = e, Ce.register(i, i.__wbg_ptr, i), i;
        }
        __destroy_into_raw() {
    ...
    class ie {
        ...
        set coeffs_count(e) {
            t.__wbg_set_incrementalunifiedbufferinfo_coeffs_count(this.__wbg_ptr, e);
        }
        set coeffs_ptr(e) {
    ...
    class re {
        ...
        get coeffs_count() {
            return t.__wbg_get_jetbufferinfo_coeffs_count(this.__wbg_ptr) >>> 0;
        }
        get coeffs_ptr() {
            return t.__wbg_get_jetbufferinfo_coeffs_ptr(this.__wbg_ptr) >>> 0;
        }
        get level_count() {
            return t.__wbg_get_jetbufferinfo_level_count(this.__wbg_ptr) >>> 0;
        }
        get levels_ptr() {
            return t.__wbg_get_jetbufferinfo_levels_ptr(this.__wbg_ptr) >>> 0;
        }
        get radii_count() {
            return t.__wbg_get_jetbufferinfo_radii_count(this.__wbg_ptr) >>> 0;
        }
        get radii_ptr() {
            return t.__wbg_get_jetbufferinfo_radii_ptr(this.__wbg_ptr) >>> 0;
        }
        set coeffs_count(e) {
            t.__wbg_set_jetbufferinfo_coeffs_count(this.__wbg_ptr, e);
        }
        set coeffs_ptr(e) {
            t.__wbg_set_jetbufferinfo_coeffs_ptr(this.__wbg_ptr, e);
        }
        set level_count(e) {
            t.__wbg_set_jetbufferinfo_level_count(this.__wbg_ptr, e);
        }
        set levels_ptr(e) {
            t.__wbg_set_jetbufferinfo_levels_ptr(this.__wbg_ptr, e);
        }
        set radii_count(e) {
            t.__wbg_set_jetbufferinfo_radii_count(this.__wbg_ptr, e);
        }
        set radii_ptr(e) {
            t.__wbg_set_jetbufferinfo_radii_ptr(this.__wbg_ptr, e);
        }
    }
    ...
    class xe {
        ...
        coordinate_to_pixel(e, i, r, a) {
            const s = x(e, t.__wbindgen_malloc, t.__wbindgen_realloc), o = h, c = x(i, t.__wbindgen_malloc, t.__wbindgen_realloc), g = h, l = t.mandelbrotnavigator_coordinate_to_pixel(this.__wbg_ptr, s, o, c, g, r, a);
            var w = Ue(l[0], l[1]).slice();
            return t.__wbindgen_free(l[0], l[1] * 8, 8), w;
        }
        current_log2_c_max() {
        ...
        constructor(e, i, r, a){
            const s = x(e, t.__wbindgen_malloc, t.__wbindgen_realloc), o = h, c = x(i, t.__wbindgen_malloc, t.__wbindgen_realloc), g = h, l = x(r, t.__wbindgen_malloc, t.__wbindgen_realloc), w = h, u = t.mandelbrotnavigator_new(s, o, c, g, l, w, a);
            return this.__wbg_ptr = u, Be.register(this, this.__wbg_ptr, this), this;
        }
        origin(e, i) {
        ...
        start_transition(e, i, r, a, s) {
            const o = x(e, t.__wbindgen_malloc, t.__wbindgen_realloc), c = h, g = x(i, t.__wbindgen_malloc, t.__wbindgen_realloc), l = h, w = x(r, t.__wbindgen_malloc, t.__wbindgen_realloc), u = h;
            t.mandelbrotnavigator_start_transition(this.__wbg_ptr, o, c, g, l, w, u, a, s);
        }
        step(e, i) {
        ...
        step_with_input(e, i, r, a, s, o) {
            ...
            var g = z(c[0], c[1]);
            return t.__wbindgen_free(c[0], c[1] * 4, 4), g;
        }
        translate(e, i) {
    ...
    class oe {
        ...
        get coeffs_count() {
            return t.__wbg_get_mobiusbufferinfo_coeffs_count(this.__wbg_ptr) >>> 0;
        }
        get coeffs_ptr() {
            return t.__wbg_get_mobiusbufferinfo_coeffs_ptr(this.__wbg_ptr) >>> 0;
        }
        get level_count() {
            return t.__wbg_get_mobiusbufferinfo_level_count(this.__wbg_ptr) >>> 0;
        }
        get levels_ptr() {
            return t.__wbg_get_mobiusbufferinfo_levels_ptr(this.__wbg_ptr) >>> 0;
        }
        get radii_count() {
            return t.__wbg_get_mobiusbufferinfo_radii_count(this.__wbg_ptr) >>> 0;
        }
        get radii_ptr() {
            return t.__wbg_get_mobiusbufferinfo_radii_ptr(this.__wbg_ptr) >>> 0;
        }
        set coeffs_count(e) {
            t.__wbg_set_mobiusbufferinfo_coeffs_count(this.__wbg_ptr, e);
        }
        set coeffs_ptr(e) {
            t.__wbg_set_mobiusbufferinfo_coeffs_ptr(this.__wbg_ptr, e);
        }
        set level_count(e) {
            t.__wbg_set_mobiusbufferinfo_level_count(this.__wbg_ptr, e);
        }
        set levels_ptr(e) {
            t.__wbg_set_mobiusbufferinfo_levels_ptr(this.__wbg_ptr, e);
        }
        set radii_count(e) {
            t.__wbg_set_mobiusbufferinfo_radii_count(this.__wbg_ptr, e);
        }
        set radii_ptr(e) {
            t.__wbg_set_mobiusbufferinfo_radii_ptr(this.__wbg_ptr, e);
        }
    }
    ...
    class K {
        ...
        get count() {
            return t.__wbg_get_orbitbufferinfo_count(this.__wbg_ptr) >>> 0;
        }
        get offset() {
            return t.__wbg_get_orbitbufferinfo_offset(this.__wbg_ptr) >>> 0;
        }
        get ptr() {
            return t.__wbg_get_orbitbufferinfo_ptr(this.__wbg_ptr) >>> 0;
        }
        set count(e) {
            t.__wbg_set_orbitbufferinfo_count(this.__wbg_ptr, e);
        }
        set offset(e) {
            t.__wbg_set_orbitbufferinfo_offset(this.__wbg_ptr, e);
        }
        set ptr(e) {
            t.__wbg_set_orbitbufferinfo_ptr(this.__wbg_ptr, e);
        }
    }
    ...
    class ae {
        ...
        set max_iter_delta(e) {
            t.__wbg_set_padebenchmark_max_iter_delta(this.__wbg_ptr, e);
        }
        set max_iter(e) {
            t.__wbg_set_padebenchmark_max_iter(this.__wbg_ptr, e);
        }
        set pade_mismatches(e) {
            t.__wbg_set_padebenchmark_pade_mismatches(this.__wbg_ptr, e);
        }
        set pixels(e) {
            t.__wbg_set_padebenchmark_pixels(this.__wbg_ptr, e);
        }
        set steps_affine(e) {
            t.__wbg_set_padebenchmark_steps_affine(this.__wbg_ptr, e);
        }
        set steps_exact(e) {
            t.__wbg_set_padebenchmark_steps_exact(this.__wbg_ptr, e);
        }
        set steps_pade(e) {
            t.__wbg_set_padebenchmark_steps_pade(this.__wbg_ptr, e);
        }
    }
    ...
    class D {
        ...
        get coeffs_count() {
            return t.__wbg_get_unifiedbufferinfo_coeffs_count(this.__wbg_ptr) >>> 0;
        }
        get coeffs_ptr() {
            return t.__wbg_get_unifiedbufferinfo_coeffs_ptr(this.__wbg_ptr) >>> 0;
        }
        get level_count() {
            return t.__wbg_get_unifiedbufferinfo_level_count(this.__wbg_ptr) >>> 0;
        }
        get levels_ptr() {
            return t.__wbg_get_unifiedbufferinfo_levels_ptr(this.__wbg_ptr) >>> 0;
        }
        get optional_gate_log2_dc() {
            return t.__wbg_get_unifiedbufferinfo_optional_gate_log2_dc(this.__wbg_ptr);
        }
        get optional_headers_count() {
            return t.__wbg_get_unifiedbufferinfo_optional_headers_count(this.__wbg_ptr) >>> 0;
        }
        get optional_headers_ptr() {
            return t.__wbg_get_unifiedbufferinfo_optional_headers_ptr(this.__wbg_ptr) >>> 0;
        }
        get optional_headers_version() {
            return t.__wbg_get_unifiedbufferinfo_optional_headers_version(this.__wbg_ptr) >>> 0;
        }
        get optional_periodic_log2_dc() {
            return t.__wbg_get_unifiedbufferinfo_optional_periodic_log2_dc(this.__wbg_ptr);
        }
        get optional_sa_log2_dc() {
            return t.__wbg_get_unifiedbufferinfo_optional_sa_log2_dc(this.__wbg_ptr);
        }
        get radii_count() {
            return t.__wbg_get_unifiedbufferinfo_radii_count(this.__wbg_ptr) >>> 0;
        }
        get radii_ptr() {
            return t.__wbg_get_unifiedbufferinfo_radii_ptr(this.__wbg_ptr) >>> 0;
        }
        get validity_count() {
            return t.__wbg_get_unifiedbufferinfo_validity_count(this.__wbg_ptr) >>> 0;
        }
        get validity_diagnostics_count() {
            return t.__wbg_get_unifiedbufferinfo_validity_diagnostics_count(this.__wbg_ptr) >>> 0;
        }
        get validity_diagnostics_ptr() {
            return t.__wbg_get_unifiedbufferinfo_validity_diagnostics_ptr(this.__wbg_ptr) >>> 0;
        }
        get validity_diagnostics_words_per_block() {
            return t.__wbg_get_unifiedbufferinfo_validity_diagnostics_words_per_block(this.__wbg_ptr) >>> 0;
        }
        get validity_level_count() {
            return t.__wbg_get_unifiedbufferinfo_validity_level_count(this.__wbg_ptr) >>> 0;
        }
        get validity_levels_ptr() {
            return t.__wbg_get_unifiedbufferinfo_validity_levels_ptr(this.__wbg_ptr) >>> 0;
        }
        get validity_ptr() {
            return t.__wbg_get_unifiedbufferinfo_validity_ptr(this.__wbg_ptr) >>> 0;
        }
        ...
        set coeffs_count(e) {
            t.__wbg_set_unifiedbufferinfo_coeffs_count(this.__wbg_ptr, e);
        }
        set coeffs_ptr(e) {
            t.__wbg_set_unifiedbufferinfo_coeffs_ptr(this.__wbg_ptr, e);
        }
        set level_count(e) {
            t.__wbg_set_unifiedbufferinfo_level_count(this.__wbg_ptr, e);
        }
        set levels_ptr(e) {
            t.__wbg_set_unifiedbufferinfo_levels_ptr(this.__wbg_ptr, e);
        }
        set optional_gate_log2_dc(e) {
            t.__wbg_set_unifiedbufferinfo_optional_gate_log2_dc(this.__wbg_ptr, e);
        }
        set optional_headers_count(e) {
            t.__wbg_set_unifiedbufferinfo_optional_headers_count(this.__wbg_ptr, e);
        }
        set optional_headers_ptr(e) {
            t.__wbg_set_unifiedbufferinfo_optional_headers_ptr(this.__wbg_ptr, e);
        }
        set optional_headers_version(e) {
            t.__wbg_set_unifiedbufferinfo_optional_headers_version(this.__wbg_ptr, e);
        }
        set optional_periodic_log2_dc(e) {
            t.__wbg_set_unifiedbufferinfo_optional_periodic_log2_dc(this.__wbg_ptr, e);
        }
        set optional_sa_log2_dc(e) {
            t.__wbg_set_unifiedbufferinfo_optional_sa_log2_dc(this.__wbg_ptr, e);
        }
        set radii_count(e) {
            t.__wbg_set_unifiedbufferinfo_radii_count(this.__wbg_ptr, e);
        }
        set radii_ptr(e) {
            t.__wbg_set_unifiedbufferinfo_radii_ptr(this.__wbg_ptr, e);
        }
        set validity_count(e) {
            t.__wbg_set_unifiedbufferinfo_validity_count(this.__wbg_ptr, e);
        }
        set validity_diagnostics_count(e) {
            t.__wbg_set_unifiedbufferinfo_validity_diagnostics_count(this.__wbg_ptr, e);
        }
        set validity_diagnostics_ptr(e) {
            t.__wbg_set_unifiedbufferinfo_validity_diagnostics_ptr(this.__wbg_ptr, e);
        }
        set validity_diagnostics_words_per_block(e) {
            t.__wbg_set_unifiedbufferinfo_validity_diagnostics_words_per_block(this.__wbg_ptr, e);
        }
        set validity_level_count(e) {
            t.__wbg_set_unifiedbufferinfo_validity_level_count(this.__wbg_ptr, e);
        }
        set validity_levels_ptr(e) {
            t.__wbg_set_unifiedbufferinfo_validity_levels_ptr(this.__wbg_ptr, e);
        }
        set validity_ptr(e) {
            t.__wbg_set_unifiedbufferinfo_validity_ptr(this.__wbg_ptr, e);
        }
    ...
    function o_() {
        const n = t.__wbindgen_externrefs, e = n.grow(4);
        n.set(0, void 0), n.set(e + 0, void 0), n.set(e + 1, null), n.set(e + 2, !0), n.set(e + 3, !1);
    }
    const Ce = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((n)=>t.__wbg_blabufferinfo_free(n, 1));
    typeof FinalizationRegistry > "u" || new FinalizationRegistry((n)=>t.__wbg_blalevel_free(n, 1));
    typeof FinalizationRegistry > "u" || new FinalizationRegistry((n)=>t.__wbg_blastep_free(n, 1));
    const Te = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((n)=>t.__wbg_incrementalunifiedbufferinfo_free(n, 1));
    typeof FinalizationRegistry > "u" || new FinalizationRegistry((n)=>t.__wbg_incrementalunifiedrangeinfo_free(n, 1));
    const ze = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((n)=>t.__wbg_jetbufferinfo_free(n, 1)), Be = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((n)=>t.__wbg_mandelbrotnavigator_free(n, 1));
    typeof FinalizationRegistry > "u" || new FinalizationRegistry((n)=>t.__wbg_mandelbrotstep_free(n, 1));
    const Ne = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((n)=>t.__wbg_mobiusbufferinfo_free(n, 1)), Oe = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((n)=>t.__wbg_orbitbufferinfo_free(n, 1)), De = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((n)=>t.__wbg_padebenchmark_free(n, 1)), Le = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((n)=>t.__wbg_unifiedbufferinfo_free(n, 1));
    function Ue(n, e) {
        return n = n >>> 0, f_().subarray(n / 8, n / 8 + e);
    }
    function z(n, e) {
        n = n >>> 0;
        const i = a_(), r = [];
        for(let a = n; a < n + 4 * e; a += 4)r.push(t.__wbindgen_externrefs.get(i.getUint32(a, !0)));
    ...
    let se = null;
    function f_() {
        return (se === null || se.byteLength === 0) && (se = new Float64Array(t.memory.buffer)), se;
    }
    function Ve(n, e) {
        return b_(n >>> 0, e);
    }
    let be = null;
    function ge() {
        return (be === null || be.byteLength === 0) && (be = new Uint8Array(t.memory.buffer)), be;
    }
    function v(n) {
        return n == null;
    }
    function x(n, e, i) {
        if (i === void 0) {
            const c = te.encode(n), g = e(c.length, 1) >>> 0;
            return ge().subarray(g, g + c.length).set(c), h = c.length, g;
        }
        ...
        if (o !== r) {
            ...
            const c = ge().subarray(a + o, a + r), g = te.encodeInto(n, c);
            o += g.written, a = i(a, r, o, 1) >>> 0;
        }
        return h = o, a;
    }
    ...
    let he = 0;
    function b_(n, e) {
        return he += e, he >= s_ && (le = new TextDecoder("utf-8", {
            ignoreBOM: !0,
            fatal: !0
        }), le.decode(), he = e), le.decode(ge().subarray(n, n + e));
    }
    ...
    var ho = Object.freeze({
        ...
        __wbg_get_blastep_dx: F_,
        __wbg_get_blastep_dy: S_,
        ...
        __wbg_get_jetbufferinfo_radii_count: jr,
        __wbg_get_jetbufferinfo_radii_ptr: Fr,
        ...
        __wbg_get_mobiusbufferinfo_coeffs_count: Sr,
        __wbg_get_mobiusbufferinfo_coeffs_ptr: Ar,
        __wbg_get_mobiusbufferinfo_level_count: Ir,
        __wbg_get_mobiusbufferinfo_levels_ptr: Mr,
        __wbg_get_mobiusbufferinfo_radii_count: Er,
        __wbg_get_mobiusbufferinfo_radii_ptr: Cr,
        ...
        __wbg_get_padebenchmark_pade_mismatches: Dr,
        ...
        __wbg_set_blabufferinfo_level_count: gt,
        __wbg_set_blabufferinfo_levels_ptr: lt,
        __wbg_set_blabufferinfo_ptr: ut,
        __wbg_set_blalevel_count: gi,
        __wbg_set_blalevel_max_radius_bits: li,
        ...
        __wbg_set_blastep_radius_alpha: jt,
        __wbg_set_blastep_radius_beta: Ft,
        __wbg_set_incrementalunifiedbufferinfo_certificate_version: St,
        __wbg_set_incrementalunifiedbufferinfo_certificate_words_per_block: At,
        __wbg_set_incrementalunifiedbufferinfo_certificates_count: It,
        ...
        __wbg_set_jetbufferinfo_levels_ptr: ji,
        __wbg_set_jetbufferinfo_radii_count: Fi,
        __wbg_set_jetbufferinfo_radii_ptr: Si,
        __wbg_set_mandelbrotstep_pad0: Ai,
        __wbg_set_mandelbrotstep_pad1: Ii,
        __wbg_set_mandelbrotstep_zx: Mi,
        __wbg_set_mandelbrotstep_zy: Ei,
        __wbg_set_mobiusbufferinfo_coeffs_count: Ci,
        ...
        __wbg_set_orbitbufferinfo_count: Di,
        ...
        mandelbrotnavigator_coordinate_to_pixel: gn,
        mandelbrotnavigator_current_log2_c_max: ln,
        ...
        mandelbrotnavigator_get_reference_orbit_len: jn,
        mandelbrotnavigator_get_reference_params: Fn,
        mandelbrotnavigator_is_in_transition: Sn,
        mandelbrotnavigator_new: An,
        mandelbrotnavigator_origin: In,
        mandelbrotnavigator_pixel_to_complex: Mn,
        mandelbrotnavigator_reference_origin: En,
        mandelbrotnavigator_reset_step_clock: Cn,
        ...
        mandelbrotnavigator_set_dynamic_block_validity: On,
    ...
    c_(ho);
    He();
    const yo = 4, $e = 19, ko = 6, Pe = 27, xo = 4;
    function Ro(n, e) {
    ...
    function So(n) {
        if (n.version !== yo || n.wordsPerBlock !== $e || n.rangesWords % ko !== 0 || n.coefficientFloats % Pe !== 0) return !1;
        const e = n.coefficientFloats / Pe;
        return n.sidecarFloats === e * xo && n.certificateWords === e * $e;
    }
    const Re = self;
    let f, y = 0, Y = !1, d = 0, j = !1, p = 0, G = 0, ye = !1, J = !1, Ao = 0, L = 0, _e = Number.NaN, ue = -1, de = -1, Io = 0, V = 0, H = 0, je = 0, Je = 0, Fe = "none", F = "none", I = "";
    const Se = 50, Mo = 2, We = 1e7, Eo = Se, Co = Se;
    function S(n, e) {
        Re.postMessage(n, e ?? []);
    }
    function O() {
    ...
    function To(n) {
        console.log("[REF worker] RESET (fresh navigator)", n.cx.slice(0, 14), "scale", n.scale.slice(0, 10)), f?.free(), f = new xe(n.cx, n.cy, n.scale, n.angle), f.set_precision_budget(n.precisionBudget), y = n.jobId, d = 0, j = !1, p = n.tableGeneration ?? 0, G = n.maxIterations, J = !1, Ye(n.approximationMode), f.set_bla_epsilon(n.blaEpsilon), f.set_gate_emission(!!n.gateEmission), f.set_dynamic_block_validity(!!n.dynamicBlockValidity), f.set_incremental_reference_table(!!n.incrementalReferenceTable), f.set_max_bla_skip(n.maxBlaSkip), f.set_viewport_aspect(n.viewportAspect ?? Number.NaN), _e = f.current_log2_c_max(), ue = -1, de = -1, V = 0, H = 0, je = 0, Je = 0, Fe = "none", F = "epoch-reset", I = "", C(n.jobId);
    }
    function zo(n, e, i) {
        const s = Math.max(0, i - e), o = new Float32Array(k.buffer, n + e * 4 * Float32Array.BYTES_PER_ELEMENT, s * 4), c = new Float32Array(s * 2);
        for(let g = 0; g < s; g++)c[g * 2] = o[g * 4], c[g * 2 + 1] = o[g * 4 + 1];
        return c;
    }
    function Qe(n, e) {
    ...
    function ce(n, e) {
        ...
        const r = L, a = p, s = i.current_log2_c_max();
        if (!pe(i, n, r, a)) return H++, {
            hasMore: !1,
            published: !1
        };
        const o = i.advance_incremental_unified_reference(e, Eo, Co);
        try {
            if (!pe(i, n, r, a)) return H++, {
                hasMore: !1,
                published: !1
            };
            const c = new Uint32Array(k.buffer, o.ranges_ptr, o.range_count * 6), g = new Uint32Array(c), l = new Float32Array(k.buffer, o.coeffs_ptr, o.coeffs_count * 27), w = new Float32Array(l), u = new Float32Array(k.buffer, o.radii_ptr, o.radii_count * 4), Q = new Float32Array(u);
            if (!So({
                version: o.certificate_version,
                wordsPerBlock: o.certificate_words_per_block,
                rangesWords: g.length,
            ...
            const A = new Uint32Array(k.buffer, o.certificates_ptr, o.certificates_count * o.certificate_words_per_block), fe = new Uint32Array(A);
            if (!pe(i, n, r, a)) return H++, {
                hasMore: !1,
                published: !1
            };
            const B = o.has_more !== 0 || o.covered_orbit_len < e + 1, U = g.length > 0 || o.reset !== 0;
            if (U) {
                const X = Fo(o.reset !== 0, o.certificates_count), b = o.reset !== 0 ? "epoch-reset" : F === "none" ? X : F;
                o.certificates_count > 0 && b === "reference-growth" && (je += o.certificates_count), b !== "none" && (Fe = b);
                ...
                S({
                    ...
                    tableGeneration: a,
                    maxIterations: N,
                    capacityOrbitLength: Bo(Math.max(1024, N + 1)),
                    ...
                    referenceGrowthCertificates: je,
                    viewportOnlyCertificateBuilds: Je,
                    lastCertificateBuildCause: Fe,
                    yields: V,
                    cancellations: H
                }, [
                    g.buffer,
    ...
    function No(n, e) {
        ...
        if (o === I) return;
        const c = performance.now(), g = i.compute_unified_header(e);
        try {
            if (!pe(i, n, r, a)) {
                H++;
                return;
    ...
    function Ge(n, e, i) {
        if (!f || n !== y || Y) return;
        const r = f.get_approximation_mode(), a = (r === 3 || r === 4 || r === 5) && d > 0 && e <= Math.ceil(d * 1.5), s = d >= e || a, o = j && (r === 3 || r === 4 || r === 5), c = s ? d : Math.max(d, e);
        if (s && !o || i < c || r === 0) return;
        const g = L, l = r === 3, w = r === 4, u = r === 5, Q = u ? "unified" : w ? "mobius" : l ? "jet" : "bla", A = (R, E)=>{
            S({
                type: "tableProgress",
                jobId: n,
                refId: g,
        ...
        if (!l && !w && !u) {
            ...
            A(.9, "transfer");
            const E = new Float32Array(k.buffer, R.ptr, R.count * 12), T = new Float32Array(E.length);
            T.set(E);
        ...
        u && m !== void 0 ? ((m & 1) !== 0 && A(1 / 3, "coefficients"), (m & 2) !== 0 && A(2 / 3, "bounds"), (m & 12) !== 0 && A(.85, "radii"), (m & 15) !== 0 && A(.9, "transfer"), (m & 1) === 0 && (B = 0), (m & 2) === 0 && (U = 0), (m & 12) === 0 && (X = 0)) : A(.9, "transfer");
        const we = u ? {
            coefficientsMs: B,
            boundsMs: U,
            radiiMs: X,
        ...
        if (d = Math.max(d, c), j = !1, u && f.get_dynamic_block_validity() && m === 16 && ue === g && de === p) {
            S({
                type: "headersReady",
                jobId: n,
                refId: g,
        ...
        const Ae = new Float32Array(k.buffer, b.radii_ptr, b.radii_count * 4), Z = new Float32Array(Ae.length);
        Z.set(Ae);
        const Ie = new Uint32Array(k.buffer, b.levels_ptr, b.level_count * 4), q = new Uint32Array(Ie.length);
        if (q.set(Ie), u && m !== void 0 && (m & 4) !== 0 && (m & -21) === 0 && ue === g && de === p) {
            S({
                type: "radiiReady",
                jobId: n,
                refId: g,
        ...
        if (u && b.validity_count > 0) {
            ...
            const R = new Float32Array(k.buffer, b.validity_ptr, b.validity_count * b.validity_words_per_block), E = new Float32Array(R.length);
            E.set(R);
            ...
            ee.set(T);
            const P = new Uint32Array(k.buffer, b.validity_levels_ptr, b.validity_level_count * 4), Ee = new Uint32Array(P.length);
            Ee.set(P), $ = {
        ...
        M && ve.push(M.data.buffer), $ && ve.push($.envelopes.buffer, $.diagnostics.buffer, $.levels.buffer), S(Ze, ve);
    }
    function ke(n, e, i) {
        if (!f) return 0;
        const r = f.compute_reference_orbit_chunk(Se, i);
        J = !1;
        const a = zo(r.ptr, r.offset, r.count), [s, o] = f.get_reference_params();
        r.offset === 0 ? (F = "epoch-reset", L = ++Ao, d = 0, j = !1, I = "", console.log("[REF worker] orbit (re)start refId=", L, "ref=", s.slice(0, 14))) : F === "none" && (F = "reference-growth");
    ...
    async function C(n) {
        ...
        try {
            for(; !Y && f && n === y;){
                const i = G, r = Math.min(i, We), a = Math.min(i * Mo, We), s = Math.max(0, f.get_reference_orbit_len()), o = f.get_approximation_mode() === 5 && f.get_dynamic_block_validity() && f.get_incremental_reference_table();
                if (J || s < r) {
                    const g = ke(n, i, r);
                    o && g > 0 && ce(n, a), V += o ? 1 : 0, await O();
                    continue;
                }
                if (o) {
                    const g = ce(n, i);
                    ...
                    const l = ce(n, Math.min(s, a));
                    if (l.published || l.hasMore) {
                        V++, await O();
                        continue;
                    }
                    if (No(n, i), await O(), G <= i && !J) break;
                    continue;
                }
                if (s >= a) {
            ...
            if (ye = !1, !e && !Y && f) {
                const i = Math.max(0, f.get_reference_orbit_len()), r = (d === 0 || j) && f.get_approximation_mode() !== 0;
                (n !== y || i < G || J || r) && C(y);
            }
        }
    }
        ...
        try {
            switch(e.type){
                    ...
                    if (f && e.jobId === y) {
                        ...
                        if (i === 3 || i === 4 || i === 5) {
                            ...
                            if (!Number.isFinite(_e) || r > _e || r < _e - 2) {
                                _e = r;
                                const a = i === 5 && f.get_dynamic_block_validity() && f.get_incremental_reference_table(), s = jo("viewport-update");
                                (!a || s) && (j = !0);
                            }
                        }
                        C(e.jobId);
                ...
                case "setApproximationMode":
                    e.jobId === y && (Ye(e.approximationMode), f?.get_incremental_reference_table() && (f.set_incremental_reference_table(!1), f.set_incremental_reference_table(!0)), d = 0, j = !1, I = "", F = "epoch-reset", p = e.tableGeneration, C(e.jobId));
                    break;
                case "setBlaEpsilon":
                    f && e.jobId === y && (f.set_bla_epsilon(e.blaEpsilon), d = 0, j = !1, I = "", F = "epoch-reset", p = e.tableGeneration, C(e.jobId));
                    break;
                case "setGateEmission":
                    f && e.jobId === y && (f.set_gate_emission(e.on), d = 0, j = !1, I = "", p = e.tableGeneration, C(e.jobId));
                    break;
                case "setDynamicBlockValidity":
                    f && e.jobId === y && (f.set_dynamic_block_validity(e.on), d = 0, j = !1, I = "", F = "epoch-reset", p = e.tableGeneration, C(e.jobId));
                    break;
                case "setIncrementalReferenceTable":
                    f && e.jobId === y && (f.set_incremental_reference_table(e.on), d = 0, j = !1, I = "", F = "epoch-reset", p = e.tableGeneration, C(e.jobId));
                    break;
                case "setMaxBlaSkip":
                    f && e.jobId === y && (f.set_max_bla_skip(e.maxBlaSkip), d = 0, j = !1, I = "", F = "epoch-reset", p = e.tableGeneration, C(e.jobId));
                    break;
                case "findMinibrot":
                    if (f && e.jobId === y) {
